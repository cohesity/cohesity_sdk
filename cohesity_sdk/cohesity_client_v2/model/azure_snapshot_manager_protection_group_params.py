...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.azure_snapshot_manager_protection_group_object_params import AzureSnapshotManagerProtectionGroupObjectParams
