...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.create_group_params import CreateGroupParams
    from cohesity_sdk.cohesity_client_v2.model.group_params_all_of import GroupParamsAllOf
