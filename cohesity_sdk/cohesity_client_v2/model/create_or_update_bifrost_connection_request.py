...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.connection_subnet import ConnectionSubnet
    globals()['ConnectionSubnet'] = ConnectionSubnet


class CreateOrUpdateBifrostConnectionRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tenant_id, subnet, *args, **kwargs):  # noqa: E501
        """CreateOrUpdateBifrostConnectionRequest - a model defined in OpenAPI
