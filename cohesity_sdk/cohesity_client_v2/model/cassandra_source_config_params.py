...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.cassandra_port_info import CassandraPortInfo
    from cohesity_sdk.cohesity_client_v2.model.cassandra_security_info import CassandraSecurityInfo
