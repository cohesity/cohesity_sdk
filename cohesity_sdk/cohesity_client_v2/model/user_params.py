...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.create_user_params import CreateUserParams
    from cohesity_sdk.cohesity_client_v2.model.user_params_all_of import UserParamsAllOf
