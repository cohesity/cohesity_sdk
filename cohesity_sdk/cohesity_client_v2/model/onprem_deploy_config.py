...
def lazy_import():
    ...
    from cohesity_sdk.cohesity_client_v2.model.onprem_deploy_config_all_of import OnpremDeployConfigAllOf
    from cohesity_sdk.cohesity_client_v2.model.onprem_deploy_params import OnpremDeployParams
