...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.common_cloud_tier_settings import CommonCloudTierSettings
    from cohesity_sdk.cohesity_client_v2.model.oracle_tier_all_of import OracleTierAllOf
