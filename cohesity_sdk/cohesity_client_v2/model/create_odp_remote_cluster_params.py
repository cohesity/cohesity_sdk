...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.create_odp_remote_cluster_params_all_of import CreateOdpRemoteClusterParamsAllOf
    from cohesity_sdk.cohesity_client_v2.model.storage_domain_pair import StorageDomainPair
