...
def lazy_import():
    ...
    from cohesity_sdk.cohesity_client_v2.model.helios_on_prem_ssh_config import HeliosOnPremSSHConfig
    from cohesity_sdk.cohesity_client_v2.model.helios_on_prem_vm_node import HeliosOnPremVMNode
