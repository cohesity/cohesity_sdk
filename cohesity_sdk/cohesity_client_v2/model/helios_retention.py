...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.data_lock_config import DataLockConfig
    from cohesity_sdk.cohesity_client_v2.model.helios_tier import HeliosTier
