...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.rigel_claim_info import RigelClaimInfo
    from cohesity_sdk.cohesity_client_v2.model.rigel_connection_info import RigelConnectionInfo
