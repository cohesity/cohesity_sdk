...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.create_ldap_params import CreateLdapParams
    from cohesity_sdk.cohesity_client_v2.model.ldap_all_of import LdapAllOf
