...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.helios_frequency_schedule import HeliosFrequencySchedule
    from cohesity_sdk.cohesity_client_v2.model.helios_week_schedule_all_of import HeliosWeekScheduleAllOf
    globals()['HeliosFrequencySchedule'] = HeliosFrequencySchedule
    globals()['HeliosWeekScheduleAllOf'] = HeliosWeekScheduleAllOf


class HeliosWeekSchedule(ModelComposed):
