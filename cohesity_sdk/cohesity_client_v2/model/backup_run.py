...
def lazy_import():
    from cohesity_sdk.cohesity_client_v2.model.backup_attempt import BackupAttempt
    from cohesity_sdk.cohesity_client_v2.model.snapshot_info import SnapshotInfo
