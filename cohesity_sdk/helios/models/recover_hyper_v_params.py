...
class RecoverHyperVParams(BaseModel):
    ...
    mount_volume_params: Optional[MountHyperVVolumeParams] = Field(default=None, description="Specifies the parameters to mount HyperV Volumes.", alias="mountVolumeParams")
    ...
    recover_file_and_folder_params: Optional[RecoverHyperVFileAndFolderParams] = Field(default=None, description="Specifies the parameters to recover files and folders.", alias="recoverFileAndFolderParams")
    recover_vm_params: Optional[RecoverHyperVVmParams] = Field(default=None, description="Specifies the parameters to recover HyperV VM.", alias="recoverVmParams")
    recovery_action: StrictStr = Field(description="Specifies the type of recovery action to be performed.", alias="recoveryAction")
    __properties: ClassVar[List[str]] = ["downloadFileAndFolderParams", "mountVolumeParams", "objects", "recoverFileAndFolderParams", "recoverVmParams", "recoveryAction"]

    @field_validator('recovery_action')
    def recovery_action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RecoverVMs', 'InstantVolumeMount', 'RecoverFiles']):
            raise ValueError("must be one of enum values ('RecoverVMs', 'InstantVolumeMount', 'RecoverFiles')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mountVolumeParams": MountHyperVVolumeParams.from_dict(obj["mountVolumeParams"]) if obj.get("mountVolumeParams") is not None else None,
            ...
            "recoverFileAndFolderParams": RecoverHyperVFileAndFolderParams.from_dict(obj["recoverFileAndFolderParams"]) if obj.get("recoverFileAndFolderParams") is not None else None,
            "recoverVmParams": RecoverHyperVVmParams.from_dict(obj["recoverVmParams"]) if obj.get("recoverVmParams") is not None else None,
