...
class AttachCloudDomainResponse(BaseModel):
    """
    AttachCloudDomainResponse
    """ # noqa: E501
    cloud_domain_id: Optional[StrictInt] = Field(default=None, description="Specifies the Id of the cloud domain..", alias="cloudDomainId")
    __properties: ClassVar[List[str]] = ["cloudDomainId"]
