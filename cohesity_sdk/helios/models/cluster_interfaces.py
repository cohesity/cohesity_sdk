...
class ClusterInterfaces(BaseModel):
    """
    Specifies the interfaces present on a Cluster grouped by the Node where they are present.
    """ # noqa: E501
    nodes: Optional[List[NodeInterfaces]] = Field(default=None, description="Specifies the list of nodes present in the cluster. If the request was sent to a free node, then this list will have exactly one entry.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [NodeInterfaces.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
