...
class CouchbaseIndexedObject(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Specifies the Couchbase Object Type. For Couchbase this is alywas set to Bucket.")
    __properties: ClassVar[List[str]] = ["name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CouchbaseBuckets']):
            raise ValueError("must be one of enum values ('CouchbaseBuckets')")
        return value
