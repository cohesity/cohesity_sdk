...
class RecoverIsilonNasVolumeParams(BaseModel):
    """
    ...
    isilon_target_params: Optional[RecoverIsilonToIsilonVolumeTargetParams] = Field(default=None, description="Specifies the params for a Isilon recovery target.", alias="isilonTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isilonTargetParams": RecoverIsilonToIsilonVolumeTargetParams.from_dict(obj["isilonTargetParams"]) if obj.get("isilonTargetParams") is not None else None,
