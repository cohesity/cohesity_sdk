...
class RecoverCassandraSnapshotParams(BaseModel):
    ...
    objects: Optional[List[RecoverCassandraNoSqlObjectParams]] = Field(default=None, description="Specifies details of objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [RecoverCassandraNoSqlObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
