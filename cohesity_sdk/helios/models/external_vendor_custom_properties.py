...
class ExternalVendorCustomProperties(BaseModel):
    """
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Specifies the unique key for custom property.")
    value: Optional[StrictStr] = Field(default=None, description="Specifies the value for the above custom key.")
