...
class PrincipalParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["activeDirectoryParams", "clusters", "createdTimeUsecs", "description", "effectiveTimeUsecs", "email", "lastUpdatedTimeUsecs", "name", "objectClass", "principalType", "roles"]
