...
class McmObjectIdentifier(BaseModel):
    """
    ...
    object_id: Optional[StrictInt] = Field(description="Specifies the object id.", alias="objectId")
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "objectId", "regionId"]
