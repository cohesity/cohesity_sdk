...
class AvailableReleaseVersion(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if release_stage (nullable) is None
        # and model_fields_set contains the field
        if self.release_stage is None and "release_stage" in self.model_fields_set:
            _dict['releaseStage'] = None
