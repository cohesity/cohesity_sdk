...
class Tags(BaseModel):
    ...
    """ # noqa: E501
    has_anomaly_tag: Optional[StrictBool] = Field(default=None, description="Specifies whether the run has an anomaly tag.", alias="hasAnomalyTag")
    tags: Optional[List[SnapshotTag]] = Field(default=None, description="Specifies the tags associated with the backup run.")
    __properties: ClassVar[List[str]] = ["hasAnomalyTag", "tags"]
