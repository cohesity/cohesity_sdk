...
class FortknoxAzureVaultRespParams(BaseModel):
    """
    Fortknox Azure vault related params.
    """ # noqa: E501
    storage_class: Optional[StrictStr] = Field(default=None, description="Specifies the Azure storage class.", alias="storageClass")
