...
class HeliosCassandraObjectsInner(BaseModel):
    """
    ...
    keyspace_type: Optional[StrictStr] = Field(default=None, description="Specifies type of Keyspace.", alias="keyspaceType")
    type: Optional[StrictStr] = Field(default=None, description="Specifies the Cassandra Object type.")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "regionId", "name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "id", "keyspaceType", "type"]
    ...
    @field_validator('keyspace_type')
    def keyspace_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['kRegular', 'kGraph', 'kSystem']):
            raise ValueError("must be one of enum values ('kRegular', 'kGraph', 'kSystem')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CassandraKeyspaces', 'CassandraTables']):
            raise ValueError("must be one of enum values ('CassandraKeyspaces', 'CassandraTables')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if keyspace_type (nullable) is None
        # and model_fields_set contains the field
        if self.keyspace_type is None and "keyspace_type" in self.model_fields_set:
            _dict['keyspaceType'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "keyspaceType": obj.get("keyspaceType"),
            "type": obj.get("type")
        })
        return _obj
