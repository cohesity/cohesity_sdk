...
class S3CompatibleTargetParams(BaseModel):
    """
    ...
    new_target_config: Optional[S3CompatibleNewTargetConfig] = Field(default=None, description="Specifies the configuration for recovering to a new target.", alias="newTargetConfig")
    ...
    recover_to_original_target: StrictBool = Field(description="Specifies whether to recover to the original target. If true, originalTargetConfig must be specified. If false, newTargetConfig must be specified.", alias="recoverToOriginalTarget")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newTargetConfig": S3CompatibleNewTargetConfig.from_dict(obj["newTargetConfig"]) if obj.get("newTargetConfig") is not None else None,
