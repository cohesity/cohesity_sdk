...
class UserAPIKeys(BaseModel):
    ...
    """ # noqa: E501
    api_keys: Optional[List[UserAPIKey]] = Field(default=None, description="List of user owned API Keys.", alias="apiKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiKeys": [UserAPIKey.from_dict(_item) for _item in obj["apiKeys"]] if obj.get("apiKeys") is not None else None
        })
        return _obj
