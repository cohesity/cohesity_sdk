...
class McmObjectsActivity(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_refresh_task_active (nullable) is None
        # and model_fields_set contains the field
        if self.is_refresh_task_active is None and "is_refresh_task_active" in self.model_fields_set:
            _dict['isRefreshTaskActive'] = None
