...
class RecoverExperimentalAdapterSnapshotParams(BaseModel):
    """
    ...
    objects: Optional[List[RecoverExperimentalAdapterObjectParams]] = Field(default=None, description="Specifies the local snapshot ids and other details of the objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [RecoverExperimentalAdapterObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
