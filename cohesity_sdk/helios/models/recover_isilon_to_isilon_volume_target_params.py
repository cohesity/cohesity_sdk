...
class RecoverIsilonToIsilonVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToIsilonVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalIsilonTargetParams] = Field(default=None, alias="originalSourceConfig")
