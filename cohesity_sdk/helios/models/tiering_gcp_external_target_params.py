...
class TieringGcpExternalTargetParams(BaseModel):
    """
    ...
    storage_class: Optional[StrictStr] = Field(description="Specifies the GCP External Target class.", alias="storageClass")
    __properties: ClassVar[List[str]] = ["authenticationMethod", "bucketName", "clientEmailAddress", "clientPrivateKey", "projectId", "region", "storageClass"]
    ...
    def storage_class_validate_enum(cls, value):
        ...
        if value not in set(['GCPStandard']):
            raise ValueError("must be one of enum values ('GCPStandard')")
        return value
