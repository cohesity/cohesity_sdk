...
class RecoverSqlAppFilesParams(BaseModel):
    """
    Specifies the parameters to recover SQL databases to flat files.
    """ # noqa: E501
    sql_target_params: SqlTargetParamsForRecoverSqlAppFiles = Field(alias="sqlTargetParams")
