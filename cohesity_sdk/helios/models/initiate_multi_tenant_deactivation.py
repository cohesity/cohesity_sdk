...
class InitiateMultiTenantDeactivation(BaseModel):
    """
    Specifies the response received when tenant deactivations are triggered.
    """ # noqa: E501
    tenants: Optional[List[InitiateTenantDeactivation]] = Field(default=None, description="Specifies the tenants for whom the deactivation was requested.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tenants": [InitiateTenantDeactivation.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
