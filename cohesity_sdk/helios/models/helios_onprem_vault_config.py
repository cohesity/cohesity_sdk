...
class HeliosOnpremVaultConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backupRunType", "configId", "copyOnRunSuccess", "retention", "schedule", "clusterId", "clusterName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HeliosOnpremVaultConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HeliosOnpremVaultConfig from a dict"""
        if obj is None:
            return None
