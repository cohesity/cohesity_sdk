...
class HeliosSearchIndexedObjectsClusterError(BaseModel):
    """
    The error from an individual cluster while calling MCM Search Indexed Objects.
    """ # noqa: E501
    cluster_identifier: Optional[StrictStr] = Field(default=None, description="clusterIdentifier for the error.", alias="clusterIdentifier")
    error_message: Optional[StrictStr] = Field(default=None, description="The error message.", alias="errorMessage")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "errorMessage"]
