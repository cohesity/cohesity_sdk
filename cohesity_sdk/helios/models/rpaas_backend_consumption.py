...
class RpaasBackendConsumption(BaseModel):
    """
    ...
    usage: Optional[List[RpaasBackendUsage]] = Field(default=None, description="The current usage per region.")
    __properties: ClassVar[List[str]] = ["regionId", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": [RpaasBackendUsage.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None
        })
        return _obj
