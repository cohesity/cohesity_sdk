...
class AwsSnapshotParams(BaseModel):
    """
    Specifies parameters of AWS type snapshots.
    """ # noqa: E501
    protection_type: Optional[StrictStr] = Field(default=None, description="Specifies the protection type of AWS snapshots.", alias="protectionType")
