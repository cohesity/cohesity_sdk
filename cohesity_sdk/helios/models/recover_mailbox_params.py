...
class RecoverMailboxParams(BaseModel):
    ...
    ews_exchange_target: Optional[EwsExchangeTargetParam] = Field(default=None, description="Specifies the Exchange target to recover to.", alias="ewsExchangeTarget")
