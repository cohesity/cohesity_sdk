...
class Idp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certificate", "defaultClusters", "defaultRegions", "defaultRoles", "domain", "isEnabled", "issuerId", "name", "sfAccountId", "signRequest", "ssoUrl", "tenantId", "id"]
