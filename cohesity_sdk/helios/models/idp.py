...
class Idp(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="Specifies the Id of the IDP Configuration.")
    __properties: ClassVar[List[str]] = ["certificate", "defaultClusters", "defaultRegions", "defaultRoles", "domain", "isEnabled", "issuerId", "name", "sendUniqueAcsUrl", "sfAccountId", "signRequest", "ssoUrl", "tenantId", "id"]
