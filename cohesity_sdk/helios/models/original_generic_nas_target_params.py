...
class OriginalGenericNasTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["continueOnError", "encryptionEnabled", "overwriteExistingFile", "preserveFileAttributes", "vlanConfig"]
