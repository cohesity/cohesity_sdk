...
class RecoverFlashbladeFilesParams(BaseModel):
    """
    ...
    flashblade_target_params: Optional[RecoverFlashbladeToFlashbladeFilesTargetParams] = Field(default=None, description="Specifies the params for a Flashblade recovery target.", alias="flashbladeTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flashbladeTargetParams": RecoverFlashbladeToFlashbladeFilesTargetParams.from_dict(obj["flashbladeTargetParams"]) if obj.get("flashbladeTargetParams") is not None else None,
