...
class HeliosRpaasConfig(BaseModel):
    """
    ...
    target_id: Optional[StrictInt] = Field(description="Specifies the RPaaS target to copy the Snapshots.", alias="targetId")
    target_name: Optional[StrictStr] = Field(default=None, description="Specifies the RPaaS target name where Snapshots are copied.", alias="targetName")
    target_type: Optional[StrictStr] = Field(default=None, description="Specifies the RPaaS target type where Snapshots are copied.", alias="targetType")
    __properties: ClassVar[List[str]] = ["backupRunType", "configId", "copyOnRunSuccess", "retention", "schedule", "targetId", "targetName", "targetType"]
