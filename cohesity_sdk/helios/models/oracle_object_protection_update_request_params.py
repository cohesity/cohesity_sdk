...
class OracleObjectProtectionUpdateRequestParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fullAutoKillTimeoutSecs", "incrAutoKillTimeoutSecs", "logAutoKillTimeoutSecs", "nfsProtocol", "objects", "persistMountpoints", "vlanParams"]
