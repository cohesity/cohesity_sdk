...
class McmObjectArchivalRunActivityParams(BaseModel):
    ...
    snapshot_expiry_time_usecs: Optional[StrictInt] = Field(default=None, description="Specifies the time of expiry of the snapshot Unix epoch Timestamp(in microseconds).", alias="snapshotExpiryTimeUsecs")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if snapshot_expiry_time_usecs (nullable) is None
        # and model_fields_set contains the field
        if self.snapshot_expiry_time_usecs is None and "snapshot_expiry_time_usecs" in self.model_fields_set:
            _dict['snapshotExpiryTimeUsecs'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshotExpiryTimeUsecs": obj.get("snapshotExpiryTimeUsecs"),
