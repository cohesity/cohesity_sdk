...
class ExchangeCaCertificatesRequest(BaseModel):
    """
    Specifies the request of exchange ca certificate request
    """ # noqa: E501
    ca_certificates: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="Specifies ca cert in pem format", alias="caCertificates")
    cluster_id: Optional[StrictInt] = Field(default=None, description="Specifies the cluster id.", alias="clusterId")
    __properties: ClassVar[List[str]] = ["caCertificates", "clusterId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "caCertificates": obj.get("caCertificates"),
