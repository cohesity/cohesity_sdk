...
class NodeInfo(BaseModel):
    ...
    cpu: Optional[StrictInt] = Field(default=None, description="Number of CPUs")
    ...
    is_node_reachable: Optional[StrictBool] = Field(default=None, description="Specifies whether the node is reachable or not", alias="isNodeReachable")
    ...
    system_memory_bytes: Optional[StrictInt] = Field(default=None, description="System Memory in bytes", alias="systemMemoryBytes")
