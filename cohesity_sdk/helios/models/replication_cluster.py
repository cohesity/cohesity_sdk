...
class ReplicationCluster(BaseModel):
    """
    ...
    purpose_replication: Optional[StrictBool] = Field(default=None, description="Specifies if the remote cluster is added for replication.", alias="purposeReplication")
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "clusterName", "purposeReplication"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if purpose_replication (nullable) is None
        # and model_fields_set contains the field
        if self.purpose_replication is None and "purpose_replication" in self.model_fields_set:
            _dict['purposeReplication'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "purposeReplication": obj.get("purposeReplication")
        })
        return _obj
