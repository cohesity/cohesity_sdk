...
class ExternalTarget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cloudDomains", "compression", "enableObjectLock", "errorMessage", "globalId", "id", "isWormCapable", "name", "ownershipContext", "purposeType", "status", "storageDomainName", "tenantIds", "useForApolloMrStore", "useRollingObjectLock", "archivalParams", "tieringParams"]
