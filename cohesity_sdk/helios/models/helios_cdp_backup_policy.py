...
class HeliosCdpBackupPolicy(BaseModel):
    """
    Specifies CDP (Continious Data Protection) backup settings for a Protection Group.
    """ # noqa: E501
    retention: Optional[HeliosCdpRetention] = None
    __properties: ClassVar[List[str]] = ["retention"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retention": HeliosCdpRetention.from_dict(obj["retention"]) if obj.get("retention") is not None else None
        })
        return _obj
