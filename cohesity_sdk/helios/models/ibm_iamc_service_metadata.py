...
class IbmIAMCServiceMetadata(BaseModel):
    """
    Specifies the service configuration for IAM service in IBM cloud.
    """ # noqa: E501
    fqdn: Optional[StrictStr] = Field(default=None, description="Specifies the fully qulified domain name along with the protocol information. If this value is not provided in the request, then we will set this to default value as 'https://iam.cloud.ibm.com'")
