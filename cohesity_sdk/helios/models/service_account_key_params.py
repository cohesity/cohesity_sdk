...
class ServiceAccountKeyParams(BaseModel):
    """
    Specifies the API key authentication method parameters.
    """ # noqa: E501
    client_email_address: Optional[StrictStr] = Field(default=None, description="Specifies the client email address of the external target.", alias="clientEmailAddress")
    ...
    __properties: ClassVar[List[str]] = ["clientEmailAddress", "clientPrivateKey"]
