...
class GetDataAccessSessionsResponseParams(BaseModel):
    """
    Specifies list of data access sessions.
    """ # noqa: E501
    pagination_cookie: Optional[StrictStr] = Field(default=None, description="pecifies the pagination cookie with which subsequent parts of the response can be fetched.", alias="paginationCookie")
    sessions: Optional[List[DataAccessSession]] = Field(default=None, description="Specifies list of data access sessions.")
    __properties: ClassVar[List[str]] = ["paginationCookie", "sessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessions": [DataAccessSession.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
