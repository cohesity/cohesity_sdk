...
class McmSources(BaseModel):
    """
    Specifies the list of Protection Sources on Helios MCM.
    """ # noqa: E501
    sources: Optional[List[McmSource]] = Field(default=None, description="Specifies the list of Protection Sources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sources": [McmSource.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None
        })
        return _obj
