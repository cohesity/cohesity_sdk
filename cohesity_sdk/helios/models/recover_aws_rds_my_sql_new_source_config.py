...
class RecoverAwsRdsMySqlNewSourceConfig(BaseModel):
    """
    Specifies the new destination Source configuration where the RDS MySQL instances will be recovered.
    """ # noqa: E501
    instance: Optional[RecoveryObjectIdentifier] = Field(default=None, description="Specifies the instance in which to deploy the Rds MySQL objects.")
    region: RecoveryObjectIdentifier
    source: RecoveryObjectIdentifier
    __properties: ClassVar[List[str]] = ["instance", "region", "source"]
