...
class O365HeliosSearchEmailsRequestParams(BaseModel):
    """
    ...
    domain_ids: Optional[List[StrictInt]] = Field(default=None, description="Specifies the domain Ids in which mailboxes are registered.", alias="domainIds")
    mailbox_ids: Optional[List[StrictInt]] = Field(default=None, description="Specifies the mailbox Ids which contains the emails/folders.", alias="mailboxIds")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "regionId", "domainIds", "mailboxIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if mailbox_ids (nullable) is None
        # and model_fields_set contains the field
        if self.mailbox_ids is None and "mailbox_ids" in self.model_fields_set:
            _dict['mailboxIds'] = None
