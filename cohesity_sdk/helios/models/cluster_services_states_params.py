...
class ClusterServicesStatesParams(BaseModel):
    """
    Describes the parameters for fetching services states of cluster
    """ # noqa: E501
    node_ids: Optional[List[StrictInt]] = Field(default=None, description="List of nodes whose services status is required.", alias="nodeIds")
