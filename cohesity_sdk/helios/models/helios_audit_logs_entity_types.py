...
class HeliosAuditLogsEntityTypes(BaseModel):
    """
    Specifies entity types of audit logs.
    """ # noqa: E501
    entity_types: Optional[List[StrictStr]] = Field(default=None, description="Specifies a list of audit logs entity types.", alias="entityTypes")
