...
class RecoverAwsRdsNewSourceConfig(BaseModel):
    """
    Specifies the new destination Source configuration where the RDS instances will be recovered.
    """ # noqa: E501
    network_config: Optional[RecoverAwsRdsNewSourceNetworkConfig] = Field(description="Specifies the networking configuration to be applied to the recovered VMs.", alias="networkConfig")
    region: Optional[RecoveryObjectIdentifier] = Field(description="Specifies the AWS region in which to deploy the RDS instance.")
    source: Optional[RecoveryObjectIdentifier] = Field(description="Specifies the id of the parent source to recover the RDS.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkConfig": RecoverAwsRdsNewSourceNetworkConfig.from_dict(obj["networkConfig"]) if obj.get("networkConfig") is not None else None,
