...
class RecoverVmwareVmOriginalSourceConfig(BaseModel):
    """
    Specifies the Source configuration if VM's are being recovered to Original Source.
    """ # noqa: E501
    network_config: Optional[RecoverVmwareVmOriginalSourceNetworkConfig] = Field(default=None, description="Specifies the networking configuration to be applied to the recovered VMs.", alias="networkConfig")
