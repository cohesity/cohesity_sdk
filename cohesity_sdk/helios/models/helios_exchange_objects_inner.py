...
class HeliosExchangeObjectsInner(BaseModel):
    """
    ...
    database_name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the Exchange database corresponding to the mailbox.", alias="databaseName")
    email: Optional[StrictStr] = Field(default=None, description="Specifies the email corresponding to the mailbox.")
    object_name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the Exchange mailbox.", alias="objectName")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "regionId", "name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "databaseName", "email", "objectName"]
