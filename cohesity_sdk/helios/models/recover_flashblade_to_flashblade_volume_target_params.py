...
class RecoverFlashbladeToFlashbladeVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToFlashbladeVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalFlashbladeTargetParams] = Field(default=None, alias="originalSourceConfig")
