...
class CommonIdentityProviderConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allowLocalUserLogin", "certificate", "certificateFilename", "isEnabled", "issuerId", "roles", "samlAttributeName", "signRequest", "ssoUrl"]
