...
class KubernetesLabelObject(BaseModel):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Specifies the label key")
    value: Optional[StrictStr] = Field(default=None, description="Specifies the label value")
