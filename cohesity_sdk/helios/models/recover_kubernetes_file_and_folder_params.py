...
class RecoverKubernetesFileAndFolderParams(BaseModel):
    """
    Specifies the parameters to recover files and folders.
    """ # noqa: E501
    files_and_folders: Optional[List[CommonRecoverFileAndFolderInfo]] = Field(description="Specifies the information about the files and folders to be recovered.", alias="filesAndFolders")
    kubernetes_target_params: Optional[KubernetesTargetParamsForRecoverFileAndFolder] = Field(default=None, description="Specifies the parameters to recover to a Kubernetes target.", alias="kubernetesTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["filesAndFolders", "kubernetesTargetParams", "targetEnvironment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kubernetesTargetParams": KubernetesTargetParamsForRecoverFileAndFolder.from_dict(obj["kubernetesTargetParams"]) if obj.get("kubernetesTargetParams") is not None else None,
