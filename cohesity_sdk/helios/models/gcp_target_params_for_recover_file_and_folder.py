...
class GcpTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[GcpRecoverFilesNewTargetConfig] = Field(default=None, description="Specifies the configuration for recovering to a new target.", alias="newTargetConfig")
    original_target_config: Optional[GcpRecoverFilesOriginalTargetConfig] = Field(default=None, description="Specifies the configuration for recovering to the original target.", alias="originalTargetConfig")
