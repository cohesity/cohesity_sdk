...
class CassandraSourceRegistrationPatchParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cassandraCredentials", "commitLogBackupLocation", "configDirectory", "dataCenterNames", "dseConfigurationDirectory", "dseSolrInfo", "isDseAuthenticator", "isDseTieredStorage", "jmxCredentials", "kerberosPrincipal", "seedNode", "sshPasswordCredentials", "sshPrivateKeyCredentials"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if config_directory (nullable) is None
        # and model_fields_set contains the field
        if self.config_directory is None and "config_directory" in self.model_fields_set:
            _dict['configDirectory'] = None
        ...
        # set to None if is_dse_authenticator (nullable) is None
        # and model_fields_set contains the field
        if self.is_dse_authenticator is None and "is_dse_authenticator" in self.model_fields_set:
            _dict['isDseAuthenticator'] = None

        # set to None if is_dse_tiered_storage (nullable) is None
        # and model_fields_set contains the field
        if self.is_dse_tiered_storage is None and "is_dse_tiered_storage" in self.model_fields_set:
            _dict['isDseTieredStorage'] = None
        ...
        # set to None if seed_node (nullable) is None
        # and model_fields_set contains the field
        if self.seed_node is None and "seed_node" in self.model_fields_set:
            _dict['seedNode'] = None
