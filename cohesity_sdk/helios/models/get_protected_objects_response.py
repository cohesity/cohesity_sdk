...
class GetProtectedObjectsResponse(BaseModel):
    ...
    """ # noqa: E501
    objects: Optional[List[ProtectedObjectInfo]] = Field(default=None, description="Specifies the protected object backup configuration and lastRun details if it has happned.")
    pagination_info: Optional[PaginationInfo] = Field(default=None, alias="paginationInfo")
    __properties: ClassVar[List[str]] = ["objects", "paginationInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [ProtectedObjectInfo.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
