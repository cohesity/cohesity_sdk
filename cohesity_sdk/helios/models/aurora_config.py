...
class AuroraConfig(BaseModel):
    ...
    db_option_group: Optional[RecoveryObjectIdentifier] = Field(default=None, description="Specifies entity representing the Aurora option group to use while restoring the DB.", alias="dbOptionGroup")
    db_parameter_group: Optional[RecoveryObjectIdentifier] = Field(default=None, description="Specifies the entity representing the Aurora parameter group to use while restoring the DB.", alias="dbParameterGroup")
