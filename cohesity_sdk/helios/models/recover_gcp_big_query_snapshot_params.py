...
class RecoverGCPBigQuerySnapshotParams(BaseModel):
    """
    ...
    replication_target_info: Optional[ReplicationTargetSummaryInfo] = Field(default=None, description="Specifies the replication target information if the snapshot is a replication snapshot.", alias="replicationTargetInfo")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_gcp_big_query_object_params
        if self.recover_gcp_big_query_object_params:
            _dict['recoverGCPBigQueryObjectParams'] = self.recover_gcp_big_query_object_params.to_dict()
        ...
        # set to None if replication_target_info (nullable) is None
        # and model_fields_set contains the field
        if self.replication_target_info is None and "replication_target_info" in self.model_fields_set:
            _dict['replicationTargetInfo'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverGCPBigQueryObjectParams": RecoverGCPBigQueryObjectParams.from_dict(obj["recoverGCPBigQueryObjectParams"]) if obj.get("recoverGCPBigQueryObjectParams") is not None else None
        })
        return _obj
