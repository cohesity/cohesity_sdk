...
class AntivirusScanConfig(BaseModel):
    ...
    prefix_scan_filter: Optional[FileExtensionFilter] = Field(default=None, description="For S3 usage only. Prefixes that meets these filter criteria will be sent to antivirus server for the scan. This filter is case-sensitive.", alias="prefixScanFilter")
    s3_tagging_filter: Optional[S3TaggingFilter] = Field(default=None, description="For S3 usage only. If set, only objects with these taggings will be scanned or not scanned, depending on the mode.", alias="s3TaggingFilter")
    scan_filter: Optional[FileExtensionFilter] = Field(default=None, description="Files extension that meets these filter criteria will be sent to antivirus server for the scan. This filter is case-insensitive.", alias="scanFilter")
