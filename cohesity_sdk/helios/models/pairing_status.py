...
class PairingStatus(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Pairing message for the cluster in that region.")
    status: Optional[StrictStr] = Field(default=None, description="Pairing status for the cluster in that region")
