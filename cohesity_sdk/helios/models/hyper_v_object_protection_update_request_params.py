...
class HyperVObjectProtectionUpdateRequestParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appConsistentSnapshot", "fallbackToCrashConsistentSnapshot", "indexingPolicy", "backupsCopyOnly", "excludeObjectIds"]
