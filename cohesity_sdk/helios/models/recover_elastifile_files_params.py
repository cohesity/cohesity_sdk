...
class RecoverElastifileFilesParams(BaseModel):
    ...
    """ # noqa: E501
    elastifile_target_params: Optional[RecoverElastifileToElastifileFilesTargetParams] = Field(default=None, description="Specifies the params for a Elastifile recovery target.", alias="elastifileTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elastifileTargetParams": RecoverElastifileToElastifileFilesTargetParams.from_dict(obj["elastifileTargetParams"]) if obj.get("elastifileTargetParams") is not None else None,
