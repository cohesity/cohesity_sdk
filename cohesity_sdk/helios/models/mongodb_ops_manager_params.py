...
class MongodbOpsManagerParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[MongodbNewOpsManagerConfig] = Field(default=None, description="Specifies the new destination Source configuration parameters where the VMs will be recovered. This is mandatory if recoverToNewSource is set to true.", alias="newSourceConfig")
