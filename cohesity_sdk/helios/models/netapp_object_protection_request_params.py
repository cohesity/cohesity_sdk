...
class NetappObjectProtectionRequestParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["continueOnError", "encryptionEnabled", "fileFilters", "fileLockConfig", "indexingPolicy", "prePostScript", "throttlingConfig", "backupExistingSnapshot", "continuousSnapshots", "excludeObjectIds", "protocol", "snapshotLabel", "objects"]
