...
class S3CompatibleNewTargetConfig(BaseModel):
    """
    Specifies the configuration for recovering S3 Compatible objects and buckets to a new target.
    """ # noqa: E501
    bucket: RecoveryObjectIdentifier = Field(description="Specifies the S3 Compatible bucket in which to recover S3 Objects.")
    region: RecoveryObjectIdentifier = Field(description="Specifies the region in S3 Compatible Source to recover S3 Objects.")
    source: RecoveryObjectIdentifier = Field(description="Specifies the S3 Compatible Source ID in which to recover S3 Objects.")
