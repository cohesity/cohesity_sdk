...
class OperationEvents(BaseModel):
    """
    List of events that took place during the operation.
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Specifies the message describing the event.")
    severity: Optional[StrictStr] = Field(default=None, description="Specifies the severity of an event.")
    timestamp: Optional[StrictInt] = Field(default=None, description="Specifies the unix epoch timestamp in microseconds when this event took place.")
