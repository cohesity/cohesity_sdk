...
class AwsRdsMySqlRecoveryTargetConfig(BaseModel):
    """
    Specifies the target object parameters to recover AWS RDS MySQL.
    """ # noqa: E501
    new_source_config: Optional[RecoverAwsRdsMySqlNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newSourceConfig": RecoverAwsRdsMySqlNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
