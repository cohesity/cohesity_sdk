...
class McmLastRunStatusStats(BaseModel):
    """
    Specifies the last run's status and count of objects having that status.
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Specifies the number of objects having this status.")
    status: Optional[StrictStr] = Field(default=None, description="Specifies the status of last run.")
    __properties: ClassVar[List[str]] = ["count", "status"]
