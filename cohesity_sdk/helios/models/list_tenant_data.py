...
class ListTenantData(BaseModel):
    """
    List of tenants and the clusters to which they belong.
    """ # noqa: E501
    tenants: Optional[List[HeliosTenant]] = Field(default=None, description="List of tenants and the clusters to which they belong.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tenants": [HeliosTenant.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
