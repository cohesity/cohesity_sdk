...
class HeliosIncrementalBackupPolicy(BaseModel):
    """
    Specifies incremental backup settings for a Protection Group.
    """ # noqa: E501
    schedule: Optional[HeliosIncrementalSchedule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schedule": HeliosIncrementalSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
