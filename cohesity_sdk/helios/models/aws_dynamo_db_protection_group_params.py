...
class AwsDynamoDBProtectionGroupParams(BaseModel):
    """
    ...
    objects: Optional[List[AwsDynamoDBProtectionGroupObjectParams]] = Field(default=None, description="Specifies the objects to be included in the Protection Group.")
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the parent of the objects.", alias="sourceId")
    __properties: ClassVar[List[str]] = ["excludeObjectIds", "objects", "sourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [AwsDynamoDBProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
