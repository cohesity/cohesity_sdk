...
class HeliosRemoteTargetConfig(BaseModel):
    """
    Specifies the configuration for adding remote cluster as repilcation target
    """ # noqa: E501
    cluster_id: Optional[StrictInt] = Field(description="Specifies the cluster id of the target replication cluster.", alias="clusterId")
    cluster_name: Optional[StrictStr] = Field(default=None, description="Specifies the cluster name of the target replication cluster.", alias="clusterName")
    __properties: ClassVar[List[str]] = ["clusterId", "clusterName"]
