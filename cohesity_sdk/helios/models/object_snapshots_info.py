...
class ObjectSnapshotsInfo(BaseModel):
    ...
    replication_snapshot_info: Optional[ReplicationTargetSummaryInfo] = Field(default=None, description="Specifies the replication snapshot information.", alias="replicationSnapshotInfo")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if replication_snapshot_info (nullable) is None
        # and model_fields_set contains the field
        if self.replication_snapshot_info is None and "replication_snapshot_info" in self.model_fields_set:
            _dict['replicationSnapshotInfo'] = None
