...
class ClusterOperationTypeAndId(BaseModel):
    """
    Operation type and id of the cluster operation.
    """ # noqa: E501
    operation_id: StrictStr = Field(description="Operation Id of cluster operation. ", alias="operationId")
    operation_type: StrictStr = Field(description="Operation type of cluster operation created for the request. ", alias="operationType")
    __properties: ClassVar[List[str]] = ["operationId", "operationType"]
