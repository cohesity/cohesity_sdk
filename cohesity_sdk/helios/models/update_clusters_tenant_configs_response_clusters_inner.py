...
class UpdateClustersTenantConfigsResponseClustersInner(BaseModel):
    """
    ...
    error_message: Optional[StrictStr] = Field(default=None, description="Error message for the cluster.", alias="errorMessage")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "organizationsEnabled", "organizationsStorageDomainSharingEnabled", "errorMessage"]
