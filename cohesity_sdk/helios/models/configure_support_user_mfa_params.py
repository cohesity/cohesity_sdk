...
class ConfigureSupportUserMfaParams(BaseModel):
    """
    ...
    email: Optional[StrictStr] = Field(default=None, description="Specifies email address of the support user. Required when the support user email is being modified.")
    mfa_type: Optional[StrictStr] = Field(default=None, description="Specifies the mechanism to receive the OTP code.", alias="mfaType")
    __properties: ClassVar[List[str]] = ["currentPassword", "email", "mfaType"]
