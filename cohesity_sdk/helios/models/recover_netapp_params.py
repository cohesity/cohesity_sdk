...
class RecoverNetappParams(BaseModel):
    """
    ...
    recover_file_and_folder_params: Optional[RecoverNetappFilesParams] = Field(default=None, description="Specifies the parameters to recover files.", alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverNetappNasVolumeParams] = Field(default=None, description="Specifies the parameters to recover Nas Volumes.", alias="recoverNasVolumeParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverFileAndFolderParams": RecoverNetappFilesParams.from_dict(obj["recoverFileAndFolderParams"]) if obj.get("recoverFileAndFolderParams") is not None else None,
            "recoverNasVolumeParams": RecoverNetappNasVolumeParams.from_dict(obj["recoverNasVolumeParams"]) if obj.get("recoverNasVolumeParams") is not None else None,
