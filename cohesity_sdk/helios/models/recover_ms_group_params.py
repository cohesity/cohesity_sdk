...
class RecoverMsGroupParams(BaseModel):
    ...
    target_group_owner: Optional[RecoveryObjectIdentifier] = Field(default=None, description="Specifies additional owner entity information for the selected target group. If targetGroupOwner is present then these will be added as owner and members of target group.", alias="targetGroupOwner")
    target_ms_group_param: Optional[TargetMsGroupParam] = Field(default=None, description="Specifies the target MS group parameters in case restoreToOriginal is false.", alias="targetMsGroupParam")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_group_owner (nullable) is None
        # and model_fields_set contains the field
        if self.target_group_owner is None and "target_group_owner" in self.model_fields_set:
            _dict['targetGroupOwner'] = None
