...
class SourceRegistrationPatchRequestParams(BaseModel):
    """
    Specifies the parameters to partially update the registration.
    """ # noqa: E501
    cassandra_params: Optional[CassandraSourceRegistrationPatchParams] = Field(default=None, alias="cassandraParams")
    environment: Optional[StrictStr] = Field(description="Specifies the environment type of the Protection Source to be patched. Currently the only environment supported is kCassandra")
    __properties: ClassVar[List[str]] = ["cassandraParams", "environment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cassandraParams": CassandraSourceRegistrationPatchParams.from_dict(obj["cassandraParams"]) if obj.get("cassandraParams") is not None else None,
