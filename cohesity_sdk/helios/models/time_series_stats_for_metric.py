...
class TimeSeriesStatsForMetric(BaseModel):
    """
    Specifies the time series stats for a metric.
    """ # noqa: E501
    data_points: Optional[List[DataPoint]] = Field(default=None, description="Specifies a list of data points.", alias="dataPoints")
    metric_name: Optional[StrictStr] = Field(default=None, description="Specifies the metric name.", alias="metricName")
    type: Optional[StrictStr] = Field(default=None, description="Specifies the type of the data points.")
    __properties: ClassVar[List[str]] = ["dataPoints", "metricName", "type"]
