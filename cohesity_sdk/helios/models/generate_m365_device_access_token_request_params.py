...
class GenerateM365DeviceAccessTokenRequestParams(BaseModel):
    """
    ...
    domain: Optional[StrictStr] = Field(default=None, description="Specifies the Microsoft365 domain.")
    __properties: ClassVar[List[str]] = ["deviceCode", "domain"]
