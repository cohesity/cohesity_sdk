...
class ObjectsSearchResponseBody(BaseModel):
    ...
    objects: Optional[List[SearchObject]] = Field(default=None, description="Specifies the list of Objects.")
    ...
    __properties: ClassVar[List[str]] = ["count", "objects", "paginationCookie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "objects": [SearchObject.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
