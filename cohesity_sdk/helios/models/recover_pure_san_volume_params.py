...
class RecoverPureSanVolumeParams(BaseModel):
    """
    Specifies the parameters to recover Pure SAN Volume.
    """ # noqa: E501
    pure_target_params: Optional[RecoverPureVolumeTargetParams] = Field(default=None, description="Specifies the parameters of the Pure SAN volume to recover to.", alias="pureTargetParams")
    ...
    def target_environment_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['kPure', 'kIbmFlashSystem']):
            raise ValueError("must be one of enum values ('kPure', 'kIbmFlashSystem')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pureTargetParams": RecoverPureVolumeTargetParams.from_dict(obj["pureTargetParams"]) if obj.get("pureTargetParams") is not None else None,
