...
class HeliosExtendedRetentionPolicy(BaseModel):
    """
    Specifies additional retention policies to apply to backup snapshots.
    """ # noqa: E501
    config_id: Optional[StrictStr] = Field(default=None, description="Specifies the unique identifier for the extedned  retention getting added. This field should only be set if policy is getting updated.", alias="configId")
    ...
    schedule: Optional[HeliosExtendedRetentionSchedule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": HeliosExtendedRetentionSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
