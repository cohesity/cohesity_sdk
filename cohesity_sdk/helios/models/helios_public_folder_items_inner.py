...
class HeliosPublicFolderItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "regionId", "name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "hasAttachments", "id", "itemClass", "itemSize", "parentFolderId", "receivedTimeSecs", "subject", "type"]
