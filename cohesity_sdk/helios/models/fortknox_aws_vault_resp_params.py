...
class FortknoxAwsVaultRespParams(BaseModel):
    """
    Fortknox AWS vault related params.
    """ # noqa: E501
    bucket_name: Optional[StrictStr] = Field(default=None, description="Name of the S3 bucket that is configured for a vault.", alias="bucketName")
    ...
    __properties: ClassVar[List[str]] = ["bucketName", "storageClass"]
    ...
    def storage_class_validate_enum(cls, value):
        ...
        if value not in set(['AmazonS3StandardIA', 'AmazonS3Glacier']):
            raise ValueError("must be one of enum values ('AmazonS3StandardIA', 'AmazonS3Glacier')")
        return value
