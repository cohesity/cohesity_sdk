...
class RecoverSqlAppOriginalSourceConfig(BaseModel):
    ...
    """ # noqa: E501
    capture_tail_logs: Optional[StrictBool] = Field(default=None, description="Set this to true if tail logs are to be captured before the recovery operation. This is only applicable if database is not being renamed.", alias="captureTailLogs")
    data_file_directory_location: Optional[StrictStr] = Field(default=None, description="Specifies the directory where to put the database data files. Missing directory will be automatically created. If you are overwriting the existing database then this field will be ignored.", alias="dataFileDirectoryLocation")
    log_file_directory_location: Optional[StrictStr] = Field(default=None, description="Specifies the directory where to put the database log files. Missing directory will be automatically created. If you are overwriting the existing database then this field will be ignored.", alias="logFileDirectoryLocation")
    new_database_name: Optional[StrictStr] = Field(default=None, description="Specifies a new name for the restored database. If this field is not specified, then the original database will be overwritten after recovery.", alias="newDatabaseName")
