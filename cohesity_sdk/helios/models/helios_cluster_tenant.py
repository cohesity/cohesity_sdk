...
class HeliosClusterTenant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "regionId", "activeDeactivation", "createdAtTimeMsecs", "deletedAtTimeMsecs", "description", "externalVendorMetadata", "finishedDeactivations", "id", "isManagedOnHelios", "lastUpdatedAtTimeMsecs", "name", "network", "status"]
