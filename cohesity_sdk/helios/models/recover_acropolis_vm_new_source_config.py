...
class RecoverAcropolisVmNewSourceConfig(BaseModel):
    ...
    prism_element: Optional[RecoveryObjectIdentifier] = Field(default=None, description="A Prism Element where the VM should be restored to. Applicable only when the parent source is Prism Central.", alias="prismElement")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if prism_element (nullable) is None
        # and model_fields_set contains the field
        if self.prism_element is None and "prism_element" in self.model_fields_set:
            _dict['prismElement'] = None
