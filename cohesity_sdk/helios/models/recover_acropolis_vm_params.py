...
class RecoverAcropolisVmParams(BaseModel):
    """
    Specifies the recovery options specific to Acropolis environment.
    """ # noqa: E501
    acropolis_target_params: Optional[AcropolisTargetParamsForRecoverVm] = Field(default=None, description="Specifies the params for recovering to a Acropolis target.", alias="acropolisTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["acropolisTargetParams", "recoverProtectionGroupRunsParams", "targetEnvironment"]

    @field_validator('target_environment')
    def target_environment_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['kAcropolis']):
            raise ValueError("must be one of enum values ('kAcropolis')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of acropolis_target_params
        if self.acropolis_target_params:
            _dict['acropolisTargetParams'] = self.acropolis_target_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acropolisTargetParams": AcropolisTargetParamsForRecoverVm.from_dict(obj["acropolisTargetParams"]) if obj.get("acropolisTargetParams") is not None else None,
