...
class UpdateClusterVlanParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allTenantAccess", "appIps", "description", "dnsDelegationZones", "ecmpEnabled", "fqdn", "gateway", "ipAddressesType", "ipPools", "ipRanges", "ips", "mtu", "subnet", "tenantId", "vlanName"]
