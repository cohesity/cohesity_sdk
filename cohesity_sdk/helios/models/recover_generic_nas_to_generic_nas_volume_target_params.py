...
class RecoverGenericNasToGenericNasVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToGenericNasVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalGenericNasTargetParams] = Field(default=None, alias="originalSourceConfig")
