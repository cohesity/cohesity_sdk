...
class ConstructMetaInfoResult(BaseModel):
    ...
    kubernetes_params: Optional[KubernetesResourceMetaInfoResult] = Field(default=None, description="Specifies include/exclude resource metadata for k8s obj", alias="kubernetesParams")
