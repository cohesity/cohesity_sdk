...
class RecoverGenericNasFilesParams(BaseModel):
    """
    ...
    generic_nas_target_params: Optional[RecoverGenericNasToGenericNasFilesTargetParams] = Field(default=None, description="Specifies the params for a Generic Nas recovery target.", alias="genericNasTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genericNasTargetParams": RecoverGenericNasToGenericNasFilesTargetParams.from_dict(obj["genericNasTargetParams"]) if obj.get("genericNasTargetParams") is not None else None,
