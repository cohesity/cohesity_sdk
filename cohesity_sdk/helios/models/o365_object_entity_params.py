...
class O365ObjectEntityParams(BaseModel):
    """
    Specifies the common parameters for O365 object.
    """ # noqa: E501
    primary_smtp_address: Optional[StrictStr] = Field(default=None, description="Specifies the Primary SMTP Address of O365 Mailbox, User or Group Object.", alias="primarySMTPAddress")
    __properties: ClassVar[List[str]] = ["primarySMTPAddress"]
