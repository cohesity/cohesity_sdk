...
class RegisterOrUpdateKerberosProviderRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adminServer", "hostAlias", "id", "kdcServers", "ldapProviderId", "overwritehostAlias", "realmName", "adminPassword", "adminPrincipal"]
