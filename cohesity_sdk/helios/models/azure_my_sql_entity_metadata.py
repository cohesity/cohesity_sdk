...
class AzureMySqlEntityMetadata(BaseModel):
    """
    Specifies the entity metadata of azure mysql entities.
    """ # noqa: E501
    metadata_list: List[AzureMySqlMetadata] = Field(description="Specifies the metadata list.", alias="metadataList")
    __properties: ClassVar[List[str]] = ["metadataList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadataList": [AzureMySqlMetadata.from_dict(_item) for _item in obj["metadataList"]] if obj.get("metadataList") is not None else None
        })
        return _obj
