...
class OriginalGenericNasFilesTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alternatePath", "continueOnError", "encryptionEnabled", "overwriteExistingFile", "preserveFileAttributes", "recoverToOriginalPath", "vlanConfig"]
