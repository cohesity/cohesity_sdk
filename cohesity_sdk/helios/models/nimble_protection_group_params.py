...
class NimbleProtectionGroupParams(BaseModel):
    """
    Specifies the parameters which are specific to Nimble related Protection Groups.
    """ # noqa: E501
    objects: Annotated[List[NimbleProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["objects", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [NimbleProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
