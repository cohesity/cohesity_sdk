...
class HDFSIndexedObject(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Specifies the HDFS Object Type.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['HDFSFolders', 'HDFSFiles']):
            raise ValueError("must be one of enum values ('HDFSFolders', 'HDFSFiles')")
        return value
