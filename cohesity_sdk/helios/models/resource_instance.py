...
class ResourceInstance(BaseModel):
    ...
    """ # noqa: E501
    entity_id: Optional[StrictInt] = Field(default=None, description="The id of the specific entity to be backed up or restored.", alias="entityId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the specific entity/resource to be backed up or restored.")
