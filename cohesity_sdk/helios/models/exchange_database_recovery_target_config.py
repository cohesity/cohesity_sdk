...
class ExchangeDatabaseRecoveryTargetConfig(BaseModel):
    """
    Specifies the target object parameters to recover Exchange database.
    """ # noqa: E501
    source: Optional[RecoveryObjectIdentifier] = Field(description="Specifies the id of the physical source to which the exchange database will be recovered.")
