...
class McmProtectionGroupsActivity(BaseModel):
    """
    Specifies the Protection Group activities.
    """ # noqa: E501
    activity: Optional[List[McmProtectionGroupActivity]] = Field(default=None, description="Specifies the activity list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": [McmProtectionGroupActivity.from_dict(_item) for _item in obj["activity"]] if obj.get("activity") is not None else None
        })
        return _obj
