...
class IdentityProviders(BaseModel):
    """
    Specifies the list of configured identity providers.
    """ # noqa: E501
    providers: Optional[List[IdentityProvider]] = Field(default=None, description="Specifies the list of identity providers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [IdentityProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
