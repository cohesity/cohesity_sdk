...
class KubernetesRecoveryObjectParams(BaseModel):
    """
    Specifies the recovery object params
    """ # noqa: E501
    ...
    recover_pvcs_only: Optional[StrictBool] = Field(default=None, description="Specifies whether to recover PVCs only during recovery. Default: false", alias="recoverPvcsOnly")
    storage_class: Optional[KubernetesStorageClassParams] = Field(default=None, alias="storageClass")
    unbind_pvcs: Optional[StrictBool] = Field(default=None, description="Specifies whether the volume bindings will be removed from all restored PVCs. This will effectively unbind the PVCs from their original PVs. Default: false", alias="unbindPvcs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KubernetesRecoveryObjectParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KubernetesRecoveryObjectParams from a dict"""
        if obj is None:
            return None
