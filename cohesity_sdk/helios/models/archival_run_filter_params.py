...
class ArchivalRunFilterParams(BaseModel):
    """
    ...
    run_types: Optional[List[StrictStr]] = Field(default=None, description="Specifies the run types to filter archival runs.", alias="runTypes")
    __properties: ClassVar[List[str]] = ["isRpaas", "protectionEnvironmentTypes", "runTypes"]
