...
class BigQueryProtectionGroupParams(BaseModel):
    ...
    """ # noqa: E501
    cloud_storage_bucket_name: Optional[StrictStr] = Field(default=None, description="The Google Cloud Storage bucket name for BigQuery backup.", alias="cloudStorageBucketName")
    ...
    __properties: ClassVar[List[str]] = ["cloudStorageBucketName", "excludeObjectIds", "objects", "sourceId", "sourceName"]
