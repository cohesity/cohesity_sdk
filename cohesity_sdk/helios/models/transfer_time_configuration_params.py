...
class TransferTimeConfigurationParams(BaseModel):
    """
    ...
    end_time: TransferTimeOfTheDay = Field(alias="endTime")
    start_time: TransferTimeOfTheDay = Field(alias="startTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": obj.get("days"),
            "endTime": TransferTimeOfTheDay.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
            "startTime": TransferTimeOfTheDay.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None
        })
        return _obj
