...
class WorkloadStatsSummary(BaseModel):
    """
    Specifies the Workload Stats Summary Schema.
    """ # noqa: E501
    workloads: Optional[List[WorkloadStatsSchema]] = Field(default=None, description="Specifies the Workload types.")
    __properties: ClassVar[List[str]] = ["workloads"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if workloads (nullable) is None
        # and model_fields_set contains the field
        if self.workloads is None and "workloads" in self.model_fields_set:
            _dict['workloads'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workloads": [WorkloadStatsSchema.from_dict(_item) for _item in obj["workloads"]] if obj.get("workloads") is not None else None
        })
        return _obj
