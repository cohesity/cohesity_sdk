...
class ActiveDirectoryAppParams(BaseModel):
    """
    Specifies the Active Directory special parameters for the Protection Group.
    """ # noqa: E501
    app_id: Optional[StrictInt] = Field(default=None, description="Specifies the application id of the Active Directory instance.", alias="appId")
    app_name: Optional[StrictStr] = Field(default=None, description="Specifies the application name of the Active Directory instance.", alias="appName")
