...
class RecoverS3CompatibleParams(BaseModel):
    """
    ...
    recover_s3_bucket_params: Optional[RecoverS3CompatibleBucketParams] = Field(default=None, description="Specifies the parameters to recover S3 Compatible objects.", alias="recoverS3BucketParams")
    recovery_action: StrictStr = Field(description="Specifies the type of recover action to be performed.", alias="recoveryAction")
    __properties: ClassVar[List[str]] = ["objects", "recoverS3BucketParams", "recoveryAction"]

    @field_validator('recovery_action')
    def recovery_action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RecoverS3Buckets']):
            raise ValueError("must be one of enum values ('RecoverS3Buckets')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverS3BucketParams": RecoverS3CompatibleBucketParams.from_dict(obj["recoverS3BucketParams"]) if obj.get("recoverS3BucketParams") is not None else None,
