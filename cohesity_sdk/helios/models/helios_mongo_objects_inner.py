...
class HeliosMongoObjectsInner(BaseModel):
    """
    ...
    cdp_info: Optional[CdpObjectInfo] = Field(default=None, alias="cdpInfo")
    id: Optional[StrictStr] = Field(default=None, description="Specifies the id of the indexed object.")
    type: Optional[StrictStr] = Field(default=None, description="Specifies the Mongo Object Type.")
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "regionId", "name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "cdpInfo", "id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MongoDatabases', 'MongoCollections']):
            raise ValueError("must be one of enum values ('MongoDatabases', 'MongoCollections')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cdpInfo": CdpObjectInfo.from_dict(obj["cdpInfo"]) if obj.get("cdpInfo") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
