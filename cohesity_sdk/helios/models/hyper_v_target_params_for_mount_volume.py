...
class HyperVTargetParamsForMountVolume(BaseModel):
    ...
    new_target_config: Optional[HyperVMountVolumesNewTargetConfig] = Field(default=None, description="Specifies the configuration for mounting to a new target.", alias="newTargetConfig")
    original_target_config: Optional[HyperVMountVolumesOriginalTargetConfig] = Field(default=None, description="Specifies the configuration for mounting to the original target.", alias="originalTargetConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newTargetConfig": HyperVMountVolumesNewTargetConfig.from_dict(obj["newTargetConfig"]) if obj.get("newTargetConfig") is not None else None,
            "originalTargetConfig": HyperVMountVolumesOriginalTargetConfig.from_dict(obj["originalTargetConfig"]) if obj.get("originalTargetConfig") is not None else None,
