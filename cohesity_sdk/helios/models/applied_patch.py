...
class AppliedPatch(BaseModel):
    ...
    """ # noqa: E501
    applied_time_msecs: Optional[StrictInt] = Field(default=None, description="Specifies the time when the patch was applied in Unix epoch in milliseconds.", alias="appliedTimeMsecs")
    ...
    dependencies: Optional[List[StrictStr]] = Field(default=None, description="Specifies the services for which their patches were applied together. They will also be reverted together.")
    ...
    patch_level: Optional[StrictInt] = Field(default=None, description="Specifies the number of patches applied so far for this service.", alias="patchLevel")
    ...
    __properties: ClassVar[List[str]] = ["appliedTimeMsecs", "component", "count", "dependencies", "fixedIssues", "patchLevel", "service", "version", "versionReplaced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appliedTimeMsecs": obj.get("appliedTimeMsecs"),
