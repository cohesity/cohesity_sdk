...
class PhysicalTargetParamsForMountVolume(BaseModel):
    ...
    new_target_config: Optional[PhysicalMountVolumesNewTargetConfig] = Field(default=None, description="Specifies the configuration for mounting to a new target.", alias="newTargetConfig")
    original_target_config: Optional[PhysicalMountVolumesOriginalTargetConfig] = Field(default=None, description="Specifies the configuration for mounting to the original target.", alias="originalTargetConfig")
