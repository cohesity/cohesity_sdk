...
class ArchivalTargetSummaryInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["archivalTaskId", "ownershipContext", "targetId", "targetName", "targetType", "tierSettings", "usageType"]
