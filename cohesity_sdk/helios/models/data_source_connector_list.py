...
class DataSourceConnectorList(BaseModel):
    """
    Specifies a list of data-source connectors.
    """ # noqa: E501
    connectors: Optional[List[DataSourceConnector]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": [DataSourceConnector.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj
