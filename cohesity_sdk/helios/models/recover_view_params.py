...
class RecoverViewParams(BaseModel):
    ...
    def recovery_action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['DownloadFilesAndFolders', 'RecoverFiles']):
            raise ValueError("must be one of enum values ('DownloadFilesAndFolders', 'RecoverFiles')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverFileAndFolderParams": RecoverViewFilesParams.from_dict(obj["recoverFileAndFolderParams"]) if obj.get("recoverFileAndFolderParams") is not None else None,
