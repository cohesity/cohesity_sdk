...
class RecoverDynamoDBParams(BaseModel):
    """
    Specifies the parameters to recover AWS Dynamo DB Tables.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForDynamoDB] = Field(default=None, description="Specifies the params for recovering to an Aws target.", alias="awsTargetParams")
    custom_tags: Optional[List[SimpleTags]] = Field(default=None, description="Specifies the custom tags that need to be present on on every entity that this job creates. Only supported for new location recovery.", alias="customTags")
    ...
    __properties: ClassVar[List[str]] = ["awsTargetParams", "customTags", "prefix", "suffix", "targetEnvironment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForDynamoDB.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
