...
class RecoverAwsRdsSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_aws_rds_object_params
        if self.recover_aws_rds_object_params:
            _dict['recoverAwsRdsObjectParams'] = self.recover_aws_rds_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverAwsRdsObjectParams": RecoverAwsRdsObjectParams.from_dict(obj["recoverAwsRdsObjectParams"]) if obj.get("recoverAwsRdsObjectParams") is not None else None
        })
        return _obj
