...
class FortknoxVaultAwsResp(BaseModel):
    """
    ...
    vault_params: Optional[FortknoxAwsVaultRespParams] = Field(default=None, alias="vaultParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vaultParams": FortknoxAwsVaultRespParams.from_dict(obj["vaultParams"]) if obj.get("vaultParams") is not None else None
        })
        return _obj
