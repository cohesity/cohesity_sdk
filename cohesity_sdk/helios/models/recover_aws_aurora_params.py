...
class RecoverAwsAuroraParams(BaseModel):
    """
    Specifies the parameters to recover AWS Aurora.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverAurora] = Field(default=None, description="Specifies the params for recovering to an AWS target.", alias="awsTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["awsTargetParams", "recoverProtectionGroupRunsParams", "targetEnvironment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverAurora.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
