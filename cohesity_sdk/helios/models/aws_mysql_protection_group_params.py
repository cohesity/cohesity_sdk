...
class AwsMysqlProtectionGroupParams(BaseModel):
    """
    ...
    exclude_aurora_tag_ids: Optional[List[List[StrictInt]]] = Field(default=None, description="Array of arrays of RDS Tag Ids that specify aurora clusters to exclude.", alias="excludeAuroraTagIds")
    ...
    objects: Optional[List[AwsMysqlProtectionGroupObjectParams]] = Field(default=None, description="Specifies the objects to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["auroraTagIds", "excludeAuroraTagIds", "excludeObjectIds", "excludeRdsTagIds", "objects", "rdsTagIds", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [AwsMysqlProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
