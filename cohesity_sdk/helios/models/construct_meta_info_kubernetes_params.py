...
class ConstructMetaInfoKubernetesParams(BaseModel):
    """
    Params to fetch resource info for a kubernetes object.
    """ # noqa: E501
    object_id: StrictInt = Field(description="Specifies the type of object id to fetch resources", alias="objectId")
