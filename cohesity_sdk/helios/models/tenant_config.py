...
class TenantConfig(BaseModel):
    ...
    """ # noqa: E501
    organizations_enabled: Optional[StrictBool] = Field(description="Specifies whether organizations is enabled for the account.", alias="organizationsEnabled")
    __properties: ClassVar[List[str]] = ["organizationsEnabled"]
