...
class RecoverOracleDbSnapshotParams(BaseModel):
    ...
    instant_recovery_info: Optional[Dict[str, Any]] = Field(default=None, description="Specifies the info about instant recovery. This is only applicable for RecoverOracle.", alias="instantRecoveryInfo")
