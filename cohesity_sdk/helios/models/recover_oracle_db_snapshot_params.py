...
class RecoverOracleDbSnapshotParams(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instantRecoveryInfo": RecoveryOracleTaskInfo.from_dict(obj["instantRecoveryInfo"]) if obj.get("instantRecoveryInfo") is not None else None
        })
        return _obj
