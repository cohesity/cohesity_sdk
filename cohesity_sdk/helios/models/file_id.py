...
class FileId(BaseModel):
    ...
    """ # noqa: E501
    entity_id: Optional[StrictInt] = Field(default=None, description="Specifies the entity id of the file.", alias="entityId")
    root_inode_id: Optional[StrictInt] = Field(default=None, description="Specifies the root inode id of the file system that file belongs to.", alias="rootInodeId")
    view_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the View the file belongs to.", alias="viewId")
    __properties: ClassVar[List[str]] = ["entityId", "rootInodeId", "viewId"]
