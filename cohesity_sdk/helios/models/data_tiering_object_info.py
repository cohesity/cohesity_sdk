...
class DataTieringObjectInfo(BaseModel):
    """
    ...
    analysis_info: Optional[DataTieringObjectAnalysisInfo] = Field(default=None, alias="analysisInfo")
    __properties: ClassVar[List[str]] = ["id", "name", "analysisInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "analysisInfo": DataTieringObjectAnalysisInfo.from_dict(obj["analysisInfo"]) if obj.get("analysisInfo") is not None else None
        })
        return _obj
