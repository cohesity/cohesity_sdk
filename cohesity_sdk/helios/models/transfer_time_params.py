...
class TransferTimeParams(BaseModel):
    """
    ...
    end_time: TransferTimeOfDay = Field(alias="endTime")
    start_time: TransferTimeOfDay = Field(alias="startTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": obj.get("days"),
            "endTime": TransferTimeOfDay.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
            "startTime": TransferTimeOfDay.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None
        })
        return _obj
