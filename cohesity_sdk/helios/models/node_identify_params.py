...
class NodeIdentifyParams(BaseModel):
    """
    Specifies the parameter to identify node.
    """ # noqa: E501
    identify: Optional[StrictBool] = Field(description="Turn on/off node led light if set to true/false respectively.")
    __properties: ClassVar[List[str]] = ["identify"]
