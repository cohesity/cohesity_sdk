...
class VcdVcenterInfo(BaseModel):
    """
    Specifies information about a vCetner.
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(default=None, description="Specifies the endpoint of the vCenter.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the vCenter.")
