...
class HeliosCloudSpinTarget(BaseModel):
    ...
    """ # noqa: E501
    aws_params: Optional[HeliosAwsCloudSpinParams] = Field(default=None, alias="awsParams")
    azure_params: Optional[HeliosAzureCloudSpinParams] = Field(default=None, alias="azureParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsParams": HeliosAwsCloudSpinParams.from_dict(obj["awsParams"]) if obj.get("awsParams") is not None else None,
            "azureParams": HeliosAzureCloudSpinParams.from_dict(obj["azureParams"]) if obj.get("azureParams") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
