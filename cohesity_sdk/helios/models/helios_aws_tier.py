...
class HeliosAWSTier(BaseModel):
    ...
    tier_type: Optional[StrictStr] = Field(description="Specifies the AWS tier types.", alias="tierType")
    ...
    def tier_type_validate_enum(cls, value):
        ...
        if value not in set(['kAmazonS3Standard', 'kAmazonS3StandardIA', 'kAmazonS3OneZoneIA', 'kAmazonS3IntelligentTiering', 'kAmazonS3Glacier', 'kAmazonS3GlacierDeepArchive']):
            raise ValueError("must be one of enum values ('kAmazonS3Standard', 'kAmazonS3StandardIA', 'kAmazonS3OneZoneIA', 'kAmazonS3IntelligentTiering', 'kAmazonS3Glacier', 'kAmazonS3GlacierDeepArchive')")
        return value
