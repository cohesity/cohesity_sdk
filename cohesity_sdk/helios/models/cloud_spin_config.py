...
class CloudSpinConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backupRunType", "configId", "copyOnRunSuccess", "logRetention", "retention", "runTimeouts", "schedule", "target"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": CloudSpinTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
