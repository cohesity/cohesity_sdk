...
class RecoverGpfsNasVolumeParams(BaseModel):
    ...
    gpfs_target_params: Optional[RecoverGpfsToGpfsVolumeTargetParams] = Field(default=None, description="Specifies the params for a GPFS recovery target.", alias="gpfsTargetParams")
