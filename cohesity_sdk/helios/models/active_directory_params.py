...
class ActiveDirectoryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["domainName", "machineAccounts", "organizationalUnitName", "preferredDomainControllers", "trustedDomainParams", "workGroupName"]
