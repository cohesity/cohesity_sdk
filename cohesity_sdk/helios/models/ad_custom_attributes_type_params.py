...
class AdCustomAttributesTypeParams(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.gid_attr_name is None and "gid_attr_name" in self.model_fields_set:
            _dict['gidAttrName'] = None

        # set to None if uid_attr_name (nullable) is None
        # and model_fields_set contains the field
        if self.uid_attr_name is None and "uid_attr_name" in self.model_fields_set:
            _dict['uidAttrName'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gidAttrName": obj.get("gidAttrName"),
            "uidAttrName": obj.get("uidAttrName")
        })
        return _obj
