...
class RecoverElastifileParams(BaseModel):
    ...
    recover_file_and_folder_params: Optional[RecoverElastifileFilesParams] = Field(default=None, description="Specifies the parameters to recover files.", alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverElastifileNasVolumeParams] = Field(default=None, description="Specifies the parameters to recover Nas Volumes.", alias="recoverNasVolumeParams")
