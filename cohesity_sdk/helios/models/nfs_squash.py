...
class NfsSquash(BaseModel):
    """
    NfsSquash
    """ # noqa: E501
    gid: Optional[StrictInt] = Field(default=None, description="GID mapped for all clients.")
    uid: Optional[StrictInt] = Field(default=None, description="UID mapped for all clients.")
