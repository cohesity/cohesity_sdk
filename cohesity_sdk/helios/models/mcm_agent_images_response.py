...
class McmAgentImagesResponse(BaseModel):
    """
    Specifies the agent image information on Helios.
    """ # noqa: E501
    agents: Optional[List[McmAgentImage]] = Field(default=None, description="Specifies a list of agents from Helios.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [McmAgentImage.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None
        })
        return _obj
