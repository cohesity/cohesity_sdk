...
class ObjectEnvironmentArchivalStats(BaseModel):
    """
    ...
    num_successful_objects: Optional[StrictInt] = Field(default=None, description="Specifies the number of successful objects.", alias="numSuccessfulObjects")
    num_unsuccessful_objects: Optional[StrictInt] = Field(default=None, description="Specifies the number of unsuccessful objects.", alias="numUnsuccessfulObjects")
    __properties: ClassVar[List[str]] = ["environment", "numSuccessfulObjects", "numUnsuccessfulObjects"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if num_successful_objects (nullable) is None
        # and model_fields_set contains the field
        if self.num_successful_objects is None and "num_successful_objects" in self.model_fields_set:
            _dict['numSuccessfulObjects'] = None

        # set to None if num_unsuccessful_objects (nullable) is None
        # and model_fields_set contains the field
        if self.num_unsuccessful_objects is None and "num_unsuccessful_objects" in self.model_fields_set:
            _dict['numUnsuccessfulObjects'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numSuccessfulObjects": obj.get("numSuccessfulObjects"),
            "numUnsuccessfulObjects": obj.get("numUnsuccessfulObjects")
        })
        return _obj
