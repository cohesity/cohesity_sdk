...
class CommonRecoverFileAndFolderInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["absolutePath", "destinationDir", "isDirectory", "isViewFileRecovery", "messages", "status"]
