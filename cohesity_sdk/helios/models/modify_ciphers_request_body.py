...
class ModifyCiphersRequestBody(BaseModel):
    """
    Specifies ciphers to enable/disable on the cluster.
    """ # noqa: E501
    ciphers: List[StrictStr] = Field(description="Specifies a list of ciphers to enable/disable on the cluster.")
    enable: StrictBool = Field(description="If true, the ciphers passed in will be enabled on the cluster and all other ciphers will be disabled. If false, the ciphers specified will be disabled and all other ciphers on the cluster will be enabled.")
