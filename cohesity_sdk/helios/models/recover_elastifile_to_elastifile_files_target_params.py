...
class RecoverElastifileToElastifileFilesTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToElastifileFilesTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalElastifileFilesTargetParams] = Field(default=None, alias="originalSourceConfig")
