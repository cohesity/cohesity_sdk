...
class UpgradeCancelResponse(BaseModel):
    ...
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Specifies an error message if failed to cancel a scheduled upgrade.", alias="ErrorMessage")
    is_upgrade_cancel_successful: Optional[StrictBool] = Field(default=None, description="Specifies if scheduled upgrade cancelling was successful.", alias="IsUpgradeCancelSuccessful")
    ...
    __properties: ClassVar[List[str]] = ["ErrorMessage", "IsUpgradeCancelSuccessful", "clusterId", "clusterIncarnationId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_upgrade_cancel_successful (nullable) is None
        # and model_fields_set contains the field
        if self.is_upgrade_cancel_successful is None and "is_upgrade_cancel_successful" in self.model_fields_set:
            _dict['IsUpgradeCancelSuccessful'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IsUpgradeCancelSuccessful": obj.get("IsUpgradeCancelSuccessful"),
