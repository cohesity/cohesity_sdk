...
class RecoverHyperVVmNewSourceNetworkConfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of virtual_switch
        if self.virtual_switch:
            _dict['virtualSwitch'] = self.virtual_switch.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "virtualSwitch": RecoveryObjectIdentifier.from_dict(obj["virtualSwitch"]) if obj.get("virtualSwitch") is not None else None
        })
        return _obj
