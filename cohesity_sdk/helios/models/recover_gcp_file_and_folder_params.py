...
class RecoverGcpFileAndFolderParams(BaseModel):
    """
    ...
    gcp_target_params: Optional[GcpTargetParamsForRecoverFileAndFolder] = Field(default=None, description="Specifies the parameters to recover to a GCP target.", alias="gcpTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["filesAndFolders", "gcpTargetParams", "targetEnvironment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if gcp_target_params (nullable) is None
        # and model_fields_set contains the field
        if self.gcp_target_params is None and "gcp_target_params" in self.model_fields_set:
            _dict['gcpTargetParams'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcpTargetParams": GcpTargetParamsForRecoverFileAndFolder.from_dict(obj["gcpTargetParams"]) if obj.get("gcpTargetParams") is not None else None,
