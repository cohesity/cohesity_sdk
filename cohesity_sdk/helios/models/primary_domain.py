...
class PrimaryDomain(BaseModel):
    ...
    tenant_ids: Optional[List[StrictStr]] = Field(default=None, description="Specifies the tenants this primary domain is part of.", alias="tenantIds")
    __properties: ClassVar[List[str]] = ["fqdn", "tenantIds"]
