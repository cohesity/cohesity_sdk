...
class HeliosCdpRetention(BaseModel):
    """
    Specifies the retention of a CDP backup.
    """ # noqa: E501
    data_lock_config: Optional[DataLockConfig] = Field(default=None, alias="dataLockConfig")
    duration: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Specifies the duration for a cdp backup retention.")
    unit: Optional[StrictStr] = Field(default=None, description="Specificies the Retention Unit of a CDP backup measured in minutes or hours.")
