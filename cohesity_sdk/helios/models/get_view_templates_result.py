...
class GetViewTemplatesResult(BaseModel):
    """
    Specifies the list of view template returned that matched the specified filter criteria.
    """ # noqa: E501
    templates: Optional[List[Template]] = Field(default=None, description="Array of view template. Specifies the list of view templates returned in this response.", alias="Templates")
