...
class ValidateSupportUserCredParams(BaseModel):
    """
    Specifies the support user credentials to validate.
    """ # noqa: E501
    password: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Specifies the password of the user to validate.")
