...
class HeliosPoliciesResponseWithPagination(BaseModel):
    """
    Specifies the list of Policies.
    """ # noqa: E501
    policies: Optional[List[HeliosPolicyResponse]] = Field(default=None, description="Specifies a list of policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [HeliosPolicyResponse.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
