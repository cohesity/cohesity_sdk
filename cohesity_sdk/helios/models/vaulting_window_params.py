...
class VaultingWindowParams(BaseModel):
    """
    Transfer time configuration.
    """ # noqa: E501
    days: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(description="List of days of a week.")
    end_time: VaultingTimeOfTheDay = Field(alias="endTime")
    start_time: VaultingTimeOfTheDay = Field(alias="startTime")
    __properties: ClassVar[List[str]] = ["days", "endTime", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": obj.get("days"),
            "endTime": VaultingTimeOfTheDay.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
            "startTime": VaultingTimeOfTheDay.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None
        })
        return _obj
