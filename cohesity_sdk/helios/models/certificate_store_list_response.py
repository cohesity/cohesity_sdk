...
class CertificateStoreListResponse(BaseModel):
    """
    Specifies a response for environment certificate store APIs returning a list of certificates.
    """ # noqa: E501
    certificates: Optional[List[CertificateObjectWithMetadata]] = Field(default=None, description="List of certificate objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [CertificateObjectWithMetadata.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None
        })
        return _obj
