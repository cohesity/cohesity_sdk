...
class RecoverGenericNasNasVolumeParams(BaseModel):
    """
    Specifies the parameters to recover Generic NAS volumes.
    """ # noqa: E501
    elastifile_target_params: Optional[RecoverOtherNasToElastifileVolumeTargetParams] = Field(default=None, description="Specifies the params for a Elastifile recovery target.", alias="elastifileTargetParams")
    ...
    generic_nas_target_params: Optional[RecoverGenericNasToGenericNasVolumeTargetParams] = Field(default=None, description="Specifies the params for a Generic NAS recovery target.", alias="genericNasTargetParams")
    ...
    netapp_target_params: Optional[RecoverOtherNasToNetappVolumeTargetParams] = Field(default=None, description="Specifies the params for an Netapp recovery target.", alias="netappTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genericNasTargetParams": RecoverGenericNasToGenericNasVolumeTargetParams.from_dict(obj["genericNasTargetParams"]) if obj.get("genericNasTargetParams") is not None else None,
