...
class FilerLifecycleManagement(BaseModel):
    ...
    """ # noqa: E501
    rules: Optional[List[FilerLifecycleRule]] = Field(default=None, description="Specifies Lifecycle configuration rules for a filer view. A maximum of 100 rules can be specified.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rules": [FilerLifecycleRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
