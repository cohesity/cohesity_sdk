...
class IntegrationList(BaseModel):
    ...
    """ # noqa: E501
    integrations: Optional[List[Integration]] = Field(default=None, description="List of integrations.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationList from a dict"""
        if obj is None:
            return None
