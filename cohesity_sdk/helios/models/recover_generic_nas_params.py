...
class RecoverGenericNasParams(BaseModel):
    """
    ...
    recover_file_and_folder_params: Optional[RecoverGenericNasFilesParams] = Field(default=None, description="Specifies the parameters to recover files.", alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverGenericNasNasVolumeParams] = Field(default=None, description="Specifies the parameters to recover Nas Volumes.", alias="recoverNasVolumeParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverFileAndFolderParams": RecoverGenericNasFilesParams.from_dict(obj["recoverFileAndFolderParams"]) if obj.get("recoverFileAndFolderParams") is not None else None,
            "recoverNasVolumeParams": RecoverGenericNasNasVolumeParams.from_dict(obj["recoverNasVolumeParams"]) if obj.get("recoverNasVolumeParams") is not None else None,
