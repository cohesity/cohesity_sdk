...
class VmwareTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[VmwareRecoverFilesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[VmwareRecoverFilesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
