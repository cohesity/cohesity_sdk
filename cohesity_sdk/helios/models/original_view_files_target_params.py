...
class OriginalViewFilesTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alternatePath", "continueOnError", "overwriteExistingFile", "preserveFileAttributes", "recoverToOriginalPath", "vlanConfig"]
