...
class RpaasRegionInfoList(BaseModel):
    """
    List of Rpaas enabled regions.
    """ # noqa: E501
    regions: Optional[List[RpaasRegionInfo]] = Field(default=None, description="Specifies an Rpaas region.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "regions": [RpaasRegionInfo.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
