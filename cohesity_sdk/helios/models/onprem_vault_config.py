...
class OnpremVaultConfig(BaseModel):
    """
    ...
    cluster_id: Optional[StrictInt] = Field(description="Specifies the cluster id of the vault cluster.", alias="clusterId")
    cluster_name: Optional[StrictStr] = Field(default=None, description="Specifies the cluster name of the vault cluster.", alias="clusterName")
    __properties: ClassVar[List[str]] = ["backupRunType", "configId", "copyOnRunSuccess", "logRetention", "retention", "runTimeouts", "schedule", "clusterId", "clusterName"]
