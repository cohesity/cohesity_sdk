...
class TransferTimeConfiguration(BaseModel):
    """
    ...
    region_id: Optional[StrictStr] = Field(default=None, description="This field is deprecated. Please use globalVaultId field instead. Id of FortKnox region.", alias="regionId")
    transfer_time_config_params: Optional[TransferTimeConfigParams] = Field(default=None, alias="transferTimeConfigParams")
    __properties: ClassVar[List[str]] = ["globalVaultId", "regionId", "transferTimeConfigParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transferTimeConfigParams": TransferTimeConfigParams.from_dict(obj["transferTimeConfigParams"]) if obj.get("transferTimeConfigParams") is not None else None
        })
        return _obj
