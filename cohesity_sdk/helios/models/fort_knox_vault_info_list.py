...
class FortKnoxVaultInfoList(BaseModel):
    """
    List of FortKnox vaults.
    """ # noqa: E501
    vaults: Optional[List[RpaasRegionInfo]] = Field(default=None, description="Specifies an FortKnox vault.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vaults": [RpaasRegionInfo.from_dict(_item) for _item in obj["vaults"]] if obj.get("vaults") is not None else None
        })
        return _obj
