...
class VmwareTargetParamsForRecoverVApp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attemptDifferentialRestore", "continueOnError", "diskProvisionType", "enableNBDSSLFallback", "leverageSanTransport", "powerOnVms", "recoveryProcessType", "recoveryTargetConfig", "renameRecoveredVAppsParams", "renameRecoveredVmsParams", "vlanConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rename_recovered_v_apps_params
        if self.rename_recovered_v_apps_params:
            _dict['renameRecoveredVAppsParams'] = self.rename_recovered_v_apps_params.to_dict()
        ...
        # set to None if rename_recovered_v_apps_params (nullable) is None
        # and model_fields_set contains the field
        if self.rename_recovered_v_apps_params is None and "rename_recovered_v_apps_params" in self.model_fields_set:
            _dict['renameRecoveredVAppsParams'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoveryTargetConfig": VmwareVAppRecoveryTargetConfig.from_dict(obj["recoveryTargetConfig"]) if obj.get("recoveryTargetConfig") is not None else None,
            "renameRecoveredVAppsParams": RecoveredOrClonedVmsRenameConfig.from_dict(obj["renameRecoveredVAppsParams"]) if obj.get("renameRecoveredVAppsParams") is not None else None,
