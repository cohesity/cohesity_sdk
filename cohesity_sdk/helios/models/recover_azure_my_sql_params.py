...
class RecoverAzureMySQLParams(BaseModel):
    """
    Specifies the parameters to recover Azure MySQL.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureMySQL] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureMySQLSnapshotParams]] = Field(description="Specifies the details of the azure mysql objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureMySQL.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureMySQLSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
