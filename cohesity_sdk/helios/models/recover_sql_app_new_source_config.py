...
class RecoverSqlAppNewSourceConfig(BaseModel):
    ...
    """ # noqa: E501
    data_file_directory_location: Optional[StrictStr] = Field(description="Specifies the directory where to put the database data files. Missing directory will be automatically created.", alias="dataFileDirectoryLocation")
    ...
    instance_name: Optional[StrictStr] = Field(description="Specifies an instance name of the Sql Server that should be used for restoring databases to.", alias="instanceName")
    log_file_directory_location: Optional[StrictStr] = Field(description="Specifies the directory where to put the database log files. Missing directory will be automatically created.", alias="logFileDirectoryLocation")
