...
class RecoverClusterScopedResourcesParams(BaseModel):
    """
    Specifies the parameters from where the cluster scoped resources would be recovered.
    """ # noqa: E501
    snapshot_id: Optional[StrictStr] = Field(default=None, description="Specifies the snapshot id of the namespace from where the cluster scoped resources are to be recovered.", alias="snapshotId")
