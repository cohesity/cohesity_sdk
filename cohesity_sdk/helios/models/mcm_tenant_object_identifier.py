...
class McmTenantObjectIdentifier(BaseModel):
    """
    Specifies an object protection for a given tenant.
    """ # noqa: E501
    object_hash: Optional[StrictStr] = Field(default=None, description="Specifies the object hash of the object.", alias="objectHash")
    object_id: Optional[StrictInt] = Field(default=None, description="Specifies the id assigned to the object.", alias="objectId")
    __properties: ClassVar[List[str]] = ["objectHash", "objectId"]
