...
class AddRpaasRegionsRequest(BaseModel):
    """
    Request params for enabling rpaas regions for the logged in account.
    """ # noqa: E501
    regions: Optional[List[AddRegionParams]] = Field(default=None, description="List of regions being added.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "regions": [AddRegionParams.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
