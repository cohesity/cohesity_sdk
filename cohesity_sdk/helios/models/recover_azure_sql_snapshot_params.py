...
class RecoverAzureSqlSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_azure_sql_object_params
        if self.recover_azure_sql_object_params:
            _dict['recoverAzureSqlObjectParams'] = self.recover_azure_sql_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverAzureSqlObjectParams": RecoverAzureSqlObjectParams.from_dict(obj["recoverAzureSqlObjectParams"]) if obj.get("recoverAzureSqlObjectParams") is not None else None
        })
        return _obj
