...
class DataSourceConnectionList(BaseModel):
    """
    Specifies a list of data-source connections.
    """ # noqa: E501
    connections: Optional[List[DataSourceConnection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connections": [DataSourceConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
