...
class FetchThrottlingStatsResponseBody(BaseModel):
    """
    Specifies the throttling stats across various workloads and api types.
    """ # noqa: E501
    aggregated_stats: Optional[List[ThrottlingStats]] = Field(default=None, description="Specifies the time-series throttling stats for a single or multiple workloads in a source.", alias="aggregatedStats")
    __properties: ClassVar[List[str]] = ["aggregatedStats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregatedStats": [ThrottlingStats.from_dict(_item) for _item in obj["aggregatedStats"]] if obj.get("aggregatedStats") is not None else None
        })
        return _obj
