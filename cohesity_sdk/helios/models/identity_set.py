...
class IdentitySet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["application", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "application": Identity.from_dict(obj["application"]) if obj.get("application") is not None else None,
            "user": Identity.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
