...
class HyperVTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[HyperVRecoverFilesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[HyperVRecoverFilesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
