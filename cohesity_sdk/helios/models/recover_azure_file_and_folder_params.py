...
class RecoverAzureFileAndFolderParams(BaseModel):
    """
    Specifies the parameters to recover Azure files and folders.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverFileAndFolder] = Field(default=None, description="Specifies the params for recovering to an Azure target.", alias="azureTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["azureTargetParams", "filesAndFolders", "targetEnvironment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverFileAndFolder.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
