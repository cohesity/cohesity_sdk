...
class AssociateEntityMetadataResult(BaseModel):
    ...
    """ # noqa: E501
    entity_list: Optional[List[AssociateEntityMetadataResultParams]] = Field(default=None, description="Specifies the list of entity ids mapped to errors (if any).", alias="entityList")
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the source id of the entities vector whose metadata is being updated.", alias="sourceId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if entity_list (nullable) is None
        # and model_fields_set contains the field
        if self.entity_list is None and "entity_list" in self.model_fields_set:
            _dict['entityList'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityList": [AssociateEntityMetadataResultParams.from_dict(_item) for _item in obj["entityList"]] if obj.get("entityList") is not None else None,
