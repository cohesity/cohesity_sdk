...
class AddFortknoxKmsKeyReq(BaseModel):
    """
    ...
    aws_params: Optional[AddAwsKmsKeyReq] = Field(default=None, alias="awsParams")
    __properties: ClassVar[List[str]] = ["accountId", "cloudProvider", "kmsKeyType", "awsParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "awsParams": AddAwsKmsKeyReq.from_dict(obj["awsParams"]) if obj.get("awsParams") is not None else None
        })
        return _obj
