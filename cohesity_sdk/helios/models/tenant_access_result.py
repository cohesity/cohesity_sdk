...
class TenantAccessResult(BaseModel):
    """
    Specifies a List of Tenant Access.
    """ # noqa: E501
    tenant_accesses: Optional[List[TenantAccess]] = Field(default=None, description="List of available Tenant Access.", alias="tenantAccesses")
    __properties: ClassVar[List[str]] = ["tenantAccesses"]
