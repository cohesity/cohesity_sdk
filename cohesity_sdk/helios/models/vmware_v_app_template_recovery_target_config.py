...
class VmwareVAppTemplateRecoveryTargetConfig(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverVmwareVAppTemplateNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverVmwareVAppOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
