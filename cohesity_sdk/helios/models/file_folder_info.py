...
class FileFolderInfo(BaseModel):
    ...
    hdfs_params: Optional[List[HdfsFileFolderParams]] = Field(default=None, description="Specifies the parameters for Hdfs.", alias="hdfsParams")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in hdfs_params (list)
        _items = []
        if self.hdfs_params:
            for _item_hdfs_params in self.hdfs_params:
                if _item_hdfs_params:
                    _items.append(_item_hdfs_params.to_dict())
            _dict['hdfsParams'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hdfsParams": [HdfsFileFolderParams.from_dict(_item) for _item in obj["hdfsParams"]] if obj.get("hdfsParams") is not None else None,
