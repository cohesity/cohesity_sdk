...
class RecoverGpfsToGpfsVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToGpfsVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalGpfsTargetParams] = Field(default=None, alias="originalSourceConfig")
