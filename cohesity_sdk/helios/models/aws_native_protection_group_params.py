...
class AwsNativeProtectionGroupParams(BaseModel):
    ...
    objects: Optional[List[AwsNativeProtectionGroupObjectParams]] = Field(default=None, description="Specifies the objects to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["excludeObjectIds", "excludeVmTagIds", "indexingPolicy", "objects", "sourceId", "sourceName", "vmTagIds", "volumeExclusionParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [AwsNativeProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
