...
class McmPolicyLastProtectionRunStats(BaseModel):
    """
    ...
    last_run_stats: Optional[McmPolicyLastProtectionRunStatsByPolicy] = Field(default=None, alias="lastRunStats")
    policy_id: Optional[StrictStr] = Field(default=None, description="Specifies the policy Id.", alias="policyId")
    policy_name: Optional[StrictStr] = Field(default=None, description="Specifies the policy name.", alias="policyName")
    region_id: Optional[StrictStr] = Field(default=None, description="Specifies the region Id.", alias="regionId")
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "lastRunStats", "policyId", "policyName", "regionId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of last_run_stats
        if self.last_run_stats:
            _dict['lastRunStats'] = self.last_run_stats.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastRunStats": McmPolicyLastProtectionRunStatsByPolicy.from_dict(obj["lastRunStats"]) if obj.get("lastRunStats") is not None else None,
