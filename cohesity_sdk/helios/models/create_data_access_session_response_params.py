...
class CreateDataAccessSessionResponseParams(BaseModel):
    """
    Create Data Access Session Response.
    """ # noqa: E501
    session_id: StrictStr = Field(description="Specifies the id of the data access session.", alias="sessionId")
