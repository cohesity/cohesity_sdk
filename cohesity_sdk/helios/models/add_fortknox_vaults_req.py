...
class AddFortknoxVaultsReq(BaseModel):
    """
    Request params for adding Fortknox vaults for a helios account.
    """ # noqa: E501
    vaults: Optional[List[AddFortknoxVaultParams]] = Field(default=None, description="List of vaults being added.")
    __properties: ClassVar[List[str]] = ["vaults"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vaults": [AddFortknoxVaultParams.from_dict(_item) for _item in obj["vaults"]] if obj.get("vaults") is not None else None
        })
        return _obj
