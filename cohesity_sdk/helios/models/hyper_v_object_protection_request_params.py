...
class HyperVObjectProtectionRequestParams(BaseModel):
    ...
    objects: List[HyperVObjectProtectionRequest] = Field(description="Specifies the objects to include in the backup.")
    __properties: ClassVar[List[str]] = ["appConsistentSnapshot", "fallbackToCrashConsistentSnapshot", "indexingPolicy", "objects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [HyperVObjectProtectionRequest.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
