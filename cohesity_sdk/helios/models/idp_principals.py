...
class IdpPrincipals(BaseModel):
    """
    Specifies a list of IDP Principals.
    """ # noqa: E501
    principals: Optional[List[IdpPrincipal]] = Field(default=None, description="Specifies a list of IDP Principals.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "principals": [IdpPrincipal.from_dict(_item) for _item in obj["principals"]] if obj.get("principals") is not None else None
        })
        return _obj
