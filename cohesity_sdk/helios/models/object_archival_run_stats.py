...
class ObjectArchivalRunStats(BaseModel):
    """
    Defines the stats of objects in archival runs.
    """ # noqa: E501
    stats: Optional[List[ObjectEnvironmentArchivalStats]] = Field(default=None, description="Specifies stats for all the environments available.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [ObjectEnvironmentArchivalStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
