...
class AzureVmRecoveryTargetConfig(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverAzureVmNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverAzureVmOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
