...
class HeliosMonthSchedule(BaseModel):
    """
    ...
    week_of_month: Optional[StrictStr] = Field(default=None, description="Specifies the week of the month (such as 'Third') in a Monthly Schedule specified by unit field as 'Months'. <br>This field is used in combination with 'dayOfWeek' to define the day in the month to start the Protection Group Run. <br> Example: if 'weekOfMonth' is set to 'Third' and day is set to 'Monday', a backup is performed on the third Monday of every month.", alias="weekOfMonth")
    __properties: ClassVar[List[str]] = ["dayOfWeek", "weekOfMonth"]
