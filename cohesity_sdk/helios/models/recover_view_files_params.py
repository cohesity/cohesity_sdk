...
class RecoverViewFilesParams(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filesAndFolders": [ViewRecoverFileAndFolderInfo.from_dict(_item) for _item in obj["filesAndFolders"]] if obj.get("filesAndFolders") is not None else None,
            "viewTargetParams": RecoverViewToViewFilesTargetParams.from_dict(obj["viewTargetParams"]) if obj.get("viewTargetParams") is not None else None
        })
        return _obj
