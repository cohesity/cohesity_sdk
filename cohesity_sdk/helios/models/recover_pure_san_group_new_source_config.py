...
class RecoverPureSanGroupNewSourceConfig(BaseModel):
    """
    ...
    source: Optional[RecoveryObjectIdentifier] = Field(description="Specifies the id of the new target parent source to recover the Pure SAN group to. This field must be specified if recoverToNewSource is true.")
    __properties: ClassVar[List[str]] = ["renameRecoveredGroupParams", "resourcePool", "source"]
