...
class RecoverElastifileNasVolumeParams(BaseModel):
    """
    Specifies the parameters to recover Elastifile NAS volumes.
    """ # noqa: E501
    elastifile_target_params: Optional[RecoverElastifileToElastifileVolumeTargetParams] = Field(default=None, description="Specifies the params for a Elastifile recovery target.", alias="elastifileTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elastifileTargetParams": RecoverElastifileToElastifileVolumeTargetParams.from_dict(obj["elastifileTargetParams"]) if obj.get("elastifileTargetParams") is not None else None,
