...
class RecoverHyperVVmOriginalSourceConfig(BaseModel):
    """
    Specifies the Source configuration if VM's are being recovered to Original Source.
    """ # noqa: E501
    network_config: Optional[RecoverHyperVVmOriginalSourceNetworkConfig] = Field(default=None, description="Specifies the networking configuration to be applied to the recovered VMs.", alias="networkConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkConfig": RecoverHyperVVmOriginalSourceNetworkConfig.from_dict(obj["networkConfig"]) if obj.get("networkConfig") is not None else None
        })
        return _obj
