...
class RunArchivalConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["archivalTargetType", "copyOnlyFullySuccessful", "id", "onLegalHold", "retention"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if copy_only_fully_successful (nullable) is None
        # and model_fields_set contains the field
        if self.copy_only_fully_successful is None and "copy_only_fully_successful" in self.model_fields_set:
            _dict['copyOnlyFullySuccessful'] = None
