...
class RecoverElastifileToElastifileVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToElastifileVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalElastifileTargetParams] = Field(default=None, alias="originalSourceConfig")
