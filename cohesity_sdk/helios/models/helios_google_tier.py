...
class HeliosGoogleTier(BaseModel):
    """
    ...
    tier_type: Optional[StrictStr] = Field(description="Specifies the Google tier types.", alias="tierType")
    ...
    def tier_type_validate_enum(cls, value):
        ...
        if value not in set(['kGoogleStandard', 'kGoogleRegional', 'kGoogleMultiRegional', 'kGoogleNearline', 'kGoogleColdline']):
            raise ValueError("must be one of enum values ('kGoogleStandard', 'kGoogleRegional', 'kGoogleMultiRegional', 'kGoogleNearline', 'kGoogleColdline')")
        return value
