...
class CreateClusterVlanParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allTenantAccess", "appIps", "description", "dnsDelegationZones", "ecmpEnabled", "fqdn", "gateway", "gatewayV6", "interfaceName", "ipAddressesType", "ipPools", "ipRanges", "ips", "loopbackInterfaceGroupId", "mtu", "subnet", "subnetV6", "tenantId", "vlanName", "vlanInterfaceGroupName"]
