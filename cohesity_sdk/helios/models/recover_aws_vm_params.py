...
class RecoverAwsVmParams(BaseModel):
    """
    Specifies the parameters to recover AWS VM.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverVm] = Field(default=None, description="Specifies the params for recovering to an AWS target.", alias="awsTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverVm.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
