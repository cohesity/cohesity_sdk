...
class MOref(BaseModel):
    ...
    """ # noqa: E501
    item: Optional[StrictStr] = Field(default=None, description="Unique identifier for the object type.")
    type: Optional[StrictStr] = Field(default=None, description="Specifies the type of VMware object")
