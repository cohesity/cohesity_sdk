...
class Office365SharepointSiteObjectProtectionParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["indexingPolicy", "objects", "sourceId", "sourceName", "excludePaths", "preservationHoldLibraryParams"]
