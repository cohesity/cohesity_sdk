...
class TargetObjectRun(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Specifies the id of the object")
    run_start_time_usecs: Optional[StrictInt] = Field(default=None, description="Specifies the start time of the run pertaining to the object", alias="runStartTimeUsecs")
    __properties: ClassVar[List[str]] = ["id", "runStartTimeUsecs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TargetObjectRun from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TargetObjectRun from a dict"""
        if obj is None:
            return None
