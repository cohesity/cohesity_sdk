...
class AssignClusterToTenantParamsBody(BaseModel):
    """
    Params to assign a cluster or region to a tenant
    """ # noqa: E501
    cluster_identifier: Optional[Annotated[str, Field(strict=True)]] = Field(description="Specifies the list of cluster identifiers. The format is clusterId:clusterIncarnationId.", alias="clusterIdentifier")
    network: TenantNetwork
    __properties: ClassVar[List[str]] = ["clusterIdentifier", "network"]
