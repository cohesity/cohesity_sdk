...
class AbortIncompleteMultipartUploadAction(BaseModel):
    """
    Specifies the Lifecycle Abort Incomplete Multipart Upload Action.
    """ # noqa: E501
    days: Optional[StrictInt] = Field(default=None, description="Specifies the number of days after which to abort an incomplete multipart upload.")
