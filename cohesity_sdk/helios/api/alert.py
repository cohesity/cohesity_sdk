...
class AlertApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_alert_summary(self, **kwargs):
        ...
        def __get_helios_alerts(self, **kwargs):
        ...
        self.get_helios_alerts = _Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    "region_id": (str,),
                    "alert_id_list": ([str],),
                    "alert_state_list": ([str],),
                    "alert_type_list": ([int],),
                    "alert_severity_list": ([str],),
                    "region_ids": ([str],),
                    "cluster_identifiers": ([str],),
                    "start_date_usecs": (int,),
                    "end_date_usecs": (int,),
                    "max_alerts": (int,),
                    "alert_category_list": ([str, none_type],),
                    "alert_type_bucket_list": ([str, none_type],),
                },
                "attribute_map": {
                    "region_id": "regionId",
        ...
        def __get_helios_alerts_summary(self, **kwargs):
