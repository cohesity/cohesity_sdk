...
class CohesityCAApi:
    ...
    def exchange_certificates(
        self,
        body: Annotated[ExchangeCaCertificatesRequest, Field(description="Specifies the parameters to exchange ca certs")],
        ...
        Exchange ca certificate/s between clusters

        :param body: Specifies the parameters to exchange ca certs (required)
        :type body: ExchangeCaCertificatesRequest
        ...
        _param = self._exchange_certificates_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "ExchangeCaCertificatesResponse",
        }
    ...
    @validate_call
    def exchange_certificates_with_http_info(
        self,
        body: Annotated[ExchangeCaCertificatesRequest, Field(description="Specifies the parameters to exchange ca certs")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExchangeCaCertificatesResponse]:
        """exchange_certificates
    ...
    @validate_call
    def exchange_certificates_without_preload_content(
        self,
        body: Annotated[ExchangeCaCertificatesRequest, Field(description="Specifies the parameters to exchange ca certs")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    def _exchange_certificates_serialize(
        self,
        body,
        access_cluster_id,
        region_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/cert-manager/exchange-ca-certs',
