...
class SupportApi:
    ...
    @validate_call
    def execute_unlock_linux_user(
        self,
        body: Annotated[UnlockLinuxUserParams, Field(description="Specifies the linux user and its state.")],
        ...
        Unlock the linux user account if the user gets locked out and make it active.

        :param body: Specifies the linux user and its state. (required)
        :type body: UnlockLinuxUserParams
        ...
        _param = self._execute_unlock_linux_user_serialize(
            body=body,
    ...
    @validate_call
    def execute_unlock_linux_user_with_http_info(
        self,
        body: Annotated[UnlockLinuxUserParams, Field(description="Specifies the linux user and its state.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    @validate_call
    def execute_unlock_linux_user_without_preload_content(
        self,
        body: Annotated[UnlockLinuxUserParams, Field(description="Specifies the linux user and its state.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    def _execute_unlock_linux_user_serialize(
        self,
        body,
        access_cluster_id,
        region_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/support-user/state',
    ...
    def get_support_user_config(
        ...
        _param = self._get_support_user_config_serialize(
            access_cluster_id=access_cluster_id,
            region_id=region_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_support_user_config_with_http_info(
        self,
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_support_user_config_without_preload_content(
        self,
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        _request_timeout: Union[
    ...
    def _get_support_user_config_serialize(
        self,
        access_cluster_id,
        region_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/support-user/config',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_support_user_config(
        self,
        body: Annotated[UpdateSupportUserParams, Field(description="Specifies the support user configuration.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param body: Specifies the support user configuration. (required)
        :type body: UpdateSupportUserParams
        :param access_cluster_id: This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.
        :type access_cluster_id: int
        :param region_id: This field uniquely represents a region        and is used for making Helios calls to a specific region.
        :type region_id: str
        ...
        _param = self._update_support_user_config_serialize(
            body=body,
            access_cluster_id=access_cluster_id,
            region_id=region_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_support_user_config_with_http_info(
        self,
        body: Annotated[UpdateSupportUserParams, Field(description="Specifies the support user configuration.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    @validate_call
    def update_support_user_config_without_preload_content(
        self,
        body: Annotated[UpdateSupportUserParams, Field(description="Specifies the support user configuration.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    def _update_support_user_config_serialize(
        self,
        body,
        access_cluster_id,
        region_id,
    ...
    @validate_call
    def validate_support_user_creds(
        self,
        body: Annotated[ValidateSupportUserCredParams, Field(description="Specifies the support user credentials.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param body: Specifies the support user credentials. (required)
        :type body: ValidateSupportUserCredParams
        :param access_cluster_id: This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.
        :type access_cluster_id: int
        :param region_id: This field uniquely represents a region        and is used for making Helios calls to a specific region.
        :type region_id: str
        ...
        _param = self._validate_support_user_creds_serialize(
            body=body,
            access_cluster_id=access_cluster_id,
            region_id=region_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def validate_support_user_creds_with_http_info(
        self,
        body: Annotated[ValidateSupportUserCredParams, Field(description="Specifies the support user credentials.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    @validate_call
    def validate_support_user_creds_without_preload_content(
        self,
        body: Annotated[ValidateSupportUserCredParams, Field(description="Specifies the support user credentials.")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    def _validate_support_user_creds_serialize(
        self,
        body,
        access_cluster_id,
        region_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/support-user/config/validate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
