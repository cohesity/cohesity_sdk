...
class ProtectionGroupApi:
    ...
    def create_mcm_protection_group(
        ...
        _param = self._create_mcm_protection_group_serialize(
            body=body,
            region_id=region_id,
    ...
    def _create_mcm_protection_group_serialize(
        self,
        body,
        region_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/mcm/data-protect/protection-groups',
    ...
    def _delete_mcm_protection_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/mcm/data-protect/protection-groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_mcm_protection_groups_activity(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "McmProtectionGroupsActivity",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def get_mcm_protection_groups_activity_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[McmProtectionGroupsActivity]:
        """Get Protection Group activity on Helios.
    ...
    def _get_mcm_protection_groups_activity_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/mcm/data-protect/protection-group/activity',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_mcm_protection_group(
        self,
        ...
        _param = self._update_mcm_protection_group_serialize(
            id=id,
            body=body,
            region_id=region_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_mcm_protection_group_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Specifies the id of the Protection Group.")],
        body: Annotated[CreateOrUpdateProtectionGroupRequest, Field(description="Specifies the parameters to update a Protection Group.")],
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region and is used for making Helios calls to a specific region.")] = None,
    ...
    @validate_call
    def update_mcm_protection_group_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Specifies the id of the Protection Group.")],
        body: Annotated[CreateOrUpdateProtectionGroupRequest, Field(description="Specifies the parameters to update a Protection Group.")],
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region and is used for making Helios calls to a specific region.")] = None,
    ...
    def _update_mcm_protection_group_serialize(
        self,
        id,
        body,
        region_id,
