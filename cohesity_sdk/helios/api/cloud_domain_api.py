...
class CloudDomainApi:
    ...
    @validate_call
    def attach_cloud_domain(
        self,
        body: Annotated[AttachCloudDomainParams, Field(description="Specified the vault id")],
        ...
        Attaches the cloud domain present in the vault to cluster config in read-only mode without validating if contents can be decrypted.

        :param body: Specified the vault id (required)
        :type body: AttachCloudDomainParams
        ...
        _param = self._attach_cloud_domain_serialize(
            body=body,
    ...
    @validate_call
    def attach_cloud_domain_with_http_info(
        self,
        body: Annotated[AttachCloudDomainParams, Field(description="Specified the vault id")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AttachCloudDomainResponse]:
        """attach_cloud_domain
    ...
    @validate_call
    def attach_cloud_domain_without_preload_content(
        self,
        body: Annotated[AttachCloudDomainParams, Field(description="Specified the vault id")],
        access_cluster_id: Annotated[Optional[StrictInt], Field(description="This field uniquely represents a Cohesity        Cluster and is used for making on-prem calls from Helios.")] = None,
        region_id: Annotated[Optional[StrictStr], Field(description="This field uniquely represents a region        and is used for making Helios calls to a specific region.")] = None,
    ...
    def _attach_cloud_domain_serialize(
        self,
        body,
        access_cluster_id,
        region_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/data-protect/attach-cloud-domain',
