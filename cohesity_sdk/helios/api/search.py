...
from cohesity_sdk.helios.model.helios_search_indexed_objects_request import (
    HeliosSearchIndexedObjectsRequest,
)
from cohesity_sdk.helios.model.helios_search_indexed_objects_response_body import (
    HeliosSearchIndexedObjectsResponseBody,
)
from cohesity_sdk.helios.model.objects_search_response_body import (
    ObjectsSearchResponseBody,
)
from cohesity_sdk.helios.model.protected_objects_search_response_body import (
    ProtectedObjectsSearchResponseBody,
)
from cohesity_sdk.helios.model.search_indexed_objects_request import (
    SearchIndexedObjectsRequest,
)
from cohesity_sdk.helios.model.search_indexed_objects_response_body import (
...
class SearchApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __global_search_indexed_objects(self, body, **kwargs):
        ...
        def __search_indexed_objects(self, body, **kwargs):
        ...
        def __search_objects(self, **kwargs):
        ...
        self.search_objects = _Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    ...
                    "is_protected": (bool,),
                    "is_deleted": (bool,),
                    "last_run_status_list": ([str],),
                    "region_ids": ([str],),
                    "cluster_identifiers": ([str],),
                    "storage_domain_ids": ([str],),
                    "include_deleted_objects": (bool,),
                    "pagination_cookie": (str,),
                    "count": (int,),
                    "must_have_tag_ids": ([str],),
                    "might_have_tag_ids": ([str],),
                    "must_have_snapshot_tag_ids": ([str],),
                    "might_have_snapshot_tag_ids": ([str],),
                },
                "attribute_map": {
                    "access_cluster_id": "accessClusterId",
                    "region_id": "regionId",
        ...
        def __search_protected_objects(self, **kwargs):
        ...
        self.search_protected_objects = _Endpoint(
            ...
            root_map={
                ...
                "openapi_types": {
                    ...
                    "sub_result_size": (int,),
                    "filter_snapshot_from_usecs": (int,),
                    "filter_snapshot_to_usecs": (int,),
                    "os_types": ([str],),
                    "source_ids": ([int],),
