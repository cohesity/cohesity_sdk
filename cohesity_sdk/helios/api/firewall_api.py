...
class FirewallApi:
    ...
    def remove_firewall_profiles(
        ...
        Remove firewall profiles and their attachments - deprecated - use delete /network/firewall/profiles/{name}
    ...
    def update_firewall_profile(
        ...
        Update the firewall profiles and/or their attachments  - deprecated - use put /network/firewall/profiles/{name}
    ...
    def update_firewall_settings(
        ...
        Update the firewall settings available in the cluster.
