...
class RecoveryApi:
    ...
    def get_mcm_recoveries(
        ...
        recovery_identifiers: Annotated[Optional[List[StrictStr]], Field(description="Specifies the list of Recovery identifiers to filter.")] = None,
        environments: Annotated[Optional[List[StrictStr]], Field(description="Specifies the list of environments of recovered objects.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Specifies the list of statuses to filter.")] = None,
        from_time_usecs: Annotated[Optional[StrictInt], Field(description="Specifies the time in Unix timestamp epoch in microsecond which filters all the recoveries started after this value.")] = None,
        ...
        :param recovery_identifiers: Specifies the list of Recovery identifiers to filter.
        :type recovery_identifiers: List[str]
        :param environments: Specifies the list of environments of recovered objects.
        :type environments: List[str]
        :param statuses: Specifies the list of statuses to filter.
        :type statuses: List[str]
        :param from_time_usecs: Specifies the time in Unix timestamp epoch in microsecond which filters all the recoveries started after this value.
        :type from_time_usecs: int
        :param to_time_usecs: Specifies the time in Unix timestamp epoch in microsecond which filters all the recoveries started before this value.
        :type to_time_usecs: int
        :param recovery_types: Specifies the recovery types to filter recoveries.
        ...
        _param = self._get_mcm_recoveries_serialize(
            ...
            recovery_identifiers=recovery_identifiers,
    ...
    def _get_mcm_recoveries_serialize(
        ...
        if recovery_identifiers is not None:
            
            _query_params.append(('recoveryIdentifiers', recovery_identifiers))
        ...
        if recovery_types is not None:
            
            _query_params.append(('recoveryTypes', recovery_types))
            
        if is_rpaas is not None:
            
            _query_params.append(('isRpaas', is_rpaas))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mcm/data-protect/recoveries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_mcm_recoveries_by_id(
        ...
        _param = self._get_mcm_recoveries_by_id_serialize(
            id=id,
            region_id=region_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_mcm_recoveries_by_id_serialize(
        self,
        id,
        region_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mcm/data-protect/recoveries/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
