...
def lazy_import():
    from cohesity_sdk.helios.model.oracle_object_based_protection_params import (
        OracleObjectBasedProtectionParams,
    )
    from cohesity_sdk.helios.model.oracle_object_protection_info import (
