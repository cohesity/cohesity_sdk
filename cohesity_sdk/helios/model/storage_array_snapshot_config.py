...
def lazy_import():
    from cohesity_sdk.helios.model.storage_array_snapshot_max_snapshot_config import (
        StorageArraySnapshotMaxSnapshotConfig,
    )
    from cohesity_sdk.helios.model.storage_array_snapshot_max_space_config import (
        StorageArraySnapshotMaxSpaceConfig,
    )
    from cohesity_sdk.helios.model.storage_array_snapshot_throttling_policy import (
