...
def lazy_import():
    from cohesity_sdk.helios.model.common_nas_protection_params import (
        CommonNasProtectionParams,
    )
    from cohesity_sdk.helios.model.elastifile_object_protection_request_params_all_of import (
    ...
    from cohesity_sdk.helios.model.generic_nas_object_protection_params import (
