...
def lazy_import():
    from cohesity_sdk.helios.model.common_archival_azure_external_target_params_all_of import (
        CommonArchivalAzureExternalTargetParamsAllOf,
    )
    from cohesity_sdk.helios.model.common_azure_external_target_params import (
