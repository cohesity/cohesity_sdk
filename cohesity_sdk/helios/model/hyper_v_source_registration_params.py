...
def lazy_import():
    from cohesity_sdk.helios.model.scvmm_registration_params import (
        ScvmmRegistrationParams,
    )
    from cohesity_sdk.helios.model.standalone_cluster_registration_params import (
        StandaloneClusterRegistrationParams,
    )
    from cohesity_sdk.helios.model.standalone_host_registration_params import (
