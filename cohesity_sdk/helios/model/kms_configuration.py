...
def lazy_import():
    from cohesity_sdk.helios.model.aws_kms_configuration_response import (
        AwsKmsConfigurationResponse,
    )
    from cohesity_sdk.helios.model.kmip_kms_configuration_response import (
        KmipKmsConfigurationResponse,
    )
    from cohesity_sdk.helios.model.kms_configuration_all_of import KmsConfigurationAllOf
    from cohesity_sdk.helios.model.kms_configuration_response_params import (
