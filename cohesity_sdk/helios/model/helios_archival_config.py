...
def lazy_import():
    from cohesity_sdk.helios.model.helios_archival_config_all_of import (
        HeliosArchivalConfigAllOf,
    )
    from cohesity_sdk.helios.model.helios_common_target_configuration import (
    ...
    from cohesity_sdk.helios.model.helios_tier_level_settings import (
