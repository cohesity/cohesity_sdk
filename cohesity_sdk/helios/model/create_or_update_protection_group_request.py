...
def lazy_import():
    from cohesity_sdk.helios.model.acropolis_protection_group_params import (
        AcropolisProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.ad_protection_group_params import (
        ADProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.aws_protection_group_params import (
        AwsProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.azure_protection_group_params import (
        AzureProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.cassandra_protection_group_params import (
        CassandraProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.common_protection_group_request_params import (
        CommonProtectionGroupRequestParams,
    )
    from cohesity_sdk.helios.model.create_or_update_protection_group_request_all_of import (
        CreateOrUpdateProtectionGroupRequestAllOf,
    )
    from cohesity_sdk.helios.model.elastifile_protection_group_params import (
        ElastifileProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.exchange_protection_group_params import (
        ExchangeProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.flashblade_protection_group_params import (
        FlashbladeProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.gcp_protection_group_params import (
        GcpProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.generic_nas_protection_group_params import (
        GenericNasProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.gpfs_protection_group_params import (
        GpfsProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.hdfs_protection_group_params import (
        HdfsProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.hyper_v_protection_group_params import (
        HyperVProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.isilon_protection_group_params import (
        IsilonProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.kubernetes_protection_group_params import (
        KubernetesProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.kvm_protection_group_params import (
        KvmProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.mongo_db_protection_group_params import (
        MongoDBProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.mssql_protection_group_params import (
        MSSQLProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.netapp_protection_group_params import (
        NetappProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.nimble_protection_group_params import (
        NimbleProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.no_sql_protection_group_params import (
        NoSqlProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.office365_protection_group_params import (
        Office365ProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.oracle_protection_group_params import (
        OracleProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.physical_protection_group_params import (
        PhysicalProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.protection_group_alerting_policy import (
        ProtectionGroupAlertingPolicy,
    )
    from cohesity_sdk.helios.model.pure_protection_group_params import (
        PureProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.remote_adapter_protection_group_params import (
        RemoteAdapterProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.sfdc_protection_group_params import (
    ...
    from cohesity_sdk.helios.model.uda_protection_group_params import (
        UdaProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.view_protection_group_params import (
        ViewProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.vmware_protection_group_params import (
