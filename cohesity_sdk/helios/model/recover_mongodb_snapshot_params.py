...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.recover_mongodb_no_sql_object_params import (
        RecoverMongodbNoSqlObjectParams,
    )
    from cohesity_sdk.helios.model.recover_mongodb_snapshot_params_all_of import (
