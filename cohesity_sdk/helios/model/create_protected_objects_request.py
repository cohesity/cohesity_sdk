...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.create_protected_objects_request_all_of import (
        CreateProtectedObjectsRequestAllOf,
    )
    from cohesity_sdk.helios.model.env_specific_object_protection_request_params import (
...
class CreateProtectedObjectsRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "activate_remote_object_protection": (
                bool,
                none_type,
            ),  # noqa: E501
            "policy_id": (
