...
def lazy_import():
    from cohesity_sdk.helios.model.aws_source_registration_params import (
        AwsSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.cassandra_source_registration_params import (
        CassandraSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.common_source_registration_request_params import (
        CommonSourceRegistrationRequestParams,
    )
    from cohesity_sdk.helios.model.connection_config import ConnectionConfig
    from cohesity_sdk.helios.model.couchbase_source_registration_params import (
        CouchbaseSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.elastifile_registration_params import (
        ElastifileRegistrationParams,
    )
    from cohesity_sdk.helios.model.flashblade_registration_params import (
        FlashbladeRegistrationParams,
    )
    from cohesity_sdk.helios.model.generic_nas_registration_params import (
        GenericNasRegistrationParams,
    )
    from cohesity_sdk.helios.model.gpfs_registration_params import (
        GpfsRegistrationParams,
    )
    from cohesity_sdk.helios.model.hbase_source_registration_params import (
        HbaseSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.hdfs_source_registration_params import (
        HdfsSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.hive_source_registration_params import (
        HiveSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.hyper_v_source_registration_params import (
        HyperVSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.isilon_registration_params import (
        IsilonRegistrationParams,
    )
    from cohesity_sdk.helios.model.mongo_db_source_registration_params import (
        MongoDBSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.netapp_registration_params import (
        NetappRegistrationParams,
    )
    from cohesity_sdk.helios.model.office365_source_registration_params import (
        Office365SourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.physical_source_registration_params import (
        PhysicalSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.sfdc_source_registration_params import (
        SfdcSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.source_registration_all_of import (
        SourceRegistrationAllOf,
    )
    from cohesity_sdk.helios.model.uda_source_registration_params import (
        UdaSourceRegistrationParams,
    )
    from cohesity_sdk.helios.model.vmware_source_registration_params import (
