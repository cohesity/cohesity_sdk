...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.mcm_common_source_registration_reponse_params import (
        McmCommonSourceRegistrationReponseParams,
    )
    from cohesity_sdk.helios.model.mcm_source_registration_all_of import (
