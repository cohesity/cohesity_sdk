...
def lazy_import():
    from cohesity_sdk.helios.model.common_tdm_object_timeline_events_response_params import (
        CommonTdmObjectTimelineEventsResponseParams,
    )
    from cohesity_sdk.helios.model.tdm_clone_task_response_params import (
        TdmCloneTaskResponseParams,
    )
    from cohesity_sdk.helios.model.tdm_object_timeline_event_all_of import (
