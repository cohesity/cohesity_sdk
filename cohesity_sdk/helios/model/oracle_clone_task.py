...
def lazy_import():
    from cohesity_sdk.helios.model.common_oracle_clone_params import (
        CommonOracleCloneParams,
    )
    from cohesity_sdk.helios.model.common_post_backup_script_params import (
        CommonPostBackupScriptParams,
    )
    from cohesity_sdk.helios.model.common_pre_backup_script_params import (
...
class OracleCloneTask(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, db_name, home_folder, base_folder, *args, **kwargs
    ):  # noqa: E501
