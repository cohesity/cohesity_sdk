...
def lazy_import():
    from cohesity_sdk.helios.model.physical_file_protection_group_params import (
        PhysicalFileProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.physical_object_protection_params import (
        PhysicalObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.physical_volume_protection_group_params import (
...
class PhysicalObjectProtectionRequestParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "volume_object_protection_type_params": (
                PhysicalVolumeProtectionGroupParams,
            ),  # noqa: E501
        }
