...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.security_config_account_lockout import (
        SecurityConfigAccountLockout,
    )
    from cohesity_sdk.helios.model.security_config_certificate_based_auth import (
        SecurityConfigCertificateBasedAuth,
    )
    from cohesity_sdk.helios.model.security_config_data_classification import (
        SecurityConfigDataClassification,
    )
    from cohesity_sdk.helios.model.security_config_password_lifetime import (
        SecurityConfigPasswordLifetime,
    )
    from cohesity_sdk.helios.model.security_config_password_reuse import (
        SecurityConfigPasswordReuse,
    )
    from cohesity_sdk.helios.model.security_config_password_strength import (
        SecurityConfigPasswordStrength,
    )
    from cohesity_sdk.helios.model.security_config_session_configuration import (
