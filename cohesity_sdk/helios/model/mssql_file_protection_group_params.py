...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.mssql_file_protection_group_host_params import (
        MSSQLFileProtectionGroupHostParams,
    )
    from cohesity_sdk.helios.model.mssql_file_protection_group_object_params import (
        MSSQLFileProtectionGroupObjectParams,
    )
    from cohesity_sdk.helios.model.mssql_file_protection_group_params_all_of import (
