...
def lazy_import():
    from cohesity_sdk.helios.model.common_tdm_task_request_params import (
        CommonTdmTaskRequestParams,
    )
    from cohesity_sdk.helios.model.create_tdm_task_request_all_of import (
        CreateTdmTaskRequestAllOf,
    )
    from cohesity_sdk.helios.model.tdm_clone_task_request_params import (
        TdmCloneTaskRequestParams,
    )
    from cohesity_sdk.helios.model.tdm_refresh_task_request_params import (
        TdmRefreshTaskRequestParams,
    )
    from cohesity_sdk.helios.model.tdm_snapshot_task_params import TdmSnapshotTaskParams
    from cohesity_sdk.helios.model.tdm_teardown_task_request_params import (
