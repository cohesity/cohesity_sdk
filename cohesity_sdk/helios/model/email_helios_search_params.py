...
def lazy_import():
    from cohesity_sdk.helios.model.email_helios_search_params_all_of import (
        EmailHeliosSearchParamsAllOf,
    )
    from cohesity_sdk.helios.model.o365_helios_search_emails_request_params import (
        O365HeliosSearchEmailsRequestParams,
    )
    from cohesity_sdk.helios.model.search_email_request_params_base import (
...
class EmailHeliosSearchParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "created_start_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "created_end_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "last_modified_start_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "last_modified_end_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "organizer_address": (
            ...
            "due_date_start_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "due_date_end_time_secs": (
                int,
                none_type,
            ),  # noqa: E501
            "task_status_types": (
