...
def lazy_import():
    from cohesity_sdk.helios.model.common_hyper_v_protection_params import (
        CommonHyperVProtectionParams,
    )
    from cohesity_sdk.helios.model.hyper_v_object_protection_request import (
        HyperVObjectProtectionRequest,
    )
    from cohesity_sdk.helios.model.hyper_v_object_protection_request_params_all_of import (
