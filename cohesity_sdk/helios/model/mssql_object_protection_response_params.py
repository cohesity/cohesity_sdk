...
def lazy_import():
    from cohesity_sdk.helios.model.common_mssql_file_object_protection_params import (
        CommonMssqlFileObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.common_mssql_native_object_protection_params import (
        CommonMssqlNativeObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.common_mssql_object_protection_params import (
