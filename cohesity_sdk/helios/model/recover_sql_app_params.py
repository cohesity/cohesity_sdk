...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.common_recover_object_snapshot_params import (
        CommonRecoverObjectSnapshotParams,
    )
    from cohesity_sdk.helios.model.host_information import HostInformation
    from cohesity_sdk.helios.model.mssql_object_entity_params import (
        MssqlObjectEntityParams,
    )
    from cohesity_sdk.helios.model.recover_sql_app_params_all_of import (
        RecoverSqlAppParamsAllOf,
    )
    from cohesity_sdk.helios.model.sql_target_params_for_recover_sql_app import (
