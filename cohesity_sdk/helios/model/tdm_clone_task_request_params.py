...
def lazy_import():
    from cohesity_sdk.helios.model.common_tdm_clone_task_request_params import (
        CommonTdmCloneTaskRequestParams,
    )
    from cohesity_sdk.helios.model.oracle_clone_task import OracleCloneTask
    from cohesity_sdk.helios.model.tdm_clone_task_request_params_all_of import (
...
class TdmCloneTaskRequestParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, environment, snapshot_id, target_host_id, *args, **kwargs
    ):  # noqa: E501
