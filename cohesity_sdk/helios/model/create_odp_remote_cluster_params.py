...
def lazy_import():
    from cohesity_sdk.helios.model.create_odp_remote_cluster_params_all_of import (
...
class CreateOdpRemoteClusterParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, cluster_id, cluster_incarnation_id, cluster_name, *args, **kwargs
    ):  # noqa: E501
