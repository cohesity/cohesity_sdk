...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.vmware_object_protection_request import (
        VmwareObjectProtectionRequest,
    )
    from cohesity_sdk.helios.model.vmware_object_protection_request_params_all_of import (
