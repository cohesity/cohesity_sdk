...
def lazy_import():
    from cohesity_sdk.helios.model.cassandra_on_prem_search_params import (
        CassandraOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.common_search_indexed_objects_request_params import (
        CommonSearchIndexedObjectsRequestParams,
    )
    from cohesity_sdk.helios.model.couch_base_on_prem_search_params import (
        CouchBaseOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.hbase_on_prem_search_params import (
        HbaseOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.hdfson_prem_search_params import (
        HDFSOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.hive_on_prem_search_params import (
        HiveOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.mongo_db_on_prem_search_params import (
        MongoDbOnPremSearchParams,
    )
    from cohesity_sdk.helios.model.search_document_library_request_params import (
        SearchDocumentLibraryRequestParams,
    )
    from cohesity_sdk.helios.model.search_email_request_params import (
        SearchEmailRequestParams,
    )
    from cohesity_sdk.helios.model.search_exchange_objects_request_params import (
        SearchExchangeObjectsRequestParams,
    )
    from cohesity_sdk.helios.model.search_file_request_params import (
        SearchFileRequestParams,
    )
    from cohesity_sdk.helios.model.search_indexed_objects_request_all_of import (
        SearchIndexedObjectsRequestAllOf,
    )
    from cohesity_sdk.helios.model.search_ms_teams_request_params import (
        SearchMsTeamsRequestParams,
    )
    from cohesity_sdk.helios.model.search_public_folder_request_params import (
        SearchPublicFolderRequestParams,
    )
    from cohesity_sdk.helios.model.search_sfdc_records_request_params import (
        SearchSfdcRecordsRequestParams,
    )
    from cohesity_sdk.helios.model.uda_on_prem_search_params import (
