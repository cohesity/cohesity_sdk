...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.common_source_connection_request_params import (
        CommonSourceConnectionRequestParams,
    )
    from cohesity_sdk.helios.model.hadoop_connection_params import (
        HadoopConnectionParams,
    )
    from cohesity_sdk.helios.model.mssql_connection_params import MssqlConnectionParams
    from cohesity_sdk.helios.model.oracle_connection_params import (
        OracleConnectionParams,
    )
    from cohesity_sdk.helios.model.source_connection_request_params_all_of import (
        SourceConnectionRequestParamsAllOf,
    )
    from cohesity_sdk.helios.model.vmware_connection_params import (
