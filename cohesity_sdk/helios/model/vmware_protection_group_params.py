...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.common_vmware_protection_params import (
    ...
    from cohesity_sdk.helios.model.vmware_protection_group_extra_params import (
        VmwareProtectionGroupExtraParams,
    )
    from cohesity_sdk.helios.model.vmware_protection_group_object_params import (
        VmwareProtectionGroupObjectParams,
    )
    from cohesity_sdk.helios.model.vmware_protection_group_params_all_of import (
        VmwareProtectionGroupParamsAllOf,
    )
    from cohesity_sdk.helios.model.vmware_protection_group_standby_resource_params import (
