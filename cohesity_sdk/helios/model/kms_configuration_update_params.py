...
def lazy_import():
    from cohesity_sdk.helios.model.aws_kms_configuration_update_params import (
        AwsKmsConfigurationUpdateParams,
    )
    from cohesity_sdk.helios.model.kmip_kms_configuration import KmipKmsConfiguration
    from cohesity_sdk.helios.model.kms_configuration_add_update_params import (
        KmsConfigurationAddUpdateParams,
    )
    from cohesity_sdk.helios.model.kms_configuration_update_params_all_of import (
