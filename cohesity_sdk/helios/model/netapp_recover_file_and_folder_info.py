...
def lazy_import():
    from cohesity_sdk.helios.model.common_recover_file_and_folder_info import (
        CommonRecoverFileAndFolderInfo,
    )
    from cohesity_sdk.helios.model.netapp_recover_file_and_folder_info_all_of import (
