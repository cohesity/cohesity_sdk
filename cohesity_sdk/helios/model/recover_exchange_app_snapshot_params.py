...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.exchange_recover_database_params import (
        ExchangeRecoverDatabaseParams,
    )
    from cohesity_sdk.helios.model.recover_exchange_app_snapshot_params_all_of import (
