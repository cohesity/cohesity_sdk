...
def lazy_import():
    from cohesity_sdk.helios.model.cluster_dhcp_network_config import (
        ClusterDhcpNetworkConfig,
    )
    from cohesity_sdk.helios.model.cluster_manual_network_config import (
...
class ClusterCreateNetworkConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, ntp_servers, domain_names, use_dhcp, *args, **kwargs
    ):  # noqa: E501
