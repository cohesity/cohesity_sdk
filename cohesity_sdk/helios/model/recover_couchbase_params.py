...
def lazy_import():
    from cohesity_sdk.helios.model.common_no_sql_recovery_options import (
        CommonNoSqlRecoveryOptions,
    )
    from cohesity_sdk.helios.model.filter_documents_params import FilterDocumentsParams
    from cohesity_sdk.helios.model.recover_couchbase_params_all_of import (
        RecoverCouchbaseParamsAllOf,
    )
    from cohesity_sdk.helios.model.recover_couchbase_snapshot_params import (
...
class RecoverCouchbaseParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, snapshots, filter_documents_params, *args, **kwargs
    ):  # noqa: E501
