...
def lazy_import():
    from cohesity_sdk.helios.model.common_data_tiering_task_response import (
        CommonDataTieringTaskResponse,
    )
    from cohesity_sdk.helios.model.create_or_update_data_tiering_task_request_all_of import (
