...
class ViewUserQuota(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ViewUserQuota - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            quota_policy ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Specifies the user quota policy.. [optional]  # noqa: E501
