...
def lazy_import():
    from cohesity_sdk.helios.model.common_identity_provider_configuration import (
        CommonIdentityProviderConfiguration,
    )
    from cohesity_sdk.helios.model.create_idp_request_params_all_of import (
...
class CreateIdpRequestParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, issuer_id, sso_url, certificate, name, domain, *args, **kwargs
    ):  # noqa: E501
