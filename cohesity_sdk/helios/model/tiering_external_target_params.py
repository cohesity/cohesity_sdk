...
def lazy_import():
    from cohesity_sdk.helios.model.common_tiering_external_target_params import (
        CommonTieringExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_aws_external_target_params import (
        TieringAwsExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_azure_external_target_params import (
        TieringAzureExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_external_target_params_all_of import (
        TieringExternalTargetParamsAllOf,
    )
    from cohesity_sdk.helios.model.tiering_gcp_external_target_params import (
        TieringGcpExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_oracle_external_target_params import (
        TieringOracleExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_s3_comp_external_target_params import (
