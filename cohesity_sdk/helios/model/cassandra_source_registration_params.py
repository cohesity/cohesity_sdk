...
def lazy_import():
    from cohesity_sdk.helios.model.cassandra_connection_params import (
        CassandraConnectionParams,
    )
    from cohesity_sdk.helios.model.cassandra_connection_params_ssh_password_credentials import (
        CassandraConnectionParamsSshPasswordCredentials,
    )
    from cohesity_sdk.helios.model.cassandra_connection_params_ssh_private_key_credentials import (
        CassandraConnectionParamsSshPrivateKeyCredentials,
    )
    from cohesity_sdk.helios.model.cassandra_source_registration_params_all_of import (
        CassandraSourceRegistrationParamsAllOf,
    )
    from cohesity_sdk.helios.model.cassandra_source_registration_params_all_of_cassandra_credentials import (
        CassandraSourceRegistrationParamsAllOfCassandraCredentials,
    )
    from cohesity_sdk.helios.model.cassandra_source_registration_params_all_of_jmx_credentials import (
