...
def lazy_import():
    from cohesity_sdk.helios.model.protected_object_pause_action_params import (
        ProtectedObjectPauseActionParams,
    )
    from cohesity_sdk.helios.model.protected_object_resume_action_params import (
        ProtectedObjectResumeActionParams,
    )
    from cohesity_sdk.helios.model.protected_object_run_now_action_params import (
        ProtectedObjectRunNowActionParams,
    )
    from cohesity_sdk.helios.model.protected_object_un_protect_action_params import (
