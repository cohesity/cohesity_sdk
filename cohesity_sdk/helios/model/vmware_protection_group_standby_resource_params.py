...
def lazy_import():
    from cohesity_sdk.helios.model.common_standby_resource_params import (
        CommonStandbyResourceParams,
    )
    from cohesity_sdk.helios.model.vmware_protection_group_standby_resource_params_all_of import (
