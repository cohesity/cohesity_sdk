...
def lazy_import():
    from cohesity_sdk.helios.model.aws_aurora_snapshot_manager_object_protection_params import (
        AwsAuroraSnapshotManagerObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.aws_common_object_protection_params import (
        AwsCommonObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.aws_native_object_protection_params import (
        AwsNativeObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.aws_object_protection_request_params_all_of import (
        AwsObjectProtectionRequestParamsAllOf,
    )
    from cohesity_sdk.helios.model.aws_rds_snapshot_manager_object_protection_params import (
        AwsRdsSnapshotManagerObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.aws_snapshot_manager_object_protection_params import (
