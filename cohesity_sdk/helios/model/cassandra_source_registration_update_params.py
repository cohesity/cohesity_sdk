...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.cassandra_source_registration_update_params_cassandra_credentials import (
        CassandraSourceRegistrationUpdateParamsCassandraCredentials,
    )
    from cohesity_sdk.helios.model.cassandra_source_registration_update_params_jmx_credentials import (
