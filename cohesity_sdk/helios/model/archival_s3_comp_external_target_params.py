...
def lazy_import():
    from cohesity_sdk.helios.model.archival_s3_comp_external_target_params_all_of import (
        ArchivalS3CompExternalTargetParamsAllOf,
    )
    from cohesity_sdk.helios.model.common_s3_comp_external_target_params import (
...
class ArchivalS3CompExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, bucket_name, access_key_id, end_point, *args, **kwargs
    ):  # noqa: E501
