...
def lazy_import():
    from cohesity_sdk.helios.model.update_archival_snapshot_config import (
        UpdateArchivalSnapshotConfig,
    )
    from cohesity_sdk.helios.model.update_local_snapshot_config import (
        UpdateLocalSnapshotConfig,
    )
    from cohesity_sdk.helios.model.update_replication_snapshot_config import (
