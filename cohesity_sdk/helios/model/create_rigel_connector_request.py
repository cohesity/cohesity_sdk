...
def lazy_import():
    from cohesity_sdk.helios.model.common_create_or_update_rigel_connector_request import (
        CommonCreateOrUpdateRigelConnectorRequest,
    )
    from cohesity_sdk.helios.model.create_rigel_connector_request_all_of import (
