...
def lazy_import():
    from cohesity_sdk.helios.model.common_generic_nas_protection_params import (
    ...
    from cohesity_sdk.helios.model.generic_nas_protection_group_extra_params import (
        GenericNasProtectionGroupExtraParams,
    )
    from cohesity_sdk.helios.model.generic_nas_protection_group_params_all_of import (
