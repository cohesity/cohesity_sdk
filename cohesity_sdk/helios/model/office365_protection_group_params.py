...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.office365_one_drive_protection_group_params import (
        Office365OneDriveProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.office365_outlook_protection_group_params import (
        Office365OutlookProtectionGroupParams,
    )
    from cohesity_sdk.helios.model.office365_protection_group_object_params import (
        Office365ProtectionGroupObjectParams,
    )
    from cohesity_sdk.helios.model.office365_public_folders_protection_group_params import (
