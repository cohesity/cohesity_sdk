...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.common_tiering_azure_external_target_params import (
        CommonTieringAzureExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_azure_external_target_params_all_of import (
