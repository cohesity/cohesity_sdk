...
class CreateOrUpdateBifrostConnectorRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, connection_id, tenant_id, name, *args, **kwargs):  # noqa: E501
        """CreateOrUpdateBifrostConnectorRequest - a model defined in OpenAPI
