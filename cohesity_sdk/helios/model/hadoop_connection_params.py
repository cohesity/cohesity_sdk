...
def lazy_import():
    from cohesity_sdk.helios.model.hadoop_connection_params_ssh_password_credentials import (
        HadoopConnectionParamsSshPasswordCredentials,
    )
    from cohesity_sdk.helios.model.hadoop_connection_params_ssh_private_key_credentials import (
