...
def lazy_import():
    from cohesity_sdk.helios.model.aws_snapshot_manager_protection_group_object_params import (
        AwsSnapshotManagerProtectionGroupObjectParams,
    )
    from cohesity_sdk.helios.model.ebs_volume_exclusion_params import (
