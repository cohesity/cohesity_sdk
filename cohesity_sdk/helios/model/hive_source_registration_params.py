...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.hive_source_registration_params_all_of import (
        HiveSourceRegistrationParamsAllOf,
    )
    from cohesity_sdk.helios.model.hive_source_registration_params_all_of_ssh_password_credentials import (
