...
def lazy_import():
    from cohesity_sdk.helios.model.helios_cassandra_objects import (
        HeliosCassandraObjects,
    )
    from cohesity_sdk.helios.model.helios_common_search_indexed_objects_response_params import (
        HeliosCommonSearchIndexedObjectsResponseParams,
    )
    from cohesity_sdk.helios.model.helios_couchbase_objects import (
    ...
    from cohesity_sdk.helios.model.helios_public_folder_items import (
        HeliosPublicFolderItems,
    )
    from cohesity_sdk.helios.model.helios_search_indexed_objects_cluster_error import (
        HeliosSearchIndexedObjectsClusterError,
    )
    from cohesity_sdk.helios.model.helios_search_indexed_objects_response_body_all_of import (
