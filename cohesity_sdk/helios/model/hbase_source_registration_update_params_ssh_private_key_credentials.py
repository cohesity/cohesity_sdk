...
class HbaseSourceRegistrationUpdateParamsSshPrivateKeyCredentials(ModelNormal):
    ...
    def __init__(self, private_key, user_id, *args, **kwargs):  # noqa: E501
        """HbaseSourceRegistrationUpdateParamsSshPrivateKeyCredentials - a model defined in OpenAPI
