...
def lazy_import():
    from cohesity_sdk.helios.model.common_create_or_update_rigel_connection_request import (
        CommonCreateOrUpdateRigelConnectionRequest,
    )
    from cohesity_sdk.helios.model.create_rigel_connection_request_all_of import (
