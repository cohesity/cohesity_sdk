...
def lazy_import():
    from cohesity_sdk.helios.model.mcm_protection_group_archival_run_activity_params import (
        McmProtectionGroupArchivalRunActivityParams,
    )
    from cohesity_sdk.helios.model.mcm_protection_group_backup_run_activity_params import (
