...
def lazy_import():
    from cohesity_sdk.helios.model.clone_action_cleanup_cloud_resources_cleanup_params import (
        CloneActionCleanupCloudResourcesCleanupParams,
    )
    from cohesity_sdk.helios.model.clone_action_cleanup_power_off_vm_params import (
...
class CloneActionCleanupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "cloud_resources_cleanup_params": (
                CloneActionCleanupCloudResourcesCleanupParams,
            ),  # noqa: E501
        }
