...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.helios_azure_target_config import (
    ...
    from cohesity_sdk.helios.model.helios_remote_target_config import (
        HeliosRemoteTargetConfig,
    )
    from cohesity_sdk.helios.model.helios_replication_config_all_of import (
