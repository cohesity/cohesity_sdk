...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.helios_extended_retention_policy import (
        HeliosExtendedRetentionPolicy,
    )
    from cohesity_sdk.helios.model.helios_policy_response_all_of import (
        HeliosPolicyResponseAllOf,
    )
    from cohesity_sdk.helios.model.helios_protection_policy import (
        HeliosProtectionPolicy,
    )
    from cohesity_sdk.helios.model.helios_retry_options import HeliosRetryOptions
    from cohesity_sdk.helios.model.helios_targets_configuration import (
