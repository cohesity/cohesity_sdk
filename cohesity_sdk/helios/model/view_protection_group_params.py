...
def lazy_import():
    from cohesity_sdk.helios.model.externally_triggered_job_params import (
        ExternallyTriggeredJobParams,
    )
    from cohesity_sdk.helios.model.indexing_policy import IndexingPolicy
    from cohesity_sdk.helios.model.view_protection_group_object_params import (
        ViewProtectionGroupObjectParams,
    )
    from cohesity_sdk.helios.model.view_protection_group_replication_params import (
