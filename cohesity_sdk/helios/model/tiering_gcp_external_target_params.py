...
def lazy_import():
    from cohesity_sdk.helios.model.common_gcp_external_target_params import (
        CommonGcpExternalTargetParams,
    )
    from cohesity_sdk.helios.model.tiering_gcp_external_target_params_all_of import (
...
class TieringGcpExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, bucket_name, project_id, client_email_address, *args, **kwargs
    ):  # noqa: E501
