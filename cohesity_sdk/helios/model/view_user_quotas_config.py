...
class ViewUserQuotasConfig(ModelNormal):
    ...
    def __init__(self, enabled, *args, **kwargs):  # noqa: E501
        """ViewUserQuotasConfig - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            default_quota_policy ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Specifies the default user quota policy.. [optional]  # noqa: E501
        """
