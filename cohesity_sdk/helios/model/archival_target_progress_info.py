...
def lazy_import():
    from cohesity_sdk.helios.model.archival_target_progress_info_all_of import (
        ArchivalTargetProgressInfoAllOf,
    )
    from cohesity_sdk.helios.model.archival_target_summary_info import (
        ArchivalTargetSummaryInfo,
    )
    from cohesity_sdk.helios.model.archival_target_tier_info import (
