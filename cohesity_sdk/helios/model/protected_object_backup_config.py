...
def lazy_import():
    from cohesity_sdk.helios.model.aws_object_protection_response_params import (
    ...
    from cohesity_sdk.helios.model.elastifile_object_protection_response_params import (
        ElastifileObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.env_specific_object_protection_response_params import (
        EnvSpecificObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.flashblade_object_protection_response_params import (
        FlashbladeObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.generic_nas_object_protection_response_params import (
        GenericNasObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.gpfs_object_protection_response_params import (
        GpfsObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.hyper_v_object_protection_response_params import (
        HyperVObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.isilon_object_protection_response_params import (
        IsilonObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.mssql_object_protection_response_params import (
        MssqlObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.netapp_object_protection_response_params import (
        NetappObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.office365_object_protection_response_params import (
        Office365ObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.oracle_object_protection_response_params import (
        OracleObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.physical_object_protection_response_params import (
        PhysicalObjectProtectionResponseParams,
    )
    from cohesity_sdk.helios.model.policy_config import PolicyConfig
    from cohesity_sdk.helios.model.protected_object_backup_config_all_of import (
        ProtectedObjectBackupConfigAllOf,
    )
    from cohesity_sdk.helios.model.sfdc_object_protection_response_params import (
    ...
    from cohesity_sdk.helios.model.vmware_object_protection_response_params import (
