...
def lazy_import():
    ...
    from cohesity_sdk.helios.model.object_type_v_center_params import (
        ObjectTypeVCenterParams,
    )
    from cohesity_sdk.helios.model.object_type_windows_cluster_params import (
        ObjectTypeWindowsClusterParams,
    )
    from cohesity_sdk.helios.model.protected_object_backup_config import (
        ProtectedObjectBackupConfig,
    )
    from cohesity_sdk.helios.model.protected_object_group_backup_config import (
        ProtectedObjectGroupBackupConfig,
    )
    from cohesity_sdk.helios.model.protected_object_info_all_of import (
        ProtectedObjectInfoAllOf,
    )
    from cohesity_sdk.helios.model.sharepoint_object_params import (
