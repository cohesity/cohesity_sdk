...
def lazy_import():
    from cohesity_sdk.helios.model.office365_groups_object_protection_params import (
        Office365GroupsObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.office365_object_protection_params import (
        Office365ObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.office365_sharepoint_site_object_protection_params import (
        Office365SharepointSiteObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.office365_teams_object_protection_params import (
        Office365TeamsObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.office365_user_mailbox_object_protection_params import (
        Office365UserMailboxObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.office365_user_one_drive_object_protection_params import (
