...
def lazy_import():
    from cohesity_sdk.helios.model.common_sql_app_source_config import (
        CommonSqlAppSourceConfig,
    )
    from cohesity_sdk.helios.model.filename_pattern_to_directory import (
        FilenamePatternToDirectory,
    )
    from cohesity_sdk.helios.model.multi_stage_restore_options import (
