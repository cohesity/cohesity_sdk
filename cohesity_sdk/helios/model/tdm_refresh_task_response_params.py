...
def lazy_import():
    from cohesity_sdk.helios.model.common_tdm_refresh_task_response_params import (
        CommonTdmRefreshTaskResponseParams,
    )
    from cohesity_sdk.helios.model.oracle_clone_refresh_task import (
        OracleCloneRefreshTask,
    )
    from cohesity_sdk.helios.model.tdm_refresh_task_response_params_all_of import (
