...
def lazy_import():
    from cohesity_sdk.helios.model.archival_external_target_params import (
        ArchivalExternalTargetParams,
    )
    from cohesity_sdk.helios.model.cloud_domain import CloudDomain
    from cohesity_sdk.helios.model.common_external_target_params import (
        CommonExternalTargetParams,
    )
    from cohesity_sdk.helios.model.external_target_all_of import ExternalTargetAllOf
    from cohesity_sdk.helios.model.tiering_external_target_params import (
