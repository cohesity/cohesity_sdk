...
def lazy_import():
    from cohesity_sdk.helios.model.aws_object_protection_update_request_params import (
        AwsObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.common_object_protect_params import (
        CommonObjectProtectParams,
    )
    from cohesity_sdk.helios.model.elastifile_object_protection_update_request_params import (
        ElastifileObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.env_specific_object_protection_update_request_params import (
        EnvSpecificObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.flashblade_object_protection_update_request_params import (
        FlashbladeObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.generic_nas_object_protection_update_request_params import (
        GenericNasObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.gpfs_object_protection_update_request_params import (
        GpfsObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.hyper_v_object_protection_update_request_params import (
        HyperVObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.isilon_object_protection_update_request_params import (
        IsilonObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.mssql_object_protection_update_request_params import (
        MssqlObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.netapp_object_protection_update_request_params import (
        NetappObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.office365_object_protection_update_request_params import (
        Office365ObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.oracle_object_protection_update_request_params import (
        OracleObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.physical_object_protection_update_request_params import (
        PhysicalObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.helios.model.policy_config import PolicyConfig
    from cohesity_sdk.helios.model.sfdc_object_protection_update_request_params import (
    ...
    from cohesity_sdk.helios.model.vmware_object_protection_update_request_params import (
