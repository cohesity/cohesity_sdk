...
def lazy_import():
    from cohesity_sdk.helios.model.aws_object_protection_request_params import (
        AwsObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.common_env_specific_object_protection_params import (
        CommonEnvSpecificObjectProtectionParams,
    )
    from cohesity_sdk.helios.model.elastifile_object_protection_request_params import (
        ElastifileObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.env_specific_object_protection_request_params_all_of import (
        EnvSpecificObjectProtectionRequestParamsAllOf,
    )
    from cohesity_sdk.helios.model.flashblade_object_protection_request_params import (
        FlashbladeObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.generic_nas_object_protection_request_params import (
        GenericNasObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.gpfs_object_protection_request_params import (
        GpfsObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.hyper_v_object_protection_request_params import (
        HyperVObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.isilon_object_protection_request_params import (
        IsilonObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.mssql_object_protection_request_params import (
        MssqlObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.netapp_object_protection_request_params import (
        NetappObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.office365_object_protection_request_params import (
        Office365ObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.oracle_object_protection_request_params import (
        OracleObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.physical_object_protection_request_params import (
        PhysicalObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.sfdc_object_protection_request_params import (
        SfdcObjectProtectionRequestParams,
    )
    from cohesity_sdk.helios.model.vmware_object_protection_request_params import (
