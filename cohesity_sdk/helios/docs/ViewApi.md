...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ViewApi(api_client)
    id = 56 # int | Specifies the id of a view.
    body = cohesity_sdk.helios.LockFileParams() # LockFileParams | Specifies the request params to lock a file
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Create a file-lock
        api_response = api_instance.lock_file(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **overwrite_view**
> overwrite_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.helios.OverwriteViewParams() # OverwriteViewParams | Specifies the request to overwrite the View.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Overwrite View.
        api_instance.overwrite_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
    except Exception as e:
...
> Template read_view_template_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Read a View Template by Id
        api_response = api_instance.read_view_template_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **read_view_templates**
> GetViewTemplatesResult read_view_templates(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # List View Templates
        api_response = api_instance.read_view_templates(access_cluster_id=access_cluster_id, region_id=region_id)
...
# **update_share**
> Share update_share(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.helios.UpdateShareParam() # UpdateShareParam | Specifies the request to update a Share.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update a Share.
        api_response = api_instance.update_share(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **update_view**
> View update_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.helios.View() # View | Request to update a view.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update a View
        api_response = api_instance.update_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> ViewDirectoryQuota update_view_directory_quota(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ViewApi(api_client)
    id = 56 # int | Specifies the View id.
    body = cohesity_sdk.helios.ViewDirectoryQuota() # ViewDirectoryQuota | Specifies the request to update directory quota.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update directory quota for the View.
        api_response = api_instance.update_view_directory_quota(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> Template update_view_template(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ViewApi(api_client)
    id = 56 # int | Specifies a unique id of the view template.
    body = cohesity_sdk.helios.Template() # Template | Request to update a view template.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update a View Template
        api_response = api_instance.update_view_template(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> UserQuota update_view_user_quota_override(view_id, user_id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.helios.QuotaPolicy() # QuotaPolicy | Specifies the user quota policy of the user.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update user quota override.
        api_response = api_instance.update_view_user_quota_override(view_id, user_id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> ViewUserQuotas update_view_user_quota_settings(view_id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ViewApi(api_client)
    view_id = 56 # int | Specifies the View id.
    body = cohesity_sdk.helios.ViewUserQuotaSettings() # ViewUserQuotaSettings | Specifies the parameters to enable/disable or update the default quota config on the view.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update View user quota settings.
        api_response = api_instance.update_view_user_quota_settings(view_id, body, access_cluster_id=access_cluster_id, region_id=region_id)
