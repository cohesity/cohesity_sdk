...
**objects** | [**List[RecoverCassandraNoSqlObjectParams]**](RecoverCassandraNoSqlObjectParams.md) | Specifies details of objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverCassandraSnapshotParams from a JSON string
recover_cassandra_snapshot_params_instance = RecoverCassandraSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverCassandraSnapshotParams.to_json())

# convert the object into a dict
recover_cassandra_snapshot_params_dict = recover_cassandra_snapshot_params_instance.to_dict()
# create an instance of RecoverCassandraSnapshotParams from a dict
recover_cassandra_snapshot_params_from_dict = RecoverCassandraSnapshotParams.from_dict(recover_cassandra_snapshot_params_dict)
```
