...
------------ | ------------- | ------------- | -------------
**aws_params** | [**AwsSnapshotParams**](AwsSnapshotParams.md) | Specifies the parameters specific to AWS type snapshot. | [optional] 
**azure_params** | [**AzureSnapshotParams**](AzureSnapshotParams.md) | Specifies the parameters specific to Azure type snapshot. | [optional] 
...
**elastifile_params** | [**CommonNasObjectParams**](CommonNasObjectParams.md) | Specifies the parameters specific to NetApp type snapshot. | [optional] 
...
**flashblade_params** | [**FlashbladeObjectParams**](FlashbladeObjectParams.md) | Specifies the parameters specific to Flashblade type snapshot. | [optional] 
**generic_nas_params** | [**CommonNasObjectParams**](CommonNasObjectParams.md) | Specifies the parameters specific to Generic NAS type snapshot. | [optional] 
**gpfs_params** | [**CommonNasObjectParams**](CommonNasObjectParams.md) | Specifies the parameters specific to GPFS type snapshot. | [optional] 
**has_data_lock** | **bool** | Specifies if this snapshot has datalock. | [optional] 
**hyperv_params** | [**HypervSnapshotParams**](HypervSnapshotParams.md) | Specifies the parameters specific to HyperV type snapshot. | [optional] 
...
**isilon_params** | [**IsilonObjectParams**](IsilonObjectParams.md) | Specifies the parameters specific to Isilon type snapshot. | [optional] 
**netapp_params** | [**NetappObjectParams**](NetappObjectParams.md) | Specifies the parameters specific to NetApp type snapshot. | [optional] 
...
**physical_params** | [**PhysicalSnapshotParams**](PhysicalSnapshotParams.md) | Specifies the parameters specific to Physical type snapshot. | [optional] 
...
**sfdc_params** | [**SfdcObjectParams**](SfdcObjectParams.md) | Specifies the parameters specific to Salesforce type snapshot. | [optional] 
