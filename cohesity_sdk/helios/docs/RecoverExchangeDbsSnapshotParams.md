...
**recovery_target_config** | **object** | Specifies the recovery target configuration if the recovery is set to a different location which is different from the original source. | [optional] 
...
json = "{}"
# create an instance of RecoverExchangeDbsSnapshotParams from a JSON string
recover_exchange_dbs_snapshot_params_instance = RecoverExchangeDbsSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverExchangeDbsSnapshotParams.to_json())

# convert the object into a dict
recover_exchange_dbs_snapshot_params_dict = recover_exchange_dbs_snapshot_params_instance.to_dict()
# create an instance of RecoverExchangeDbsSnapshotParams from a dict
recover_exchange_dbs_snapshot_params_from_dict = RecoverExchangeDbsSnapshotParams.from_dict(recover_exchange_dbs_snapshot_params_dict)
```
