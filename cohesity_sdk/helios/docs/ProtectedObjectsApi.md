...
try:
	# Perform Actions on Protect Objects.
	api_response = client.protected_objects.perform_action_on_protect_objects(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ProtectedObjectsApi->perform_action_on_protect_objects: %s\n" % e)
```
...
try:
	# Create Object Backup.
	api_response = client.protected_objects.protect_objects_of_any_type(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ProtectedObjectsApi->protect_objects_of_any_type: %s\n" % e)
```
...
try:
	# Update Object Backup.
	api_response = client.protected_objects.update_protected_objects_of_any_type(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ProtectedObjectsApi->update_protected_objects_of_any_type: %s\n" % e)
```
