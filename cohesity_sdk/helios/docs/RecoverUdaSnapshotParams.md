...
**objects** | [**List[RecoverUdaObjectParams]**](RecoverUdaObjectParams.md) | Specifies the local snapshot ids and other details of the objects to be recovered. | [optional] 
...
recover_uda_snapshot_params_instance = RecoverUdaSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverUdaSnapshotParams.to_json())

# convert the object into a dict
recover_uda_snapshot_params_dict = recover_uda_snapshot_params_instance.to_dict()
# create an instance of RecoverUdaSnapshotParams from a dict
recover_uda_snapshot_params_from_dict = RecoverUdaSnapshotParams.from_dict(recover_uda_snapshot_params_dict)
```
