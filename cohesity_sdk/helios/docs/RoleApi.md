...
try:
	# Create a Role.
	api_response = client.role.create_role(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling RoleApi->create_role: %s\n" % e)
```
...
try:
	# Delete a Role.
	client.role.delete_role(name, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling RoleApi->delete_role: %s\n" % e)
```
...
try:
	# Get Roles.
	api_response = client.role.get_roles(access_cluster_id=access_cluster_id, region_id=region_id, names=names, tenant_ids=tenant_ids, include_tenants=include_tenants)
	pprint(api_response)
except ApiException as e:
...
try:
	# Update a Role.
	api_response = client.role.update_role(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling RoleApi->update_role: %s\n" % e)
```
