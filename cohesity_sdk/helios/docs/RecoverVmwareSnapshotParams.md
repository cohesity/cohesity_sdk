...
json = "{}"
# create an instance of RecoverVmwareSnapshotParams from a JSON string
recover_vmware_snapshot_params_instance = RecoverVmwareSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverVmwareSnapshotParams.to_json())

# convert the object into a dict
recover_vmware_snapshot_params_dict = recover_vmware_snapshot_params_instance.to_dict()
# create an instance of RecoverVmwareSnapshotParams from a dict
recover_vmware_snapshot_params_from_dict = RecoverVmwareSnapshotParams.from_dict(recover_vmware_snapshot_params_dict)
```
