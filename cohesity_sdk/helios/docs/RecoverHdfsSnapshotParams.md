...
**objects** | [**List[RecoverHdfsNoSqlObjectParams]**](RecoverHdfsNoSqlObjectParams.md) | Specifies details of objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverHdfsSnapshotParams from a JSON string
recover_hdfs_snapshot_params_instance = RecoverHdfsSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverHdfsSnapshotParams.to_json())

# convert the object into a dict
recover_hdfs_snapshot_params_dict = recover_hdfs_snapshot_params_instance.to_dict()
# create an instance of RecoverHdfsSnapshotParams from a dict
recover_hdfs_snapshot_params_from_dict = RecoverHdfsSnapshotParams.from_dict(recover_hdfs_snapshot_params_dict)
```
