...
**storage_container** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type** | A storage container where the VM&#39;s files should be restored to. | [optional] 
