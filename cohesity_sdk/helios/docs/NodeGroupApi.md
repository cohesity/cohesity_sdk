...
try:
	# Create a Node Group.
	api_response = client.node_group.create_node_group(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NodeGroupApi->create_node_group: %s\n" % e)
```
...
try:
	# Delete a Node Group.
	client.node_group.delete_node_group(group_name, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling NodeGroupApi->delete_node_group: %s\n" % e)
```
...
try:
	# List Node Groups for a given Group Name.
	api_response = client.node_group.get_node_group_by_name(group_name, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NodeGroupApi->get_node_group_by_name: %s\n" % e)
```
...
try:
	# List Node Groups based on provided filtering parameters.
	api_response = client.node_group.get_node_groups(access_cluster_id=access_cluster_id, region_id=region_id, group_names=group_names, group_type=group_type)
	pprint(api_response)
except ApiException as e:
...
try:
	# Update a Node Group.
	api_response = client.node_group.update_node_group(group_name, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NodeGroupApi->update_node_group: %s\n" % e)
```
