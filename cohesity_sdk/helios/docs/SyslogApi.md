...
# **add_syslog_server**
> SyslogServer add_syslog_server(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.SyslogApi(api_client)
    body = cohesity_sdk.helios.SyslogServer() # SyslogServer | Specifies parameters to add syslog server.
    ...
    try:
        # Add Syslog Server
        api_response = api_instance.add_syslog_server(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> List[str] get_supported_syslog_program_names(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get supported program names.
        api_response = api_instance.get_supported_syslog_program_names(access_cluster_id=access_cluster_id, region_id=region_id)
...
> SyslogAuditTag get_syslog_audit_tags(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get cluster audit tags.
        api_response = api_instance.get_syslog_audit_tags(access_cluster_id=access_cluster_id, region_id=region_id)
...
> SyslogServer get_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a syslog server by id.
        api_response = api_instance.get_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
> SyslogServerStatus get_syslog_server_status_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a syslog server reachability status.
        api_response = api_instance.get_syslog_server_status_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **get_syslog_servers**
> SyslogServers get_syslog_servers(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get list of syslog servers.
        api_response = api_instance.get_syslog_servers(access_cluster_id=access_cluster_id, region_id=region_id)
...
> SyslogServer patch_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id, body=body)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)
    body = cohesity_sdk.helios.SyslogServer() # SyslogServer | Specifies the body of syslog server fields to patch. (optional)

    try:
        # Patch a syslog server by id.
        api_response = api_instance.patch_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id, body=body)
...
> remove_syslog_server(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove syslog server by id
        api_instance.remove_syslog_server(id, access_cluster_id=access_cluster_id, region_id=region_id)
    except Exception as e:
...
> remove_syslog_servers(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove syslog servers
        api_instance.remove_syslog_servers(access_cluster_id=access_cluster_id, region_id=region_id)
    except Exception as e:
...
> SyslogAuditTag update_syslog_audit_tags(access_cluster_id=access_cluster_id, region_id=region_id, body=body)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)
    body = cohesity_sdk.helios.SyslogAuditTag() # SyslogAuditTag | Specifies syslog audit tag to update. (optional)

    try:
        # Update cluster audit tags.
        api_response = api_instance.update_syslog_audit_tags(access_cluster_id=access_cluster_id, region_id=region_id, body=body)
...
> SyslogServer update_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id, body=body)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)
    body = cohesity_sdk.helios.SyslogServer() # SyslogServer | Specifies the body of syslog server body to update. (optional)

    try:
        # Update a syslog server by id.
        api_response = api_instance.update_syslog_server_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id, body=body)
