# cohesity_sdk.helios.PrivilegeApi
...
# **get_privileges**
> Privileges get_privileges(access_cluster_id=access_cluster_id, region_id=region_id, names=names)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.PrivilegeApi(api_client)
    ...
    try:
        # Get Privileges.
        api_response = api_instance.get_privileges(access_cluster_id=access_cluster_id, region_id=region_id, names=names)
