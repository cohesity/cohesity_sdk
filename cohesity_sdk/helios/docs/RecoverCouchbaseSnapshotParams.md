...
**objects** | [**List[RecoverCouchbaseNoSqlObjectParams]**](RecoverCouchbaseNoSqlObjectParams.md) | Specifies details of objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverCouchbaseSnapshotParams from a JSON string
recover_couchbase_snapshot_params_instance = RecoverCouchbaseSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverCouchbaseSnapshotParams.to_json())

# convert the object into a dict
recover_couchbase_snapshot_params_dict = recover_couchbase_snapshot_params_instance.to_dict()
# create an instance of RecoverCouchbaseSnapshotParams from a dict
recover_couchbase_snapshot_params_from_dict = RecoverCouchbaseSnapshotParams.from_dict(recover_couchbase_snapshot_params_dict)
```
