# cohesity_sdk.helios.PatchManagementApi
...
# **apply_patches**
> List[ServicePatchLevel] apply_patches(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.PatchManagementApi(api_client)
    body = cohesity_sdk.helios.ApplyPatchesRequest() # ApplyPatchesRequest | Request to apply patches.
    ...
    try:
        # Apply patches
        api_response = api_instance.apply_patches(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **get_applied_patches**
> List[AppliedPatch] get_applied_patches(access_cluster_id=access_cluster_id, region_id=region_id, service=service, include_details=include_details)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get applied patches
        api_response = api_instance.get_applied_patches(access_cluster_id=access_cluster_id, region_id=region_id, service=service, include_details=include_details)
...
> List[AvailablePatch] get_available_patches(access_cluster_id=access_cluster_id, region_id=region_id, service=service, include_details=include_details)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get available patches
        api_response = api_instance.get_available_patches(access_cluster_id=access_cluster_id, region_id=region_id, service=service, include_details=include_details)
...
> PatchOperationStatus get_patch_operation_status(access_cluster_id=access_cluster_id, region_id=region_id, include_details=include_details)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get patch operation status
        api_response = api_instance.get_patch_operation_status(access_cluster_id=access_cluster_id, region_id=region_id, include_details=include_details)
...
# **get_patches_history**
> List[PatchOperation] get_patches_history(access_cluster_id=access_cluster_id, region_id=region_id, service=service)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get patches history
        api_response = api_instance.get_patches_history(access_cluster_id=access_cluster_id, region_id=region_id, service=service)
...
# **import_patches**
> List[PatchDetail] import_patches(file_name, checksum, patch, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Import patches
        api_response = api_instance.import_patches(file_name, checksum, patch, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **revert_patches**
> List[ServicePatchLevel] revert_patches(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cohesity_sdk.helios.PatchManagementApi(api_client)
    body = cohesity_sdk.helios.RevertPatchesRequest() # RevertPatchesRequest | Request to revert patches.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Revert patches
        api_response = api_instance.revert_patches(body, access_cluster_id=access_cluster_id, region_id=region_id)
