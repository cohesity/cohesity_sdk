...
Specifies the common params to create a File based MSSQL Object Protection.
...
json = "{}"
# create an instance of CommonMssqlFileObjectProtectionParams from a JSON string
common_mssql_file_object_protection_params_instance = CommonMssqlFileObjectProtectionParams.from_json(json)
# print the JSON string representation of the object
print(CommonMssqlFileObjectProtectionParams.to_json())

# convert the object into a dict
common_mssql_file_object_protection_params_dict = common_mssql_file_object_protection_params_instance.to_dict()
# create an instance of CommonMssqlFileObjectProtectionParams from a dict
common_mssql_file_object_protection_params_from_dict = CommonMssqlFileObjectProtectionParams.from_dict(common_mssql_file_object_protection_params_dict)
```
