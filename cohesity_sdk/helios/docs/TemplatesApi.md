# cohesity_sdk.helios.TemplatesApi
...
# **download_art_file**
> bytearray download_art_file(access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.TemplatesApi(api_client)
    ...
    try:
        # Download the azure resource template.
        api_response = api_instance.download_art_file(access_cluster_id=access_cluster_id, region_id=region_id)
        print("The response of TemplatesApi->download_art_file:\n")
        pprint(api_response)
