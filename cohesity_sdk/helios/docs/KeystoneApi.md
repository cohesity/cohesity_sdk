# cohesity_sdk.helios.KeystoneApi
...
# **create_keystone**
> Keystone create_keystone(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.KeystoneApi(api_client)
    body = cohesity_sdk.helios.CreateKeystoneRequest() # CreateKeystoneRequest | Specifies the paremters to create a Keystone configuration.
    ...
    try:
        # Create a Keystone configuration.
        api_response = api_instance.create_keystone(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **delete_keystone**
> delete_keystone(id, admin_password, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a Keystone configuration.
        api_instance.delete_keystone(id, admin_password, access_cluster_id=access_cluster_id, region_id=region_id)
    except Exception as e:
...
# **get_keystones**
> Keystones get_keystones(access_cluster_id=access_cluster_id, region_id=region_id, names=names, tenant_ids=tenant_ids, include_tenants=include_tenants)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Keystones.
        api_response = api_instance.get_keystones(access_cluster_id=access_cluster_id, region_id=region_id, names=names, tenant_ids=tenant_ids, include_tenants=include_tenants)
...
# **get_keystones_by_id**
> Keystone get_keystones_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a Keystone by its id.
        api_response = api_instance.get_keystones_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
...
# **update_keystone**
> Keystone update_keystone(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.KeystoneApi(api_client)
    id = 56 # int | Specifies the Keystone id.
    body = cohesity_sdk.helios.UpdateKeystoneRequest() # UpdateKeystoneRequest | Specifies the paremters to update a Keystone configuration.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update a Keystone configuration.
        api_response = api_instance.update_keystone(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
