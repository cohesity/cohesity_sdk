...
json = "{}"
# create an instance of HeliosCouchbaseObjectsInner from a JSON string
helios_couchbase_objects_inner_instance = HeliosCouchbaseObjectsInner.from_json(json)
# print the JSON string representation of the object
print(HeliosCouchbaseObjectsInner.to_json())

# convert the object into a dict
helios_couchbase_objects_inner_dict = helios_couchbase_objects_inner_instance.to_dict()
# create an instance of HeliosCouchbaseObjectsInner from a dict
helios_couchbase_objects_inner_from_dict = HeliosCouchbaseObjectsInner.from_dict(helios_couchbase_objects_inner_dict)
```
