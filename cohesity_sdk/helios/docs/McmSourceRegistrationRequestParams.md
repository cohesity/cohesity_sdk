...
Specifies the request parameters to register a Protection Source.
...
json = "{}"
# create an instance of McmSourceRegistrationRequestParams from a JSON string
mcm_source_registration_request_params_instance = McmSourceRegistrationRequestParams.from_json(json)
# print the JSON string representation of the object
print(McmSourceRegistrationRequestParams.to_json())

# convert the object into a dict
mcm_source_registration_request_params_dict = mcm_source_registration_request_params_instance.to_dict()
# create an instance of McmSourceRegistrationRequestParams from a dict
mcm_source_registration_request_params_from_dict = McmSourceRegistrationRequestParams.from_dict(mcm_source_registration_request_params_dict)
```
