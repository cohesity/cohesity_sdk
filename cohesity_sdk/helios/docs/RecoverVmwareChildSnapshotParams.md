...
------------ | ------------- | ------------- | -------------
**archival_target_info** | [**ArchivalTargetSummaryInfo**](ArchivalTargetSummaryInfo.md) | Specifies the archival target information if the snapshot is an archival snapshot. | [optional] 
...
**object_info** | [**ObjectSummary**](ObjectSummary.md) | Specifies the information about the object for which the snapshot is taken. | [optional] 
...
**datastore_migration_info** | **object** | Specifies the info about datastore migration. This is only applicable for RecoverVm. | [optional] 
**instant_recovery_info** | **object** | Specifies the info about instant recovery. This is only applicable for RecoverVm. | [optional] 
...
json = "{}"
# create an instance of RecoverVmwareChildSnapshotParams from a JSON string
recover_vmware_child_snapshot_params_instance = RecoverVmwareChildSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverVmwareChildSnapshotParams.to_json())

# convert the object into a dict
recover_vmware_child_snapshot_params_dict = recover_vmware_child_snapshot_params_instance.to_dict()
# create an instance of RecoverVmwareChildSnapshotParams from a dict
recover_vmware_child_snapshot_params_from_dict = RecoverVmwareChildSnapshotParams.from_dict(recover_vmware_child_snapshot_params_dict)
```
