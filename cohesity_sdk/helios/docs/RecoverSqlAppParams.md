...
recover_sql_app_params_instance = RecoverSqlAppParams.from_json(json)
# print the JSON string representation of the object
print(RecoverSqlAppParams.to_json())

# convert the object into a dict
recover_sql_app_params_dict = recover_sql_app_params_instance.to_dict()
# create an instance of RecoverSqlAppParams from a dict
recover_sql_app_params_from_dict = RecoverSqlAppParams.from_dict(recover_sql_app_params_dict)
```
