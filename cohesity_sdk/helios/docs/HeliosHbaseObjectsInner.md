...
json = "{}"
# create an instance of HeliosHbaseObjectsInner from a JSON string
helios_hbase_objects_inner_instance = HeliosHbaseObjectsInner.from_json(json)
# print the JSON string representation of the object
print(HeliosHbaseObjectsInner.to_json())

# convert the object into a dict
helios_hbase_objects_inner_dict = helios_hbase_objects_inner_instance.to_dict()
# create an instance of HeliosHbaseObjectsInner from a dict
helios_hbase_objects_inner_from_dict = HeliosHbaseObjectsInner.from_dict(helios_hbase_objects_inner_dict)
```
