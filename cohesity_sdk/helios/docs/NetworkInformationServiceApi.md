...
try:
	# Create an NIS netgroup.
	api_response = client.network_information_service.create_nis_netgroup(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->create_nis_netgroup: %s\n" % e)
```
...
try:
	# Create an NIS Provider.
	api_response = client.network_information_service.create_nis_provider(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->create_nis_provider: %s\n" % e)
```
...
try:
	# Delete an NIS netgroup by name.
	client.network_information_service.delete_nis_netgroup_by_name(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->delete_nis_netgroup_by_name: %s\n" % e)
```
...
try:
	# Delete an NIS Provider by domain name.
	client.network_information_service.delete_nis_provider_by_domain_name(domain, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->delete_nis_provider_by_domain_name: %s\n" % e)
```
...
try:
	# Get an NIS netgroup by name.
	api_response = client.network_information_service.get_nis_netgroup_by_name(name, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->get_nis_netgroup_by_name: %s\n" % e)
```
...
try:
	# Get a list of NIS netgroups.
	api_response = client.network_information_service.get_nis_netgroups(access_cluster_id=access_cluster_id, region_id=region_id, netgroup_names=netgroup_names)
	pprint(api_response)
except ApiException as e:
...
try:
	# Get an NIS Provider by domain name.
	api_response = client.network_information_service.get_nis_provider_by_domain_name(domain, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->get_nis_provider_by_domain_name: %s\n" % e)
```
...
try:
	# Get a list of NIS Providers.
	api_response = client.network_information_service.get_nis_providers(access_cluster_id=access_cluster_id, region_id=region_id, domain_names=domain_names)
	pprint(api_response)
except ApiException as e:
...
try:
	# Update an NIS netgroup by name.
	api_response = client.network_information_service.update_nis_netgroup_by_name(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->update_nis_netgroup_by_name: %s\n" % e)
```
...
try:
	# Update an NIS Provider by domain name.
	api_response = client.network_information_service.update_nis_provider_by_domain_name(domain, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling NetworkInformationServiceApi->update_nis_provider_by_domain_name: %s\n" % e)
```
