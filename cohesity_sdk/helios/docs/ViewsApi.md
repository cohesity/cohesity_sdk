...
try:
	# Clone View.
	api_response = client.views.clone_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->clone_view: %s\n" % e)
```
...
try:
	# Clone View Directory.
	client.views.clone_view_directory(body, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling ViewsApi->clone_view_directory: %s\n" % e)
```
...
try:
	# Create a Share.
	api_response = client.views.create_share(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->create_share: %s\n" % e)
```
...
try:
	# Create a View
	api_response = client.views.create_view(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->create_view: %s\n" % e)
```
...
try:
	# Create a View Template
	api_response = client.views.create_view_template(body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->create_view_template: %s\n" % e)
```
...
try:
	# Delete a Share.
	client.views.delete_share(name, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling ViewsApi->delete_share: %s\n" % e)
```
...
try:
	# Delete a View
	client.views.delete_view(id, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling ViewsApi->delete_view: %s\n" % e)
```
...
try:
	# Delete directory quota for the View.
	client.views.delete_view_directory_quota(id, access_cluster_id=access_cluster_id, region_id=region_id, directory_path=directory_path, delete_all_directory_quotas=delete_all_directory_quotas)
except ApiException as e:
	print("Exception when calling ViewsApi->delete_view_directory_quota: %s\n" % e)
```
...
try:
	# Delete a View Template
	client.views.delete_view_template(id, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling ViewsApi->delete_view_template: %s\n" % e)
```
...
try:
	# Get a Share by name.
	api_response = client.views.get_share_by_name(name, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->get_share_by_name: %s\n" % e)
```
...
try:
	# Get Shares.
	api_response = client.views.get_shares(access_cluster_id=access_cluster_id, region_id=region_id, name=name, match_partial_name=match_partial_name, max_count=max_count, cookie=cookie, tenant_ids=tenant_ids, include_tenants=include_tenants)
	pprint(api_response)
except ApiException as e:
...
try:
	# Get a View by Id
	api_response = client.views.get_view_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->get_view_by_id: %s\n" % e)
```
...
try:
	# Get View Clients.
	api_response = client.views.get_view_clients(access_cluster_id=access_cluster_id, region_id=region_id, protocols=protocols, view_ids=view_ids, node_ip=node_ip)
	pprint(api_response)
except ApiException as e:
...
try:
	# Get View Clients Summary.
	api_response = client.views.get_view_clients_summary(access_cluster_id=access_cluster_id, region_id=region_id, view_ids=view_ids)
	pprint(api_response)
except ApiException as e:
...
try:
	# Get directory quotas for the View.
	api_response = client.views.get_view_directory_quotas(id, access_cluster_id=access_cluster_id, region_id=region_id, max_count=max_count, cookie=cookie)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->get_view_directory_quotas: %s\n" % e)
```
...
try:
	# Get user quotas for the View.
	api_response = client.views.get_view_user_quotas(id, access_cluster_id=access_cluster_id, region_id=region_id, max_count=max_count, cookie=cookie)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->get_view_user_quotas: %s\n" % e)
```
...
try:
	# Get View user quotas config.
	api_response = client.views.get_view_user_quotas_config(id, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->get_view_user_quotas_config: %s\n" % e)
```
...
try:
	# Get Views summary.
	api_response = client.views.get_views_summary(access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
...
try:
	# Overwrite View.
	client.views.overwrite_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
except ApiException as e:
	print("Exception when calling ViewsApi->overwrite_view: %s\n" % e)
```
...
try:
	# Read a View Template by Id
	api_response = client.views.read_view_template_by_id(id, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->read_view_template_by_id: %s\n" % e)
```
...
try:
	# List View Templates
	api_response = client.views.read_view_templates(access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
...
try:
	# Update a Share.
	api_response = client.views.update_share(name, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->update_share: %s\n" % e)
```
...
try:
	# Update a View
	api_response = client.views.update_view(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->update_view: %s\n" % e)
```
...
try:
	# Upadte directory quota for the View.
	api_response = client.views.update_view_directory_quota(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->update_view_directory_quota: %s\n" % e)
```
...
try:
	# Update a View Template
	api_response = client.views.update_view_template(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ViewsApi->update_view_template: %s\n" % e)
```
