...
common_object_protect_params_instance = CommonObjectProtectParams.from_json(json)
# print the JSON string representation of the object
print(CommonObjectProtectParams.to_json())

# convert the object into a dict
common_object_protect_params_dict = common_object_protect_params_instance.to_dict()
# create an instance of CommonObjectProtectParams from a dict
common_object_protect_params_from_dict = CommonObjectProtectParams.from_dict(common_object_protect_params_dict)
```
