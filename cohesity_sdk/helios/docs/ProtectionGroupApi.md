# cohesity_sdk.helios.ProtectionGroupApi
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the list of runs for a Protection Group.
        api_response = api_instance.get_protection_group_runs(id, access_cluster_id=access_cluster_id, region_id=region_id, request_initiator_type=request_initiator_type, run_id=run_id, start_time_usecs=start_time_usecs, end_time_usecs=end_time_usecs, tenant_ids=tenant_ids, include_tenants=include_tenants, run_types=run_types, include_object_details=include_object_details, local_backup_run_status=local_backup_run_status, replication_run_status=replication_run_status, archival_run_status=archival_run_status, cloud_spin_run_status=cloud_spin_run_status, num_runs=num_runs, exclude_non_restorable_runs=exclude_non_restorable_runs, run_tags=run_tags, use_cached_data=use_cached_data, filter_by_end_time=filter_by_end_time, snapshot_target_types=snapshot_target_types, only_return_successful_copy_run=only_return_successful_copy_run, filter_by_copy_task_end_time=filter_by_copy_task_end_time, max_result_count=max_result_count, pagination_cookie=pagination_cookie)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the debug logs for a particular object in a run from a Protection Group.
        api_instance.get_run_debug_logs_for_object(id, run_id, object_id, access_cluster_id=access_cluster_id, region_id=region_id)
    except Exception as e:
...
> get_run_messages_report(id, run_id, object_id, access_cluster_id=access_cluster_id, region_id=region_id, file_type=file_type, name=name)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the CSV of various Proto Messages for a given run and an object.
        api_instance.get_run_messages_report(id, run_id, object_id, access_cluster_id=access_cluster_id, region_id=region_id, file_type=file_type, name=name)
    except Exception as e:
...
# **get_runs_report**
> get_runs_report(id, run_id, object_id, access_cluster_id=access_cluster_id, region_id=region_id, file_type=file_type, name=name)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the CSV of errors/warnings for a given run and an object.
        api_instance.get_runs_report(id, run_id, object_id, access_cluster_id=access_cluster_id, region_id=region_id, file_type=file_type, name=name)
    except Exception as e:
...
> PerformRunActionResponse perform_action_on_protection_group_run(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ProtectionGroupApi(api_client)
    id = 'id_example' # str | Specifies a unique id of the Protection Group.
    body = cohesity_sdk.helios.PerformActionOnProtectionGroupRunRequest() # PerformActionOnProtectionGroupRunRequest | Specifies the parameters to perform an action on a protection run.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Actions on protection group run.
        api_response = api_instance.perform_action_on_protection_group_run(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> ProtectionGroup update_mcm_protection_group(id, body, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.helios.CreateOrUpdateProtectionGroupRequest() # CreateOrUpdateProtectionGroupRequest | Specifies the parameters to update a Protection Group.
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update a Protection Group.
        api_response = api_instance.update_mcm_protection_group(id, body, region_id=region_id)
        print("The response of ProtectionGroupApi->update_mcm_protection_group:\n")
        pprint(api_response)
    except Exception as e:
...
> ProtectionGroup update_protection_group(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a Protection Group.
        api_response = api_instance.update_protection_group(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> UpdateProtectionGroupRunResponseBody update_protection_group_run(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.helios.ProtectionGroupApi(api_client)
    id = 'id_example' # str | Specifies a unique id of the Protection Group.
    body = cohesity_sdk.helios.UpdateProtectionGroupRunRequestBody() # UpdateProtectionGroupRunRequestBody | Specifies the parameters to update a Protection Group Run.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Update runs for a particular Protection Group.
        api_response = api_instance.update_protection_group_run(id, body, access_cluster_id=access_cluster_id, region_id=region_id)
...
> UpdateProtectionGroupsState update_protection_groups_state(body, access_cluster_id=access_cluster_id, region_id=region_id)
...
with cohesity_sdk.helios.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cohesity_sdk.helios.ProtectionGroupApi(api_client)
    body = cohesity_sdk.helios.UpdateProtectionGroupsStateRequest() # UpdateProtectionGroupsStateRequest | Specifies the parameters to perform an action of list of Protection Groups.
    access_cluster_id = 56 # int | This field uniquely represents a Cohesity Cluster and is used for making on-prem calls from Helios. (optional)
    region_id = 'region_id_example' # str | This field uniquely represents a region and is used for making Helios calls to a specific region. (optional)

    try:
        # Perform an action like pause, resume, active, deactivate on all specified Protection Groups.
        api_response = api_instance.update_protection_groups_state(body, access_cluster_id=access_cluster_id, region_id=region_id)
