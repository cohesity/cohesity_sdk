...
**objects** | [**List[RecoverHbaseNoSqlObjectParams]**](RecoverHbaseNoSqlObjectParams.md) | Specifies details of objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverHbaseSnapshotParams from a JSON string
recover_hbase_snapshot_params_instance = RecoverHbaseSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverHbaseSnapshotParams.to_json())

# convert the object into a dict
recover_hbase_snapshot_params_dict = recover_hbase_snapshot_params_instance.to_dict()
# create an instance of RecoverHbaseSnapshotParams from a dict
recover_hbase_snapshot_params_from_dict = RecoverHbaseSnapshotParams.from_dict(recover_hbase_snapshot_params_dict)
```
