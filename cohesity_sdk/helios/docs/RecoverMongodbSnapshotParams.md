...
**objects** | [**List[RecoverMongodbNoSqlObjectParams]**](RecoverMongodbNoSqlObjectParams.md) | Specifies details of objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverMongodbSnapshotParams from a JSON string
recover_mongodb_snapshot_params_instance = RecoverMongodbSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverMongodbSnapshotParams.to_json())

# convert the object into a dict
recover_mongodb_snapshot_params_dict = recover_mongodb_snapshot_params_instance.to_dict()
# create an instance of RecoverMongodbSnapshotParams from a dict
recover_mongodb_snapshot_params_from_dict = RecoverMongodbSnapshotParams.from_dict(recover_mongodb_snapshot_params_dict)
```
