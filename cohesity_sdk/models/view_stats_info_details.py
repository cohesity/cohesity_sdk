...
class ViewStatsInfoDetails(BaseModel):
    """
    Specifies the View stats details.
    """ # noqa: E501
    metric: Optional[StrictStr] = Field(default=None, description="Specifies the stats metric.")
    value_in_last_hours: Optional[List[ViewStatsInLastHours]] = Field(default=None, description="Specifies the stats value in last hours.", alias="valueInLastHours")
    __properties: ClassVar[List[str]] = ["metric", "valueInLastHours"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "valueInLastHours": [ViewStatsInLastHours.from_dict(_item) for _item in obj["valueInLastHours"]] if obj.get("valueInLastHours") is not None else None
        })
        return _obj
