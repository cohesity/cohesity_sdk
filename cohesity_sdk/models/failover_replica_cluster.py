...
class FailoverReplicaCluster(BaseModel):
    """
    Specifies the details about replication cluster involved in the failover operation.
    """ # noqa: E501
    objects: Optional[List[FailoverObject]] = Field(description="Specifies the details about the objects being failed over. In case if view based orchastrator is calling this then they should pass a object id for replicated view entity which belongs to the live tracking view on replication cluster.")
    protection_group_id: Optional[StrictStr] = Field(default=None, description="Specifies the protection group id from the replication cluster from where the objects being failed over. If this is not specified then it will be infer from the list of objects being failed over. The protection group id must be specified in this format <cluster_id>:<cluster_incarnation_id:jobid>", alias="protectionGroupId")
    __properties: ClassVar[List[str]] = ["objects", "protectionGroupId"]
