...
class Attachment(BaseModel):
    ...
    """ # noqa: E501
    action: Optional[StrictStr] = Field(default=None, description="Specifies the action.")
    description: Optional[StrictStr] = Field(default=None, description="Specifies a description for the attachment.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if is_implicit (nullable) is None
        # and model_fields_set contains the field
