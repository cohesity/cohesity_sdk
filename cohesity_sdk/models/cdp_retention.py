...
class CdpRetention(BaseModel):
    ...
    duration: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(description="Specifies the duration for a cdp backup retention.")
    unit: Optional[StrictStr] = Field(description="Specificies the Retention Unit of a CDP backup measured in minutes or hours.")
