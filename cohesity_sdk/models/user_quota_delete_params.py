...
class UserQuotaDeleteParams(BaseModel):
    """
    Specifies list of users to delete logical user quota. If userIds are not specified, all the user quotas will be deleted.
    """ # noqa: E501
    user_ids: Optional[List[UserId]] = Field(default=None, description="Array of userIds. Specifies the list of user Ids to delete logical user quota override.", alias="userIds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userIds": [UserId.from_dict(_item) for _item in obj["userIds"]] if obj.get("userIds") is not None else None
        })
        return _obj
