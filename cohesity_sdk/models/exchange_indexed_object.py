...
class ExchangeIndexedObject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "databaseName", "email", "objectName"]
