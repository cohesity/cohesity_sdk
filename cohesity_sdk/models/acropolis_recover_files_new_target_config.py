...
class AcropolisRecoverFilesNewTargetConfig(BaseModel):
    """
    Specifies the configuration for recovering files and folders to the new target.
    """ # noqa: E501
    absolute_path: Optional[StrictStr] = Field(description="Specifies the absolute path location to recover files to.", alias="absolutePath")
