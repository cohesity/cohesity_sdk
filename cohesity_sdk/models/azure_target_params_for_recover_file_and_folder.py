...
class AzureTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[AzureRecoverFilesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[AzureRecoverFilesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
