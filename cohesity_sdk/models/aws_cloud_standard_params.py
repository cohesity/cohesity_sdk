...
class AwsCloudStandardParams(BaseModel):
    """
    Specifies the parameters which are specific to AWS related External Targets with Cloud Type Standard.
    """ # noqa: E501
    authentication_method: Optional[AwsAuthenticationMethodsParams] = Field(default=None, alias="authenticationMethod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authenticationMethod": AwsAuthenticationMethodsParams.from_dict(obj["authenticationMethod"]) if obj.get("authenticationMethod") is not None else None
        })
        return _obj
