...
class CassandraProtectionGroupParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["autoScaleConcurrency", "bandwidthMBPS", "concurrency", "customSourceName", "excludeObjectIds", "objects", "sourceId", "sourceName", "dataCenters", "isLogBackup", "isSystemKeyspaceBackup"]
