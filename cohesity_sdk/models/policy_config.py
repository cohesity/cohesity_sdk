...
class PolicyConfig(BaseModel):
    ...
    """ # noqa: E501
    policies: Optional[Annotated[List[ObjectPolicy], Field(min_length=1)]] = Field(default=None, description="Specifies the list of protection policies for protecting an object with multiple policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [ObjectPolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
