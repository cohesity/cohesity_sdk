...
class ClusterManualNetworkConfig(BaseModel):
    """
    ...
    gateway: Optional[StrictStr] = Field(description="Specifies the gateway of the new cluster network.")
    subnet_ip: Optional[StrictStr] = Field(description="Specifies the ip subnet ip of the cluster network.", alias="subnetIp")
    subnet_mask: Optional[StrictStr] = Field(description="Specifies the ip subnet mask of the cluster network.", alias="subnetMask")
