...
class ClusterCreateNodeParams(BaseModel):
    """
    Node params required for cluster creation
    """ # noqa: E501
    node_id: Optional[StrictInt] = Field(description="Specifies the node id of the node.", alias="nodeId")
    node_ip: Optional[StrictStr] = Field(description="Specifies the node ip address which is either in ipv4/ipv6 format.", alias="nodeIp")
