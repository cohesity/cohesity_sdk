...
class ProtectionPolicyResponse(BaseModel):
    ...
    is_usable: Optional[StrictBool] = Field(default=None, description="This field is set to true if the linked policy which is internally created from a policy templates qualifies as usable to create more policies on the cluster. If the linked policy is partially filled and can not create a working policy then this field will be set to false. In case of normal policy created on the cluster, this field wont be populated.", alias="isUsable")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.is_replicated is None and "is_replicated" in self.model_fields_set:
        ...
        # set to None if num_protection_groups (nullable) is None
        # and model_fields_set contains the field
        if self.num_protection_groups is None and "num_protection_groups" in self.model_fields_set:
            _dict['numProtectionGroups'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numProtectionGroups": obj.get("numProtectionGroups"),
