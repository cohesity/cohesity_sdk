...
class TimeRangeUsecs(BaseModel):
    """
    Specifies a valid time range in micro seconds.
    """ # noqa: E501
    end_time_usecs: Optional[StrictInt] = Field(description="Specifies the end time of this time range.", alias="endTimeUsecs")
    start_time_usecs: Optional[StrictInt] = Field(description="Specifies the start time of this time range.", alias="startTimeUsecs")
    __properties: ClassVar[List[str]] = ["endTimeUsecs", "startTimeUsecs"]
