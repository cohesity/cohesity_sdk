...
class VmwareAdditionalParams(BaseModel):
    """
    Additional params for VMware protection source.
    """ # noqa: E501
    vcd_params: Optional[VcdAdditionalParams] = Field(default=None, alias="vcdParams")
    __properties: ClassVar[List[str]] = ["vcdParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vcdParams": VcdAdditionalParams.from_dict(obj["vcdParams"]) if obj.get("vcdParams") is not None else None
        })
        return _obj
