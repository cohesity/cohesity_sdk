...
class ListTrustedCasResult(BaseModel):
    """
    Specifies the basic info about CA Root Certificate.
    """ # noqa: E501
    certificates: Optional[List[TrustedCa]] = Field(default=None, description="Array of trusted certificates. Specifies the list of certificates returned in this response. List is not sorted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [TrustedCa.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None
        })
        return _obj
