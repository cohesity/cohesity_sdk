...
class AzureSnapshotParams(BaseModel):
    """
    Specifies parameters of Azure type snapshots.
    """ # noqa: E501
    protection_type: Optional[StrictStr] = Field(default=None, description="Specifies the protection type of Azure snapshots.", alias="protectionType")
