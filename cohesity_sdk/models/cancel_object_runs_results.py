...
class CancelObjectRunsResults(BaseModel):
    """
    Results after canceling object runs. If no errors happen, this will not be returned.
    """ # noqa: E501
    results: Optional[List[CancelObjectRunsResult]] = Field(default=None, description="Specifies results after canceling object runs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [CancelObjectRunsResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
