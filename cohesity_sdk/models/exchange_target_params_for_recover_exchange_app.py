...
class ExchangeTargetParamsForRecoverExchangeApp(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": RecoverExchangeAppSnapshotParams.from_dict(obj["object"]) if obj.get("object") is not None else None
        })
        return _obj
