...
class ActiveDirectoryPrincipals(BaseModel):
    """
    Response of Active directory principals.
    """ # noqa: E501
    principals: Optional[List[ActiveDirectoryPrincipal]] = Field(default=None, description="A list of Active directory principals")
