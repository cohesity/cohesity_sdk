...
class GetEntityMetadataResult(BaseModel):
    """
    Specifies the response for the GetEntityMetadata.
    """ # noqa: E501
    entity_list: Optional[List[EntityMetadataParams]] = Field(default=None, description="Specifies the list of entities with thier metadata.", alias="entityList")
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the source id of the entities whose metadata is being requested.", alias="sourceId")
