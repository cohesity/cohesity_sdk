...
class UdaOnPremSearchParams(BaseModel):
    """
    Parameters required to search Universal Data Adapter objects.
    """ # noqa: E501
    search_string: Optional[StrictStr] = Field(description="Specifies the search string to search the Universal Data Adapter Objects", alias="searchString")
    ...
    __properties: ClassVar[List[str]] = ["searchString", "sourceIds"]
