...
class PaginationInfo(BaseModel):
    ...
    """ # noqa: E501
    cookie: Optional[StrictStr] = Field(default=None, description="Specifies a cookie which can be passed in by the user in order to retrieve the next page of results.")
    __properties: ClassVar[List[str]] = ["cookie"]
