...
class CouchbaseParams(BaseModel):
    """
    Specifies the recovery options specific to Couchbase environment.
    """ # noqa: E501
    recover_couchbase_params: RecoverCouchbaseParams = Field(alias="recoverCouchbaseParams")
    recovery_action: StrictStr = Field(description="Specifies the type of recover action to be performed.", alias="recoveryAction")
    __properties: ClassVar[List[str]] = ["recoverCouchbaseParams", "recoveryAction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_couchbase_params
        if self.recover_couchbase_params:
            _dict['recoverCouchbaseParams'] = self.recover_couchbase_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoverCouchbaseParams": RecoverCouchbaseParams.from_dict(obj["recoverCouchbaseParams"]) if obj.get("recoverCouchbaseParams") is not None else None,
