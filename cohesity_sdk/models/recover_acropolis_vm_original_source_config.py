...
class RecoverAcropolisVmOriginalSourceConfig(BaseModel):
    """
    Specifies the Source configuration if VM's are being recovered to Original Source.
    """ # noqa: E501
    network_config: Optional[RecoverAcropolisVmOriginalSourceNetworkConfig] = Field(default=None, alias="networkConfig")
