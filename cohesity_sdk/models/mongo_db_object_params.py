...
class MongoDBObjectParams(BaseModel):
    """
    Specifies the parameters for MongoDB object.
    """ # noqa: E501
    cdp_info: Optional[CdpSourceObjectInfo] = Field(default=None, alias="cdpInfo")
    __properties: ClassVar[List[str]] = ["cdpInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cdpInfo": CdpSourceObjectInfo.from_dict(obj["cdpInfo"]) if obj.get("cdpInfo") is not None else None
        })
        return _obj
