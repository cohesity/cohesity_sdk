...
class ViewClientsSummary(BaseModel):
    """
    Specifies the View Client summary.
    """ # noqa: E501
    summary: Optional[List[ViewClientsSummaryInfo]] = Field(default=None, description="Specifies a list of summary.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": [ViewClientsSummaryInfo.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None
        })
        return _obj
