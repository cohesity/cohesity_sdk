...
class RecoverNetappToNetappFilesTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToNetappFilesTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalNetappFilesTargetParams] = Field(default=None, alias="originalSourceConfig")
