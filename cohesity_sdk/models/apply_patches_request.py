...
class ApplyPatchesRequest(BaseModel):
    ...
    """ # noqa: E501
    all: Optional[StrictBool] = Field(default=None, description="Specifies all the available patches should be applied.")
    service: Optional[StrictStr] = Field(default=None, description="Specifies the name of the service whose patch should be applied.")
    __properties: ClassVar[List[str]] = ["all", "service"]
