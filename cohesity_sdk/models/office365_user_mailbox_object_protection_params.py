...
class Office365UserMailboxObjectProtectionParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["indexingPolicy", "objects", "sourceId", "sourceName", "excludeFolders", "includeFolders"]
