...
class HbaseParams(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_hbase_params
        if self.recover_hbase_params:
            _dict['recoverHbaseParams'] = self.recover_hbase_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoverHbaseParams": RecoverHbaseParams.from_dict(obj["recoverHbaseParams"]) if obj.get("recoverHbaseParams") is not None else None,
