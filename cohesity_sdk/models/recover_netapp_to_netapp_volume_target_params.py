...
class RecoverNetappToNetappVolumeTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverOtherNasToNetappVolumeTargetParams] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[OriginalNetappTargetParams] = Field(default=None, alias="originalSourceConfig")
