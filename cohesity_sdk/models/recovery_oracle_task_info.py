...
class RecoveryOracleTaskInfo(BaseModel):
    """
    ...
    progress_task_id: Optional[StrictStr] = Field(default=None, description="Specifies the progress monitor id.", alias="progressTaskId")
