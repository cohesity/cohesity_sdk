...
class FreeNodes(BaseModel):
    """
    Specifies the free nodes information.
    """ # noqa: E501
    nodes: Optional[List[FreeNodeInformation]] = Field(default=None, description="Specifies the list of free nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [FreeNodeInformation.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
