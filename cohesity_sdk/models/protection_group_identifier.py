...
class ProtectionGroupIdentifier(BaseModel):
    """
    Specifies Protection Group Identifier.
    """ # noqa: E501
    protection_group_id: Optional[StrictStr] = Field(default=None, description="Specifies Protection Group id.", alias="protectionGroupId")
    protection_group_name: Optional[StrictStr] = Field(default=None, description="Specifies Protection Group name.", alias="protectionGroupName")
