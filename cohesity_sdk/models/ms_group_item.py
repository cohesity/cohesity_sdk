...
class MsGroupItem(BaseModel):
    ...
    mailbox_item: Optional[Email] = Field(default=None, alias="mailboxItem")
    site_item: Optional[DocumentLibraryItem] = Field(default=None, alias="siteItem")
    type: Optional[StrictStr] = Field(default=None, description="Specifies the M365 Group item type.")
    __properties: ClassVar[List[str]] = ["name", "path", "policyId", "policyName", "protectionGroupId", "protectionGroupName", "sourceInfo", "storageDomainId", "snapshotTags", "tags", "mailboxItem", "siteItem", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tags:
            ...
            _dict['tags'] = _items
        # override the default output from pydantic by calling `to_dict()` of mailbox_item
        if self.mailbox_item:
            _dict['mailboxItem'] = self.mailbox_item.to_dict()
        # override the default output from pydantic by calling `to_dict()` of site_item
        if self.site_item:
            _dict['siteItem'] = self.site_item.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mailboxItem": Email.from_dict(obj["mailboxItem"]) if obj.get("mailboxItem") is not None else None,
            "siteItem": DocumentLibraryItem.from_dict(obj["siteItem"]) if obj.get("siteItem") is not None else None,
            "type": obj.get("type")
        })
        return _obj
