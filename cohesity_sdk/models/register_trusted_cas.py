...
class RegisterTrustedCas(BaseModel):
    """
    Specifies the parameters to register a Certificate.
    """ # noqa: E501
    certificates: Optional[Annotated[List[TrustedCaRequest], Field(min_length=1)]] = Field(description="Specifies the certificates to be imported.")
    only_validate: Optional[StrictBool] = Field(default=None, description="Specifies if the certificates are only to be validated.", alias="onlyValidate")
    __properties: ClassVar[List[str]] = ["certificates", "onlyValidate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if only_validate (nullable) is None
        # and model_fields_set contains the field
        if self.only_validate is None and "only_validate" in self.model_fields_set:
            _dict['onlyValidate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificates": [TrustedCaRequest.from_dict(_item) for _item in obj["certificates"]] if obj.get("certificates") is not None else None,
