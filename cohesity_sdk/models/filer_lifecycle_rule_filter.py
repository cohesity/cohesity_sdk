...
class FilerLifecycleRuleFilter(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if file_extensions (nullable) is None
        # and model_fields_set contains the field
        if self.file_extensions is None and "file_extensions" in self.model_fields_set:
            _dict['fileExtensions'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fileSize": FilerLifecycleSizeFilter.from_dict(obj["fileSize"]) if obj.get("fileSize") is not None else None
        })
        return _obj
