...
class HyperVVmRecoveryTargetConfig(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverHyperVVmNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverHyperVVmOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
