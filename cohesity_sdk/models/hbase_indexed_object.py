...
class HbaseIndexedObject(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Specifies the Hbase Object Type.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['HbaseNamespaces', 'HbaseTables']):
            raise ValueError("must be one of enum values ('HbaseNamespaces', 'HbaseTables')")
        return value
