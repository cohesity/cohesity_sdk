...
class PluggableDatabaseInfo(BaseModel):
    """
    Specifies the information about Pluggable databases.
    """ # noqa: E501
    database_id: Optional[StrictStr] = Field(default=None, description="Specifies the database Id of the Pluggable DB.", alias="databaseId")
    database_name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the Pluggable DB.", alias="databaseName")
    __properties: ClassVar[List[str]] = ["databaseId", "databaseName"]
