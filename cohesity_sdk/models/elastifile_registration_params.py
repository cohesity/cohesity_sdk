...
class ElastifileRegistrationParams(BaseModel):
    """
    Specifies parameters to register an Elastifile Source.
    """ # noqa: E501
    credentials: Credentials
    endpoint: Optional[StrictStr] = Field(description="Specifies the Hostname or IP Address Endpoint for the Elastifile Source.")
    throttling_config: Optional[NasThrottlingConfig] = Field(default=None, alias="throttlingConfig")
    __properties: ClassVar[List[str]] = ["credentials", "endpoint", "throttlingConfig"]
