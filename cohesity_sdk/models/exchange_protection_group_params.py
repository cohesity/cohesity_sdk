...
class ExchangeProtectionGroupParams(BaseModel):
    """
    ...
    exclude_database_ids: Optional[List[Optional[StrictInt]]] = Field(default=None, description="Specifies the list of IDs of the databases to not be protected by this Protection Group. This can be used to ignore specific databases under Exchange Server/DAG which has been included for protection.", alias="excludeDatabaseIds")
    indexing_policy: Optional[IndexingPolicy] = Field(default=None, alias="indexingPolicy")
    objects: Annotated[List[ExchangeProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the list of object ids to be protected.")
    __properties: ClassVar[List[str]] = ["backupsCopyOnly", "excludeDatabaseIds", "indexingPolicy", "objects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludeDatabaseIds": obj.get("excludeDatabaseIds"),
            "indexingPolicy": IndexingPolicy.from_dict(obj["indexingPolicy"]) if obj.get("indexingPolicy") is not None else None,
            "objects": [ExchangeProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
