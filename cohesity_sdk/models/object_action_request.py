...
class ObjectActionRequest(BaseModel):
    ...
    vmware_params: Optional[VmwareObjectActionParams] = Field(default=None, alias="vmwareParams")
    __properties: ClassVar[List[str]] = ["environment", "vmwareParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vmwareParams": VmwareObjectActionParams.from_dict(obj["vmwareParams"]) if obj.get("vmwareParams") is not None else None
        })
        return _obj
