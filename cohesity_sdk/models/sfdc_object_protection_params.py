...
class SfdcObjectProtectionParams(BaseModel):
    """
    Specifies the parameters that are specific to Sfdc Object Protection.
    """ # noqa: E501
    objects: Annotated[List[SfdcObjectProtectionObjectParams], Field(min_length=1, max_length=1)] = Field(description="Specifies the objects to be included in the Object Protection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [SfdcObjectProtectionObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
