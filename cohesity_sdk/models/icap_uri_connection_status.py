...
class IcapUriConnectionStatus(BaseModel):
    """
    Specifies the ICAP Uri connection status.
    """ # noqa: E501
    connection_status: Optional[StrictStr] = Field(default=None, description="Specifies the connection status.", alias="connectionStatus")
    icap_uri: Optional[StrictStr] = Field(default=None, description="Specifies the ICAP Uri.", alias="icapUri")
    __properties: ClassVar[List[str]] = ["connectionStatus", "icapUri"]
