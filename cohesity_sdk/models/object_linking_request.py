...
class ObjectLinkingRequest(BaseModel):
    """
    Request for linking replicated objects to failover objects on replication cluster.
    """ # noqa: E501
    object_map: Optional[List[ReplicaFailoverObject]] = Field(default=None, description="Specifies the objectMap that will be used to create linking between given replicated source entity and newly restored entity on erplication cluster.", alias="objectMap")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objectMap": [ReplicaFailoverObject.from_dict(_item) for _item in obj["objectMap"]] if obj.get("objectMap") is not None else None
        })
        return _obj
