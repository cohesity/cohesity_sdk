...
class MongodbParams(BaseModel):
    ...
    """ # noqa: E501
    recover_mongodb_params: RecoverMongodbParams = Field(alias="recoverMongodbParams")
    recovery_action: StrictStr = Field(description="Specifies the type of recover action to be performed.", alias="recoveryAction")
    __properties: ClassVar[List[str]] = ["recoverMongodbParams", "recoveryAction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_mongodb_params
        if self.recover_mongodb_params:
            _dict['recoverMongodbParams'] = self.recover_mongodb_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoverMongodbParams": RecoverMongodbParams.from_dict(obj["recoverMongodbParams"]) if obj.get("recoverMongodbParams") is not None else None,
