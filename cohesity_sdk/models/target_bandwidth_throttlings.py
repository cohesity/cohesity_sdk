...
class TargetBandwidthThrottlings(BaseModel):
    """
    Specifies the bandwidth throttling setting of the External Target.
    """ # noqa: E501
    download: Optional[BandwidthThrottling] = None
    upload: Optional[BandwidthThrottling] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "download": BandwidthThrottling.from_dict(obj["download"]) if obj.get("download") is not None else None,
            "upload": BandwidthThrottling.from_dict(obj["upload"]) if obj.get("upload") is not None else None
        })
        return _obj
