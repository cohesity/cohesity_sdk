...
class HyperVTargetParamsForMountVolume(BaseModel):
    ...
    new_target_config: Optional[HyperVMountVolumesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[HyperVMountVolumesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
