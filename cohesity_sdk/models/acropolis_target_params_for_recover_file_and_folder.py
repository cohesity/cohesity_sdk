...
class AcropolisTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[AcropolisRecoverFilesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[AcropolisRecoverFilesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
