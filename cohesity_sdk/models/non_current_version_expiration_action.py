...
class NonCurrentVersionExpirationAction(BaseModel):
    """
    Specifies the Lifecycle Non-current Version Expiration Action.
    """ # noqa: E501
    days: Optional[StrictInt] = Field(default=None, description="Specifies the number of days an object is non-current before performing the associated action.")
