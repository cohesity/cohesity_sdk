...
class ProtectionRunsStatsList(BaseModel):
    """
    Specifies the statistics of protection runs at the specific time.
    """ # noqa: E501
    stats: Optional[List[ProtectionRunsStats]] = Field(default=None, description="Specifies the protection runs stats.")
    timestamp: Optional[StrictInt] = Field(default=None, description="Specifies a Unix epoch Timestamp (in microseconds) of this statistics.")
    __properties: ClassVar[List[str]] = ["stats", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [ProtectionRunsStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None,
