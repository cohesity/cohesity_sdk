...
class RecoverOtherNasToGenericNasFilesTargetParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["alternatePath", "continueOnError", "encryptionEnabled", "overwriteExistingFile", "parentSource", "preserveFileAttributes", "vlanConfig", "volume"]
