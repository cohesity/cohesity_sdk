...
class ActiveDirectoryAdminParams(BaseModel):
    """
    Specifies the params of a user with administrative privilege of an Active Directory.
    """ # noqa: E501
    password: Optional[StrictStr] = Field(description="Specifies the password of the user.")
    username: Optional[StrictStr] = Field(description="Specifies the user name.")
