...
class PhysicalObjectEntityParams(BaseModel):
    """
    Specifies the common parameters for physical objects.
    """ # noqa: E501
    enable_system_backup: Optional[StrictBool] = Field(default=None, description="Specifies if system backup was enabled for the source in a particular run.", alias="enableSystemBackup")
    __properties: ClassVar[List[str]] = ["enableSystemBackup"]
