...
class CancellationTimeoutParams(BaseModel):
    """
    Specifies timeouts for different backup types (kFull, kRegular etc.)
    """ # noqa: E501
    backup_type: Optional[StrictStr] = Field(default=None, description="The scheduled backup type(kFull, kRegular etc.)", alias="backupType")
    timeout_mins: Optional[StrictInt] = Field(default=None, description="Specifies the timeout in mins", alias="timeoutMins")
    __properties: ClassVar[List[str]] = ["backupType", "timeoutMins"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if timeout_mins (nullable) is None
        # and model_fields_set contains the field
        if self.timeout_mins is None and "timeout_mins" in self.model_fields_set:
            _dict['timeoutMins'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeoutMins": obj.get("timeoutMins")
        })
        return _obj
