...
class HdfsProtectionGroupParams(BaseModel):
    """
    ...
    exclude_paths: Optional[List[StrictStr]] = Field(default=None, description="Specifies the paths to be excluded in the Protection Group. excludePaths will ovrride includePaths.", alias="excludePaths")
    hdfs_source_id: Optional[StrictInt] = Field(description="The object ID of the HDFS source for this protection group.", alias="hdfsSourceId")
    include_paths: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="Specifies the paths to be included in the Protection Group.", alias="includePaths")
    ...
    __properties: ClassVar[List[str]] = ["bandwidthMBPS", "concurrency", "excludePaths", "hdfsSourceId", "includePaths", "indexingPolicy", "sourceId", "sourceName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if hdfs_source_id (nullable) is None
        # and model_fields_set contains the field
        if self.hdfs_source_id is None and "hdfs_source_id" in self.model_fields_set:
            _dict['hdfsSourceId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hdfsSourceId": obj.get("hdfsSourceId"),
