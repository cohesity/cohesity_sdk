...
class InterfaceGroup(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="Id of the interface group.")
    __properties: ClassVar[List[str]] = ["name", "networkParams", "nodeInterfaceParams", "type", "id"]
