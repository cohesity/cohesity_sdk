...
class CountByTier(BaseModel):
    """
    CountByTier provides the disk count of each storage tier.
    """ # noqa: E501
    disk_count: Optional[StrictInt] = Field(default=None, description="DiskCount is the disk number of the storage tier.", alias="diskCount")
    ...
    __properties: ClassVar[List[str]] = ["diskCount", "storageTier"]
    ...
    def storage_tier_validate_enum(cls, value):
        ...
        if value not in set(['PCIeSSD', 'SATASSD', 'SATAHDD', 'CLOUD']):
            raise ValueError("must be one of enum values ('PCIeSSD', 'SATASSD', 'SATAHDD', 'CLOUD')")
        return value
