...
class HiveParams(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_hive_params
        if self.recover_hive_params:
            _dict['recoverHiveParams'] = self.recover_hive_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoverHiveParams": RecoverHiveParams.from_dict(obj["recoverHiveParams"]) if obj.get("recoverHiveParams") is not None else None,
