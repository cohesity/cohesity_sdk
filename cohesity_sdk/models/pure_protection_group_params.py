...
class PureProtectionGroupParams(BaseModel):
    """
    Specifies the parameters which are specific to Pure related Protection Groups.
    """ # noqa: E501
    max_snapshots_on_primary: Optional[StrictInt] = Field(default=None, description="Specifies the number of snapshots to retain on the primary environment. If not specified, then snapshots will not be deleted from the primary environment.", alias="maxSnapshotsOnPrimary")
    objects: Annotated[List[PureProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["maxSnapshotsOnPrimary", "objects", "prePostScript", "sourceId", "sourceName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if max_snapshots_on_primary (nullable) is None
        # and model_fields_set contains the field
        if self.max_snapshots_on_primary is None and "max_snapshots_on_primary" in self.model_fields_set:
            _dict['maxSnapshotsOnPrimary'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxSnapshotsOnPrimary": obj.get("maxSnapshotsOnPrimary"),
            "objects": [PureProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
