...
class GenericNasProtectionGroupParams(BaseModel):
    """
    ...
    objects: Annotated[List[ProtectionObjectInput], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    __properties: ClassVar[List[str]] = ["continueOnError", "encryptionEnabled", "fileFilters", "fileLockConfig", "indexingPolicy", "prePostScript", "throttlingConfig", "directCloudArchive", "nativeFormat", "protocol", "objects"]
