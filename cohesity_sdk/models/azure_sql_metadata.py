...
class AzureSqlMetadata(BaseModel):
    """
    ...
    def metadata_type_validate_enum(cls, value):
        ...
        if value not in set(['Credentials', 'ManagedIdentity']):
            raise ValueError("must be one of enum values ('Credentials', 'ManagedIdentity')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if metadata_type (nullable) is None
        # and model_fields_set contains the field
        if self.metadata_type is None and "metadata_type" in self.model_fields_set:
            _dict['metadataType'] = None
