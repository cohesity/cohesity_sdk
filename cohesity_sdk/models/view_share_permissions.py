...
class ViewSharePermissions(BaseModel):
    """
    Specifies share permissions of the view.
    """ # noqa: E501
    permissions: Optional[List[SmbPermission]] = Field(default=None, description="Specifies a list of share permissions.")
    ...
    __properties: ClassVar[List[str]] = ["permissions", "superUserSids"]
