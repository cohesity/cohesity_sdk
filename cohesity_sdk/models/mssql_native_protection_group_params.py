...
class MSSQLNativeProtectionGroupParams(BaseModel):
    ...
    num_streams: Optional[StrictInt] = Field(default=None, description="Specifies the number of streams to be used.", alias="numStreams")
    objects: Optional[Annotated[List[MSSQLNativeProtectionGroupObjectParams], Field(min_length=1)]] = Field(description="Specifies the list of object params to be protected.")
    with_clause: Optional[StrictStr] = Field(default=None, description="Specifies the WithClause to be used.", alias="withClause")
    __properties: ClassVar[List[str]] = ["aagBackupPreferenceType", "advancedSettings", "backupSystemDbs", "excludeFilters", "fullBackupsCopyOnly", "logBackupNumStreams", "logBackupWithClause", "prePostScript", "useAagPreferencesFromServer", "userDbBackupPreferenceType", "numStreams", "objects", "withClause"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if num_streams (nullable) is None
        # and model_fields_set contains the field
        if self.num_streams is None and "num_streams" in self.model_fields_set:
            _dict['numStreams'] = None
        ...
        # set to None if with_clause (nullable) is None
        # and model_fields_set contains the field
        if self.with_clause is None and "with_clause" in self.model_fields_set:
            _dict['withClause'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numStreams": obj.get("numStreams"),
            "objects": [MSSQLNativeProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
            "withClause": obj.get("withClause")
        })
        return _obj
