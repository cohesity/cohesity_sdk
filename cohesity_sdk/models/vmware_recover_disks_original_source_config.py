...
class VmwareRecoverDisksOriginalSourceConfig(BaseModel):
    """
    Specifies the configuration for restoring a disk to the original VM from which the snapshot was taken.
    """ # noqa: E501
    disks: Annotated[List[VmwareRecoverOriginalSourceDiskParams], Field(min_length=1)] = Field(description="Specifies the disks to be recovered and the location to which they will be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "disks": [VmwareRecoverOriginalSourceDiskParams.from_dict(_item) for _item in obj["disks"]] if obj.get("disks") is not None else None
        })
        return _obj
