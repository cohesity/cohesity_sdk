...
class StaticRoutes(BaseModel):
    ...
    """ # noqa: E501
    routes: Optional[List[StaticRouteParams]] = Field(default=None, description="Specifies the list of routes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "routes": [StaticRouteParams.from_dict(_item) for _item in obj["routes"]] if obj.get("routes") is not None else None
        })
        return _obj
