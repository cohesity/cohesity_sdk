...
class UnlockLinuxUserParams(BaseModel):
    """
    Specifies the Linux username whose account needs to be unlocked.
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="Specifies the status of the linux user")
    username: StrictStr = Field(description="The linux username to unlock.")
    __properties: ClassVar[List[str]] = ["state", "username"]
