...
class OpenIdProvider(BaseModel):
    ...
    Open ID provider
    """ # noqa: E501
    audience_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]], Field(min_length=1, max_length=50)]] = Field(description="Specifies the audience IDs of the configuration. This is used for validation. We will check this against the 'aud' field sent in the JWT at authorization time and if they do not match against at least one of the elements in this list, then authentication will fail.", alias="audienceIds")
    ...
    __properties: ClassVar[List[str]] = ["audienceIds", "pollingFrequencyMins", "publicKeyUrl"]
