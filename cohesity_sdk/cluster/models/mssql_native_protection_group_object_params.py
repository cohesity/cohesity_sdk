...
class MSSQLNativeProtectionGroupObjectParams(BaseModel):
    """
    Specifies the object params to create File based MSSQL Protection Group.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(description="Specifies the ID of the object being protected. If this is a non leaf level object, then the object will be auto-protected unless leaf objects are specified for exclusion.")
