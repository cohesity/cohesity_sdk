...
class KmsConfigurationUpdateParams(BaseModel):
    ...
    gcp_kms_params: Optional[GcpKmsConfigurationUpdateParams] = Field(default=None, alias="gcpKmsParams")
    ibm_kms_params: Optional[IbmKmsConfigurationUpdateParams] = Field(default=None, alias="ibmKmsParams")
    __properties: ClassVar[List[str]] = ["externalTargetIds", "kmipKmsParams", "name", "storageDomainIds", "awsKmsParams", "gcpKmsParams", "ibmKmsParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcpKmsParams": GcpKmsConfigurationUpdateParams.from_dict(obj["gcpKmsParams"]) if obj.get("gcpKmsParams") is not None else None,
