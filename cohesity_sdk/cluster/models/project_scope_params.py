...
class ProjectScopeParams(BaseModel):
    ...
    """ # noqa: E501
    domain_name: Optional[StrictStr] = Field(description="Specifies the domain name of the project.", alias="domainName")
    project_name: Optional[StrictStr] = Field(description="Specifies the project name.", alias="projectName")
    __properties: ClassVar[List[str]] = ["domainName", "projectName"]
