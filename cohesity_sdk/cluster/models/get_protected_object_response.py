...
class GetProtectedObjectResponse(BaseModel):
    """
    Specifies the protected objects response.
    """ # noqa: E501
    object: Optional[ProtectedObjectInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": ProtectedObjectInfo.from_dict(obj["object"]) if obj.get("object") is not None else None
        })
        return _obj
