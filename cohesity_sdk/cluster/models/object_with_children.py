...
class ObjectWithChildren(BaseModel):
    ...
    o365_params: Optional[O365ObjectEntityParams] = Field(default=None, alias="o365Params")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "o365Params": O365ObjectEntityParams.from_dict(obj["o365Params"]) if obj.get("o365Params") is not None else None,
            ...
            "objects": [ObjectWithChildren.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ObjectWithChildren.model_rebuild(raise_errors=False)
