...
class PstParam(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if create_pst (nullable) is None
        # and model_fields_set contains the field
        if self.create_pst is None and "create_pst" in self.model_fields_set:
            _dict['createPst'] = None
