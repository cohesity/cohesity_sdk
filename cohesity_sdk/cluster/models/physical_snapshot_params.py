...
class PhysicalSnapshotParams(BaseModel):
    """
    Specifies parameters of Physical type snapshots.
    """ # noqa: E501
    enable_system_backup: Optional[StrictBool] = Field(default=None, description="Specifies if system backup was enabled for the source in that particular run.", alias="enableSystemBackup")
    protection_type: Optional[StrictStr] = Field(default=None, description="Specifies the protection type of Physical snapshots.", alias="protectionType")
    __properties: ClassVar[List[str]] = ["enableSystemBackup", "protectionType"]
