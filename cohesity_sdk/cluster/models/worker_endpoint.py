...
class WorkerEndpoint(BaseModel):
    ...
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(default=None, description="Specifies the end point of the worker which is combination of both endpoint and port number.")
