...
class CreateFortknoxOnpremPrimaryClusterParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "clusterName", "allEndpointsReachable", "bandwidthLimit", "compressionEnabled", "storageDomainConfigs"]
