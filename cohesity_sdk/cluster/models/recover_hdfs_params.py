...
class RecoverHdfsParams(BaseModel):
    """
    ...
    snapshots: Optional[List[RecoverHdfsSnapshotParams]] = Field(description="Specifies the local snapshot ids of the Objects to be recovered.")
    target_directory: Optional[StrictStr] = Field(default=None, description="Specifies the target directory where files and folders are to be recovered. If not set, this will be taken as '/'", alias="targetDirectory")
    __properties: ClassVar[List[str]] = ["advancedConfigs", "bandwidthMBPS", "concurrency", "overwrite", "recoverTo", "warnings", "snapshots", "targetDirectory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if target_directory (nullable) is None
        # and model_fields_set contains the field
        if self.target_directory is None and "target_directory" in self.model_fields_set:
            _dict['targetDirectory'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshots": [RecoverHdfsSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
            "targetDirectory": obj.get("targetDirectory")
        })
        return _obj
