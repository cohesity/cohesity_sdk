...
class Time(BaseModel):
    ...
    """ # noqa: E501
    hour: Optional[StrictInt] = Field(default=None, description="Specifies the hour of this time.")
    minute: Optional[StrictInt] = Field(default=None, description="Specifies the minute of this time.")
