...
class RecoverRdsMsSQLParams(BaseModel):
    """
    Specifies the parameters to recover AWS RDS MS SQL.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverRdsMsSQL] = Field(default=None, alias="awsTargetParams")
    snapshots: Optional[List[RecoverRdsMsSQLSnapshotParams]] = Field(description="Specifies the details of the AWS RDS MS SQL objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverRdsMsSQL.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
            "snapshots": [RecoverRdsMsSQLSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
