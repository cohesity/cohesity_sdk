...
class RecoverAwsRDSOracleParams(BaseModel):
    """
    Specifies the parameters to recover AWS RDS Oracle.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverRDSOracle] = Field(default=None, alias="awsTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["awsTargetParams", "targetEnvironment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverRDSOracle.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
