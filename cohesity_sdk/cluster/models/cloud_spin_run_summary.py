...
class CloudSpinRunSummary(BaseModel):
    """
    Specifies summary information about cloud spin run.
    """ # noqa: E501
    cloud_spin_target_results: Optional[List[CloudSpinTargetResult]] = Field(default=None, description="Cloud Spin results for each Cloud Spin target.", alias="cloudSpinTargetResults")
