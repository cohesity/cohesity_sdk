...
class FetchUptierDataResponse(BaseModel):
    """
    Specifies the amount of data in bytes estimated to be uptiered as part of the current restore job.
    """ # noqa: E501
    data_size: Optional[StrictInt] = Field(default=None, description="Specifies the amount of data in bytes estimated to be uptiered as part of the current restore job.", alias="dataSize")
    __properties: ClassVar[List[str]] = ["dataSize"]
