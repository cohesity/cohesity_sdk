...
class DownloadFileDetails(BaseModel):
    """
    Specifies the details of a file to be downloaded.
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Specifies error message about the file download.", alias="errorMessage")
    file_path: Optional[StrictStr] = Field(default=None, alias="filePath")
    identifier: Optional[StrictStr] = None
    progress_task_id: Optional[StrictStr] = Field(default=None, description="Progress monitor task id for download of file.", alias="progressTaskId")
    status: Optional[StrictStr] = Field(default=None, description="Status of the file download. 'Running' indicates that the Download is still running. 'Canceled' indicates that the Download has been cancelled. 'Failed' indicates that the Download has failed. 'Succeeded' indicates that the Download has finished successfully.")
    __properties: ClassVar[List[str]] = ["errorMessage", "filePath", "identifier", "progressTaskId", "status"]
