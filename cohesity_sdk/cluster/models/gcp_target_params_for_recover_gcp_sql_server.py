...
class GCPTargetParamsForRecoverGCPSqlServer(BaseModel):
    """
    Specifies the recovery target params for Google SQL Server target config.
    """ # noqa: E501
    cloud_storage_bucket_name: Optional[StrictStr] = Field(default=None, description="The Google Cloud Storage bucket name for SQL recovery.", alias="cloudStorageBucketName")
    new_source_config: Optional[RecoverGCPSqlServerNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newSourceConfig": RecoverGCPSqlServerNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
