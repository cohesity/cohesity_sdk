...
class GetIndexedObjectSnapshotsResponseBody(BaseModel):
    """
    Specifies the snapshots of an indexed object.
    """ # noqa: E501
    snapshots: Optional[List[IndexedObjectSnapshot]] = Field(default=None, description="Specifies a list of snapshots containing the indexed object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "snapshots": [IndexedObjectSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
