...
class ClusterOperationResponseParams(BaseModel):
    """
    Specifies cluster operation response parameters.
    """ # noqa: E501
    operation_id: Optional[StrictStr] = Field(default=None, description="Specifies the cluster operation id. This can be used to track the progress of the operation.", alias="operationId")
