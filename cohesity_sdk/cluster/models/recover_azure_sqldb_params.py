...
class RecoverAzureSQLDBParams(BaseModel):
    """
    Specifies the parameters to recover Azure SQL Database.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureSQLDB] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureSQLDBSnapshotParams]] = Field(description="Specifies the details of the azure SQL Database objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureSQLDB.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureSQLDBSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
