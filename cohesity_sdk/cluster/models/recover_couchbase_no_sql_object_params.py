...
class RecoverCouchbaseNoSqlObjectParams(BaseModel):
    """
    ...
    rename_to: Optional[StrictStr] = Field(default=None, description="Specifies the new name to which the object should be renamed, at the time of recovery.", alias="renameTo")
    __properties: ClassVar[List[str]] = ["objectName", "renameTo"]
