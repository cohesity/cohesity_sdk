...
class RecoverGoogleSpannerNewSourceConfig(BaseModel):
    """
    Specifies the configuration for recovering Google Spanner database to the new target.
    """ # noqa: E501
    source: RecoveryObjectIdentifier
    target_instance: RecoveryObjectIdentifier = Field(alias="targetInstance")
    __properties: ClassVar[List[str]] = ["source", "targetInstance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of target_instance
        if self.target_instance:
            _dict['targetInstance'] = self.target_instance.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetInstance": RecoveryObjectIdentifier.from_dict(obj["targetInstance"]) if obj.get("targetInstance") is not None else None
        })
        return _obj
