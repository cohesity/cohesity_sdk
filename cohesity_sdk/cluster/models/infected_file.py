...
class InfectedFile(ModelNormal):
    ...
    def __init__(self, entity_id, root_inode_id, view_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            entity_type (str, none_type): Specifies the type of the infected entity.. [optional]  # noqa: E501
            last_modified_time_usecs (int, none_type): Specifies the timestamp in microseconds when this entity was last modified.. [optional]  # noqa: E501
            path (str, none_type): Specifies the infected entity path.. [optional]  # noqa: E501
            ...
            state (str, none_type): Specifies the state of the infected entity.. [optional]  # noqa: E501
            threat_descriptions ([str], none_type): Specifies a list of virus threat descriptions found in the entity.. [optional]  # noqa: E501
            view_name (str, none_type): Specifies the View name to which the infected entity belongs to.. [optional]  # noqa: E501
        """
