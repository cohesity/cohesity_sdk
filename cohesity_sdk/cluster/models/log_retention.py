...
class LogRetention(BaseModel):
    ...
    duration: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(description="Specifies the duration for a backup retention. <br> Example. If duration is 7 and unit is Months, the retention of a backup is 7 * 30 = 210 days.")
