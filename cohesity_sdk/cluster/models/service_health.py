...
class ServiceHealth(BaseModel):
    ...
    """ # noqa: E501
    health_status: Optional[StrictStr] = Field(default=None, description="\"The health status of the service (e.g., Healthy, Degraded,\" \" Unhealthy).\" ", alias="healthStatus")
    service_name: Optional[StrictStr] = Field(default=None, description="The name of the service.", alias="serviceName")
    __properties: ClassVar[List[str]] = ["healthStatus", "serviceName"]
