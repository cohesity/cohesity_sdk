...
class GCPTargetParamsForRecoverGCPFirestore(BaseModel):
    """
    Specifies the recovery target params for GCP Firestore target config.
    """ # noqa: E501
    cloud_storage_bucket_name: StrictStr = Field(description="The Google Cloud Storage bucket name for Firestore recovery.", alias="cloudStorageBucketName")
    new_source_config: Optional[RecoverGCPFirestoreNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newSourceConfig": RecoverGCPFirestoreNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
