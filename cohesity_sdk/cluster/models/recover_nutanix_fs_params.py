...
class RecoverNutanixFSParams(BaseModel):
    """
    ...
    recover_file_and_folder_params: Optional[RecoverNutanixFSFilesParams] = Field(default=None, alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverNutanixFSNasVolumeParams] = Field(default=None, alias="recoverNasVolumeParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverFileAndFolderParams": RecoverNutanixFSFilesParams.from_dict(obj["recoverFileAndFolderParams"]) if obj.get("recoverFileAndFolderParams") is not None else None,
            "recoverNasVolumeParams": RecoverNutanixFSNasVolumeParams.from_dict(obj["recoverNasVolumeParams"]) if obj.get("recoverNasVolumeParams") is not None else None,
