...
def lazy_import():
    from cohesity_sdk.cluster.models.tenant_assignment_type_integer_id import TenantAssignmentTypeIntegerId
    from cohesity_sdk.cluster.models.tenant_assignment_type_string_id import TenantAssignmentTypeStringId
