...
class TenantAssignmentsResult(BaseModel):
    """
    ...
    policies: Optional[List[StrictStr]] = Field(default=None, description="A list of Ids of properties assigned to the tenant.")
    storage_domains: Optional[List[StrictInt]] = Field(default=None, description="A list of Ids of properties assigned to the tenant.", alias="storageDomains")
    views: Optional[List[StrictInt]] = Field(default=None, description="A list of Ids of properties assigned to the tenant.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storageDomains": obj.get("storageDomains"),
            "views": obj.get("views"),
            "vlans": obj.get("vlans")
        })
        return _obj
