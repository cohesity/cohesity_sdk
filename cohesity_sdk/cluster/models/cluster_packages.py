...
class ClusterPackages(BaseModel):
    """
    List of cluster software packages.
    """ # noqa: E501
    packages: Optional[List[ClusterPackageParams]] = Field(default=None, description="List of cluster software packages.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "packages": [ClusterPackageParams.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None
        })
        return _obj
