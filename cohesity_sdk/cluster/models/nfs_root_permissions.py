...
class NfsRootPermissions(BaseModel):
    """
    Specifies the config of NFS root permission of a view file system.
    """ # noqa: E501
    gid: Optional[StrictInt] = Field(default=None, description="Unix GID for the root of the file system.")
    mode: Optional[StrictInt] = Field(default=None, description="Unix mode bits for the root of the file system.")
    uid: Optional[StrictInt] = Field(default=None, description="Unix UID for the root of the file system.")
    __properties: ClassVar[List[str]] = ["gid", "mode", "uid"]
