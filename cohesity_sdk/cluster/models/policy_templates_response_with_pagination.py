...
class PolicyTemplatesResponseWithPagination(BaseModel):
    """
    Specifies the details about the Protection Policy Templates.
    """ # noqa: E501
    policies: Optional[List[PolicyTemplateResponse]] = Field(default=None, description="Specifies a list of protection policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [PolicyTemplateResponse.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
