...
class RecoverHyperVVmOriginalSourceNetworkConfig(BaseModel):
    """
    Specifies the network config parameters to be applied for HyperV VMs if recovering to original Source.
    """ # noqa: E501
    detach_network: Optional[StrictBool] = Field(default=None, description="If this is set to true, then the network will be detached from the recovered VMs. Default value is false.", alias="detachNetwork")
