...
class ReplicationClustersResponse(BaseModel):
    """
    Specifies the Replication Clusters Response.
    """ # noqa: E501
    clusters: Optional[List[ReplicationClusterStats]] = Field(default=None, description="Specifies a list of Replication Cluster stats.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [ReplicationClusterStats.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
