...
class HypervSnapshotParams(BaseModel):
    """
    Specifies parameters of HyperV type snapshots.
    """ # noqa: E501
    protection_type: Optional[StrictStr] = Field(default=None, description="Specifies the protection type of HyperV snapshots.", alias="protectionType")
    __properties: ClassVar[List[str]] = ["protectionType"]
