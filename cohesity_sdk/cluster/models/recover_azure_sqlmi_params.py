...
class RecoverAzureSQLMIParams(BaseModel):
    """
    Specifies the parameters to recover Azure SQL Managed Instance.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureSQLMI] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureSQLMISnapshotParams]] = Field(description="Specifies the details of the azure SQL Managed Instance objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureSQLMI.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureSQLMISnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
