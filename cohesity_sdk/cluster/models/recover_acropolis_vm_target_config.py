...
class RecoverAcropolisVmTargetConfig(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverAcropolisVmNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverAcropolisVmOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
