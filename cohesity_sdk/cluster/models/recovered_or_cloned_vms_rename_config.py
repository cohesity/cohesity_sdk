...
class RecoveredOrClonedVmsRenameConfig(BaseModel):
    """
    Specifies the prefix and suffix to be added to VMs that are recovered or cloned.
    """ # noqa: E501
    prefix: Optional[StrictStr] = Field(default=None, description="Specifies the prefix string to be added to recovered or cloned object names.")
    suffix: Optional[StrictStr] = Field(default=None, description="Specifies the suffix string to be added to recovered or cloned object names.")
