...
class DataTieringAnalysisRunRequest(BaseModel):
    """
    Specifies the request to run analysis group once.
    """ # noqa: E501
    shares: Optional[List[DataTieringAnalysisShareInfo]] = Field(default=None, description="Specifies the list of shares to analyse.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shares": [DataTieringAnalysisShareInfo.from_dict(_item) for _item in obj["shares"]] if obj.get("shares") is not None else None
        })
        return _obj
