...
class ArchivalS3CompExternalTargetParams(BaseModel):
    """
    ...
    def storage_class_validate_enum(cls, value):
        ...
        if value not in set(['S3CompatibleRegular', 'S3CompatibleTapeBased']):
            raise ValueError("must be one of enum values ('S3CompatibleRegular', 'S3CompatibleTapeBased')")
        return value
