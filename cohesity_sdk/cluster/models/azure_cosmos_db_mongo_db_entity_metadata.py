...
class AzureCosmosDBMongoDBEntityMetadata(BaseModel):
    """
    Specifies the entity metadata of azure cosmosdb mongodb entities.
    """ # noqa: E501
    metadata_list: List[AzureCosmosDBMongoDBMetadata] = Field(description="Specifies the metadata list.", alias="metadataList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadataList": [AzureCosmosDBMongoDBMetadata.from_dict(_item) for _item in obj["metadataList"]] if obj.get("metadataList") is not None else None
        })
        return _obj
