...
class RecoverRdsMsSQLSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_rds_ms_sql_object_params
        if self.recover_rds_ms_sql_object_params:
            _dict['recoverRdsMsSQLObjectParams'] = self.recover_rds_ms_sql_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverRdsMsSQLObjectParams": RecoverRdsMsSQLObjectParams.from_dict(obj["recoverRdsMsSQLObjectParams"]) if obj.get("recoverRdsMsSQLObjectParams") is not None else None
        })
        return _obj
