...
class RecoverSapHanaParams(BaseModel):
    """
    ...
    start_database: Optional[StrictBool] = Field(default=True, description="Start the database after the recovery is complete.", alias="startDatabase")
    ...
    __properties: ClassVar[List[str]] = ["concurrency", "recoverTo", "snapshots", "startDatabase", "warnings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if start_database (nullable) is None
        # and model_fields_set contains the field
        if self.start_database is None and "start_database" in self.model_fields_set:
            _dict['startDatabase'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "startDatabase": obj.get("startDatabase") if obj.get("startDatabase") is not None else True,
