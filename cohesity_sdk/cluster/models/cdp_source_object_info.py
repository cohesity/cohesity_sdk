...
class CdpSourceObjectInfo(BaseModel):
    """
    ...
    protection_group_ids: Optional[List[StrictStr]] = Field(default=None, description="Specifies the protection group ids which belong to this source object for which CDP is enabled.", alias="protectionGroupIds")
    __properties: ClassVar[List[str]] = ["cdpEnabled", "protectionGroupIds"]
