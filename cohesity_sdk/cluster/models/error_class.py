...
class ErrorClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["className", "count"]
    ...
    def class_name_validate_enum(cls, value):
        ...
        if value not in set(['File', 'Folder', 'Persistent', 'Intermittent', 'Discovery', 'Ingestion']):
            raise ValueError("must be one of enum values ('File', 'Folder', 'Persistent', 'Intermittent', 'Discovery', 'Ingestion')")
        return value
