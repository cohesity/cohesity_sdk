...
class CommonGenericNasProtectionParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["continueOnError", "encryptionEnabled", "fileFilters", "fileLockConfig", "indexingPolicy", "prePostScript", "throttlingConfig"]
