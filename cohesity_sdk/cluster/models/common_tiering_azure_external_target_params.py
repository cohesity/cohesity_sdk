...
class CommonTieringAzureExternalTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientId", "containerName", "region", "storageAccessKey", "storageAccountName", "storageClass"]
