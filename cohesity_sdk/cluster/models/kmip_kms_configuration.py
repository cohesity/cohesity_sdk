...
class KmipKmsConfiguration(BaseModel):
    """
    ...
    ca_certificate: StrictStr = Field(description="CA certificate.", alias="caCertificate")
    ...
    client_certificate: StrictStr = Field(description="Client certificate.", alias="clientCertificate")
    client_key: StrictStr = Field(description="Client key.", alias="clientKey")
    port: Optional[StrictInt] = Field(default=5696, description="Port on which the KMS server is listening.")
    protocol_version: StrictStr = Field(description="KMIP protocol version used to communicate with the KMS.", alias="protocolVersion")
    server: StrictStr = Field(description="KMS server IP address or FQDN.")
    __properties: ClassVar[List[str]] = ["AdditionalServerAddress", "caCertificate", "certificateExpiryDate", "clientCertificate", "clientKey", "port", "protocolVersion", "server"]
