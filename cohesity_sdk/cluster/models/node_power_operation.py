...
class NodePowerOperation(BaseModel):
    ...
    NodePowerOperation
    """ # noqa: E501
    node_id: Optional[StrictInt] = Field(default=None, description="Id of the node to do the specified operation.", alias="nodeId")
    operation: Optional[StrictStr] = Field(description="The operation clould be poweroff, reboot.")
    __properties: ClassVar[List[str]] = ["nodeId", "operation"]
    ...
    def operation_validate_enum(cls, value):
        ...
        if value not in set(['poweroff', 'reboot']):
            raise ValueError("must be one of enum values ('poweroff', 'reboot')")
        return value
