...
class AnalysisTaskInfo(BaseModel):
    ...
    AnalysisTaskInfo
    """ # noqa: E501
    instance_id: Optional[StrictStr] = Field(default=None, description="Id of that particular Analysis Task.", alias="instanceId")
    name: Optional[StrictStr] = Field(default=None, description="Name of the Analysis task.")
    ...
    task_id: Optional[StrictStr] = Field(default=None, description="Id of the Analysis task.", alias="taskId")
