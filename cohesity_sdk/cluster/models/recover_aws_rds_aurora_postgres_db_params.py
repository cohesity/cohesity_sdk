...
class RecoverAwsRdsAuroraPostgresDbParams(BaseModel):
    """
    Specifies the parameters to recover RDS Aurora Postgres.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverRdsPostgresDb] = Field(default=None, alias="awsTargetParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverRdsPostgresDb.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
