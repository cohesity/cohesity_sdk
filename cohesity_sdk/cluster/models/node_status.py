...
class NodeStatus(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error_message (str, none_type): Specifies an optional message relating to the node status.. [optional]  # noqa: E501
            ipmi_ip (str, none_type): Specifies the IPMI IP of the node (if physical cluster).. [optional]  # noqa: E501
            node_id (int, none_type): Specifies the ID of the node.. [optional]  # noqa: E501
            node_ip (str, none_type): Specifies the IP of the node.. [optional]  # noqa: E501
        """
