...
class NodeStatus(BaseModel):
    ...
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Specifies an optional message relating to the node status.", alias="errorMessage")
    ipmi_ip: Optional[StrictStr] = Field(default=None, description="Specifies the IPMI IP of the node (if physical cluster).", alias="ipmiIp")
    node_id: Optional[StrictInt] = Field(default=None, description="Specifies the ID of the node.", alias="nodeId")
    node_ip: Optional[StrictStr] = Field(default=None, description="Specifies the IP of the node.", alias="nodeIp")
    __properties: ClassVar[List[str]] = ["errorMessage", "ipmiIp", "nodeId", "nodeIp"]
