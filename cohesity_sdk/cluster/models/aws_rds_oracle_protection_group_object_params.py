...
class AwsRDSOracleProtectionGroupObjectParams(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the database instance.")
