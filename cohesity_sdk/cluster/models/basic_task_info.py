...
class BasicTaskInfo(BaseModel):
    ...
    BasicTaskInfo
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the Basic Task.")
    task_id: Optional[StrictStr] = Field(default=None, description="Id of the Basic task.", alias="taskId")
