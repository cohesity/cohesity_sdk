...
class CreateProtectedObjectsRequest(BaseModel):
    ...
    activate_remote_object_protection: Optional[StrictBool] = Field(default=None, description="If set to true, it will look for the remote backup of the given user and object, and activates it. Creates a new backup if the remote backup is not found. After activation, this object cannot get snapshots from remote clusters.", alias="activateRemoteObjectProtection")
    is_paused: Optional[StrictBool] = Field(default=None, description="If set to true, then the object specs will be created in the paused state preventing any runs from happening until they are unpaused.", alias="isPaused")
    objects: Optional[List[EnvSpecificObjectProtectionRequestParams]] = Field(description="Specifies the list of objects to be protected. Multiple objects from different adapters can be provided as input.")
    __properties: ClassVar[List[str]] = ["abortInBlackouts", "endTimeUsecs", "policyConfig", "policyId", "priority", "qosPolicy", "skipRigelForBackup", "sla", "startTime", "storageDomainId", "activateRemoteObjectProtection", "isPaused", "objects"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if activate_remote_object_protection (nullable) is None
        # and model_fields_set contains the field
        if self.activate_remote_object_protection is None and "activate_remote_object_protection" in self.model_fields_set:
            _dict['activateRemoteObjectProtection'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activateRemoteObjectProtection": obj.get("activateRemoteObjectProtection"),
            "isPaused": obj.get("isPaused"),
            "objects": [EnvSpecificObjectProtectionRequestParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
