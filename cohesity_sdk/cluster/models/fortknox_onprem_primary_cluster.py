...
class FortknoxOnpremPrimaryCluster(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clusterId", "clusterIncarnationId", "clusterName", "allEndpointsReachable", "bandwidthLimit", "compressionEnabled", "storageDomainConfigs", "networkInterface", "nodeIPs"]
