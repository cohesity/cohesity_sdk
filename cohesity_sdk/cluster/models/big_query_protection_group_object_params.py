...
class BigQueryProtectionGroupObjectParams(BaseModel):
    """
    Specifies the object parameters to create GCP BigQuery Protection Group.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(description="Specifies the id of the dataset.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the dataset.")
