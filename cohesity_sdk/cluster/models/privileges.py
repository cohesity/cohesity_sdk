...
class Privileges(BaseModel):
    ...
    """ # noqa: E501
    privileges: Optional[List[Privilege]] = Field(default=None, description="Specifies the list of Privileges.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "privileges": [Privilege.from_dict(_item) for _item in obj["privileges"]] if obj.get("privileges") is not None else None
        })
        return _obj
