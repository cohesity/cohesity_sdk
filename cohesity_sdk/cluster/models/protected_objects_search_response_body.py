...
class ProtectedObjectsSearchResponseBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": ProtectedObjectsSearchMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "numResults": obj.get("numResults"),
            "objects": [ProtectedObject.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
