...
class RecoverAzureCosmosDBCassandraParams(BaseModel):
    """
    Specifies the parameters to recover Azure CosmosDB Cassandra.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureCosmosDBCassandra] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureCosmosDBCassandraSnapshotParams]] = Field(description="Specifies the details of the azure cosmosdb cassandra objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureCosmosDBCassandra.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureCosmosDBCassandraSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
