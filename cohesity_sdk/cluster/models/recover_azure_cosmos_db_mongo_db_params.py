...
class RecoverAzureCosmosDBMongoDBParams(BaseModel):
    """
    Specifies the parameters to recover Azure CosmosDB MongoDB.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureCosmosDBMongoDB] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureCosmosDBMongoDBSnapshotParams]] = Field(description="Specifies the details of the azure cosmosdb mongodb objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureCosmosDBMongoDB.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureCosmosDBMongoDBSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
