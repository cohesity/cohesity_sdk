...
class RecoverGCPSqlServerSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_gcp_sql_server_object_params
        if self.recover_gcp_sql_server_object_params:
            _dict['recoverGcpSqlServerObjectParams'] = self.recover_gcp_sql_server_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverGcpSqlServerObjectParams": RecoverGcpObjectParams.from_dict(obj["recoverGcpSqlServerObjectParams"]) if obj.get("recoverGcpSqlServerObjectParams") is not None else None
        })
        return _obj
