...
class UpdateLinuxPasswordRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'verify_password': (bool, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'verify_password': 'verifyPassword',  # noqa: E501
    }
    ...
    def __init__(self, username, *args, **kwargs):  # noqa: E501
        """UpdateLinuxPasswordRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            new_password (str, none_type): Specifies the new linux password.. [optional]  # noqa: E501
            verify_password (bool, none_type): True if request is only to verify if current password matches with set password.. [optional]  # noqa: E501
        """
