...
class DocumentObject(BaseModel):
    ...
    """ # noqa: E501
    is_directory: Optional[StrictBool] = Field(default=None, description="Specifies whether the document is a directory. Since currently only files are supported this should always be false.", alias="isDirectory")
    item_id: Optional[StrictStr] = Field(description="Specifies the item id of the document.", alias="itemId")
    __properties: ClassVar[List[str]] = ["isDirectory", "itemId"]
