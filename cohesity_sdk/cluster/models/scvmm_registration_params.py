...
class ScvmmRegistrationParams(BaseModel):
    """
    ...
    agent_endpoint: Optional[StrictStr] = Field(default=None, description="Specifies the agent endpoint if it is different from the source endpoint.", alias="agentEndpoint")
    throttling_params: Optional[ThrottlingParams] = Field(default=None, alias="throttlingParams")
    __properties: ClassVar[List[str]] = ["password", "username", "description", "endpoint", "agentEndpoint", "throttlingParams"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if agent_endpoint (nullable) is None
        # and model_fields_set contains the field
        if self.agent_endpoint is None and "agent_endpoint" in self.model_fields_set:
            _dict['agentEndpoint'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "agentEndpoint": obj.get("agentEndpoint"),
            "throttlingParams": ThrottlingParams.from_dict(obj["throttlingParams"]) if obj.get("throttlingParams") is not None else None
        })
        return _obj
