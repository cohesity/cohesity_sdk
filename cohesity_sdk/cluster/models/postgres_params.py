...
class PostgresParams(BaseModel):
    ...
    """ # noqa: E501
    recover_postgres_params: RecoverPostgresParams = Field(alias="recoverPostgresParams")
    recovery_action: StrictStr = Field(description="Specifies the type of recover action to be performed.", alias="recoveryAction")
    __properties: ClassVar[List[str]] = ["recoverPostgresParams", "recoveryAction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_postgres_params
        if self.recover_postgres_params:
            _dict['recoverPostgresParams'] = self.recover_postgres_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoverPostgresParams": RecoverPostgresParams.from_dict(obj["recoverPostgresParams"]) if obj.get("recoverPostgresParams") is not None else None,
