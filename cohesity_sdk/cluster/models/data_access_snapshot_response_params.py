...
class DataAccessSnapshotResponseParams(BaseModel):
    """
    Specifies the snapshot information.
    """ # noqa: E501
    environment: Optional[StrictStr] = Field(default=None, description="Specifies the environment of the source.")
    object_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the object snapshot.", alias="objectId")
    ...
    vault_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the cluster vault.", alias="vaultId")
    __properties: ClassVar[List[str]] = ["environment", "objectId", "pointInTimeUsecs", "runStartTimeUsecs", "vaultId"]
