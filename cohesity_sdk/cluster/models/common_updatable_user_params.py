...
class CommonUpdatableUserParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "effectiveTimeMsecs", "expiryTimeMsecs", "locked", "otherGroups", "primaryGroup", "restricted", "roles"]
