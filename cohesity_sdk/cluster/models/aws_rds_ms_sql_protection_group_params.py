...
class AwsRdsMsSqlProtectionGroupParams(BaseModel):
    """
    ...
    cloud_storage_bucket_name: Optional[StrictStr] = Field(default=None, description="The Cloud Storage bucket name for MS SQL database backup.", alias="cloudStorageBucketName")
    ...
    objects: Optional[List[AwsRdsMsSqlProtectionGroupObjectParams]] = Field(default=None, description="Specifies the objects to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["bucketAutoCreate", "cloudStorageBucketName", "excludeObjectIds", "excludeRdsTagIds", "objects", "rdsTagIds", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [AwsRdsMsSqlProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
