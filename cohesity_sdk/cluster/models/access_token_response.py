...
class AccessTokenResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="Created access token.", alias="accessToken")
    privileges: Optional[List[StrictStr]] = Field(default=None, description="Privileges for the user.")
    token_type: Optional[StrictStr] = Field(default=None, description="Access token type.", alias="tokenType")
    __properties: ClassVar[List[str]] = ["accessToken", "privileges", "tokenType"]
