...
class RecoverAcropolisFileAndFolderParams(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "acropolisTargetParams": AcropolisTargetParamsForRecoverFileAndFolder.from_dict(obj["acropolisTargetParams"]) if obj.get("acropolisTargetParams") is not None else None,
