...
class RecoverNutanixFSFilesParams(BaseModel):
    """
    ...
    files_and_folders: Optional[List[NutanixFSRecoverFileAndFolderInfo]] = Field(description="Specifies the list of info about the nutanixFS files and folders to be recovered.", alias="filesAndFolders")
    ...
    nutanix_fs_target_params: Optional[RecoverNutanixFSToNutanixFSFilesTargetParams] = Field(default=None, alias="nutanixFSTargetParams")
    ...
    __properties: ClassVar[List[str]] = ["elastifileTargetParams", "filesAndFolders", "flashbladeTargetParams", "genericNasTargetParams", "gpfsTargetParams", "isFromSourceInitiatedProtection", "isilonTargetParams", "netappTargetParams", "nutanixFSTargetParams", "targetEnvironment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nutanix_fs_target_params
        if self.nutanix_fs_target_params:
            _dict['nutanixFSTargetParams'] = self.nutanix_fs_target_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filesAndFolders": [NutanixFSRecoverFileAndFolderInfo.from_dict(_item) for _item in obj["filesAndFolders"]] if obj.get("filesAndFolders") is not None else None,
            ...
            "nutanixFSTargetParams": RecoverNutanixFSToNutanixFSFilesTargetParams.from_dict(obj["nutanixFSTargetParams"]) if obj.get("nutanixFSTargetParams") is not None else None,
