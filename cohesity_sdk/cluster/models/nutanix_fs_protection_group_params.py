...
class NutanixFSProtectionGroupParams(BaseModel):
    """
    Specifies the parameters which are specific to Nutanix FS related Protection Groups.
    """ # noqa: E501
    backup_existing_snapshot: Optional[StrictBool] = Field(default=None, description="Specifies that snapshot label is not set for Data-Protect Nutanix FS Volumes backup. If field is set to true, existing oldest snapshot is used for backup and subsequent incremental will be selected in ascending order of snapshot create time on the source. If snapshot label is set, this field is set to false.", alias="backupExistingSnapshot")
    ...
    modify_source_permissions: Optional[StrictBool] = Field(default=None, description="Specifies if the Nutanix FS source permissions should be modified internally to allow backups.", alias="modifySourcePermissions")
    ...
    objects: Annotated[List[NutanixFSProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [NutanixFSProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
