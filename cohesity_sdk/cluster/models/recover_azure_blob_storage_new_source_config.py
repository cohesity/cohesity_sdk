...
class RecoverAzureBlobStorageNewSourceConfig(BaseModel):
    """
    Specifies the configuration for recovering Azure Blob Storage instance to the new target.
    """ # noqa: E501
    parent_source: RecoveryObjectIdentifier = Field(alias="parentSource")
    region: Optional[RecoveryObjectIdentifier] = None
    source: RecoveryObjectIdentifier
    __properties: ClassVar[List[str]] = ["parentSource", "region", "source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parentSource": RecoveryObjectIdentifier.from_dict(obj["parentSource"]) if obj.get("parentSource") is not None else None,
