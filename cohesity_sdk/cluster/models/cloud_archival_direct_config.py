...
class CloudArchivalDirectConfig(BaseModel):
    """
    Specifies the properties of vaults used to perform Cloud Archive Direct (CAD)
    """ # noqa: E501
    bucket_namespace: Optional[StrictStr] = Field(default=None, description="Specifies a namespace under the bucket used for archival.", alias="bucketNamespace")
    physical_quota: Optional[QuotaPolicy] = Field(default=None, alias="physicalQuota")
    __properties: ClassVar[List[str]] = ["bucketNamespace", "physicalQuota"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bucket_namespace (nullable) is None
        # and model_fields_set contains the field
        if self.bucket_namespace is None and "bucket_namespace" in self.model_fields_set:
            _dict['bucketNamespace'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bucketNamespace": obj.get("bucketNamespace"),
