...
class LogicalStats(BaseModel):
    """
    Specifies the total logical data size of all the local and Cloud Tier data stored by the Cohesity Cluster
    """ # noqa: E501
    total_logical_usage_bytes: Optional[StrictInt] = Field(default=None, description="Specifies the size of data before reduction by deduplication and compression.", alias="totalLogicalUsageBytes")
    __properties: ClassVar[List[str]] = ["totalLogicalUsageBytes"]
