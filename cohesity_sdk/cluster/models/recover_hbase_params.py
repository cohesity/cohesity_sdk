...
class RecoverHbaseParams(BaseModel):
    """
    ...
    snapshots: Optional[List[RecoverHbaseSnapshotParams]] = Field(description="Specifies the local snapshot ids of the Objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshots": [RecoverHbaseSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
