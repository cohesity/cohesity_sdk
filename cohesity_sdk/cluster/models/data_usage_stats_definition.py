...
class DataUsageStatsDefinition(BaseModel):
    """
    ...
    data_in_bytes_prev: Optional[StrictInt] = Field(default=None, description="Specifies the storage used before any data reduction using deduplication and compression.", alias="dataInBytesPrev")
    data_in_bytes_prev_timestamp_usec: Optional[StrictInt] = Field(default=None, description="Specifies Timestamp of DataInBytesPrev", alias="dataInBytesPrevTimestampUsec")
    ...
    data_written_bytes_prev: Optional[StrictInt] = Field(default=None, description="Specifies the data written after it has been reduced by deduplication and compression at a previous time.", alias="dataWrittenBytesPrev")
    data_written_bytes_prev_timestamp_usec: Optional[StrictInt] = Field(default=None, description="Specifies Timestamp of DataWrittenBytesPrev", alias="dataWrittenBytesPrevTimestampUsec")
    ...
    local_tier_resiliency_impact_bytes_prev: Optional[StrictInt] = Field(default=None, description="Specifies the size of the data has been replicated to other nodes as per RF or Erasure Coding policy at a specific time.", alias="localTierResiliencyImpactBytesPrev")
    local_tier_resiliency_impact_bytes_prev_timestamp_usec: Optional[StrictInt] = Field(default=None, description="Specifies Timestamp of LocalTierResiliencyImpactBytesPrev.", alias="localTierResiliencyImpactBytesPrevTimestampUsec")
    ...
    outdated_logical_usage_bytes: Optional[StrictInt] = Field(default=None, description="Specifies the logical usage as computed by the Cohesity Cluster.", alias="outdatedLogicalUsageBytes")
    ...
    storage_consumed_bytes_prev: Optional[StrictInt] = Field(default=None, description="Specifies the total capacity, as computed by the Cohesity Cluster, after the size of the data has been reduced by change-block tracking, compression and deduplication at a previous time to compare.", alias="storageConsumedBytesPrev")
    storage_consumed_bytes_prev_timestamp_usec: Optional[StrictInt] = Field(default=None, description="Specifies Timestamp of StorageConsumedBytesPrev.", alias="storageConsumedBytesPrevTimestampUsec")
    ...
    unique_physical_data_bytes_timestamp_usec: Optional[StrictInt] = Field(default=None, description="Specifies Timestamp of UniquePhysicalDataBytes.", alias="uniquePhysicalDataBytesTimestampUsec")
    __properties: ClassVar[List[str]] = ["cloudDataWrittenBytes", "cloudDataWrittenBytesTimestampUsec", "cloudTotalPhysicalUsageBytes", "cloudTotalPhysicalUsageBytesTimestampUsec", "dataInBytes", "dataInBytesAfterDedup", "dataInBytesAfterDedupTimestampUsec", "dataInBytesPrev", "dataInBytesPrevTimestampUsec", "dataInBytesTimestampUsec", "dataProtectLogicalUsageBytes", "dataProtectLogicalUsageBytesTimestampUsec", "dataProtectPhysicalUsageBytes", "dataProtectPhysicalUsageBytesTimestampUsec", "dataWrittenBytes", "dataWrittenBytesPrev", "dataWrittenBytesPrevTimestampUsec", "dataWrittenBytesTimestampUsec", "fileServicesLogicalUsageBytes", "fileServicesLogicalUsageBytesTimestampUsec", "fileServicesPhysicalUsageBytes", "fileServicesPhysicalUsageBytesTimestampUsec", "localDataWrittenBytes", "localDataWrittenBytesTimestampUsec", "localTierResiliencyImpactBytes", "localTierResiliencyImpactBytesPrev", "localTierResiliencyImpactBytesPrevTimestampUsec", "localTierResiliencyImpactBytesTimestampUsec", "localTotalPhysicalUsageBytes", "localTotalPhysicalUsageBytesTimestampUsec", "numDirectories", "numDirectoriesPrev", "numFiles", "numFilesPrev", "outdatedLogicalUsageBytes", "outdatedLogicalUsageBytesTimestampUsec", "storageConsumedBytes", "storageConsumedBytesPrev", "storageConsumedBytesPrevTimestampUsec", "storageConsumedBytesTimestampUsec", "totalLogicalUsageBytes", "totalLogicalUsageBytesTimestampUsec", "uniquePhysicalDataBytes", "uniquePhysicalDataBytesTimestampUsec"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if data_in_bytes_prev (nullable) is None
        # and model_fields_set contains the field
        if self.data_in_bytes_prev is None and "data_in_bytes_prev" in self.model_fields_set:
            _dict['dataInBytesPrev'] = None

        # set to None if data_in_bytes_prev_timestamp_usec (nullable) is None
        # and model_fields_set contains the field
        if self.data_in_bytes_prev_timestamp_usec is None and "data_in_bytes_prev_timestamp_usec" in self.model_fields_set:
            _dict['dataInBytesPrevTimestampUsec'] = None
        ...
        # set to None if unique_physical_data_bytes_timestamp_usec (nullable) is None
        # and model_fields_set contains the field
        if self.unique_physical_data_bytes_timestamp_usec is None and "unique_physical_data_bytes_timestamp_usec" in self.model_fields_set:
            _dict['uniquePhysicalDataBytesTimestampUsec'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataInBytesPrev": obj.get("dataInBytesPrev"),
            "dataInBytesPrevTimestampUsec": obj.get("dataInBytesPrevTimestampUsec"),
            ...
            "uniquePhysicalDataBytesTimestampUsec": obj.get("uniquePhysicalDataBytesTimestampUsec")
        })
        return _obj
