...
class HeliosRegConfig(BaseModel):
    ...
    def entity_type_validate_enum(cls, value):
        ...
        if value not in set(['Rigel', 'Cluster', 'Cohesion', 'IBMStorageProtect', 'CloudNativeDataplane']):
            raise ValueError("must be one of enum values ('Rigel', 'Cluster', 'Cohesion', 'IBMStorageProtect', 'CloudNativeDataplane')")
        return value
