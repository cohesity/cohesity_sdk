...
class MfaConfigInfo(BaseModel):
    """
    Holds the MFA configuration to be returned or stored.
    """ # noqa: E501
    authentication_types: Optional[List[StrictStr]] = Field(default=None, description="Specifies the list of mechanism to receive the OTP code.", alias="authenticationTypes")
    enabled: Optional[StrictBool] = Field(default=False, description="Specifies whether MFA is enabled on a cluster level.")
    retain_user_mfa_settings: Optional[StrictBool] = Field(default=None, description="Specifies whether user MFA setting needs to be retained.", alias="retainUserMfaSettings")
    __properties: ClassVar[List[str]] = ["authenticationTypes", "enabled", "retainUserMfaSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retainUserMfaSettings": obj.get("retainUserMfaSettings")
        })
        return _obj
