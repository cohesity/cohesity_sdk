...
class TargetOneDriveParam(BaseModel):
    """
    Specifies the target OneDrive to recover to.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the target onedrive. Atleast one of id or primarySMTPAddress need to be defined. In case both id and primarySMTPAddress are defined then id takes precedence.")
