...
class AgentUpgradeTaskInfo(BaseModel):
    """
    AgentUpgradeTaskInfo
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the Agent Upgrade task.")
    start_time_usecs: Optional[StrictStr] = Field(default=None, description="Denotes the start time of the agent upgrade task.", alias="startTimeUsecs")
    task_id: Optional[StrictStr] = Field(default=None, description="Id of the Agent Upgrade task.", alias="taskId")
    __properties: ClassVar[List[str]] = ["name", "startTimeUsecs", "taskId"]
