...
class TargetMsGroupObject(BaseModel):
    """
    ...
    primary_smtp_address: Optional[StrictStr] = Field(default=None, description="Specifies the primary SMTP Address of the target group.", alias="primarySMTPAddress")
    __properties: ClassVar[List[str]] = ["id", "name", "primarySMTPAddress"]
