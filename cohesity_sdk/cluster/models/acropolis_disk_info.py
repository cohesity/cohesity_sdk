...
class AcropolisDiskInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["controllerType", "unitNumber"]
    ...
    def controller_type_validate_enum(cls, value):
        ...
        if value not in set(['scsi', 'ide', 'pci', 'sata', 'spapr', 'nvme']):
            raise ValueError("must be one of enum values ('scsi', 'ide', 'pci', 'sata', 'spapr', 'nvme')")
        return value
