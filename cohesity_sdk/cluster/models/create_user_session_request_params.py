...
class CreateUserSessionRequestParams(BaseModel):
    """
    Specifies user session request parameters
    """ # noqa: E501
    certificate: Optional[StrictStr] = Field(default=None, description="Specifies the certificate for cert based authentication.")
    ...
    otp_type: Optional[StrictStr] = Field(default=None, description="Specifies OTP Type for MFA verification.", alias="otpType")
    password: Optional[StrictStr] = Field(default=None, description="Specifies the password of the Cohesity user")
    private_key: Optional[StrictStr] = Field(default=None, description="Specifies the private key for cert based authentication.", alias="privateKey")
    username: Optional[StrictStr] = Field(default=None, description="Specifies the login name of the Cohesity user")
    __properties: ClassVar[List[str]] = ["certificate", "domain", "otpCode", "otpType", "password", "privateKey", "username"]
