...
class NewViewFilesTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["alternatePath", "continueOnError", "overwriteExistingFile", "preserveFileAttributes", "vlanConfig"]
