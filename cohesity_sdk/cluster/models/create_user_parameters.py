...
class CreateUserParameters(BaseModel):
    ...
    s3_access_keys: Optional[S3Keys] = Field(default=None, alias="S3AccessKeys")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of s3_access_keys
        if self.s3_access_keys:
            _dict['S3AccessKeys'] = self.s3_access_keys.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roles": obj.get("roles"),
            "S3AccessKeys": S3Keys.from_dict(obj["S3AccessKeys"]) if obj.get("S3AccessKeys") is not None else None,
