...
class SecretKeyEntity(BaseModel):
    """
    Specifies the new secret key instance generated for the user.
    """ # noqa: E501
    secret_key: Optional[StrictStr] = Field(default=None, description="Specifies the new s3 secret key.", alias="secret-key")
    __properties: ClassVar[List[str]] = ["secret-key"]
