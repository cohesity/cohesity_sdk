...
class RecoverGenericNasParams(BaseModel):
    ...
    recover_file_and_folder_params: Optional[RecoverGenericNasFilesParams] = Field(default=None, alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverGenericNasNasVolumeParams] = Field(default=None, alias="recoverNasVolumeParams")
