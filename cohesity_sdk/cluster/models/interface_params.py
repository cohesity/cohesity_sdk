...
class InterfaceParams(BaseModel):
    ...
    network_params: Optional[InterfaceNetworkParams] = Field(default=None, alias="networkParams")
    __properties: ClassVar[List[str]] = ["name", "networkParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "networkParams": InterfaceNetworkParams.from_dict(obj["networkParams"]) if obj.get("networkParams") is not None else None
        })
        return _obj
