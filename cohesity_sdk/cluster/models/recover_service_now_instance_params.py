...
class RecoverServiceNowInstanceParams(BaseModel):
    ...
    common_recovery_options: Optional[CommonRecoveryOptions] = Field(default=None, alias="commonRecoveryOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "commonRecoveryOptions": CommonRecoveryOptions.from_dict(obj["commonRecoveryOptions"]) if obj.get("commonRecoveryOptions") is not None else None,
