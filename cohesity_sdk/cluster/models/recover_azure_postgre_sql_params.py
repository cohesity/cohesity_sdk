...
class RecoverAzurePostgreSQLParams(BaseModel):
    """
    Specifies the parameters to recover Azure PostgreSQL.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzurePostgreSQL] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzurePostgreSQLSnapshotParams]] = Field(description="Specifies the details of the azure PostgreSQL objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzurePostgreSQL.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzurePostgreSQLSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
