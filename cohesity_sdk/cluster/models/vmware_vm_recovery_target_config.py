...
class VmwareVmRecoveryTargetConfig(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverVmwareVmNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverVmwareVmOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
