...
class OracleConnectionParams(BaseModel):
    ...
    """ # noqa: E501
    hostname: Optional[StrictStr] = Field(description="Specifies the unique identifier to locate the Oracle node or cluster. The host identifier can be IP address or FQDN.")
