...
class ViewClientStats(BaseModel):
    """
    Specifies the View Client stats.
    """ # noqa: E501
    client_ip: Optional[StrictStr] = Field(default=None, description="Specifies the client IP.", alias="clientIp")
    stats: Optional[List[ClientStats]] = Field(default=None, description="Specifies the list of Client stats.")
    __properties: ClassVar[List[str]] = ["clientIp", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": [ClientStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
