...
class GcpSqlServerProtectionGroupObjectParams(BaseModel):
    """
    Specifies the object parameters to create Google SQL Server Protection Group.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(description="Specifies the id of the database.")
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the database.")
