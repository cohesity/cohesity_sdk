...
class FailedProtectionGroupDetails(BaseModel):
    """
    Specifies a list of ids of Protection Group that failed to update along with error details
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Specifies the error mesage for failed protection group.", alias="errorMessage")
    protection_group_id: Optional[StrictStr] = Field(default=None, description="Specifies the id of the failed protection group.", alias="protectionGroupId")
    __properties: ClassVar[List[str]] = ["errorMessage", "protectionGroupId"]
