...
class RecoverGpfsParams(BaseModel):
    ...
    recover_file_and_folder_params: Optional[RecoverGpfsFilesParams] = Field(default=None, alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverGpfsNasVolumeParams] = Field(default=None, alias="recoverNasVolumeParams")
