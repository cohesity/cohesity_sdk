...
class ArchivalTargetStatsInfo(BaseModel):
    ...
    objects: Optional[List[ObjectStatsInfo]] = Field(default=None, description="Specifies stats for objects.")
    __properties: ClassVar[List[str]] = ["archivalTaskId", "ownershipContext", "targetId", "targetName", "targetType", "tierSettings", "usageType", "backupGenericStats", "nasStats", "objects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [ObjectStatsInfo.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
