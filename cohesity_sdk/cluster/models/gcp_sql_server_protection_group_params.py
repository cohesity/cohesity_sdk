...
class GcpSqlServerProtectionGroupParams(BaseModel):
    """
    Specifies the parameters which are specific to Google SQL Server related Protection Groups.
    """ # noqa: E501
    bucket_auto_create: Optional[StrictBool] = Field(default=None, description="This flag controls whether SQL backup auto-creates bucket or uses the provided bucket name.", alias="bucketAutoCreate")
    cloud_storage_bucket_name: StrictStr = Field(description="The Google Cloud Storage bucket name for Cloud SQL backup.", alias="cloudStorageBucketName")
    ...
    objects: Optional[List[GcpSqlServerProtectionGroupObjectParams]] = Field(default=None, description="Specifies the SQL Server databases to be included in the Protection Group.")
    ...
    __properties: ClassVar[List[str]] = ["bucketAutoCreate", "cloudStorageBucketName", "excludeObjectIds", "objects", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [GcpSqlServerProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
