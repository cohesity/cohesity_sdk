...
class RecoverHyperVParams(BaseModel):
    ...
    mount_volume_params: Optional[MountHyperVVolumeParams] = Field(default=None, alias="mountVolumeParams")
    ...
    recover_file_and_folder_params: Optional[RecoverHyperVFileAndFolderParams] = Field(default=None, alias="recoverFileAndFolderParams")
    recover_vm_params: Optional[RecoverHyperVVmParams] = Field(default=None, alias="recoverVmParams")
