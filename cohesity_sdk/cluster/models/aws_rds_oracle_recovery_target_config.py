...
class AwsRDSOracleRecoveryTargetConfig(BaseModel):
    """
    Specifies the target object parameters to recover AWS RDS Oracle.
    """ # noqa: E501
    new_source_config: RecoverAwsRDSOracleNewSourceConfig = Field(alias="newSourceConfig")
    num_channels: Optional[StrictInt] = Field(default=None, description="Number of channels for Oracle restore.", alias="numChannels")
    ...
    __properties: ClassVar[List[str]] = ["newSourceConfig", "numChannels", "recoverToNewSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if num_channels (nullable) is None
        # and model_fields_set contains the field
        if self.num_channels is None and "num_channels" in self.model_fields_set:
            _dict['numChannels'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newSourceConfig": RecoverAwsRDSOracleNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
