...
class NetappDataTieringParams(BaseModel):
    """
    ...
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the root of data tiering source.", alias="sourceId")
