...
class LockFileParams(BaseModel):
    ...
    """ # noqa: E501
    expiry_timestamp_msecs: Optional[StrictInt] = Field(description="Specifies a definite timestamp in milliseconds for retaining the file or to extend it's expiry timestamp.", alias="expiryTimestampMsecs")
    file_path: Optional[StrictStr] = Field(description="Specifies the file path that needs to be locked.", alias="filePath")
    __properties: ClassVar[List[str]] = ["expiryTimestampMsecs", "filePath"]
