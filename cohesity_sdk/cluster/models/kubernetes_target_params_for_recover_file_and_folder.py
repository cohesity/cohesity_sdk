...
class KubernetesTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    new_target_config: Optional[KubernetesRecoverFilesNewTargetConfig] = Field(default=None, alias="newTargetConfig")
    original_target_config: Optional[KubernetesRecoverFilesOriginalTargetConfig] = Field(default=None, alias="originalTargetConfig")
