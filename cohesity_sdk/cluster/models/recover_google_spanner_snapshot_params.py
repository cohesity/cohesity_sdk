...
class RecoverGoogleSpannerSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_google_spanner_object_params
        if self.recover_google_spanner_object_params:
            _dict['recoverGoogleSpannerObjectParams'] = self.recover_google_spanner_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverGoogleSpannerObjectParams": RecoverGcpObjectParams.from_dict(obj["recoverGoogleSpannerObjectParams"]) if obj.get("recoverGoogleSpannerObjectParams") is not None else None
        })
        return _obj
