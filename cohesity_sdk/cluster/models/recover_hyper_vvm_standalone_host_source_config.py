...
class RecoverHyperVVmStandaloneHostSourceConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["networkConfig", "source", "volume"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkConfig": RecoverHyperVVmNewSourceNetworkConfig.from_dict(obj["networkConfig"]) if obj.get("networkConfig") is not None else None,
