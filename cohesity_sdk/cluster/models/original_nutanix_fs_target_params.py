...
class OriginalNutanixFSTargetParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["continueOnError", "encryptionEnabled", "filterIpConfig", "overwriteExistingFile", "preserveFileAttributes", "vlanConfig"]
