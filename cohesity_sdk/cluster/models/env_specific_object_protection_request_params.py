...
class EnvSpecificObjectProtectionRequestParams(BaseModel):
    ...
    nutanix_fs_params: Optional[NutanixFSObjectProtectionRequestParams] = Field(default=None, alias="nutanixFSParams")
    ...
    __properties: ClassVar[List[str]] = ["environment", "awsParams", "azureParams", "elastifileParams", "experimentalAdapterParams", "flashbladeParams", "genericNasParams", "googleWorkspaceParams", "gpfsParams", "hypervParams", "isilonParams", "kubernetesParams", "mssqlParams", "netappParams", "nutanixFSParams", "office365Params", "oracleParams", "physicalParams", "sapHanaParams", "serviceNowParams", "sfdcParams", "udaParams", "vmwareParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nutanixFSParams": NutanixFSObjectProtectionRequestParams.from_dict(obj["nutanixFSParams"]) if obj.get("nutanixFSParams") is not None else None,
