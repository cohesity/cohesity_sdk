...
class CreationInfo(BaseModel):
    ...
    """ # noqa: E501
    user_name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the user who created the protection group or recovery.", alias="userName")
