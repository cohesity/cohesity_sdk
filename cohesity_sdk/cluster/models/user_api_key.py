...
class UserAPIKey(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdByUserSid", "createdByUsername", "createdTimeMsecs", "expiryTimeMsecs", "id", "isActive", "isExpired", "lastRotatedTimeMsecs", "name", "ownerUsername", "userSid"]
