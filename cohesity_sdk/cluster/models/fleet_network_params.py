...
class FleetNetworkParams(BaseModel):
    """
    Specifies various network params for the fleet.
    """ # noqa: E501
    subnet: Optional[StrictStr] = Field(description="Specifies subnet for the fleet.")
    vpc: Optional[StrictStr] = Field(description="Specifies vpc for the fleet.")
