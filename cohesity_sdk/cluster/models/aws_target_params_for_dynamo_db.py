...
class AwsTargetParamsForDynamoDB(BaseModel):
    ...
    """ # noqa: E501
    encryption_config: Optional[DDBEncryptionConfig] = Field(default=None, alias="encryptionConfig")
    new_source_config: Optional[RecoverAwsDDBNewSourceConfig] = Field(default=None, alias="newSourceConfig")
