...
class AwsTargetParamsForRecoverRedshift(BaseModel):
    """
    Specifies the parameters for an AWS Redshift recovery target.
    """ # noqa: E501
    recovery_target_config: Optional[AwsRedshiftRecoveryTargetConfig] = Field(default=None, alias="recoveryTargetConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoveryTargetConfig": AwsRedshiftRecoveryTargetConfig.from_dict(obj["recoveryTargetConfig"]) if obj.get("recoveryTargetConfig") is not None else None
        })
        return _obj
