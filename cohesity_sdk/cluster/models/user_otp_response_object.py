...
class UserOtpResponseObject(BaseModel):
    """
    Returns a Boolean Indicating Status With User Details.
    """ # noqa: E501
    success: StrictBool = Field(description="Specifies whether the Operation Was Successful.")
    user_details: UserDetails = Field(alias="userDetails")
    __properties: ClassVar[List[str]] = ["success", "userDetails"]
