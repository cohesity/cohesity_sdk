...
class AwsTargetParamsForRecoverRDSOracle(BaseModel):
    """
    Specifies the parameters for an AWS RDS Oracle recovery target.
    """ # noqa: E501
    recovery_target_config: Optional[AwsRDSOracleRecoveryTargetConfig] = Field(default=None, alias="recoveryTargetConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recoveryTargetConfig": AwsRDSOracleRecoveryTargetConfig.from_dict(obj["recoveryTargetConfig"]) if obj.get("recoveryTargetConfig") is not None else None
        })
        return _obj
