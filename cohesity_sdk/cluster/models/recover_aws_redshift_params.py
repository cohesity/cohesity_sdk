...
class RecoverAwsRedshiftParams(BaseModel):
    """
    Specifies the parameters to recover Redshift.
    """ # noqa: E501
    aws_target_params: AwsTargetParamsForRecoverRedshift = Field(alias="awsTargetParams")
    snapshots: Optional[List[RecoverAwsRedshiftSnapshotParams]] = Field(default=None, description="Specifies the details of the aws redshift objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverRedshift.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
            "snapshots": [RecoverAwsRedshiftSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
