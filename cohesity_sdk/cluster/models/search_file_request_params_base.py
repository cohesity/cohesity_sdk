...
class SearchFileRequestParamsBase(BaseModel):
    """
    ...
    def source_environments_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['kVMware', 'kHyperV', 'kSQL', 'kView', 'kRemoteAdapter', 'kPhysical', 'kPhysicalFiles', 'kPure', 'kIbmFlashSystem', 'kAzure', 'kNetapp', 'kNutanixFS', 'kGenericNas', 'kAcropolis', 'kIsilon', 'kGPFS', 'kKVM', 'kAWS', 'kExchange', 'kOracle', 'kGCP', 'kFlashBlade', 'kO365', 'kHyperFlex', 'kKubernetes', 'kElastifile', 'kS3Compatible', 'kSAPHANA', 'kUDA', 'kSfdc', 'kExperimentalAdapter', 'kMongoDBPhysical', 'kGoogleWorkspace', 'kDB2', 'kServiceNow', 'kPostgres']):
                raise ValueError("each list item must be one of ('kVMware', 'kHyperV', 'kSQL', 'kView', 'kRemoteAdapter', 'kPhysical', 'kPhysicalFiles', 'kPure', 'kIbmFlashSystem', 'kAzure', 'kNetapp', 'kNutanixFS', 'kGenericNas', 'kAcropolis', 'kIsilon', 'kGPFS', 'kKVM', 'kAWS', 'kExchange', 'kOracle', 'kGCP', 'kFlashBlade', 'kO365', 'kHyperFlex', 'kKubernetes', 'kElastifile', 'kS3Compatible', 'kSAPHANA', 'kUDA', 'kSfdc', 'kExperimentalAdapter', 'kMongoDBPhysical', 'kGoogleWorkspace', 'kDB2', 'kServiceNow', 'kPostgres')")
        return value
    ...
    def types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['File', 'Directory', 'Symlink', 'OneNoteNotebook']):
                raise ValueError("each list item must be one of ('File', 'Directory', 'Symlink', 'OneNoteNotebook')")
        return value
