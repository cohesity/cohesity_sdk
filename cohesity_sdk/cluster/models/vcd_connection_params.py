...
class VcdConnectionParams(BaseModel):
    """
    ...
    host: Optional[StrictStr] = Field(description="IP or hostname of the source.")
    __properties: ClassVar[List[str]] = ["password", "username", "host"]
