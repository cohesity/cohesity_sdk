...
class AwsDocumentDBEntityMetadata(BaseModel):
    """
    ...
    metadata_list: List[AwsDocumentDBMetadata] = Field(description="Specifies the metadata list.", alias="metadataList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadataList": [AwsDocumentDBMetadata.from_dict(_item) for _item in obj["metadataList"]] if obj.get("metadataList") is not None else None
        })
        return _obj
