...
class NutanixFSRegistrationParams(BaseModel):
    """
    ...
    endpoint: Optional[StrictStr] = Field(description="Specifies the Hostname or IP Address Endpoint for the NutanixFS Source.")
    ...
    source_type: Optional[StrictStr] = Field(description="Specifies the NutanixFS source type. Can be either kPrismCentral or kPrismElement or kFileServer or kMountTarget.", alias="sourceType")
    ...
    def source_type_validate_enum(cls, value):
        ...
        if value not in set(['kPrismCentral', 'kPrismElement', 'kFileServer', 'kMountTarget']):
            raise ValueError("must be one of enum values ('kPrismCentral', 'kPrismElement', 'kFileServer', 'kMountTarget')")
        return value
