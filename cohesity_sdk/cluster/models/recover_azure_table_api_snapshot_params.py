...
class RecoverAzureTableAPISnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_azure_table_api_object_params
        if self.recover_azure_table_api_object_params:
            _dict['recoverAzureTableAPIObjectParams'] = self.recover_azure_table_api_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverAzureTableAPIObjectParams": AzureDbObjectRecoveryParams.from_dict(obj["recoverAzureTableAPIObjectParams"]) if obj.get("recoverAzureTableAPIObjectParams") is not None else None
        })
        return _obj
