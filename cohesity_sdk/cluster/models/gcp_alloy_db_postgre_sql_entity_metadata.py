...
class GcpAlloyDBPostgreSQLEntityMetadata(BaseModel):
    """
    Specifies the entity metadata of GCP AlloyDB PostgreSQL entities.
    """ # noqa: E501
    metadata_list: List[GcpAlloyDBPostgreSQLMetadata] = Field(description="Specifies the metadata list.", alias="metadataList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadataList": [GcpAlloyDBPostgreSQLMetadata.from_dict(_item) for _item in obj["metadataList"]] if obj.get("metadataList") is not None else None
        })
        return _obj
