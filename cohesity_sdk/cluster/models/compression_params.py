...
class CompressionParams(BaseModel):
    ...
    """ # noqa: E501
    inline_enabled: Optional[StrictBool] = Field(default=None, description="Specifies whether inline compression is enabled. This field is appliciable only if inlineDeduplicationEnabled is set to true and compression is enabled.", alias="inlineEnabled")
    type: Optional[StrictStr] = Field(default=None, description="Specifies copmpression type for a Storage Domain.")
    __properties: ClassVar[List[str]] = ["inlineEnabled", "type"]
