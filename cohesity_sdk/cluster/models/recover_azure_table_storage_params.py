...
class RecoverAzureTableStorageParams(BaseModel):
    """
    Specifies the parameters to recover Azure Table Storage.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureTableStorage] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureTableStorageSnapshotParams]] = Field(description="Specifies the details of the azure table storage objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureTableStorage.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureTableStorageSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
