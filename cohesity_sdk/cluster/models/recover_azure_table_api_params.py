...
class RecoverAzureTableAPIParams(BaseModel):
    """
    Specifies the parameters to recover Azure Table API.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureTableAPI] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureTableAPISnapshotParams]] = Field(description="Specifies the details of the azure table api objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureTableAPI.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureTableAPISnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
