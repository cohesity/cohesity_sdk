...
class TimeWindow(BaseModel):
    ...
    """ # noqa: E501
    day_of_the_week: Optional[StrictStr] = Field(default=None, description="Specifies the week day.", alias="dayOfTheWeek")
    end_time: Optional[Time] = Field(default=None, alias="endTime")
    start_time: Optional[Time] = Field(default=None, alias="startTime")
    __properties: ClassVar[List[str]] = ["dayOfTheWeek", "endTime", "startTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endTime": Time.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
