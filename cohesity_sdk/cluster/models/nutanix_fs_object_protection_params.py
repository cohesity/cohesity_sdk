...
class NutanixFSObjectProtectionParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backupExistingSnapshot", "continuousSnapshots", "excludeObjectIds", "nfsVersionPreference", "protocol", "snapshotLabel"]
