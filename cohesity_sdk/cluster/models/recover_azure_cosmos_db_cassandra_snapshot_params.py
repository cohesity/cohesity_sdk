...
class RecoverAzureCosmosDBCassandraSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_azure_cosmos_db_cassandra_object_params
        if self.recover_azure_cosmos_db_cassandra_object_params:
            _dict['recoverAzureCosmosDBCassandraObjectParams'] = self.recover_azure_cosmos_db_cassandra_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverAzureCosmosDBCassandraObjectParams": AzureDbObjectRecoveryParams.from_dict(obj["recoverAzureCosmosDBCassandraObjectParams"]) if obj.get("recoverAzureCosmosDBCassandraObjectParams") is not None else None
        })
        return _obj
