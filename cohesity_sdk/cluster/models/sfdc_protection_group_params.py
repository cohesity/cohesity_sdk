...
class SfdcProtectionGroupParams(BaseModel):
    """
    Specifies the parameters to create SFDC Protection Group.
    """ # noqa: E501
    objects: Optional[Annotated[List[SfdcProtectionGroupObjectParams], Field(min_length=1)]] = Field(description="Specifies the list of objects to be protected.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [SfdcProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
