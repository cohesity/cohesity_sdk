...
class BigQueryProtectionGroupParams(BaseModel):
    """
    ...
    cloud_storage_bucket_name: StrictStr = Field(description="The Google Cloud Storage bucket name for BigQuery backup.", alias="cloudStorageBucketName")
    ...
    objects: Optional[List[BigQueryProtectionGroupObjectParams]] = Field(default=None, description="Specifies the BigQuery datasets to be included in the Protection Group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [BigQueryProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
