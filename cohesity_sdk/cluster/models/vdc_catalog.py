...
class VdcCatalog(BaseModel):
    """
    Specifies a VDC Catalog.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Specifies the name of the catalog.")
    uuid: Optional[StrictStr] = Field(description="Specifies the UUID of the catalog.")
