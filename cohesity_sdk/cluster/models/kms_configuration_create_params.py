...
class KmsConfigurationCreateParams(BaseModel):
    ...
    gcp_kms_params: Optional[GcpKmsConfiguration] = Field(default=None, alias="gcpKmsParams")
    ...
    __properties: ClassVar[List[str]] = ["externalTargetIds", "kmipKmsParams", "name", "storageDomainIds", "awsKmsParams", "gcpKmsParams", "ibmKmsParams", "ownershipContext", "type", "usageType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gcpKmsParams": GcpKmsConfiguration.from_dict(obj["gcpKmsParams"]) if obj.get("gcpKmsParams") is not None else None,
