...
class ExchangeCaCertificatesResponse(BaseModel):
    """
    Specifies the response of exchange ca certificate request
    """ # noqa: E501
    ca_certificates: Optional[List[StrictStr]] = Field(default=None, description="Specifies ca cert in pem format", alias="caCertificates")
