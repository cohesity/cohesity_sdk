...
class PreCheckValidation(BaseModel):
    """
    Specifies details of pre-check validations.
    """ # noqa: E501
    is_passed: Optional[StrictBool] = Field(default=None, description="Specifies validation passed or failed", alias="isPassed")
    message: Optional[StrictStr] = Field(default=None, description="Specifies the validation failure message")
    validation: Optional[StrictStr] = Field(default=None, description="Specifies validation type")
    __properties: ClassVar[List[str]] = ["isPassed", "message", "validation"]
