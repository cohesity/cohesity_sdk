...
class AzureTargetParamsForRecoverAzureBlobStorage(BaseModel):
    """
    ...
    new_source_config: Optional[RecoverAzureBlobStorageNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    ...
    preserve_object_attributes: Optional[StrictBool] = Field(default=None, description="Specifies if we should preserve object attributes at the time of restore.", alias="preserveObjectAttributes")
    ...
    __properties: ClassVar[List[str]] = ["continueOnError", "newSourceConfig", "objectPrefix", "overwriteExisting", "preserveObjectAttributes", "recoverToNewSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if preserve_object_attributes (nullable) is None
        # and model_fields_set contains the field
        if self.preserve_object_attributes is None and "preserve_object_attributes" in self.model_fields_set:
            _dict['preserveObjectAttributes'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newSourceConfig": RecoverAzureBlobStorageNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
            "objectPrefix": obj.get("objectPrefix"),
            "overwriteExisting": obj.get("overwriteExisting"),
            "preserveObjectAttributes": obj.get("preserveObjectAttributes"),
