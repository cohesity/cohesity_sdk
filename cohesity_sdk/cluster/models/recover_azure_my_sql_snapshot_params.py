...
class RecoverAzureMySQLSnapshotParams(BaseModel):
    ...
    recover_azure_mysql_object_params: Optional[AzureDbObjectRecoveryParams] = Field(default=None, alias="recoverAzureMysqlObjectParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverAzureMysqlObjectParams": AzureDbObjectRecoveryParams.from_dict(obj["recoverAzureMysqlObjectParams"]) if obj.get("recoverAzureMysqlObjectParams") is not None else None
        })
        return _obj
