...
class CustomTagParams(BaseModel):
    """
    Specifies tag information of custom tags to be applied to various resources when converting and deploying a VM to AWS.
    """ # noqa: E501
    key: Optional[StrictStr] = Field(description="Specifies key of the custom tag.")
    value: Optional[StrictStr] = Field(description="Specifies value of the custom tag.")
