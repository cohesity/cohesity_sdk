...
class ObjectLocalSnapshotInfo(BaseModel):
    """
    ...
    snapshot_id: Optional[StrictStr] = Field(default=None, description="Specifies the id of the local snapshot for the object.", alias="snapshotId")
    __properties: ClassVar[List[str]] = ["logicalSizeBytes", "snapshotId"]
