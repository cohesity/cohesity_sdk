...
class SearchExchangeObjectsRequestParams(BaseModel):
    """
    Specifies the parameters which are specific for searching Exchange mailboxes.
    """ # noqa: E501
    search_string: Optional[StrictStr] = Field(description="Specifies the search string to search the Exchange Objects", alias="searchString")
