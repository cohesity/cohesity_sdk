...
class RecoverKvmVmNewNetworkConfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vnic_profile
        if self.vnic_profile:
            _dict['vnicProfile'] = self.vnic_profile.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vnicProfile": RecoveryObjectIdentifier.from_dict(obj["vnicProfile"]) if obj.get("vnicProfile") is not None else None
        })
        return _obj
