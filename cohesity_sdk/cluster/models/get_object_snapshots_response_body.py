...
class GetObjectSnapshotsResponseBody(BaseModel):
    """
    Specifies the list of object snapshots.
    """ # noqa: E501
    snapshots: Optional[List[ObjectSnapshot]] = Field(default=None, description="Specifies the list of snapshots.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "snapshots": [ObjectSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
