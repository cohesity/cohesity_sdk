...
class ChangeServicesStatesResult(BaseModel):
    """
    Specifies the result returned after a successful request to change the state of services running on the Cluster
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Specifies a description of the result of the operation")
