...
class UserSessionsCount(BaseModel):
    """
    Specifies the sessions count for a user.
    """ # noqa: E501
    sessions_count: Optional[StrictInt] = Field(default=None, description="Specifies the number of sessions for the user.", alias="sessionsCount")
    sid: Optional[StrictStr] = Field(default=None, description="Specifies the user sid.")
    __properties: ClassVar[List[str]] = ["sessionsCount", "sid"]
