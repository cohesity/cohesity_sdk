...
class ReplicationConfig(BaseModel):
    ...
    remote_target_config: Optional[RemoteTargetConfig] = Field(default=None, alias="remoteTargetConfig")
    ...
    __properties: ClassVar[List[str]] = ["backupRunType", "configId", "copyOnRunSuccess", "logRetention", "retention", "runTimeouts", "schedule", "awsTargetConfig", "azureTargetConfig", "remoteTargetConfig", "targetType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remoteTargetConfig": RemoteTargetConfig.from_dict(obj["remoteTargetConfig"]) if obj.get("remoteTargetConfig") is not None else None,
