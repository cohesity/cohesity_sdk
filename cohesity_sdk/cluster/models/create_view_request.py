...
class CreateViewRequest(BaseModel):
    ...
    storage_domain_id: Optional[StrictInt] = Field(description="Specifies the id of the Storage Domain (View Box) where the View will be created.", alias="storageDomainId")
