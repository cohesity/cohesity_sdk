...
class GCPTargetParamsForRecoverGCPPostgreSQL(BaseModel):
    """
    Specifies the recovery target params for Google PostgreSQL target config.
    """ # noqa: E501
    new_source_config: Optional[RecoverGCPPostgreSQLNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newSourceConfig": RecoverGCPPostgreSQLNewSourceConfig.from_dict(obj["newSourceConfig"]) if obj.get("newSourceConfig") is not None else None,
