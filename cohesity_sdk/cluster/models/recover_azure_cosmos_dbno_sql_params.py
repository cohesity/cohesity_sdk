...
class RecoverAzureCosmosDBNoSQLParams(BaseModel):
    """
    Specifies the parameters to recover Azure CosmosDB NoSQL.
    """ # noqa: E501
    azure_target_params: Optional[AzureTargetParamsForRecoverAzureCosmosDBNoSQL] = Field(default=None, alias="azureTargetParams")
    snapshots: Optional[List[RecoverAzureCosmosDBNoSQLSnapshotParams]] = Field(description="Specifies the details of the azure cosmosdb nosql objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "azureTargetParams": AzureTargetParamsForRecoverAzureCosmosDBNoSQL.from_dict(obj["azureTargetParams"]) if obj.get("azureTargetParams") is not None else None,
            "snapshots": [RecoverAzureCosmosDBNoSQLSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
