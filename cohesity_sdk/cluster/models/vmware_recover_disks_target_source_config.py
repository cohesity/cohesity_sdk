...
class VmwareRecoverDisksTargetSourceConfig(ModelNormal):
    ...
    def __init__(self, disks, source_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            source_name (str, none_type): Specifies the source name of the VM to which the disks will be restored.. [optional]  # noqa: E501
            target (str, none_type): Specifies the name of the vm to which the disks will be restored.. [optional]  # noqa: E501
        """
