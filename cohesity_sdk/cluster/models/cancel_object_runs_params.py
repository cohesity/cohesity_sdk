...
class CancelObjectRunsParams(BaseModel):
    ...
    def snapshot_backend_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['kAWSNative', 'kAWSSnapshotManager', 'kPhysical', 'kSQL', 'kOracle', 'kRDSSnapshotManager', 'kRDSPostgresSnapshotManager', 'kRDSMySQLSnapshotManager', 'kRDSMSSQLSnapshotManager', 'kRDSOracleSnapshotManager', 'kRDSMariaDBSnapshotManager', 'kRDSCustomMSSQLSnapshotManager', 'kRDSCustomOracleSnapshotManager', 'kAuroraSnapshotManager', 'kAuroraPostgresSnapshotManager', 'kAuroraMySQLSnapshotManager', 'kAwsS3', 'kAwsRDSPostgresBackup', 'kAzureNative', 'kAzureSnapshotManager', 'kAzureSQL', 'kAwsAuroraPostgres', 'kAwsRDSPostgres', 'kAWSMySQL', 'kAWSRdsOracle', 'kAWSDocumentDB', 'kAzureEntraID', 'kAzureMySQL', 'kAzureCosmosDBNoSQL', 'kAzureCosmosDBMongoDB', 'kAzureCosmosDBCassandra', 'kAzurePostgreSQLServer', 'kAzureSQLDB', 'kAzureSQLMI', 'kAzureTableStorage', 'kAzureBlobStorage', 'kAzureTableAPI', 'kAwsDynamoDB', 'kO365Exchange', 'kO365OneDrive', 'kAWSAuroraMySQL', 'kAWSRDSPostgresDB', 'kAWSAuroraPostgresDB', 'kNutanixFS', 'kAWSRDSMSSQL', 'kAWSRedshift']):
                raise ValueError("each list item must be one of ('kAWSNative', 'kAWSSnapshotManager', 'kPhysical', 'kSQL', 'kOracle', 'kRDSSnapshotManager', 'kRDSPostgresSnapshotManager', 'kRDSMySQLSnapshotManager', 'kRDSMSSQLSnapshotManager', 'kRDSOracleSnapshotManager', 'kRDSMariaDBSnapshotManager', 'kRDSCustomMSSQLSnapshotManager', 'kRDSCustomOracleSnapshotManager', 'kAuroraSnapshotManager', 'kAuroraPostgresSnapshotManager', 'kAuroraMySQLSnapshotManager', 'kAwsS3', 'kAwsRDSPostgresBackup', 'kAzureNative', 'kAzureSnapshotManager', 'kAzureSQL', 'kAwsAuroraPostgres', 'kAwsRDSPostgres', 'kAWSMySQL', 'kAWSRdsOracle', 'kAWSDocumentDB', 'kAzureEntraID', 'kAzureMySQL', 'kAzureCosmosDBNoSQL', 'kAzureCosmosDBMongoDB', 'kAzureCosmosDBCassandra', 'kAzurePostgreSQLServer', 'kAzureSQLDB', 'kAzureSQLMI', 'kAzureTableStorage', 'kAzureBlobStorage', 'kAzureTableAPI', 'kAwsDynamoDB', 'kO365Exchange', 'kO365OneDrive', 'kAWSAuroraMySQL', 'kAWSRDSPostgresDB', 'kAWSAuroraPostgresDB', 'kNutanixFS', 'kAWSRDSMSSQL', 'kAWSRedshift')")
        return value
