...
class GoogleWorkspaceProtectionGroupParams(BaseModel):
    """
    ...
    google_drive_protection_type_params: Optional[Dict[str, Any]] = Field(default=None, description="Specifies the parameters which are specific to Google Workspace Google Drive related Protection Groups.", alias="googleDriveProtectionTypeParams")
    indexing_policy: Optional[IndexingPolicy] = Field(default=None, alias="indexingPolicy")
    objects: Annotated[List[GoogleWorkspaceProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    protection_types: Optional[StrictStr] = Field(description="Specifies the Google Workspace Protection Group types.", alias="protectionTypes")
    ...
    __properties: ClassVar[List[str]] = ["excludeObjectIds", "googleDriveProtectionTypeParams", "indexingPolicy", "objects", "protectionTypes", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "googleDriveProtectionTypeParams": obj.get("googleDriveProtectionTypeParams"),
            "indexingPolicy": IndexingPolicy.from_dict(obj["indexingPolicy"]) if obj.get("indexingPolicy") is not None else None,
            "objects": [GoogleWorkspaceProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
