...
class S3CompatibleProtectionGroupParams(BaseModel):
    """
    ...
    objects: Annotated[List[S3CompatibleProtectionGroupObjectParams], Field(min_length=1)] = Field(description="Specifies the objects to be included in the Protection Group.")
    protection_type: Optional[StrictStr] = Field(default=None, description="Specifies the S3 Compatible Protection type.", alias="protectionType")
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the parent id of the objects being protected.", alias="sourceId")
    source_name: Optional[StrictStr] = Field(default=None, description="Specifies the parent source name of the objects being protected.", alias="sourceName")
    __properties: ClassVar[List[str]] = ["backupObjectLevelACLs", "objects", "protectionType", "sourceId", "sourceName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [S3CompatibleProtectionGroupObjectParams.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
