...
class AzureSourceUnRegisterParams(BaseModel):
    """
    Specifies the paramaters to unregister an Azure source when source was registered using Express Mode.
    """ # noqa: E501
    graph_access_token: Optional[StrictStr] = Field(default=None, description="Specifies the graph access token for using Azure graph API.", alias="graphAccessToken")
    management_access_token: Optional[StrictStr] = Field(default=None, description="Specifies the management access token for using Azure management API.", alias="managementAccessToken")
    __properties: ClassVar[List[str]] = ["graphAccessToken", "managementAccessToken"]
