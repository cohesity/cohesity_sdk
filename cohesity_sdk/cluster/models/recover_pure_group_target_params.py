...
class RecoverPureGroupTargetParams(BaseModel):
    ...
    """ # noqa: E501
    new_source_config: Optional[RecoverPureSanGroupNewSourceConfig] = Field(default=None, alias="newSourceConfig")
    original_source_config: Optional[RecoverPureSanGroupOriginalSourceConfig] = Field(default=None, alias="originalSourceConfig")
