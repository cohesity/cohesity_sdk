...
class ClusterOperationAttribute(ModelNormal):
    ...
    allowed_values = {
        ('name',): {
            'KUPGRADEPACKAGENAME': "kUpgradePackageName",
            'KPATCHPACKAGENAME': "kPatchPackageName",
            'KPACKAGETYPE': "kPackageType",
            'KPACKAGESUBTYPE': "kPackageSubType",
        },
    }
    ...
    def __init__(self, name, value, *args, **kwargs):  # noqa: E501
        """ClusterOperationAttribute - a model defined in OpenAPI
