...
class ExchangeEnvJobParams(BaseModel):
    """
    Specifies job parameters applicable for all 'kExchange' Environment type Protection Sources in a Protection Job.
    """ # noqa: E501
    backups_copy_only: Optional[StrictBool] = Field(default=None, alias="backupsCopyOnly")
    __properties: ClassVar[List[str]] = ["backupsCopyOnly"]
