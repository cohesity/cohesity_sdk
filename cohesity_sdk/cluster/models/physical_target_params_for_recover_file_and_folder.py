...
class PhysicalTargetParamsForRecoverFileAndFolder(BaseModel):
    ...
    restore_exclusion_param: Optional[List[StrictStr]] = Field(default=None, description="Specifies list of exclusions that needs to be applicable for the current file level restores. Applicable only for file level restores.", alias="restoreExclusionParam")
    ...
    __properties: ClassVar[List[str]] = ["alternateRestoreDirectory", "continueOnError", "mountCredentials", "overwriteExisting", "preserveAcls", "preserveAttributes", "preserveTimestamps", "recoverTarget", "restoreEntityType", "restoreExclusionParam", "restoreToOriginalPaths", "saveSuccessFiles", "vlanConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if restore_exclusion_param (nullable) is None
        # and model_fields_set contains the field
        if self.restore_exclusion_param is None and "restore_exclusion_param" in self.model_fields_set:
            _dict['restoreExclusionParam'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restoreExclusionParam": obj.get("restoreExclusionParam"),
