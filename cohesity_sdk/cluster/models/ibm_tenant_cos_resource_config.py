...
class IbmTenantCOSResourceConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    resource_url: Optional[StrictStr] = Field(default=None, description="Specifies the resource COS resource configuration endpoint that will be used for fetching bucket usage for a given tenant.", alias="resourceURL")
    __properties: ClassVar[List[str]] = ["resourceURL"]
