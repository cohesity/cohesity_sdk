...
def lazy_import():
    ...
    from cohesity_sdk.cluster.models.create_view_all_of import CreateViewAllOf
    ...
    globals()['ViewProtectionConfig'] = ViewProtectionConfig
...
class CreateView(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, storage_domain_id, category, protocol_access, *args, **kwargs):  # noqa: E501
