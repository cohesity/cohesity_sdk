...
class ClusterCustomMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Specifies the key for the customer cluster metadata.")
    value: Optional[StrictStr] = Field(default=None, description="Specifies the value for the above key.")
