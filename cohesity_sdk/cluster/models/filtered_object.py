...
class FilteredObject(BaseModel):
    """
    Specifies the filter details.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Specifies object id.")
    source_id: Optional[StrictInt] = Field(default=None, description="Specifies the source id to which this object belongs to.", alias="sourceId")
    __properties: ClassVar[List[str]] = ["id", "sourceId"]
