...
class SourceHierarchyObjectSummary(BaseModel):
    """
    ...
    parent_id: Optional[StrictInt] = Field(default=None, description="Specifies the ID of the direct parent of this object in the source hierarchy.", alias="parentId")
    __properties: ClassVar[List[str]] = ["entityId", "environment", "id", "name", "sourceId", "sourceName", "childObjects", "globalId", "logicalSizeBytes", "objectHash", "objectType", "osType", "protectionType", "sharepointSiteSummary", "uuid", "vCenterSummary", "windowsClusterSummary", "parentId"]
