...
def lazy_import():
    ...
    from cohesity_sdk.cluster.models.added_active_directory_principal_all_of import AddedActiveDirectoryPrincipalAllOf
    globals()['AddActiveDirectoryPrincipalsParameters'] = AddActiveDirectoryPrincipalsParameters
