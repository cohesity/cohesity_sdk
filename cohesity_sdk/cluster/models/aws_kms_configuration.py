...
class AwsKmsConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accessKeyId", "caCertificate", "iamRoleArn", "secretAccessKey", "verifySSL", "cmkAlias", "cmkArn", "cmkKeyId", "region"]
