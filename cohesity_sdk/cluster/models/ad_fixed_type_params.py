...
class AdFixedTypeParams(BaseModel):
    """
    Specifies the properties accociated to a Fixed type user id mapping.
    """ # noqa: E501
    gid: Optional[StrictInt] = Field(description="Specifies the fixed Unix GID, when mapping type is set to kFixed.")
    uid: Optional[StrictInt] = Field(description="Specifies the fixed Unix UID, when mapping type is set to kFixed.")
    __properties: ClassVar[List[str]] = ["gid", "uid"]
