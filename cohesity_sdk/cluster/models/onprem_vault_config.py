...
def lazy_import():
    ...
    from cohesity_sdk.cluster.models.onprem_vault_config_all_of import OnpremVaultConfigAllOf
    ...
    globals()['OnpremVaultConfigAllOf'] = OnpremVaultConfigAllOf
    globals()['Retention'] = Retention
    globals()['TargetSchedule'] = TargetSchedule


class OnpremVaultConfig(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, retention, schedule, cluster_id, *args, **kwargs):  # noqa: E501
        """OnpremVaultConfig - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cluster_name (str, none_type): Specifies the cluster name of the vault cluster.. [optional]  # noqa: E501
        """
