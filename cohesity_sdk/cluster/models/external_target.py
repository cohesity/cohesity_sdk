...
def lazy_import():
    ...
    from cohesity_sdk.cluster.models.external_target_all_of import ExternalTargetAllOf
...
class ExternalTarget(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'enable_object_lock': (bool, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'enable_object_lock': 'enableObjectLock',  # noqa: E501
    ...
    def __init__(self, name, purpose_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enable_object_lock (bool, none_type): Whether to enable object lock for this vault. If this field is set, all the objects written to the vault will be object locked until all the archives referring to them expire.. [optional]  # noqa: E501
