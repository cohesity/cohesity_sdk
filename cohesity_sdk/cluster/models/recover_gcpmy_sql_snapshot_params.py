...
class RecoverGCPMySqlSnapshotParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of recover_gcp_my_sql_object_params
        if self.recover_gcp_my_sql_object_params:
            _dict['recoverGcpMySqlObjectParams'] = self.recover_gcp_my_sql_object_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recoverGcpMySqlObjectParams": RecoverGcpObjectParams.from_dict(obj["recoverGcpMySqlObjectParams"]) if obj.get("recoverGcpMySqlObjectParams") is not None else None
        })
        return _obj
