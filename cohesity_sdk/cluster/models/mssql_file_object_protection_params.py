...
class MssqlFileObjectProtectionParams(BaseModel):
    ...
    objects: Optional[Annotated[List[MssqlFileObjectProtection], Field(min_length=1)]] = Field(description="Specifies the list of objects to be protected.")
    __properties: ClassVar[List[str]] = ["aagBackupPreferenceType", "advancedSettings", "backupSystemDbs", "excludeFilters", "fullBackupsCopyOnly", "logBackupNumStreams", "logBackupWithClause", "prePostScript", "useAagPreferencesFromServer", "userDbBackupPreferenceType", "objects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objects": [MssqlFileObjectProtection.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
        return _obj
