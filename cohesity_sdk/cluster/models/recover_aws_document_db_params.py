...
class RecoverAWSDocumentDBParams(BaseModel):
    """
    Specifies the parameters to recover AWS DocumentDB.
    """ # noqa: E501
    aws_target_params: Optional[AwsTargetParamsForRecoverDocumentDB] = Field(default=None, alias="awsTargetParams")
    snapshots: Optional[List[RecoverAwsDocumentDBSnapshotParams]] = Field(description="Specifies the details of the AWS DocumentDB objects to be recovered.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsTargetParams": AwsTargetParamsForRecoverDocumentDB.from_dict(obj["awsTargetParams"]) if obj.get("awsTargetParams") is not None else None,
            "snapshots": [RecoverAwsDocumentDBSnapshotParams.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
