...
class RecoverNetappParams(BaseModel):
    ...
    recover_file_and_folder_params: Optional[RecoverNetappFilesParams] = Field(default=None, alias="recoverFileAndFolderParams")
    recover_nas_volume_params: Optional[RecoverNetappNasVolumeParams] = Field(default=None, alias="recoverNasVolumeParams")
