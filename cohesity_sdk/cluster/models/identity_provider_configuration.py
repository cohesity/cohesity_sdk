...
class IdentityProviderConfiguration(BaseModel):
    ...
    domain: Optional[StrictStr] = Field(default=None, description="Specifies domain of idp configuration")
    id: Optional[StrictInt] = Field(default=None, description="Specifies id of idp configuration")
    name: Optional[StrictStr] = Field(default=None, description="Specifies name of the vendor providing idp service")
    ...
    __properties: ClassVar[List[str]] = ["allowLocalUserLogin", "certificate", "certificateFilename", "isEnabled", "issuerId", "roles", "samlAttributeName", "signRequest", "ssoUrl", "domain", "id", "name", "tenantId"]
