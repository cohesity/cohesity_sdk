...
class VmwareObjectProtectionResponseParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["excludeDisks", "includeDisks", "truncateExchangeLogs", "cdpInfo", "excludeObjectIds", "standbyInfo", "appConsistentSnapshot", "enableNBDSSLFallback", "fallbackToCrashConsistentSnapshot", "indexingPolicy", "leverageSanTransport", "prePostScript", "skipPhysicalRDMDisks", "globalIncludeDisks"]
