...
class RegisterRemoteClusterParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["nodeAddresses", "password", "username", "autoRegisterTarget", "clusterId", "clusterIncarnationId", "clusterName", "description", "effectiveAesEncryptionMode", "isAutoRegistered", "localAddresses", "multiTenancyEnabled", "networkInterface", "purpose", "replicationParams", "supportedAesEncryptionMode", "tenantId", "tenantStorageDomainSharingEnabled", "tlsEnabled"]
