...
class RecoverGCPBigQueryNewSourceConfig(BaseModel):
    """
    Specifies the configuration for recovering GCP BigQuery dataset to the new target.
    """ # noqa: E501
    source: RecoveryObjectIdentifier
    target_region: Optional[RecoveryObjectIdentifier] = Field(default=None, alias="targetRegion")
    __properties: ClassVar[List[str]] = ["source", "targetRegion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of target_region
        if self.target_region:
            _dict['targetRegion'] = self.target_region.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetRegion": RecoveryObjectIdentifier.from_dict(obj["targetRegion"]) if obj.get("targetRegion") is not None else None
        })
        return _obj
