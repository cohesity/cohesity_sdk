...
class SapHanaProtectionGroupParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, delta, objects, source_id, *args, **kwargs):  # noqa: E501
        """SapHanaProtectionGroupParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            concurrency (int, none_type): Specifies the maximum number of concurrent IO Streams that will be created to exchange data with the cluster. If not specified, the default value is taken as 1.. [optional] if omitted the server will use the default value of 8  # noqa: E501
