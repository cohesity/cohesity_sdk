...
class CreateGroupsParams(BaseModel):
    """
    Specifies the parameters to add one or more Cohesity groups.
    """ # noqa: E501
    groups: Optional[Annotated[List[CreateGroupParams], Field(min_length=1)]] = Field(default=None, description="Specifies the list of groups to be created.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [CreateGroupParams.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
