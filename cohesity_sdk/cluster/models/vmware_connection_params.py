...
class VmwareConnectionParams(BaseModel):
    """
    ...
    vcd_params: Optional[VcdConnectionParams] = Field(default=None, alias="vcdParams")
    __properties: ClassVar[List[str]] = ["type", "vcdParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "vcdParams": VcdConnectionParams.from_dict(obj["vcdParams"]) if obj.get("vcdParams") is not None else None
        })
        return _obj
