...
class ObjectStoreCiphersResp(BaseModel):
    """
    Specifies a list of enabled/disabled object store ciphers on the cluster.
    """ # noqa: E501
    disabled_ciphers: Optional[List[StrictStr]] = Field(default=None, description="Disabled object store ciphers.", alias="disabledCiphers")
    enabled_ciphers: Optional[List[StrictStr]] = Field(default=None, description="Enabled object store ciphers.", alias="enabledCiphers")
