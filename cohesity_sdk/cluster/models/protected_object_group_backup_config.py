...
class ProtectedObjectGroupBackupConfig(BaseModel):
    """
    Specifies the parameters of a protection group which is protecting an object.
    """ # noqa: E501
    protection_group_id: Optional[StrictStr] = Field(default=None, description="Specifies the protection group id, if given object is also protected by a protection group.", alias="protectionGroupId")
    protection_group_name: Optional[StrictStr] = Field(default=None, description="Specifies the protection group name, if given object is also protected by a protection group.", alias="protectionGroupName")
    __properties: ClassVar[List[str]] = ["protectionGroupId", "protectionGroupName"]
