...
class RecoverS3CompatibleBucketParams(BaseModel):
    ...
    s3_compatible_bucket_restore_filter_policy: Optional[S3CompatibleBucketRestoreFilterPolicy] = Field(default=None, alias="s3CompatibleBucketRestoreFilterPolicy")
    s3_compatible_target_params: Optional[S3CompatibleTargetParams] = Field(default=None, alias="s3CompatibleTargetParams")
