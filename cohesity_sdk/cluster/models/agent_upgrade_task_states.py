...
class AgentUpgradeTaskStates(BaseModel):
    """
    List of agent upgrade tasks.
    """ # noqa: E501
    tasks: Optional[List[AgentUpgradeTaskState]] = Field(default=None, description="Specifies the list of agent upgrade tasks.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tasks": [AgentUpgradeTaskState.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
