...
class ServiceNowApiKeyCredentials(BaseModel):
    """
    Specifies the credentials to register a ServiceNow source
    """ # noqa: E501
    access_key: Optional[StrictStr] = Field(description="Specifies the Access Key for API key authentication.", alias="accessKey")
