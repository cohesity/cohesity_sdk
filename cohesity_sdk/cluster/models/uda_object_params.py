...
class UdaObjectParams(BaseModel):
    """
    Specifies the common parameters for UDA objects.
    """ # noqa: E501
    has_entity_support: Optional[StrictBool] = Field(default=None, description="Specifies whether this Object belongs to a source having entity support.", alias="hasEntitySupport")
    source_type: Optional[StrictStr] = Field(default=None, description="Specifies the source type for Universal Data Adapter object.", alias="sourceType")
    __properties: ClassVar[List[str]] = ["hasEntitySupport", "sourceType"]
