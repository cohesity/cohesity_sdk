...
class ApplicationCredentials(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_environment, *args, **kwargs):  # noqa: E501
        """ApplicationCredentials - a model defined in OpenAPI
