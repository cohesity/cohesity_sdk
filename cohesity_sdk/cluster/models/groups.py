...
class Groups(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[List[GroupParams]] = Field(default=None, description="Specifies the list of groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GroupParams.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
