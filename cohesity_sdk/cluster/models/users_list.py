...
class UsersList(BaseModel):
    ...
    """ # noqa: E501
    users: Optional[List[UserParams]] = Field(default=None, description="Specifies the list of users.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserParams.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
