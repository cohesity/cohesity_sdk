...
class TieringOracleExternalTargetParams(BaseModel):
    """
    ...
    storage_class: Optional[StrictStr] = Field(description="Specifies the Oracle External Target class.", alias="storageClass")
    __properties: ClassVar[List[str]] = ["accessKeyId", "bucketName", "region", "storageAccessKey", "tenancy", "storageClass"]
    ...
    def storage_class_validate_enum(cls, value):
        ...
        if value not in set(['OracleObjectStorage']):
            raise ValueError("must be one of enum values ('OracleObjectStorage')")
        return value
