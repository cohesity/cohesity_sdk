...
class CancelObjectRunsResult(BaseModel):
    """
    Result after canceling object runs.
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Specifies the error message if any error happens.", alias="errorMessage")
    object_id: Optional[StrictInt] = Field(default=None, description="Specifies the id of the object.", alias="objectId")
    __properties: ClassVar[List[str]] = ["errorMessage", "objectId"]
