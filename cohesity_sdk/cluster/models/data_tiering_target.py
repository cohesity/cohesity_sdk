...
class DataTieringTarget(BaseModel):
    """
    Specifies the target data tiering details.
    """ # noqa: E501
    mount_path: Optional[StrictStr] = Field(default=None, description="Specifies the mount path inside the view.", alias="mountPath")
    ...
    view_name: Optional[StrictStr] = Field(description="Specifies the view name.", alias="viewName")
    __properties: ClassVar[List[str]] = ["mountPath", "storageDomainId", "viewName"]
