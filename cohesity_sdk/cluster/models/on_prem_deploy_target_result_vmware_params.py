...
class OnPremDeployTargetResultVmwareParams(BaseModel):
    """
    Specifies information about a VMware OnPrem deploy target.
    """ # noqa: E501
    moref: Optional[MOref] = None
    uuid: Optional[StrictStr] = Field(default=None, description="UUID of the recovered VMware VM")
    __properties: ClassVar[List[str]] = ["moref", "uuid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of moref
        if self.moref:
            _dict['moref'] = self.moref.to_dict()
