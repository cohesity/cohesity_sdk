...
class OracleEnvJobParams(BaseModel):
    """
    Specifies job parameters applicable for all 'kOracle' Environment type Protection Sources in a Protection Job.
    """ # noqa: E501
    persist_mountpoints: Optional[StrictBool] = Field(default=None, description="Specifies whether the mountpoints created while backing up Oracle DBs should be persisted. Note: This parameter is for the entire Job. For overriding persistence of mountpoints for a subset of Oracle hosts within the job, refer OracleSourceParams.", alias="persistMountpoints")
    vlan_params: Optional[VlanParams] = Field(default=None, alias="vlanParams")
    __properties: ClassVar[List[str]] = ["persistMountpoints", "vlanParams"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "persistMountpoints": obj.get("persistMountpoints"),
