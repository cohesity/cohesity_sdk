...
class ReplicationClusterStats(BaseModel):
    """
    Specifies the Replication Cluster Stats.
    """ # noqa: E501
    bytes: Optional[StrictInt] = Field(description="Specifies the total replicated bytes to the cluster.")
    id: Optional[StrictInt] = Field(description="Specifies the cluster Id.")
    __properties: ClassVar[List[str]] = ["bytes", "id"]
