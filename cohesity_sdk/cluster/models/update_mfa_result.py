...
class UpdateMFAResult(BaseModel):
    """
    UpdateMFAResult
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["accountName", "totpSecretKey", "totpUri", "currentPassword", "email", "enabled", "isQuorumManaged", "mfaCode", "mfaType", "otpVerificationState", "referenceId", "requiresPasswordAuth"]
