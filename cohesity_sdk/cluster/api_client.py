...
from cohesity_sdk.cluster.api_response import ApiResponse, T as ApiResponseT
import cohesity_sdk.cluster.models
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cohesity_sdk.cluster.models, klass)
