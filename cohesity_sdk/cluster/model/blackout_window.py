...
class BlackoutWindow(ModelNormal):
    ...
    def __init__(self, day, end_time, start_time, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            config_id (str): Specifies the unique identifier for the target getting added. This field need to be passed olny when policies are updated.. [optional]  # noqa: E501
        """
