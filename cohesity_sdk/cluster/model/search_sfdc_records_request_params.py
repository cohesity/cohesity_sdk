...
class SearchSfdcRecordsRequestParams(ModelNormal):
    ...
    def __init__(self, mutation_types, object_name, snapshot_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            query_string (str): Specifies the query string to search records. Query string can be one or multiples clauses joined together by 'AND' or 'OR' claused.. [optional]  # noqa: E501
        """
