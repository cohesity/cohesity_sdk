...
class ObjectSnapshot(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'has_data_lock': (bool,),  # noqa: E501
            'hyperv_params': (HypervSnapshotParams,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'indexing_status': (str,),  # noqa: E501
            ...
            'protection_group_run_id': (str,),  # noqa: E501
            'region_id': (str,),  # noqa: E501
            'run_instance_id': (int,),  # noqa: E501
            ...
            'snapshot_timestamp_usecs': (int,),  # noqa: E501
            'source_group_id': (str,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cluster_id (int): Specifies the cluster id where this snapshot belongs to.. [optional]  # noqa: E501
            cluster_incarnation_id (int): Specifies the cluster incarnation id where this snapshot belongs to.. [optional]  # noqa: E501
            elastifile_params (CommonNasObjectParams): [optional]  # noqa: E501
            environment (str): Specifies the snapshot environment.. [optional]  # noqa: E501
            expiry_time_usecs (int): Specifies the expiry time of the snapshot in Unix timestamp epoch in microseconds. If the snapshot has no expiry, this property will not be set.. [optional]  # noqa: E501
            ...
            has_data_lock (bool): Specifies if this snapshot has datalock.. [optional]  # noqa: E501
            hyperv_params (HypervSnapshotParams): [optional]  # noqa: E501
            id (str): Specifies the id of the snapshot.. [optional]  # noqa: E501
            indexing_status (str): Specifies the indexing status of objects in this snapshot.<br> 'InProgress' indicates the indexing is in progress.<br> 'Done' indicates indexing is done.<br> 'NoIndex' indicates indexing is not applicable.<br> 'Error' indicates indexing failed with error.. [optional]  # noqa: E501
            isilon_params (IsilonObjectParams): [optional]  # noqa: E501
            netapp_params (NetappObjectParams): [optional]  # noqa: E501
            object_id (int): Specifies the object id which the snapshot is taken from.. [optional]  # noqa: E501
            object_name (str): Specifies the object name which the snapshot is taken from.. [optional]  # noqa: E501
            on_legal_hold (bool): Specifies if this snapshot is on legalhold.. [optional]  # noqa: E501
            ...
            protection_group_id (str): Specifies id of the Protection Group.. [optional]  # noqa: E501
            protection_group_name (str): Specifies name of the Protection Group.. [optional]  # noqa: E501
            protection_group_run_id (str): Specifies id of the Protection Group Run.. [optional]  # noqa: E501
            region_id (str): Specifies the region id where this snapshot belongs to.. [optional]  # noqa: E501
            run_instance_id (int): Specifies the instance id of the protection run which create the snapshot.. [optional]  # noqa: E501
            run_start_time_usecs (int): Specifies the start time of the run in micro seconds.. [optional]  # noqa: E501
            run_type (str): Specifies the type of protection run created this snapshot.. [optional]  # noqa: E501
            sfdc_params (SfdcObjectParams): [optional]  # noqa: E501
            snapshot_target_type (str): Specifies the target type where the Object's snapshot resides.. [optional]  # noqa: E501
            snapshot_timestamp_usecs (int): Specifies the timestamp in Unix time epoch in microseconds when the snapshot is taken for the specified Object.. [optional]  # noqa: E501
            source_group_id (str): Specifies the source protection group id in case of replication.. [optional]  # noqa: E501
            source_id (int): Specifies the object source id which the snapshot is taken from.. [optional]  # noqa: E501
            storage_domain_id (int): Specifies the Storage Domain id where the snapshot of object is present.. [optional]  # noqa: E501
        """
