...
class UpdateExistingArchivalSnapshotConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'archival_target_type': (str,),  # noqa: E501
            'id': (int,),  # noqa: E501
            'data_lock': (str,),  # noqa: E501
            'days_to_keep': (int,),  # noqa: E501
            'delete_snapshot': (bool,),  # noqa: E501
            'enable_legal_hold': (bool,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'resync': (bool,),  # noqa: E501
        }
    ...
    def __init__(self, archival_target_type, id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            delete_snapshot (bool): Specifies whether to delete the snapshot. When this is set to true, all other params will be ignored.. [optional]  # noqa: E501
            ...
            name (str): Specifies the name of the archival target.. [optional]  # noqa: E501
            resync (bool): Specifies whether to retry the archival operation in case if earlier attempt failed. If not specified or set to false, archival is not retried.. [optional]  # noqa: E501
        """
