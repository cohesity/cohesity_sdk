...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.uda_source_registration_params_credentials import (
        UdaSourceRegistrationParamsCredentials,
    )
    from cohesity_sdk.cluster.model.uda_source_registration_params_view_params import (
