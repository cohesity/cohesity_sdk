...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.mssql_native_object_protection import (
        MssqlNativeObjectProtection,
    )
    from cohesity_sdk.cluster.model.mssql_native_object_protection_params_all_of import (
