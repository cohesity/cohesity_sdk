...
def lazy_import():
    from cohesity_sdk.cluster.model.scvmm_registration_params import (
        ScvmmRegistrationParams,
    )
    from cohesity_sdk.cluster.model.standalone_cluster_registration_params import (
        StandaloneClusterRegistrationParams,
    )
    from cohesity_sdk.cluster.model.standalone_host_registration_params import (
