...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.mssql_native_protection_group_object_params import (
        MSSQLNativeProtectionGroupObjectParams,
    )
    from cohesity_sdk.cluster.model.mssql_native_protection_group_params_all_of import (
