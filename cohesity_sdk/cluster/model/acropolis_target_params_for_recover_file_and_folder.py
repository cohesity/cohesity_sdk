...
def lazy_import():
    from cohesity_sdk.cluster.model.acropolis_recover_files_new_target_config import (
        AcropolisRecoverFilesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.acropolis_recover_files_original_target_config import (
