...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_vmware_child_snapshot_params import (
        RecoverVmwareChildSnapshotParams,
    )
    from cohesity_sdk.cluster.model.recover_vmware_snapshot_params_all_of import (
