...
class FileLevelDataLockConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'auto_lock_after_duration_idle_msecs': (int,),  # noqa: E501
            'coexisting_lock_mode': (bool,),  # noqa: E501
            'default_retention_duration_msecs': (int,),  # noqa: E501
            'default_retention_duration_years': (int,),  # noqa: E501
            'expiry_timestamp_msecs': (int,),  # noqa: E501
            'locking_protocol': (str,),  # noqa: E501
            'max_retention_duration_msecs': (int,),  # noqa: E501
            'min_retention_duration_msecs': (int,),  # noqa: E501
            'mode': (str,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            auto_lock_after_duration_idle_msecs (int): Specifies the duration to lock a file that has not been accessed or modified (ie. has been idle) for a certain duration of time in milliseconds. Do not set if it is required to disable auto lock.. [optional]  # noqa: E501
            coexisting_lock_mode (bool): Specified if files in the View can be locked in different modes. This property is immutable and can only be set when enabling File level datalock. If this property is set for an S3 View, S3 bucket Versioning should also be enabled.. [optional]  # noqa: E501
            default_retention_duration_msecs (int): Specifies a global default retention duration for files in this view, if file lock is enabled for this view. Also, it is a required field if file lock is enabled. Set to -1 if the required default retention period is forever.. [optional]  # noqa: E501
            default_retention_duration_years (int): Specifies a global default retention duration in years for files in this view, if file/object lock is enabled for this view.. [optional]  # noqa: E501
            expiry_timestamp_msecs (int): Specifies a definite timestamp in milliseconds for retaining the file.. [optional]  # noqa: E501
            ...
            max_retention_duration_msecs (int): Specifies a maximum duration in milliseconds for which any file in this view can be retained for. Set to -1 if the required retention duration is forever. If set, it should be greater than or equal to the default retention period as well as the min retention period.. [optional]  # noqa: E501
