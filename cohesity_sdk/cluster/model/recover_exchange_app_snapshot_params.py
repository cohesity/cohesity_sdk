...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.exchange_recover_database_params import (
        ExchangeRecoverDatabaseParams,
    )
    from cohesity_sdk.cluster.model.object_summary import ObjectSummary
    from cohesity_sdk.cluster.model.recover_exchange_app_snapshot_params_all_of import (
