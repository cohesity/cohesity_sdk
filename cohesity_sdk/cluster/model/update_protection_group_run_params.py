...
def lazy_import():
    from cohesity_sdk.cluster.model.update_archival_snapshot_config import (
        UpdateArchivalSnapshotConfig,
    )
    from cohesity_sdk.cluster.model.update_local_snapshot_config import (
        UpdateLocalSnapshotConfig,
    )
    from cohesity_sdk.cluster.model.update_replication_snapshot_config import (
