...
class MonthSchedule(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'day_of_week': (list[str],),  # noqa: E501
            'week_of_month': (str,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            day_of_month (int): Specifies the exact date of the month (such as 18) in a Monthly Schedule specified by unit field as 'Years'. <br> Example: if 'dayOfMonth' is set to '18', a backup is performed on the 18th of every month.. [optional]  # noqa: E501
            day_of_week (list[str]): Specifies a list of days of the week when to start Protection Group Runs. <br> Example: To run a Protection Group on every Monday and Tuesday, set the schedule with following values: <br>  unit: 'Weeks' <br>  dayOfWeek: ['Monday','Tuesday']. [optional]  # noqa: E501
