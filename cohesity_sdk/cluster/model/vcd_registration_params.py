...
class VcdRegistrationParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vcenter_credential_info_list': (list[VcenterCredentialInfo],),  # noqa: E501
    ...
    def __init__(self, password, username, endpoint, vcenter_credential_info_list, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            vcenter_credential_info_list (list[VcenterCredentialInfo]): Specifies the credentials information for all the vcenters in vcloud director.
