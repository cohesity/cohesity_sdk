...
class ViewProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[ViewProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[ViewProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
