...
class S3CompatibleSourceRegistrationParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_key_id, endpoint, port, secret_access_key, *args, **kwargs):  # noqa: E501
        """S3CompatibleSourceRegistrationParams - a model defined in OpenAPI
