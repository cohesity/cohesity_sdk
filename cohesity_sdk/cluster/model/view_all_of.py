...
class ViewAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'aliases': (list[ViewAliasInfo],),  # noqa: E501
            'basic_mount_path': (str,),  # noqa: E501
            'case_insensitive_names_enabled': (bool,),  # noqa: E501
            'create_time_msecs': (int,),  # noqa: E501
            'data_lock_expiry_usecs': (int,),  # noqa: E501
            'file_count_by_size': (list[FileCount],),  # noqa: E501
            'intent': (ViewIntent,),  # noqa: E501
            'is_category_inferred': (bool,),  # noqa: E501
            'is_target_for_migrated_data': (bool,),  # noqa: E501
            'nfs_mount_path': (str,),  # noqa: E501
            'nfs_mount_paths': (list[str],),  # noqa: E501
            'object_services_mapping_config': (str,),  # noqa: E501
            'owner_sid': (str,),  # noqa: E501
            's3_folder_support_enabled': (bool,),  # noqa: E501
            'smb_mount_paths': (list[str],),  # noqa: E501
            'stats': (ViewStats,),  # noqa: E501
            'storage_domain_id': (int,),  # noqa: E501
            'storage_domain_name': (str,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aliases (list[ViewAliasInfo]): Aliases created for the view. A view alias allows a directory path inside a view to be mounted using the alias name.. [optional]  # noqa: E501
            basic_mount_path (str): Specifies the NFS mount path of the View (without the hostname information). This path is used to support NFS mounting of the paths specified in the nfsExportPathList on Windows systems.. [optional]  # noqa: E501
            ...
            create_time_msecs (int): Specifies the time that the View was created in milliseconds.. [optional]  # noqa: E501
            data_lock_expiry_usecs (int): DataLock (Write Once Read Many) lock expiry epoch time in microseconds. If a view is marked as a DataLock view, only a Data Security Officer (a user having Data Security Privilege) can delete the view until the lock expiry time.. [optional]  # noqa: E501
            ...
            is_target_for_migrated_data (bool): Specifies if a view contains migrated data.. [optional]  # noqa: E501
            nfs_mount_path (str): This field is currently deprecated. Please use NFS MountPaths which would be an array of strings.. [optional]  # noqa: E501
            nfs_mount_paths (list[str]): Array of NFS Paths. Specifies the path for mounting this View as an NFS share. If Kerberos Provider has multiple hostaliases, each host alias has  its own path.. [optional]  # noqa: E501
            ...
            owner_sid (str): Specifies the sid of the view owner.. [optional]  # noqa: E501
            ...
            smb_mount_paths (list[str]): Array of SMB Paths. Specifies the possible paths that can be used to mount this View as a SMB share. If Active Directory has multiple account names; each machine account has its own path.. [optional]  # noqa: E501
            stats (ViewStats): [optional]  # noqa: E501
            storage_domain_id (int): Specifies the id of the Storage Domain (View Box) where the View is stored.. [optional]  # noqa: E501
            storage_domain_name (str): Specifies the name of the Storage Domain (View Box) where the View is stored.. [optional]  # noqa: E501
            view_failover (ViewFailover): [optional]  # noqa: E501
            view_id (int): Specifies an id of the View assigned by the Cohesity Cluster.. [optional]  # noqa: E501
