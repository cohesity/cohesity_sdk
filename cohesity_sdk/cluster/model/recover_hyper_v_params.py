...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.mount_hyper_v_volume_params import (
        MountHyperVVolumeParams,
    )
    from cohesity_sdk.cluster.model.recover_hyper_v_file_and_folder_params import (
        RecoverHyperVFileAndFolderParams,
    )
    from cohesity_sdk.cluster.model.recover_hyper_vvm_params import (
