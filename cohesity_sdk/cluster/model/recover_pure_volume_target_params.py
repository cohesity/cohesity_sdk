...
def lazy_import():
    from cohesity_sdk.cluster.model.recover_pure_san_volume_new_source_config import (
        RecoverPureSanVolumeNewSourceConfig,
    )
    from cohesity_sdk.cluster.model.recover_pure_san_volume_original_source_config import (
