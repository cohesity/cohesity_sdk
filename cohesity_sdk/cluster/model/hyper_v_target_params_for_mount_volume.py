...
def lazy_import():
    from cohesity_sdk.cluster.model.hyper_v_mount_volumes_new_target_config import (
        HyperVMountVolumesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.hyper_v_mount_volumes_original_target_config import (
