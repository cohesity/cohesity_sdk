...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.vmware_recover_files_new_target_config import (
        VmwareRecoverFilesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.vmware_recover_files_original_target_config import (
