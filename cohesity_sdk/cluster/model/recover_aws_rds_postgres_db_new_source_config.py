...
class RecoverAwsRdsPostgresDbNewSourceConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, region, source, *args, **kwargs):  # noqa: E501
        """RecoverAwsRdsPostgresDbNewSourceConfig - a model defined in OpenAPI
