...
class CommonRecoveryResponseParams(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            can_tear_down (bool): Specifies whether it's possible to tear down the objects created by the recovery.. [optional]  # noqa: E501
            ...
            id (str): Specifies the id of the Recovery.. [optional]  # noqa: E501
            is_multi_stage_restore (bool): Specifies whether the current recovery operation is a multi-stage restore operation. This is currently used by VMware recoveres for the migration/hot-standby use case.. [optional]  # noqa: E501
            is_parent_recovery (bool): Specifies whether the current recovery operation has created child recoveries. This is currently used in SQL recovery where multiple child recoveries can be tracked under a common/parent recovery.. [optional]  # noqa: E501
            messages (list[str]): Specifies messages about the recovery.. [optional]  # noqa: E501
            name (str): Specifies the name of the Recovery.. [optional]  # noqa: E501
            parent_recovery_id (str): If current recovery is child recovery triggered by another parent recovery operation, then this field willt specify the id of the parent recovery.. [optional]  # noqa: E501
            permissions (list[TenantInfo]): Specifies the list of tenants that have permissions for this recovery.. [optional]  # noqa: E501
            progress_task_id (str): Progress monitor task id for Recovery.. [optional]  # noqa: E501
            recovery_action (str): Specifies the type of recover action.. [optional]  # noqa: E501
            retrieve_archive_tasks (list[RetrieveArchiveTask]): Specifies the list of persistent state of a retrieve of an archive task.. [optional]  # noqa: E501
            ...
            tear_down_message (str): Specifies the error message about the tear down operation if it fails.. [optional]  # noqa: E501
