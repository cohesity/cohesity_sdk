...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.nutanix_fs_object_protection_params import NutanixFSObjectProtectionParams
    ...
    globals()['NutanixFSObjectProtectionParams'] = NutanixFSObjectProtectionParams
    globals()['SnapshotLabel'] = SnapshotLabel


class NutanixFSObjectProtectionUpdateRequestParams(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """NutanixFSObjectProtectionUpdateRequestParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            backup_existing_snapshot (bool, none_type): Specifies that snapshot label is not set for Data-Protect NutanixFS Volumes backup. If field is set to true, existing oldest snapshot is used for backup and subsequent incremental will be selected in ascending order of snapshot create time on the source. If snapshot label is set, this field is set to false.. [optional]  # noqa: E501
