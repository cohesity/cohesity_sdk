...
class AzureSourceRegistrationParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'registration_level': (str,),  # noqa: E501
            'registration_workflow': (str,),  # noqa: E501
            'application_credentials': (list[AzureApplicationCredentials],),  # noqa: E501
            'azure_tenant_id': (str,),  # noqa: E501
            'subscription_details': (list[AzureSubscription],),  # noqa: E501
            'use_cases': (list[str],),  # noqa: E501
        }
    ...
    def __init__(self, registration_level, registration_workflow, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            application_credentials (list[AzureApplicationCredentials]): Specifies the credentials for a list of applications from azure active directory.. [optional]  # noqa: E501
            azure_tenant_id (str): Specifies Tenant Id of the active directory of Azure account. Accpets both Azure tanant Id and tenant domain name.. [optional]  # noqa: E501
            subscription_details (list[AzureSubscription]): Specifies the list subscription ids to be registered.. [optional]  # noqa: E501
            use_cases (list[str]): The use cases for which the source is to be registered.. [optional]  # noqa: E501
        """
