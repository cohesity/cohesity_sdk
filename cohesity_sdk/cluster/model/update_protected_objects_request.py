...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_object_protection_update_request_params import (
        AwsObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.azure_object_protection_update_request_params import (
    ...
    from cohesity_sdk.cluster.model.elastifile_object_protection_update_request_params import (
        ElastifileObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.env_specific_object_protection_update_request_params import (
        EnvSpecificObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.flashblade_object_protection_update_request_params import (
        FlashbladeObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.generic_nas_object_protection_update_request_params import (
        GenericNasObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.gpfs_object_protection_update_request_params import (
        GpfsObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_object_protection_update_request_params import (
        HyperVObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.isilon_object_protection_update_request_params import (
        IsilonObjectProtectionUpdateRequestParams,
    )
    from cohesity_sdk.cluster.model.netapp_object_protection_update_request_params import (
    ...
    from cohesity_sdk.cluster.model.vmware_object_protection_update_request_params import (
