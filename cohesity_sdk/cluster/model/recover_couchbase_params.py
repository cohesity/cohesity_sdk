...
def lazy_import():
    from cohesity_sdk.cluster.model.common_no_sql_recovery_options import (
    ...
    from cohesity_sdk.cluster.model.recover_couchbase_params_all_of import (
        RecoverCouchbaseParamsAllOf,
    )
    from cohesity_sdk.cluster.model.recover_couchbase_snapshot_params import (
...
class RecoverCouchbaseParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, filter_documents_params, snapshots, *args, **kwargs
    ):  # noqa: E501
