...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.cassandra_source_registration_params_all_of import (
        CassandraSourceRegistrationParamsAllOf,
    )
    from cohesity_sdk.cluster.model.cassandra_source_registration_params_all_of_cassandra_credentials import (
        CassandraSourceRegistrationParamsAllOfCassandraCredentials,
    )
    from cohesity_sdk.cluster.model.cassandra_source_registration_params_all_of_jmx_credentials import (
        CassandraSourceRegistrationParamsAllOfJmxCredentials,
    )
    from cohesity_sdk.cluster.model.dse_solr_info import DSESolrInfo
    from cohesity_sdk.cluster.model.ssh_password_credentials import (
        SshPasswordCredentials,
    )
    from cohesity_sdk.cluster.model.ssh_private_key_credentials import (
