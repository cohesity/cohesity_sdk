...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_object_protection_request_params import (
        AwsObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.azure_object_protection_request_params import (
        AzureObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.common_env_specific_object_protection_params import (
        CommonEnvSpecificObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.elastifile_object_protection_request_params import (
        ElastifileObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.env_specific_object_protection_request_params_all_of import (
        EnvSpecificObjectProtectionRequestParamsAllOf,
    )
    from cohesity_sdk.cluster.model.flashblade_object_protection_request_params import (
        FlashbladeObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.generic_nas_object_protection_request_params import (
        GenericNasObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.gpfs_object_protection_request_params import (
        GpfsObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_object_protection_request_params import (
        HyperVObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.isilon_object_protection_request_params import (
        IsilonObjectProtectionRequestParams,
    )
    from cohesity_sdk.cluster.model.mssql_object_protection_params import (
        MssqlObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.netapp_object_protection_request_params import (
    ...
    from cohesity_sdk.cluster.model.vmware_object_protection_request_params import (
