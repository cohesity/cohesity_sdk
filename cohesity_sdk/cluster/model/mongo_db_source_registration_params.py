...
class MongoDBSourceRegistrationParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'authenticating_database': (str,),  # noqa: E501
    ...
    def __init__(self, auth_type, hosts, is_ssl_required, use_secondary_for_backup, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authenticating_database (str): Authenticating Database for this cluster. Should be set if 'authType' is 'LDAP' or 'SCRAM'.. [optional]  # noqa: E501
            password (str): Specifies the password for the MongoDB cluster. Should be set if 'authType' is 'LDAP' or 'SCRAM'.. [optional]  # noqa: E501
            principal (str): Specifies the principal name of the MongoDB cluster. Should be set if 'authType' is 'KERBEROS'.. [optional]  # noqa: E501
            ...
            username (str): Specifies the username of the MongoDB cluster. Should be set if 'authType' is 'LDAP' or 'SCRAM'.. [optional]  # noqa: E501
        """
