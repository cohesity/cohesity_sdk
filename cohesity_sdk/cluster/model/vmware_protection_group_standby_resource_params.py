...
def lazy_import():
    from cohesity_sdk.cluster.model.common_standby_resource_params import (
        CommonStandbyResourceParams,
    )
    from cohesity_sdk.cluster.model.recover_vmware_vm_new_source_network_config import (
    ...
    from cohesity_sdk.cluster.model.vmware_protection_group_standby_resource_params_all_of import (
