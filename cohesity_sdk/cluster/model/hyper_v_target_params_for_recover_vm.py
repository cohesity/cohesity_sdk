...
def lazy_import():
    from cohesity_sdk.cluster.model.hyper_vvm_recovery_target_config import HyperVVmRecoveryTargetConfig
    ...
    globals()['HyperVVmRecoveryTargetConfig'] = HyperVVmRecoveryTargetConfig
...
class HyperVTargetParamsForRecoverVm(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'overwrite_existing_vms': (bool, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'overwrite_existing_vms': 'overwriteExistingVms',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            overwrite_existing_vms (bool, none_type): Specifies whether to overwrite existing VMs while performing recovery of a VM. Default value is false.. [optional]  # noqa: E501
            ...
            use_smb_service (bool, none_type): Specifies if the HyperV recovery is using the SMB service to perform the restore. It is false for copy-recovery if nothing is specified. For instant-recovery it is true by default. Since DMaaS does not support SMB, only stream copy recovery is supported.. [optional]  # noqa: E501
