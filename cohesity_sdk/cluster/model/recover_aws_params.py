...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_aws_aurora_params import (
        RecoverAwsAuroraParams,
    )
    from cohesity_sdk.cluster.model.recover_aws_file_and_folder_params import (
        RecoverAwsFileAndFolderParams,
    )
    from cohesity_sdk.cluster.model.recover_aws_rds_params import RecoverAwsRdsParams
    from cohesity_sdk.cluster.model.recover_aws_s3_bucket_params import (
        RecoverAwsS3BucketParams,
    )
    from cohesity_sdk.cluster.model.recover_aws_vm_params import RecoverAwsVmParams
    from cohesity_sdk.cluster.model.recover_rds_postgres_params import (
