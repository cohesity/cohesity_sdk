...
class CreateUserParameters(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            's3_access_keys': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    def __init__(self, domain, username, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            s3_access_keys ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Specifies the S3 Access Keys of the User.. [optional]  # noqa: E501
