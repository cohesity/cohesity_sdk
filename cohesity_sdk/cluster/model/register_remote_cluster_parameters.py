...
def lazy_import():
    ...
    globals()['ValidateRemoteClusterConnectionParams'] = ValidateRemoteClusterConnectionParams


class RegisterRemoteClusterParameters(ModelComposed):
    ...
    def __init__(self, node_addresses, password, username, *args, **kwargs):  # noqa: E501
        """RegisterRemoteClusterParameters - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            tenant_id (str, none_type): Specifies the tenant Id of the Remote Cluster.. [optional]  # noqa: E501
