...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.vmware_recover_disks_original_source_config import (
        VmwareRecoverDisksOriginalSourceConfig,
    )
    from cohesity_sdk.cluster.model.vmware_recover_disks_target_source_config import (
