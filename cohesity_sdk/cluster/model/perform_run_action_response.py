...
def lazy_import():
    from cohesity_sdk.cluster.model.cancel_protection_group_run_response_params import (
        CancelProtectionGroupRunResponseParams,
    )
    from cohesity_sdk.cluster.model.pause_protection_run_action_response_params import (
        PauseProtectionRunActionResponseParams,
    )
    from cohesity_sdk.cluster.model.resume_protection_run_action_response_params import (
