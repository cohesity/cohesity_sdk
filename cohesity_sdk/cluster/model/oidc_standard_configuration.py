...
class OIDCStandardConfiguration(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, issuer, *args, **kwargs):  # noqa: E501
        """OIDCStandardConfiguration - a model defined in OpenAPI
