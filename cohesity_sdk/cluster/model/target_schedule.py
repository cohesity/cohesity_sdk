...
class TargetSchedule(ModelNormal):
    ...
    def __init__(self, unit, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            frequency (int): Specifies a factor to multiply the unit by, to determine the copy schedule. For example if set to 2 and the unit is hourly, then Snapshots from the first eligible Job Run for every 2 hour period is copied.. [optional]  # noqa: E501
        """
