...
def lazy_import():
    from cohesity_sdk.cluster.model.archival_aws_external_target_params_all_of import (
        ArchivalAwsExternalTargetParamsAllOf,
    )
    from cohesity_sdk.cluster.model.aws_glacier_params import AwsGlacierParams
    from cohesity_sdk.cluster.model.aws_s3_glacier_deep_archive_params import (
    ...
    from cohesity_sdk.cluster.model.aws_s3_intelligent_params import (
        AwsS3IntelligentParams,
    )
    from cohesity_sdk.cluster.model.aws_s3_one_zone_ia_params import (
        AwsS3OneZoneIAParams,
    )
    from cohesity_sdk.cluster.model.aws_s3_standard_ia_params import (
        AwsS3StandardIAParams,
    )
    from cohesity_sdk.cluster.model.aws_s3_standard_params import AwsS3StandardParams
    from cohesity_sdk.cluster.model.common_archival_aws_external_target_params import (
...
class ArchivalAwsExternalTargetParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "source_side_deduplication": (
                bool,
                none_type,
            ),  # noqa: E501
            "aws_glacier_params": (AwsGlacierParams,),  # noqa: E501
            "aws_s3_glacier_deep_archive_params": (
                AwsS3GlacierDeepArchiveParams,
            ),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, bucket_name, region, storage_class, *args, **kwargs
    ):  # noqa: E501
