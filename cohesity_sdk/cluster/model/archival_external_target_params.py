...
def lazy_import():
    from cohesity_sdk.cluster.model.archival_aws_external_target_params import (
        ArchivalAwsExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_azure_external_target_params import (
        ArchivalAzureExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_external_target_params_all_of import (
        ArchivalExternalTargetParamsAllOf,
    )
    from cohesity_sdk.cluster.model.archival_gcp_external_target_params import (
        ArchivalGcpExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_nas_external_target_params import (
        ArchivalNasExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_oracle_external_target_params import (
        ArchivalOracleExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_qstar_tape_external_target_params import (
        ArchivalQstarTapeExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.archival_s3_comp_external_target_params import (
        ArchivalS3CompExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.common_archival_external_target_params import (
        CommonArchivalExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.encryption_settings import EncryptionSettings
    from cohesity_sdk.cluster.model.target_bandwidth_throttlings import (
