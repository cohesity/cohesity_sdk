...
def lazy_import():
    from cohesity_sdk.cluster.model.physical_file_protection_group_params import (
        PhysicalFileProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.physical_volume_protection_group_params import (
