...
class FlashbladeProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[FlashbladeProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[FlashbladeProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            continue_on_error (bool): Specifies whether or not the Protection Group should continue regardless of whether or not an error was encountered.. [optional]  # noqa: E501
