...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.create_or_update_primary_cluster_connection_params_all_of import CreateOrUpdatePrimaryClusterConnectionParamsAllOf
    globals()['CommonCredentialsParams'] = CommonCredentialsParams
    globals()['CreateOrUpdatePrimaryClusterConnectionParamsAllOf'] = CreateOrUpdatePrimaryClusterConnectionParamsAllOf


class CreateOrUpdatePrimaryClusterConnectionParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, password, username, node_addresses, *args, **kwargs):  # noqa: E501
        """CreateOrUpdatePrimaryClusterConnectionParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            all_endpoints_reachable (bool, none_type): Specifies if all endpoints on Primary Cluster are reachable.. [optional] if omitted the server will use the default value of False  # noqa: E501
