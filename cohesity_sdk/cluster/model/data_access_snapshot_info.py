...
class DataAccessSnapshotInfo(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, snapshot_id, *args, **kwargs):  # noqa: E501
        """DataAccessSnapshotInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            restore_time_usecs (int, none_type): Specifies the time to which the object needs to be restored. If this is not specified the object is restore from the base snapshot identified by the run_start_time_usecs.. [optional]  # noqa: E501
        """
