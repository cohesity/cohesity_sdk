...
class RecoverPhysicalParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[CommonRecoverObjectSnapshotParams],),  # noqa: E501
    ...
    def __init__(self, objects, recovery_action, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[CommonRecoverObjectSnapshotParams]): Specifies the list of Recover Object parameters. For recovering files, specifies the object contains the file to recover.
