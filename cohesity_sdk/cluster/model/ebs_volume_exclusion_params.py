...
class EbsVolumeExclusionParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'device_names': (list[str],),  # noqa: E501
            'max_volume_size_bytes': (int,),  # noqa: E501
            'raw_query': (str,),  # noqa: E501
            'tag_params_array': (list[TagParams],),  # noqa: E501
            'volume_ids': (list[str],),  # noqa: E501
            'volume_types': (list[str],),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            device_names (list[str]): Array of device names to exclude. Eg - /dev/sda.. [optional]  # noqa: E501
            max_volume_size_bytes (int): Any volume larger than this size will be excluded.. [optional]  # noqa: E501
            ...
            tag_params_array (list[TagParams]): Array of TagParams objects. Each TagParams object consists of two vectors: for exclusion and inclusion. Each TagPararms object is present as an ORed item. User can only input queries of form: (<> AND <> AND <> ..) OR (<> AND <> AND <> ..) OR (..) OR (..) OR .. There cannot be an OR operator inside the bracket. Example query: (K1 = V1 AND K2 = V2 AND K3 != V3) OR (K4 = V4 AND K6 != V6). This will lead to formation of two items in tagParamsArray. First item: {exclusionTagArray: [(K1, V1),  (K2, V2)], inclusionTagArray: [(K3, V3)]} Second item: {exclusionTagArray: [(K4, V4)], inclusionTagArray: [(K6, V6)]}.. [optional]  # noqa: E501
            volume_ids (list[str]): Array of volume IDs that are to be excluded. This is only for object level exclusion.. [optional]  # noqa: E501
            volume_types (list[str]): Array of volume types to exclude. Eg - gp2, gp3.. [optional]  # noqa: E501
        """
