...
class CommonIBMCOSExternalTargetParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, authentication_method, bucket_name, location, *args, **kwargs):  # noqa: E501
        """CommonIBMCOSExternalTargetParams - a model defined in OpenAPI
