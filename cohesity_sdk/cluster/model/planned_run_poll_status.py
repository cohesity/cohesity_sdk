...
class PlannedRunPollStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'backup_task_status': (str,),  # noqa: E501
            'failover_id': (str,),  # noqa: E501
            'on_prem_deploy_task_status': (str,),  # noqa: E501
            'protection_group_id': (str,),  # noqa: E501
            'run_id': (str,),  # noqa: E501
            'waiting_on_other_run_cancellations': (bool,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            failover_id (str): Specifies the unique failover Id which will be generated by orchestrator. This Id will be used to uniquely identify current failover operation.. [optional]  # noqa: E501
            on_prem_deploy_task_status (str): Status of the OnPrem deploy task. 'Running' indicates that the run is still running. 'Canceled' indicates that the run has been canceled. 'Canceling' indicates that the run is in the process of being canceled. 'Paused' indicates that the ongoing run has been paused. 'Failed' indicates that the run has failed. 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening. 'Succeeded' indicates that the run has finished successfully. 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages. 'Skipped' indicates that the run was skipped.. [optional]  # noqa: E501
            protection_group_id (str): Specifies the protection group id to which this run belongs.. [optional]  # noqa: E501
            run_id (str): If run has been scheduled then this field will be populated with unique run id.. [optional]  # noqa: E501
