...
def lazy_import():
    from cohesity_sdk.cluster.model.cassandra_indexed_objects import (
        CassandraIndexedObjects,
    )
    from cohesity_sdk.cluster.model.common_search_indexed_objects_response_params import (
        CommonSearchIndexedObjectsResponseParams,
    )
    from cohesity_sdk.cluster.model.couchbase_indexed_objects import (
        CouchbaseIndexedObjects,
    )
    from cohesity_sdk.cluster.model.emails import Emails
    from cohesity_sdk.cluster.model.exchange_indexed_objects import (
    ...
    from cohesity_sdk.cluster.model.search_indexed_objects_response_body_all_of import (
