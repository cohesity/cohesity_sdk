...
class RecoverProtectionGroupRunParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'archival_target_id': (int,),  # noqa: E501
    ...
    def __init__(self, protection_group_instance_id, protection_group_run_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            archival_target_id (int): Specifies the archival target id. If specified and Protection Group run has an archival snapshot then VMs are recovered from the specified archival snapshot. If not specified (default), VMs are recovered from local snapshot.. [optional]  # noqa: E501
            protection_group_id (str): Specifies the local Protection Group id. In case of recovering a replication Run, this field should be provided with local Protection Group id.. [optional]  # noqa: E501
        """
