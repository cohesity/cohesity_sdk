...
class CommonDataTieringTaskResponse(ModelNormal):
    ...
    def __init__(self, name, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): Specifies a description of the data tiering task.. [optional]  # noqa: E501
            id (str): Specifies the id of the data tiering task.. [optional]  # noqa: E501
            is_active (bool): Whether the data tiering task is active or not.. [optional] if omitted the server will use the default value of True  # noqa: E501
            is_deleted (bool): Tracks whether the backup job has actually been deleted.. [optional] if omitted the server will use the default value of True  # noqa: E501
            is_paused (bool): Whether the data tiering task is paused. New runs are not scheduled for the paused tasks. Active run of the task (if any) is not impacted.. [optional] if omitted the server will use the default value of True  # noqa: E501
