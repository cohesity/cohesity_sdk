...
def lazy_import():
    from cohesity_sdk.cluster.model.hyper_v_recover_files_new_target_config import (
        HyperVRecoverFilesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.hyper_v_recover_files_original_target_config import (
