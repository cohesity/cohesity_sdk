...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.protected_object_backup_config import (
        ProtectedObjectBackupConfig,
    )
    from cohesity_sdk.cluster.model.protected_object_group_backup_config import (
        ProtectedObjectGroupBackupConfig,
    )
    from cohesity_sdk.cluster.model.protected_object_info_all_of import (
