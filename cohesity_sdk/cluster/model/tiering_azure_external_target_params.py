...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.common_tiering_azure_external_target_params import (
        CommonTieringAzureExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.tiering_azure_external_target_params_all_of import (
...
class TieringAzureExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, container_name, storage_account_name, *args, **kwargs
    ):  # noqa: E501
