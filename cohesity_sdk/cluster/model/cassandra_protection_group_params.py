...
def lazy_import():
    from cohesity_sdk.cluster.model.cassandra_protection_group_params_all_of import (
        CassandraProtectionGroupParamsAllOf,
    )
    from cohesity_sdk.cluster.model.no_sql_protection_group_object_params import (
