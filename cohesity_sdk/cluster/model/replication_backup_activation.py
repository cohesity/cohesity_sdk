...
class ReplicationBackupActivation(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'create_object_backup': (bool,),  # noqa: E501
            'do_not_protect': (bool,),  # noqa: E501
            'enable_reverse_replication': (bool,),  # noqa: E501
            'objects': (list[FailoverObject],),  # noqa: E501
            'protection_group_id': (str,),  # noqa: E501
            'target_failover_environment': (str,),  # noqa: E501
            'target_failover_policy_id': (str,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            create_object_backup (bool): If set to true then object based backups will be created for the failed over VMs.. [optional]  # noqa: E501
            do_not_protect (bool): Whether to skip protecting the failed over entities previously specified via Initiate Failover API.. [optional]  # noqa: E501
            ...
            target_failover_environment (str): If this is specified, then the protection environment of the failed over objects will be set to this. Otherwise, the protection environment of the failed over objects is determined by the objects' environment.. [optional]  # noqa: E501
            target_failover_policy_id (str): Policy which will be used in the protection of the failed over objects.. [optional]  # noqa: E501
        """
