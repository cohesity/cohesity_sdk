...
class RecoverAzureEntraIdObjectParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, uuid, *args, **kwargs):  # noqa: E501
        """RecoverAzureEntraIdObjectParams - a model defined in OpenAPI
