...
def lazy_import():
    from cohesity_sdk.cluster.model.action_object_level_response_all_of import (
        ActionObjectLevelResponseAllOf,
    )
    from cohesity_sdk.cluster.model.pause_action_object_level_response import (
        PauseActionObjectLevelResponse,
    )
    from cohesity_sdk.cluster.model.protection_object_input import ProtectionObjectInput
    from cohesity_sdk.cluster.model.resume_action_object_level_response import (
        ResumeActionObjectLevelResponse,
    )
    from cohesity_sdk.cluster.model.run_now_action_object_level_response import (
        RunNowActionObjectLevelResponse,
    )
    from cohesity_sdk.cluster.model.unprotect_action_object_level_response import (
