...
class MountUserCreds(ModelNormal):
    ...
    attribute_map = {
        'is_local_user': 'isLocalUser',  # noqa: E501
        'sid': 'sid',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_local_user, sid, username, *args, **kwargs):  # noqa: E501
        """MountUserCreds - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            domain_name (str, none_type): Specifies the domain the user belongs to. Optional domain if a user from AD is selected.. [optional]  # noqa: E501
            password (str, none_type): Specifies the password to access the SMB share. Optional if domain user is selected.. [optional]  # noqa: E501
        """
