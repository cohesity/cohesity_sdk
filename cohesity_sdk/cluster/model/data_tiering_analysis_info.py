...
class DataTieringAnalysisInfo(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            message (str): message from the last analysis run stating the error message in case of error in analysis run or warning message if the run finished successfully, but there were some warning messages.. [optional]  # noqa: E501
