...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_service_now_table_params_all_of import RecoverServiceNowTableParamsAllOf
    ...
    globals()['RecoverServiceNowTableParamsAllOf'] = RecoverServiceNowTableParamsAllOf
    globals()['ReplicationTargetSummaryInfo'] = ReplicationTargetSummaryInfo


class RecoverServiceNowTableParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, snapshot_id, name, *args, **kwargs):  # noqa: E501
        """RecoverServiceNowTableParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            records ([str], none_type): Specifies a list of records IDs to be recovered for the  specified table.. [optional]  # noqa: E501
        """
