...
def lazy_import():
    from cohesity_sdk.cluster.model.common_updatable_user_params import (
        CommonUpdatableUserParams,
    )
    from cohesity_sdk.cluster.model.local_user_update_params import (
        LocalUserUpdateParams,
    )
    from cohesity_sdk.cluster.model.update_user_parameters_all_of import (
