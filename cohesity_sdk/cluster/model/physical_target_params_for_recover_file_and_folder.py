...
class PhysicalTargetParamsForRecoverFileAndFolder(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'restore_exclusion_param': ([str], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'restore_exclusion_param': 'restoreExclusionParam',  # noqa: E501
    ...
    def __init__(self, recover_target, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            restore_exclusion_param ([str], none_type): Specifies list of exclusions that needs to be applicable for the current file level restores. Applicable only for file level restores.. [optional]  # noqa: E501
