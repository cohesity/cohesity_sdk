...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.sql_target_params_for_recover_sql_app_files import SqlTargetParamsForRecoverSqlAppFiles
    ...
    globals()['SqlTargetParamsForRecoverSqlAppFiles'] = SqlTargetParamsForRecoverSqlAppFiles


class RecoverSqlAppFilesParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sql_target_params': (SqlTargetParamsForRecoverSqlAppFiles,),  # noqa: E501
    ...
    def __init__(self, snapshot_id, *args, **kwargs):  # noqa: E501
        """RecoverSqlAppFilesParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sql_target_params (SqlTargetParamsForRecoverSqlAppFiles): [optional]  # noqa: E501
            target_environment (str): Specifies the environment of the recovery target. The corresponding params below must be filled out.. [optional] if omitted the server will use the default value of "kSQL"  # noqa: E501
