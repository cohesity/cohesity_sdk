...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.v_mware_mount_volumes_new_target_config import (
        VMwareMountVolumesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.v_mware_mount_volumes_original_target_config import (
