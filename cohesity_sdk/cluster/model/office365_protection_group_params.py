...
class Office365ProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[Office365ProtectionGroupObjectParams],),  # noqa: E501
            'protection_types': (list[str],),  # noqa: E501
    ...
    def __init__(self, objects, protection_types, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[Office365ProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
