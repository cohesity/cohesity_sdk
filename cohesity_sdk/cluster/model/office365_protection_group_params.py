...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.office365_one_drive_protection_group_params import (
        Office365OneDriveProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.office365_outlook_protection_group_params import (
        Office365OutlookProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.office365_protection_group_object_params import (
        Office365ProtectionGroupObjectParams,
    )
    from cohesity_sdk.cluster.model.office365_public_folders_protection_group_params import (
        Office365PublicFoldersProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.office365_share_point_protection_group_params import (
