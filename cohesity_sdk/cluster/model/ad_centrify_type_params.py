...
def lazy_import():
    from cohesity_sdk.cluster.model.ad_centrify_type_params_all_of import (
        AdCentrifyTypeParamsAllOf,
    )
    from cohesity_sdk.cluster.model.centrify_zone import CentrifyZone
    from cohesity_sdk.cluster.model.fallback_user_id_mapping_params import (
...
class AdCentrifyTypeParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, description, distinguished_name, schema, fallback_option, *args, **kwargs
    ):  # noqa: E501
