...
class ProtectionGroupAlertingPolicy(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'backup_run_status': (list[str],),  # noqa: E501
            'alert_targets': (list[AlertTarget],),  # noqa: E501
    ...
    def __init__(self, backup_run_status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            alert_targets (list[AlertTarget]): Specifies a list of targets to receive the alerts.. [optional]  # noqa: E501
