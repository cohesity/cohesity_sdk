...
def lazy_import():
    from cohesity_sdk.cluster.model.recover_hyper_vvm_scvmm_source_config import (
        RecoverHyperVVmSCVMMSourceConfig,
    )
    from cohesity_sdk.cluster.model.recover_hyper_vvm_standalone_cluster_source_config import (
        RecoverHyperVVmStandaloneClusterSourceConfig,
    )
    from cohesity_sdk.cluster.model.recover_hyper_vvm_standalone_host_source_config import (
