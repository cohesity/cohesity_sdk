...
class QoS(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            principal_id (int): Specifies the id of the QoS Policy used for the View. (Deprecated) This parameter is deprecated and shall not be supported in future releases. Use name instead.. [optional]  # noqa: E501
            principal_name (str): Specifies the name of the QoS Policy. If not specified, the default is 'Backup Target Low'. (To be deprecated in future release, use name instead). [optional]  # noqa: E501
        """
