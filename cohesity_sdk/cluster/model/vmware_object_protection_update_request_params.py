...
def lazy_import():
    from cohesity_sdk.cluster.model.common_vmware_object_params import (
    ...
    from cohesity_sdk.cluster.model.vmware_object_protection_update_request_params_all_of import (
