...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_s3_bucket_restore_filter_policy import (
        AwsS3BucketRestoreFilterPolicy,
    )
    from cohesity_sdk.cluster.model.aws_target_params_for_recover_s3 import (
...
class RecoverAwsS3BucketParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "aws_s3_bucket_restore_filter_policy": (
                AwsS3BucketRestoreFilterPolicy,
            ),  # noqa: E501
