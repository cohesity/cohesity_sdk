...
class VmwareRecoverDisksTargetSourceConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'disks': (list[VmwareRecoverTargetSourceDiskParams],),  # noqa: E501
    ...
    def __init__(self, disks, source_id, *args, **kwargs):  # noqa: E501
        ...
        Args:
            disks (list[VmwareRecoverTargetSourceDiskParams]): Specifies the disks to be recovered and the location to which they will be recovered.
