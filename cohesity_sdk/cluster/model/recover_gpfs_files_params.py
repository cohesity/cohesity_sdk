...
def lazy_import():
    from cohesity_sdk.cluster.model.common_recover_file_and_folder_info import (
        CommonRecoverFileAndFolderInfo,
    )
    from cohesity_sdk.cluster.model.recover_gpfs_to_gpfs_files_target_params import (
        RecoverGpfsToGpfsFilesTargetParams,
    )
    from cohesity_sdk.cluster.model.recover_other_nas_to_elastifile_files_target_params import (
        RecoverOtherNasToElastifileFilesTargetParams,
    )
    from cohesity_sdk.cluster.model.recover_other_nas_to_flashblade_files_target_params import (
        RecoverOtherNasToFlashbladeFilesTargetParams,
    )
    from cohesity_sdk.cluster.model.recover_other_nas_to_generic_nas_files_target_params import (
        RecoverOtherNasToGenericNasFilesTargetParams,
    )
    from cohesity_sdk.cluster.model.recover_other_nas_to_isilon_files_target_params import (
        RecoverOtherNasToIsilonFilesTargetParams,
    )
    from cohesity_sdk.cluster.model.recover_other_nas_to_netapp_files_target_params import (
        RecoverOtherNasToNetappFilesTargetParams,
    )

    globals()["CommonRecoverFileAndFolderInfo"] = CommonRecoverFileAndFolderInfo
    globals()["RecoverGpfsToGpfsFilesTargetParams"] = RecoverGpfsToGpfsFilesTargetParams
    globals()[
        "RecoverOtherNasToElastifileFilesTargetParams"
    ] = RecoverOtherNasToElastifileFilesTargetParams
    globals()[
...
class RecoverGpfsFilesParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "gpfs_target_params": (RecoverGpfsToGpfsFilesTargetParams,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, files_and_folders, target_environment, *args, **kwargs
    ):  # noqa: E501
        ...
        Keyword Args:
            ...
            gpfs_target_params (RecoverGpfsToGpfsFilesTargetParams): [optional]  # noqa: E501
