...
class RecoverOneDriveParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[ObjectOneDriveParam],),  # noqa: E501
            'continue_on_error': (bool,),  # noqa: E501
            'recover_preservation_hold_library': (bool,),  # noqa: E501
            'recover_user_default_drive': (bool,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[ObjectOneDriveParam]): Specifies a list of OneDrive params associated with the objects to recover. These parameters allow overriding the request level 'recoverUserDefaultDrive' parameter for each object specified here.
        ...
        Keyword Args:
            ...
            continue_on_error (bool): Specifies whether to continue recovering other OneDrive items if one of items failed to recover. Default value is false.. [optional]  # noqa: E501
            recover_preservation_hold_library (bool): Specifies whether to recover Preservation Hold Library associated with the OneDrives selected for restore. Default value is false.. [optional]  # noqa: E501
