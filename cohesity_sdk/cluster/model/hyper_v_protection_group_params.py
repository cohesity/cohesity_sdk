...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.hyper_v_protection_group_object_params import (
        HyperVProtectionGroupObjectParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_protection_group_params_all_of import (
