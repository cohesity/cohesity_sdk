...
class HyperVProtectionGroupParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'global_exclude_disks': (list[HyperVDiskInfo],),  # noqa: E501
            'global_include_disks': (list[HyperVDiskInfo],),  # noqa: E501
            'objects': (list[HyperVProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            exclude_object_ids (list[int]): Specifies the list of IDs of the objects to not be protected by this Protection Group. This can be used to ignore specific objects under a parent object which has been included for protection.. [optional]  # noqa: E501
            ...
            global_exclude_disks (list[HyperVDiskInfo]): Specifies a global list of disks to be excluded for the all the VMs part of the protection group.. [optional]  # noqa: E501
            global_include_disks (list[HyperVDiskInfo]): Specifies a global list of disks to be included for the all the VMs part of the protection group.. [optional]  # noqa: E501
            objects (list[HyperVProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.. [optional]  # noqa: E501
            ...
            app_consistent_snapshot (bool): Specifies whether or not to quiesce apps and the file system in order to take app consistent snapshots. If not specified or false then snapshots will not be app consistent.. [optional]  # noqa: E501
            fallback_to_crash_consistent_snapshot (bool): Specifies whether or not to fallback to a crash consistent snapshot in the event that an app consistent snapshot fails.. [optional]  # noqa: E501
