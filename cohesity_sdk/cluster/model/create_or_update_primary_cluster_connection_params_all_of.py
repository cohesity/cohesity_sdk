...
class CreateOrUpdatePrimaryClusterConnectionParamsAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, node_addresses, *args, **kwargs):  # noqa: E501
        """CreateOrUpdatePrimaryClusterConnectionParamsAllOf - a model defined in OpenAPI
