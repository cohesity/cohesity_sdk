...
class ObjectProtectionRunSummary(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_cloud_archival_direct': (bool,),  # noqa: E501
            'is_local_snapshots_deleted': (bool,),  # noqa: E501
            'is_replication_run': (bool,),  # noqa: E501
            ...
            'origin_protection_group_id': (str,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_cloud_archival_direct (bool): Specifies whether the run is a CAD run if cloud archive direct feature is enabled. If this field is true, the primary backup copy will only be available at the given archived location.. [optional]  # noqa: E501
            is_local_snapshots_deleted (bool): Specifies if snapshots for this run has been deleted.. [optional]  # noqa: E501
            is_replication_run (bool): Specifies if this protection run is a replication run.. [optional]  # noqa: E501
            ...
            on_legal_hold (bool): Specifies if object's snapshot is on legal hold.. [optional]  # noqa: E501
            on_prem_deploy_info (OnPremDeployRun): [optional]  # noqa: E501
            origin_cluster_identifier (ClusterIdentifier): [optional]  # noqa: E501
            origin_protection_group_id (str): ProtectionGroupId to which this run belongs on the primary cluster if this run is a replication run.. [optional]  # noqa: E501
            original_backup_info (BackupRun): [optional]  # noqa: E501
            permissions (list[TenantInfo]): Specifies the list of tenants that have permissions for this protection group run.. [optional]  # noqa: E501
            policy_id (str): Specifies the unique id of the Protection Policy associated with the Protection Run. The Policy provides retry settings Protection Schedules, Priority, SLA, etc.. [optional]  # noqa: E501
            policy_name (str): Specifies Specifies the name of the Protection Policy.. [optional]  # noqa: E501
            protection_group_id (str): ProtectionGroupId to which this run belongs. This will only be populated if the object is protected by a protection group.. [optional]  # noqa: E501
            protection_group_name (str): Name of the Protection Group to which this run belongs. This will only be populated if the object is protected by a protection group.. [optional]  # noqa: E501
            replication_info (ReplicationRun): [optional]  # noqa: E501
            run_id (str): Specifies the ID of the protection run.. [optional]  # noqa: E501
            run_label (str): Specifies a label with which this run is created. Only applicable for user triggered protect now action.. [optional]  # noqa: E501
            ...
            storage_domain_id (int): Specifies the Storage Domain (View Box) ID where this Protection Run writes data.. [optional]  # noqa: E501
        """
