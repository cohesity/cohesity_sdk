...
def lazy_import():
    from cohesity_sdk.cluster.model.cloud_down_water_fall_params import CloudDownWaterFallParams
    from cohesity_sdk.cluster.model.data_usage_stats import DataUsageStats
    ...
    from cohesity_sdk.cluster.model.storage_domain_purpose_param import StorageDomainPurposeParam
    from cohesity_sdk.cluster.model.storage_policy import StoragePolicy
    from cohesity_sdk.cluster.model.subnet import Subnet
    globals()['CloudDownWaterFallParams'] = CloudDownWaterFallParams
    globals()['DataUsageStats'] = DataUsageStats
    globals()['FileCount'] = FileCount
    globals()['QuotaPolicy'] = QuotaPolicy
    globals()['Schema'] = Schema
    globals()['StorageDomainPurposeParam'] = StorageDomainPurposeParam
    globals()['StoragePolicy'] = StoragePolicy
...
class StorageDomain(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'optimize_throughput_settings': (bool, none_type,),  # noqa: E501
            'physical_quota': (QuotaPolicy,),  # noqa: E501
            'purpose': (StorageDomainPurposeParam,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'optimize_throughput_settings': 'optimizeThroughputSettings',  # noqa: E501
    ...
    def __init__(self, cluster_partition_id, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            optimize_throughput_settings (bool, none_type): Indicates whether the storage domain supports workload/throughput optimized performance settings for its Views. Note: This value cannot be modified after the storage domain is created.. [optional]  # noqa: E501
            physical_quota (QuotaPolicy): [optional]  # noqa: E501
            purpose (StorageDomainPurposeParam): [optional]  # noqa: E501
