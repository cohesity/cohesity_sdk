...
class HeliosOnPremConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'kubernetes_subnet_cidr': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'cluster_id': (int,),  # noqa: E501
            'network_config': (ClusterCreateNetworkConfig,),  # noqa: E501
            'nodes': (list[HeliosOnPremVMNode],),  # noqa: E501
    ...
    def __init__(self, kubernetes_subnet_cidr, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            nodes (list[HeliosOnPremVMNode]): Specifies the Nodes present in this Cluster.. [optional]  # noqa: E501
