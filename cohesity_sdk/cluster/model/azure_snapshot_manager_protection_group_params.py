...
def lazy_import():
    from cohesity_sdk.cluster.model.azure_snapshot_manager_protection_group_object_params import (
        AzureSnapshotManagerProtectionGroupObjectParams,
    )
    from cohesity_sdk.cluster.model.cloud_backup_script_params import (
