...
def lazy_import():
    from cohesity_sdk.cluster.model.common_oracle_external_target_params import (
        CommonOracleExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.tiering_oracle_external_target_params_all_of import (
...
class TieringOracleExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, access_key_id, bucket_name, region, tenancy, *args, **kwargs
    ):  # noqa: E501
