...
def lazy_import():
    from cohesity_sdk.cluster.model.cancellation_timeout_params import (
        CancellationTimeoutParams,
    )
    from cohesity_sdk.cluster.model.common_target_configuration import (
        CommonTargetConfiguration,
    )
    from cohesity_sdk.cluster.model.log_retention import LogRetention
    from cohesity_sdk.cluster.model.onprem_deploy_config_all_of import (
