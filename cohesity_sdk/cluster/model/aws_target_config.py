...
class AWSTargetConfig(ModelNormal):
    ...
    def __init__(self, region, source_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): Specifies the name of the AWS Replication target.. [optional]  # noqa: E501
            region_name (str): Specifies name of the AWS region in which to replicate the Snapshot to. Applicable if replication target is AWS target.. [optional]  # noqa: E501
        """
