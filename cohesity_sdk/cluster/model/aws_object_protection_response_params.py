...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_aurora_snapshot_manager_object_protection_params import (
        AwsAuroraSnapshotManagerObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_common_object_protection_params import (
        AwsCommonObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_native_object_protection_params import (
        AwsNativeObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_object_protection_request_params_all_of import (
        AwsObjectProtectionRequestParamsAllOf,
    )
    from cohesity_sdk.cluster.model.aws_rds_postgres_protection_params import (
        AwsRdsPostgresProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_rds_snapshot_manager_object_protection_params import (
        AwsRdsSnapshotManagerObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_s3_protection_params import (
        AwsS3ProtectionParams,
    )
    from cohesity_sdk.cluster.model.aws_snapshot_manager_object_protection_params import (
...
class AwsObjectProtectionResponseParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "aurora_snapshot_manager_protection_type_params": (
                AwsAuroraSnapshotManagerObjectProtectionParams,
            ),  # noqa: E501
            ...
            "rds_snapshot_manager_protection_type_params": (
                AwsRdsSnapshotManagerObjectProtectionParams,
            ),  # noqa: E501
