...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.common_tiering_aws_external_target_params import (
        CommonTieringAwsExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.tiering_aws_external_target_params_all_of import (
