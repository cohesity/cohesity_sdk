...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.oracle_recovery_validation_info import (
        OracleRecoveryValidationInfo,
    )
    from cohesity_sdk.cluster.model.recover_oracle_granular_restore_info import (
        RecoverOracleGranularRestoreInfo,
    )
    from cohesity_sdk.cluster.model.restore_spfile_or_pfile_info import (
