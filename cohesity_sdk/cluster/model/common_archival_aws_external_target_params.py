...
def lazy_import():
    from cohesity_sdk.cluster.model.common_archival_aws_external_target_params_all_of import (
        CommonArchivalAwsExternalTargetParamsAllOf,
    )
    from cohesity_sdk.cluster.model.common_aws_external_target_params import (
