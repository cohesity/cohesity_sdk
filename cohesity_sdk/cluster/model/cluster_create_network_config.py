...
def lazy_import():
    from cohesity_sdk.cluster.model.cluster_dhcp_network_config import (
        ClusterDhcpNetworkConfig,
    )
    from cohesity_sdk.cluster.model.cluster_manual_network_config import (
...
class ClusterCreateNetworkConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, domain_names, ntp_servers, use_dhcp, *args, **kwargs
    ):  # noqa: E501
