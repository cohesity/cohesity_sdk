...
class ClusterCreateNetworkConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'domain_names': (list[str],),  # noqa: E501
            'ntp_servers': (list[str],),  # noqa: E501
            'use_dhcp': (bool,),  # noqa: E501
    ...
    def __init__(self, domain_names, ntp_servers, use_dhcp, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ip_preference (str): Specifies IP preference of the cluster to be Ipv4/Ipv6. It is Ipv4 by default.. [optional]  # noqa: E501
            ...
            vip_host_name (str): Specifies the FQDN hostname of the cluster.. [optional]  # noqa: E501
        """
