...
def lazy_import():
    from cohesity_sdk.cluster.model.active_directory_admin_params import (
        ActiveDirectoryAdminParams,
    )
    from cohesity_sdk.cluster.model.common_active_directory_params import (
        CommonActiveDirectoryParams,
    )
    from cohesity_sdk.cluster.model.domain_controller import DomainController
    from cohesity_sdk.cluster.model.id_mapping_params import IdMappingParams
    ...
    from cohesity_sdk.cluster.model.update_active_directory_request_all_of import (
    ...
    globals()["IdMappingParams"] = IdMappingParams
...
class UpdateActiveDirectoryRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "transitive_ad_trust_level_limit": (
                int,
                none_type,
            ),  # noqa: E501
        }
