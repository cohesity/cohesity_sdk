...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.fortknox_onprem_primary_cluster_all_of import FortknoxOnpremPrimaryClusterAllOf
    from cohesity_sdk.cluster.model.storage_domain_config import StorageDomainConfig
    globals()['BandwidthThrottling'] = BandwidthThrottling
    globals()['ClusterIdentifier'] = ClusterIdentifier
    globals()['FortknoxOnpremClusterCommonParams'] = FortknoxOnpremClusterCommonParams
    globals()['FortknoxOnpremPrimaryClusterAllOf'] = FortknoxOnpremPrimaryClusterAllOf
    globals()['StorageDomainConfig'] = StorageDomainConfig


class FortknoxOnpremPrimaryCluster(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'storage_domain_configs': ([StorageDomainConfig],),  # noqa: E501
            'network_interface': (str, none_type,),  # noqa: E501
            'node_ips': ([str, none_type], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'storage_domain_configs': 'storageDomainConfigs',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FortknoxOnpremPrimaryCluster - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            all_endpoints_reachable (bool, none_type): Specifies if all endpoints on the Cluster are reachable.. [optional] if omitted the server will use the default value of False  # noqa: E501
            bandwidth_limit (BandwidthThrottling): [optional]  # noqa: E501
            compression_enabled (bool, none_type): Specifies whether to compress the outbound data when transferring the replication data over the network to the Vault Cluster.. [optional] if omitted the server will use the default value of True  # noqa: E501
            storage_domain_configs ([StorageDomainConfig]): Specifies a list of Storage Domain configurations.. [optional]  # noqa: E501
            ...
            node_ips ([str, none_type], none_type): List of IPs of nodes in the cluster.. [optional]  # noqa: E501
        """
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              FortknoxOnpremPrimaryClusterAllOf,
          ],
          'oneOf': [
          ],
        }
