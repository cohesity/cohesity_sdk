...
class NetappProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[NetappProtectionGroupObjectParams],),  # noqa: E501
            'backup_existing_snapshot': (bool,),  # noqa: E501
            'continue_on_error': (bool,),  # noqa: E501
            'continuous_snapshots': (ContinuousSnapshotParams,),  # noqa: E501
            'direct_cloud_archive': (bool,),  # noqa: E501
            ...
            'modify_source_permissions': (bool,),  # noqa: E501
            'native_format': (bool,),  # noqa: E501
            'nfs_version_preference': (str,),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[NetappProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            continue_on_error (bool): Specifies whether or not the Protection Group should continue regardless of whether or not an error was encountered during protection group run.. [optional]  # noqa: E501
            ...
            encryption_enabled (bool): Specifies whether the protection group should use encryption while backup or not.. [optional]  # noqa: E501
            ...
            modify_source_permissions (bool): Specifies if the Netapp source permissions should be modified internally to allow backups.. [optional]  # noqa: E501
            native_format (bool): Specifies whether or not to enable native format for direct archive job. This field is set to true if native format should be used for archiving.. [optional]  # noqa: E501
            nfs_version_preference (str): Specifies the preference of NFS version to be backed up if a volume supports multiple versions of NFS.. [optional]  # noqa: E501
            pre_post_script (HostBasedBackupScriptParams): [optional]  # noqa: E501
            protocol (str): Specifies the preferred protocol to use if this device supports multiple protocols.. [optional]  # noqa: E501
