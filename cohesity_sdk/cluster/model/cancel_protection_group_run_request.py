...
class CancelProtectionGroupRunRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'archival_task_id': (list[str],),  # noqa: E501
            'cloud_spin_task_id': (list[str],),  # noqa: E501
            'local_task_id': (str,),  # noqa: E501
            'object_ids': (list[int],),  # noqa: E501
            'replication_task_id': (list[str],),  # noqa: E501
        }
    ...
    def __init__(self, run_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            archival_task_id (list[str]): Specifies the task id of the archival run.. [optional]  # noqa: E501
            cloud_spin_task_id (list[str]): Specifies the task id of the cloudSpin run.. [optional]  # noqa: E501
            local_task_id (str): Specifies the task id of the local run.. [optional]  # noqa: E501
            ...
            replication_task_id (list[str]): Specifies the task id of the replication run.. [optional]  # noqa: E501
        """
