...
def lazy_import():
    from cohesity_sdk.cluster.model.common_gcp_external_target_params import (
        CommonGcpExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.tiering_gcp_external_target_params_all_of import (
...
class TieringGcpExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, bucket_name, client_email_address, project_id, *args, **kwargs
    ):  # noqa: E501
