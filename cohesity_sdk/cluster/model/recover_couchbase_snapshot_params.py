...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_couchbase_no_sql_object_params import (
        RecoverCouchbaseNoSqlObjectParams,
    )
    from cohesity_sdk.cluster.model.recover_couchbase_snapshot_params_all_of import (
