...
def lazy_import():
    from cohesity_sdk.cluster.model.o365_search_emails_request_params import (
        O365SearchEmailsRequestParams,
    )
    from cohesity_sdk.cluster.model.search_email_request_params_all_of import (
        SearchEmailRequestParamsAllOf,
    )
    from cohesity_sdk.cluster.model.search_email_request_params_base import (
