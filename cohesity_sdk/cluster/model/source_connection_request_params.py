...
def lazy_import():
    from cohesity_sdk.cluster.model.cassandra_connection_params import (
        CassandraConnectionParams,
    )
    from cohesity_sdk.cluster.model.common_source_connection_request_params import (
        CommonSourceConnectionRequestParams,
    )
    from cohesity_sdk.cluster.model.hadoop_connection_params import (
        HadoopConnectionParams,
    )
    from cohesity_sdk.cluster.model.ms_sql_common_connection_params import (
        MsSQLCommonConnectionParams,
    )
    from cohesity_sdk.cluster.model.oracle_connection_params import (
        OracleConnectionParams,
    )
    from cohesity_sdk.cluster.model.source_connection_request_params_all_of import (
        SourceConnectionRequestParamsAllOf,
    )
    from cohesity_sdk.cluster.model.vmware_connection_params import (
