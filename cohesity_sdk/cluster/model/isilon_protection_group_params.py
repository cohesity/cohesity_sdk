...
class IsilonProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[IsilonProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[IsilonProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            modify_source_permissions (bool): Specifies if the Isilon source permissions should be modified internally to allow backups.. [optional]  # noqa: E501
            ...
            use_changelist (bool): Specify whether to use the Isilon Changelist API to directly discover changed files/directories for faster incremental backup. Cohesity will keep an extra snapshot which will be deleted by the next successful backup.. [optional]  # noqa: E501
        """
