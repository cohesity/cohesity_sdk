...
def lazy_import():
    from cohesity_sdk.cluster.model.mssql_file_protection_group_params import (
        MSSQLFileProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.mssql_native_protection_group_params import (
        MSSQLNativeProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.mssql_volume_protection_group_params import (
