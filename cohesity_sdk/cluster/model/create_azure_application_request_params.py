...
class CreateAzureApplicationRequestParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'existing_microsoft365_app_credentials_list': (list[Office365AppCredentials],),  # noqa: E501
            'microsoft365_region': (str,),  # noqa: E501
        }
    ...
    def __init__(self, access_token, app_count, username, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            existing_microsoft365_app_credentials_list (list[Office365AppCredentials]): Specifies a list of Microsoft365 azure application credentials already added within the Microsoft365 source.. [optional]  # noqa: E501
            microsoft365_region (str): Specifies the region where Office 365 Exchange environment is.. [optional]  # noqa: E501
        """
