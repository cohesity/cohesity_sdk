...
class CommonLSUPairFields(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, local_lsuid, remote_cluster_id, remote_lsuid, *args, **kwargs):  # noqa: E501
        """CommonLSUPairFields - a model defined in OpenAPI
