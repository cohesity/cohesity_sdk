...
class FailoverRunConfiguration(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cancel_non_failover_runs': (bool,),  # noqa: E501
            'pause_next_runs': (bool,),  # noqa: E501
    ...
    def __init__(self, objects, replication_cluster_id, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[FailoverObject]): Specifies the list of all local entity ids of all the objects being failed from the source cluster.
        ...
        Keyword Args:
            ...
            pause_next_runs (bool): If this is set to true then unless failover operation is completed, all the next runs will be pasued.. [optional]  # noqa: E501
            protection_group_id (str): Specifies the active protection group id on the source cluster from where the objects are being failed over.. [optional]  # noqa: E501
            ...
            view_id (int): If failover is initiated by view based orchastrator, then this field specifies the local view id of source cluster which is being failed over.. [optional]  # noqa: E501
        """
