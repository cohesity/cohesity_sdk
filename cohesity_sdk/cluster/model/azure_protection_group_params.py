...
def lazy_import():
    from cohesity_sdk.cluster.model.azure_agent_protection_group_params import (
        AzureAgentProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.azure_native_protection_group_params import (
        AzureNativeProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.azure_snapshot_manager_protection_group_params import (
