...
class AwsSnapshotManagerProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ami_creation_frequency': (int,),  # noqa: E501
            'create_ami': (bool,),  # noqa: E501
            'exclude_object_ids': (list[int],),  # noqa: E501
            'exclude_vm_tag_ids': (list[list[int]],),  # noqa: E501
            'objects': (list[AwsSnapshotManagerProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ami_creation_frequency (int): The frequency of AMI creation. This should be set if the option to create AMI is set. A value of n creates an AMI from the snapshots after every n runs. eg. n = 2 implies every alternate backup run starting from the first will create an AMI.. [optional]  # noqa: E501
            create_ami (bool): Specifies whether AMI should be created after taking snapshots of the instance.. [optional]  # noqa: E501
            ...
            objects (list[AwsSnapshotManagerProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.. [optional]  # noqa: E501
