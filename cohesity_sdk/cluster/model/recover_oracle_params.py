...
class RecoverOracleParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[RecoverOracleDbSnapshotParams],),  # noqa: E501
    ...
    def __init__(self, objects, recovery_action, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[RecoverOracleDbSnapshotParams]): Specifies the list of parameters for list of objects to be recovered.
