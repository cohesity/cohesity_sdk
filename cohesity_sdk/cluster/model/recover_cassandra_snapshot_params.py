...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_cassandra_no_sql_object_params import (
        RecoverCassandraNoSqlObjectParams,
    )
    from cohesity_sdk.cluster.model.recover_cassandra_snapshot_params_all_of import (
