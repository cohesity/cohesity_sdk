...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.create_protected_objects_request_all_of import (
        CreateProtectedObjectsRequestAllOf,
    )
    from cohesity_sdk.cluster.model.env_specific_object_protection_request_params import (
