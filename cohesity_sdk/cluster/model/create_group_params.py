...
def lazy_import():
    from cohesity_sdk.cluster.model.common_group_params import CommonGroupParams
    from cohesity_sdk.cluster.model.create_group_params_all_of import CreateGroupParamsAllOf
    from cohesity_sdk.cluster.model.local_group_params import LocalGroupParams
    globals()['CommonGroupParams'] = CommonGroupParams
    globals()['CreateGroupParamsAllOf'] = CreateGroupParamsAllOf
    globals()['LocalGroupParams'] = LocalGroupParams


class CreateGroupParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, domain, group_type, name, *args, **kwargs):  # noqa: E501
