...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.recover_acropolis_file_and_folder_params import (
        RecoverAcropolisFileAndFolderParams,
    )
    from cohesity_sdk.cluster.model.recover_acropolis_snapshot_params import (
        RecoverAcropolisSnapshotParams,
    )
    from cohesity_sdk.cluster.model.recover_acropolis_vm_params import (
