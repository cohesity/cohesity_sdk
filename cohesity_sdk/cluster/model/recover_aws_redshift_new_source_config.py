...
class RecoverAwsRedshiftNewSourceConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, cluster, source, *args, **kwargs):  # noqa: E501
        """RecoverAwsRedshiftNewSourceConfig - a model defined in OpenAPI
