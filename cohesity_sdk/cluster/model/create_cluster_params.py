...
def lazy_import():
    from cohesity_sdk.cluster.model.cluster_create_cloud_params import (
        ClusterCreateCloudParams,
    )
    from cohesity_sdk.cluster.model.cluster_create_network_config import (
        ClusterCreateNetworkConfig,
    )
    from cohesity_sdk.cluster.model.cluster_create_physical_params import (
        ClusterCreatePhysicalParams,
    )
    from cohesity_sdk.cluster.model.cluster_create_rigel_params import (
        ClusterCreateRigelParams,
    )
    from cohesity_sdk.cluster.model.cluster_create_virtual_params import (
        ClusterCreateVirtualParams,
    )
    from cohesity_sdk.cluster.model.cluster_proxy_server_config import (
