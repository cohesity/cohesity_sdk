...
def lazy_import():
    from cohesity_sdk.cluster.model.archival_ibm_external_target_params_all_of import ArchivalIBMExternalTargetParamsAllOf
    from cohesity_sdk.cluster.model.common_ibmcos_external_target_params import CommonIBMCOSExternalTargetParams
    from cohesity_sdk.cluster.model.ibm_authentication_methods_params import IBMAuthenticationMethodsParams
    globals()['ArchivalIBMExternalTargetParamsAllOf'] = ArchivalIBMExternalTargetParamsAllOf
    globals()['CommonIBMCOSExternalTargetParams'] = CommonIBMCOSExternalTargetParams
    globals()['IBMAuthenticationMethodsParams'] = IBMAuthenticationMethodsParams


class ArchivalIBMExternalTargetParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'authentication_method': (IBMAuthenticationMethodsParams,),  # noqa: E501
            ...
            'endpoint_for_connectors': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'endpoint_for_connectors': 'endpointForConnectors',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, authentication_method, bucket_name, location, storage_class, *args, **kwargs):  # noqa: E501
        """ArchivalIBMExternalTargetParams - a model defined in OpenAPI

        Args:
            authentication_method (IBMAuthenticationMethodsParams):
        ...
        Keyword Args:
            ...
            endpoint (str, none_type): Specifies the complete endpoint to be used by the Cohesity cluster to access the external target. If specified, location and endpointType parameters are ignored. For example, an endpoint would look like s3.direct.us-east.cloud-object-storage.appdomain.cloud (direct endpoint) OR s3.us-east.cloud-object-storage.appdomain.cloud (public endpoint).. [optional]  # noqa: E501
            endpoint_for_connectors (str, none_type): Specifies the complete endpoint to be used by the data-source connector(s) to access the external target. If not specified, 'endpoint' parameter is used. If 'endpoint' parameter is also not specified, endpoint constructed by 'location' and 'endpointType' would be used by the data-source connector(s) to access the external target.. [optional]  # noqa: E501
            endpoint_type (str, none_type): Specifies the endpoint type to be used to access the external target. The endpoint used by the Cohesity cluster or data-source connectors is constructed using 'endpointType' and 'location' as follows, s3[.endpointType].[location].cloud-object-storage.appdomaincloud. Eg. s3.private.us-east.cloud-object-storage.appdomain.cloud. [optional]  # noqa: E501
            is_forever_incremental_archival_enabled (bool, none_type): Specifies if Forever Incremental Archival setting is enabled or not. Check the documentation for details.. [optional]  # noqa: E501
            is_incremental_archival_enabled (bool, none_type): Specifies if Incremental Archival setting is enabled or not. Check the documentation for details.. [optional]  # noqa: E501
            source_side_deduplication (bool, none_type): Specifies the Source Side Deduplication setting for the IBM COS external target. If set to true deduplication is done before sending data to the external target.. [optional]  # noqa: E501
        """
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ArchivalIBMExternalTargetParamsAllOf,
