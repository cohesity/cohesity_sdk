...
def lazy_import():
    from cohesity_sdk.cluster.model.common_nas_protection_params import (
        CommonNasProtectionParams,
    )
    from cohesity_sdk.cluster.model.continuous_snapshot_params import (
        ContinuousSnapshotParams,
    )
    from cohesity_sdk.cluster.model.elastifile_object_protection_request_params_all_of import (
    ...
    from cohesity_sdk.cluster.model.file_level_data_lock_config import (
        FileLevelDataLockConfig,
    )
    from cohesity_sdk.cluster.model.host_based_backup_script_params import (
    ...
    from cohesity_sdk.cluster.model.netapp_object_protection_params import (
