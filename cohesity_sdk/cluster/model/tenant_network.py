...
class TenantNetwork(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'connector_enabled': (bool,),  # noqa: E501
            'cluster_hostname': (str,),  # noqa: E501
            'cluster_ips': (list[str],),  # noqa: E501
        }
    ...
    def __init__(self, connector_enabled, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cluster_ips (list[str]): Set of IPs as seen from the tenant's network for the Cohesity cluster. Only one from 'clusterHostname' and 'clusterIps' is needed.. [optional]  # noqa: E501
        """
