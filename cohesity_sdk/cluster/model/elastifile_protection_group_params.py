...
class ElastifileProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[ElastifileProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[ElastifileProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            protocol (str): Specifies the protocol of the NAS device being backed up.. [optional]  # noqa: E501
