...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.group_object_entity_params import (
    ...
    from cohesity_sdk.cluster.model.mssql_object_entity_params import (
    ...
    from cohesity_sdk.cluster.model.object_protection_stats_summary import (
        ObjectProtectionStatsSummary,
    )
    from cohesity_sdk.cluster.model.object_string_identifier import (
        ObjectStringIdentifier,
    )
    from cohesity_sdk.cluster.model.object_summary import ObjectSummary
    from cohesity_sdk.cluster.model.object_type_v_center_params import (
        ObjectTypeVCenterParams,
    )
    from cohesity_sdk.cluster.model.object_type_windows_cluster_params import (
        ObjectTypeWindowsClusterParams,
    )
    from cohesity_sdk.cluster.model.object_with_children_all_of import (
        ObjectWithChildrenAllOf,
    )
    from cohesity_sdk.cluster.model.oracle_object_entity_params import (
        OracleObjectEntityParams,
    )
    from cohesity_sdk.cluster.model.permission_info import PermissionInfo
    from cohesity_sdk.cluster.model.physical_object_entity_params import (
        PhysicalObjectEntityParams,
    )
    from cohesity_sdk.cluster.model.sharepoint_object_entity_params import (
        SharepointObjectEntityParams,
    )
    from cohesity_sdk.cluster.model.sharepoint_object_params import (
    ...
    from cohesity_sdk.cluster.model.vmware_object_entity_params import (
