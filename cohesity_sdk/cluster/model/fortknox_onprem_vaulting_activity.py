...
def lazy_import():
    from cohesity_sdk.cluster.model.fortknox_onprem_vaulting_activity_replica_info import FortknoxOnpremVaultingActivityReplicaInfo
    globals()['FortknoxOnpremVaultingActivityReplicaInfo'] = FortknoxOnpremVaultingActivityReplicaInfo


class FortknoxOnpremVaultingActivity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'replication_info': (FortknoxOnpremVaultingActivityReplicaInfo,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FortknoxOnpremVaultingActivity - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            policy_id (str, none_type): Policy ID of the Protection Group on the current cluster. For replication runs, the replicated policy on the Vault cluster shares the same ID as the policy on the Primary cluster.. [optional]  # noqa: E501
            policy_name (str, none_type): Name of the policy of the Protection Group on the primary cluster.. [optional]  # noqa: E501
            protection_environment_type (str, none_type): Specifies the type of protection environment.. [optional]  # noqa: E501
            protection_group_id (str, none_type): Protection Group Id to which this run belongs on current cluster.. [optional]  # noqa: E501
            protection_group_name (str, none_type): Name of the Protection Group to which this run belongs on current cluster.. [optional]  # noqa: E501
            replication_info (FortknoxOnpremVaultingActivityReplicaInfo): [optional]  # noqa: E501
            run_id (str, none_type): Specifies the ID of the Protection Group run.. [optional]  # noqa: E501
            run_start_time_usecs (int, none_type): Specifies the start time of run in Unix epoch Timestamp(in microseconds).. [optional]  # noqa: E501
        """
