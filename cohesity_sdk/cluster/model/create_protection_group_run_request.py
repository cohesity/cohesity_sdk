...
class CreateProtectionGroupRunRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': (list[RunObject],),  # noqa: E501
    ...
    def __init__(self, run_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            objects (list[RunObject]): Specifies the list of objects to be protected by this Protection Group run. These can be leaf objects or non-leaf objects in the protection hierarchy. This must be specified only if a subset of objects from the Protection Groups needs to be protected.. [optional]  # noqa: E501
