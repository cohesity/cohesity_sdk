...
def lazy_import():
    from cohesity_sdk.cluster.model.cassandra_protection_run_params import (
        CassandraProtectionRunParams,
    )
    from cohesity_sdk.cluster.model.run_object import RunObject
    from cohesity_sdk.cluster.model.run_targets_configuration import (
        RunTargetsConfiguration,
    )
    from cohesity_sdk.cluster.model.uda_protection_run_params import (
