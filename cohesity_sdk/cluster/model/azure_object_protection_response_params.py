...
def lazy_import():
    from cohesity_sdk.cluster.model.azure_common_object_protection_params import (
        AzureCommonObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.azure_native_object_protection_params import (
        AzureNativeObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.azure_object_protection_request_params_all_of import (
        AzureObjectProtectionRequestParamsAllOf,
    )
    from cohesity_sdk.cluster.model.azure_sql_object_protection_params import (
...
class AzureObjectProtectionResponseParams(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            "azure_sql_protection_type_params": (
                AzureSqlObjectProtectionParams,
            ),  # noqa: E501
