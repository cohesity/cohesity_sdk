...
class RecoverNetappFilesParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'files_and_folders': (list[NetappRecoverFileAndFolderInfo],),  # noqa: E501
    ...
    def __init__(self, files_and_folders, target_environment, *args, **kwargs):  # noqa: E501
        ...
        Args:
            files_and_folders (list[NetappRecoverFileAndFolderInfo]): Specifies the list of info about the netapp files and folders to be recovered.
