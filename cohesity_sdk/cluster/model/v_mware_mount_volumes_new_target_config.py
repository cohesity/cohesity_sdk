...
class VMwareMountVolumesNewTargetConfig(ModelNormal):
    ...
    def __init__(self, bring_disks_online, mount_target, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            use_existing_agent (bool): Specifies whether this will use an existing agent on the target vm or will deploy a new agent. This is required if bringDisksOnline is set to true.. [optional]  # noqa: E501
        """
