...
class GenericNasProtectionGroupParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[ProtectionObjectInput],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[ProtectionObjectInput]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            continue_on_error (bool): Specifies whether or not the backup should continue regardless of whether or not an error was encountered.. [optional]  # noqa: E501
            encryption_enabled (bool): Specifies whether the encryption should be used while backup or not.. [optional]  # noqa: E501
