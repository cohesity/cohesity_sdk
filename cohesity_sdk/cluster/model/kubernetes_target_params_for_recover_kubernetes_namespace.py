...
class KubernetesTargetParamsForRecoverKubernetesNamespace(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'excluded_pvcs': (list[KubernetesPvcInfo],),  # noqa: E501
            'objects': (list[CommonRecoverObjectSnapshotParams],),  # noqa: E501
            'recover_protection_group_runs_params': (list[RecoverProtectionGroupRunParams],),  # noqa: E501
    ...
    def __init__(self, recovery_target_config, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            excluded_pvcs (list[KubernetesPvcInfo]): Specifies the list of pvc to be excluded from recovery.. [optional]  # noqa: E501
            objects (list[CommonRecoverObjectSnapshotParams]): Specifies the objects to be recovered.. [optional]  # noqa: E501
            recover_protection_group_runs_params (list[RecoverProtectionGroupRunParams]): Specifies the Protection Group Runs params to recover. All the VM's that are successfully backed up by specified Runs will be recovered. This can be specified along with individual snapshots of VMs. User has to make sure that specified Object snapshots and Protection Group Runs should not have any intersection. For example, user cannot specify multiple Runs which has same Object or an Object snapshot and a Run which has same Object's snapshot.. [optional]  # noqa: E501
