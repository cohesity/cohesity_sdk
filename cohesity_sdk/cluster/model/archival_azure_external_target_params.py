...
def lazy_import():
    from cohesity_sdk.cluster.model.archival_azure_external_target_params_all_of import (
        ArchivalAzureExternalTargetParamsAllOf,
    )
    from cohesity_sdk.cluster.model.azure_archive_blob_params import (
    ...
    from cohesity_sdk.cluster.model.common_archival_azure_external_target_params import (
        CommonArchivalAzureExternalTargetParams,
    )
    from cohesity_sdk.cluster.model.worm_specific_target_params import (
...
class ArchivalAzureExternalTargetParams(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, container_name, storage_account_name, storage_class, *args, **kwargs
    ):  # noqa: E501
