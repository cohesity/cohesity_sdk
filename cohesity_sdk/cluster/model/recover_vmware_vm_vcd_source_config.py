...
class RecoverVmwareVmVCDSourceConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'datastores': (list[RecoveryObjectIdentifier],),  # noqa: E501
    ...
    def __init__(self, source, vdc, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            datastores (list[RecoveryObjectIdentifier]): Specifies the datastore objects where the object's files should be recovered to. This should only be specified if storageProfile is not specified.. [optional]  # noqa: E501
