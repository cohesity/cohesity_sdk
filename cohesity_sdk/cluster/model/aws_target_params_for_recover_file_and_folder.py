...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_recover_files_new_target_config import (
        AwsRecoverFilesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.aws_recover_files_original_target_config import (
