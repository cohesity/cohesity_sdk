...
class DownloadFilesAndFoldersRequestParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'files_and_folders': (list[FilesAndFoldersObject],),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    def __init__(self, files_and_folders, name, object, *args, **kwargs):  # noqa: E501
        ...
        Args:
            files_and_folders (list[FilesAndFoldersObject]): Specifies the list of files and folders to download.
