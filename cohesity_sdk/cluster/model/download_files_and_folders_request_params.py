...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.document_object import DocumentObject
    ...
    globals()['DocumentObject'] = DocumentObject
...
class DownloadFilesAndFoldersRequestParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'documents': ([DocumentObject], none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, object, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            documents ([DocumentObject], none_type): Specifies the list of documents to download using item ids. Only one of filesAndFolders or documents should be used. Currently only files are supported by documents.. [optional]  # noqa: E501
            files_and_folders ([FilesAndFoldersObject], none_type): Specifies the list of files and folders to download. Only one of filesAndFolders or documents should be used.. [optional]  # noqa: E501
