...
class IdentityProviderConfiguration(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'allow_local_user_login': (bool,),  # noqa: E501
            'certificate_filename': (str,),  # noqa: E501
            'is_enabled': (bool,),  # noqa: E501
            'roles': (list[str],),  # noqa: E501
            'saml_attribute_name': (str,),  # noqa: E501
            'sign_request': (bool,),  # noqa: E501
    ...
    def __init__(self, certificate, issuer_id, sso_url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            certificate_filename (str): Specifies the filename used for the certificate. The default value is idp_certificate.pem. [optional]  # noqa: E501
            is_enabled (bool): Specifies a flag to enable or disable this idp service. When it is set to true, idp service is enabled. When it is set to false, idp service is disabled. By defaut idp is enabled i.e the value is true.. [optional]  # noqa: E501
            roles (list[str]): Specifies the default roles assined for all SSO users. [optional]  # noqa: E501
            saml_attribute_name (str): Specifies the SAML attribute name that contains a comma separated list of cluster roles. This sets the default roles for all SSO users. Either this field or roles must be set, this field takes higher precedence than the roles field.. [optional]  # noqa: E501
            ...
            domain (str): Specifies domain of idp configuration. [optional]  # noqa: E501
            id (int): Specifies id of idp configuration. [optional]  # noqa: E501
            name (str): Specifies name of the vendor providing idp service. [optional]  # noqa: E501
