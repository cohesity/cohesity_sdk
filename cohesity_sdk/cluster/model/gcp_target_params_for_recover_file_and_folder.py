...
def lazy_import():
    from cohesity_sdk.cluster.model.gcp_recover_files_new_target_config import (
        GcpRecoverFilesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.gcp_recover_files_original_target_config import (
