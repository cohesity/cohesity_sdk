...
class AddedActiveDirectoryPrincipal(ModelComposed):
    ...
    def __init__(self, domain_name, name, object_class, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): Specifies a description about the user or group.. [optional]  # noqa: E501
            restricted (bool): Whether the principal is a restricted principal. A restricted principal can only view the objects he has permissions to.. [optional]  # noqa: E501
            ...
            created_time_msecs (int): Specifies the epoch time in milliseconds when the group or user was added to the Cohesity Cluster.. [optional]  # noqa: E501
            last_updated_time_msecs (int): Specifies the epoch time in milliseconds when the group or user was last modified on the Cohesity Cluster.. [optional]  # noqa: E501
            sid (str): Specifies the unique Security ID (SID) of the Active Directory principal associated with this group or user.. [optional]  # noqa: E501
        """
