...
class CloudSpinTargetResult(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'id': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'cloudspin_task_id': (str,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (int): Specifies the unique id of the cloud spin entity.. [optional]  # noqa: E501
            name (str): Specifies the name of the already added cloud spin target.. [optional]  # noqa: E501
            cloudspin_task_id (str): Task ID for a CloudSpin protection run.. [optional]  # noqa: E501
            data_lock_constraints (DataLockConstraints): [optional]  # noqa: E501
            end_time_usecs (int): Specifies the end time of Cloud Spin in Unix epoch Timestamp(in microseconds) for a target.. [optional]  # noqa: E501
            ...
            message (str): Message about the Cloud Spin run.. [optional]  # noqa: E501
            on_legal_hold (bool): Specifies the legal hold status for a cloud spin target.. [optional]  # noqa: E501
            progress_task_id (str): Progress monitor task id for Cloud Spin run.. [optional]  # noqa: E501
            start_time_usecs (int): Specifies the start time of Cloud Spin in Unix epoch Timestamp(in microseconds) for a target.. [optional]  # noqa: E501
