...
def lazy_import():
    from cohesity_sdk.cluster.model.acropolis_protection_group_params import (
        AcropolisProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.ad_protection_group_params import (
        ADProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_protection_group_params import (
        AwsProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.azure_protection_group_params import (
        AzureProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.cassandra_protection_group_params import (
        CassandraProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.common_protection_group_response_params import (
        CommonProtectionGroupResponseParams,
    )
    from cohesity_sdk.cluster.model.common_protection_group_run_response_parameters import (
        CommonProtectionGroupRunResponseParameters,
    )
    from cohesity_sdk.cluster.model.create_or_update_protection_group_request_all_of import (
        CreateOrUpdateProtectionGroupRequestAllOf,
    )
    from cohesity_sdk.cluster.model.elastifile_protection_group_params import (
        ElastifileProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.exchange_protection_group_params import (
        ExchangeProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.flashblade_protection_group_params import (
        FlashbladeProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.gcp_protection_group_params import (
        GcpProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.generic_nas_protection_group_params import (
        GenericNasProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.gpfs_protection_group_params import (
        GpfsProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.hdfs_protection_group_params import (
        HdfsProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_protection_group_params import (
        HyperVProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.ibm_flash_system_protection_group_params import (
        IbmFlashSystemProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.isilon_protection_group_params import (
        IsilonProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.key_value_pair import KeyValuePair
    from cohesity_sdk.cluster.model.kubernetes_protection_group_params import (
        KubernetesProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.kvm_protection_group_params import (
        KvmProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.missing_entity_params import MissingEntityParams
    from cohesity_sdk.cluster.model.mongo_db_protection_group_params import (
        MongoDBProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.mssql_protection_group_params import (
        MSSQLProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.netapp_protection_group_params import (
        NetappProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.nimble_protection_group_params import (
        NimbleProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.no_sql_protection_group_params import (
        NoSqlProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.office365_protection_group_params import (
        Office365ProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.oracle_protection_group_params import (
        OracleProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.physical_protection_group_params import (
        PhysicalProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.protection_group_alerting_policy import (
        ProtectionGroupAlertingPolicy,
    )
    from cohesity_sdk.cluster.model.pure_protection_group_params import (
        PureProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.remote_adapter_protection_group_params import (
        RemoteAdapterProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.sfdc_protection_group_params import (
    ...
    from cohesity_sdk.cluster.model.uda_protection_group_params import (
