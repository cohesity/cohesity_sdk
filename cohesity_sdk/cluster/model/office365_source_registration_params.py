...
def lazy_import():
    from cohesity_sdk.cluster.model.common_source_registration_params import (
        CommonSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.credentials import Credentials
    from cohesity_sdk.cluster.model.objects_discovery_params import (
        ObjectsDiscoveryParams,
    )
    from cohesity_sdk.cluster.model.office365_app_credentials import (
        Office365AppCredentials,
    )
    from cohesity_sdk.cluster.model.office365_source_registration_params_all_of import (
