...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_source_registration_params import (
        AwsSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.azure_source_registration_params import (
        AzureSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.cassandra_source_registration_params import (
        CassandraSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.common_source_registration_reponse_params import (
        CommonSourceRegistrationReponseParams,
    )
    from cohesity_sdk.cluster.model.connection_config import ConnectionConfig
    from cohesity_sdk.cluster.model.couchbase_source_registration_params import (
        CouchbaseSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.elastifile_registration_params import (
        ElastifileRegistrationParams,
    )
    from cohesity_sdk.cluster.model.entity_external_metadata import (
        EntityExternalMetadata,
    )
    from cohesity_sdk.cluster.model.flashblade_registration_params import (
        FlashbladeRegistrationParams,
    )
    from cohesity_sdk.cluster.model.generic_nas_registration_params import (
        GenericNasRegistrationParams,
    )
    from cohesity_sdk.cluster.model.gpfs_registration_params import (
        GpfsRegistrationParams,
    )
    from cohesity_sdk.cluster.model.hbase_source_registration_params import (
        HbaseSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.hdfs_source_registration_params import (
        HdfsSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.hive_source_registration_params import (
        HiveSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_source_registration_params import (
        HyperVSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.isilon_registration_params import (
        IsilonRegistrationParams,
    )
    from cohesity_sdk.cluster.model.key_value_pair import KeyValuePair
    from cohesity_sdk.cluster.model.mongo_db_source_registration_params import (
        MongoDBSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.netapp_registration_params import (
        NetappRegistrationParams,
    )
    from cohesity_sdk.cluster.model.object import Object
    from cohesity_sdk.cluster.model.office365_source_registration_params import (
        Office365SourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.physical_source_registration_params import (
        PhysicalSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.sfdc_source_registration_params import (
        SfdcSourceRegistrationParams,
    )
    from cohesity_sdk.cluster.model.source_registration_all_of import (
        SourceRegistrationAllOf,
    )
    from cohesity_sdk.cluster.model.uda_source_registration_params import (
