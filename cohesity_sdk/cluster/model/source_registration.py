...
class SourceRegistration(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'connections': (list[ConnectionConfig],),  # noqa: E501
            'connector_group_id': (int,),  # noqa: E501
            'environment': (str,),  # noqa: E501
            'id': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'source_id': (int,),  # noqa: E501
            'source_info': (Object,),  # noqa: E501
            'authentication_status': (str,),  # noqa: E501
            'last_refreshed_time_msecs': (int,),  # noqa: E501
            'registration_time_msecs': (int,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            advanced_configs (list[KeyValuePair]): Specifies the advanced configuration for a protection source.. [optional]  # noqa: E501
            connection_id (int): Specifies the id of the connection from where this source is reachable. This should only be set for a source being registered by a tenant user. This field will be depricated in future. Use connections field.. [optional]  # noqa: E501
            connections (list[ConnectionConfig]): Specfies the list of connections for the source.. [optional]  # noqa: E501
            connector_group_id (int): Specifies the connector group id of connector groups.. [optional]  # noqa: E501
            environment (str): Specifies the environment type of the Protection Source.. [optional]  # noqa: E501
            id (int): Source Registration ID. This can be used to retrieve, edit or delete the source registration.. [optional]  # noqa: E501
            name (str): The user specified name for this source.. [optional]  # noqa: E501
            source_id (int): ID of top level source object discovered after the registration.. [optional]  # noqa: E501
            ...
            last_refreshed_time_msecs (int): Specifies the time when the source was last refreshed in milliseconds.. [optional]  # noqa: E501
            registration_time_msecs (int): Specifies the time when the source was registered in milliseconds. [optional]  # noqa: E501
