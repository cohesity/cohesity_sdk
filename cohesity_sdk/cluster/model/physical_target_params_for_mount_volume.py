...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.physical_mount_volumes_new_target_config import (
        PhysicalMountVolumesNewTargetConfig,
    )
    from cohesity_sdk.cluster.model.physical_mount_volumes_original_target_config import (
