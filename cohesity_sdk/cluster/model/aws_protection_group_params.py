...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_agent_protection_group_params import (
        AwsAgentProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_aurora_protection_group_params import (
        AwsAuroraProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_native_protection_group_params import (
        AwsNativeProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_rds_postgres_protection_group_params import (
        AwsRdsPostgresProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_rds_protection_group_params import (
        AwsRdsProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_s3_protection_group_params import (
        AwsS3ProtectionGroupParams,
    )
    from cohesity_sdk.cluster.model.aws_snapshot_manager_protection_group_params import (
