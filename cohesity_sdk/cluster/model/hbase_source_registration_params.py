...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.hbase_source_registration_params_all_of import (
        HbaseSourceRegistrationParamsAllOf,
    )
    from cohesity_sdk.cluster.model.hbase_source_registration_params_all_of_ssh_password_credentials import (
