...
def lazy_import():
    from cohesity_sdk.cluster.model.aws_object_protection_response_params import (
        AwsObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.azure_object_protection_response_params import (
        AzureObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.common_backup_params import CommonBackupParams
    from cohesity_sdk.cluster.model.common_mssql_object_protection_params import (
        CommonMssqlObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.elastifile_object_protection_response_params import (
        ElastifileObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.env_specific_object_protection_response_params import (
        EnvSpecificObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.flashblade_object_protection_response_params import (
        FlashbladeObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.generic_nas_object_protection_response_params import (
        GenericNasObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.gpfs_object_protection_response_params import (
        GpfsObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.hyper_v_object_protection_response_params import (
        HyperVObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.isilon_object_protection_response_params import (
        IsilonObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.netapp_object_protection_response_params import (
        NetappObjectProtectionResponseParams,
    )
    from cohesity_sdk.cluster.model.office365_object_protection_params import (
        Office365ObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.oracle_object_based_protection_params import (
        OracleObjectBasedProtectionParams,
    )
    from cohesity_sdk.cluster.model.physical_object_protection_params import (
        PhysicalObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.policy_config import PolicyConfig
    from cohesity_sdk.cluster.model.protected_object_backup_config_all_of import (
        ProtectedObjectBackupConfigAllOf,
    )
    from cohesity_sdk.cluster.model.sfdc_object_protection_params import (
    ...
    from cohesity_sdk.cluster.model.uda_object_protection_params import (
        UdaObjectProtectionParams,
    )
    from cohesity_sdk.cluster.model.vmware_object_protection_response_params import (
