...
class Office365UserMailboxObjectProtectionParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': (list[Office365ObjectProtectionObjectParams],),  # noqa: E501
            'indexing_policy': (IndexingPolicy,),  # noqa: E501
            'source_id': (int,),  # noqa: E501
            'source_name': (str,),  # noqa: E501
            'exclude_folders': (list[str],),  # noqa: E501
            'include_folders': (list[str],),  # noqa: E501
        }
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        ...
        Args:
            objects (list[Office365ObjectProtectionObjectParams]): Specifies the objects to be included in the Object Protection.
