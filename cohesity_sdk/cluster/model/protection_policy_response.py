...
class ProtectionPolicyResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'blackout_window': (list[BlackoutWindow],),  # noqa: E501
            'cascaded_targets_config': (list[CascadedTargetConfiguration],),  # noqa: E501
            'data_lock': (str,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'enable_smart_local_retention_adjustment': (bool,),  # noqa: E501
            'extended_retention': (list[ExtendedRetentionPolicy],),  # noqa: E501
            'is_cbs_enabled': (bool,),  # noqa: E501
            'last_modification_time_usecs': (int,),  # noqa: E501
            'remote_target_policy': (TargetsConfiguration,),  # noqa: E501
            'retry_options': (RetryOptions,),  # noqa: E501
            'version': (int,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'is_replicated': (bool,),  # noqa: E501
            'is_usable': (bool,),  # noqa: E501
            'num_protected_objects': (int,),  # noqa: E501
            'num_protection_groups': (int,),  # noqa: E501
    ...
    def __init__(self, backup_policy, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            blackout_window (list[BlackoutWindow]): List of Blackout Windows. If specified, this field defines blackout periods when new Group Runs are not started. If a Group Run has been scheduled but not yet executed and the blackout period starts, the behavior depends on the policy field AbortInBlackoutPeriod.. [optional]  # noqa: E501
            cascaded_targets_config (list[CascadedTargetConfiguration]): Specifies the configuration for cascaded replications. Using cascaded replication, replication cluster(Rx) can further replicate and archive the snapshot copies to further targets. Its recommended to create cascaded configuration where protection group will be created.. [optional]  # noqa: E501
            data_lock (str): This field is now deprecated. Please use the DataLockConfig in the backup retention.. [optional]  # noqa: E501
            description (str): Specifies the description of the Protection Policy.. [optional]  # noqa: E501
            ...
            extended_retention (list[ExtendedRetentionPolicy]): Specifies additional retention policies that should be applied to the backup snapshots. A backup snapshot will be retained up to a time that is the maximum of all retention policies that are applicable to it.. [optional]  # noqa: E501
            is_cbs_enabled (bool): Specifies true if Calender Based Schedule is supported by client. Default value is assumed as false for this feature.. [optional]  # noqa: E501
            ...
            version (int): Specifies the current policy verison. Policy version is incremented for optionally supporting new features and differentialting across releases.. [optional]  # noqa: E501
            id (str): Specifies a unique Policy id assigned by the Cohesity Cluster.. [optional]  # noqa: E501
            is_replicated (bool): This field is set to true when policy is the replicated policy.. [optional]  # noqa: E501
            ...
            num_protected_objects (int): Specifies the number of protected objects using the protection policy.. [optional]  # noqa: E501
            num_protection_groups (int): Specifies the number of protection groups using the protection policy.. [optional]  # noqa: E501
            template_id (str): Specifies the parent policy template id to which the policy is linked to. This field is set only when policy is created from template.. [optional]  # noqa: E501
        """
