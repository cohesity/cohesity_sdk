...
def lazy_import():
    ...
    from cohesity_sdk.cluster.model.nutanix_fs_protection_group_object_params import NutanixFSProtectionGroupObjectParams
    ...
    globals()['NutanixFSProtectionGroupObjectParams'] = NutanixFSProtectionGroupObjectParams
    globals()['SnapMirrorConfig'] = SnapMirrorConfig
    globals()['SnapshotLabel'] = SnapshotLabel


class NutanixFSProtectionGroupParams(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([NutanixFSProtectionGroupObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """NutanixFSProtectionGroupParams - a model defined in OpenAPI

        Args:
            objects ([NutanixFSProtectionGroupObjectParams]): Specifies the objects to be included in the Protection Group.
        ...
        Keyword Args:
            ...
            backup_existing_snapshot (bool, none_type): Specifies that snapshot label is not set for Data-Protect Nutanix FS Volumes backup. If field is set to true, existing oldest snapshot is used for backup and subsequent incremental will be selected in ascending order of snapshot create time on the source. If snapshot label is set, this field is set to false.. [optional]  # noqa: E501
            ...
            modify_source_permissions (bool, none_type): Specifies if the Nutanix FS source permissions should be modified internally to allow backups.. [optional]  # noqa: E501
