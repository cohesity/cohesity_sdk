...
from cohesity_sdk.cluster.api import storage_domain
from cohesity_sdk.cluster.cohesity.model.storage_domain import StorageDomain
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = storage_domain.StorageDomainApi(api_client)
    body = StorageDomain(
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a Storage Domain by id.
        api_response = api_instance.get_storage_domain_by_id(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import storage_domain
from cohesity_sdk.cluster.cohesity.model.storage_domains import StorageDomains
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
