...
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.user_quota_overrides import UserQuotaOverrides
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = view.ViewApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.clear_nlm_lock_request import ClearNlmLockRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view import View
from cohesity_sdk.cluster.cohesity.model.clone_view_params import CloneViewParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.clone_view_directory_params import CloneViewDirectoryParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.close_smb_file_open_params import CloseSmbFileOpenParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.share import Share
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view import View
from cohesity_sdk.cluster.cohesity.model.create_view_request import CreateViewRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.template import Template
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete directory quota for the View.
        api_instance.delete_view_directory_quota(id)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.user_quota_delete_params import UserQuotaDeleteParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.file_lock_status import FileLockStatus
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.get_nlm_locks_result import GetNlmLocksResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.qos_policies_result import QosPoliciesResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.error import Error
from cohesity_sdk.cluster.cohesity.model.shares import Shares
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
configuration = cohesity_sdk.cluster.Configuration(
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_clients import ViewClients
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_clients_summary import ViewClientsSummary
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_directory_quotas import ViewDirectoryQuotas
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get directory quotas for the View.
        api_response = api_instance.get_view_directory_quotas(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_user_quotas import ViewUserQuotas
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get View user quotas.
        api_response = api_instance.get_view_user_quotas(view_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.get_views_result import GetViewsResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    view_protection_types = [
        "Local",
    ] # [str] | Filter by a list of View protection types. Supported types: [Local Archival ReplicationOut ReplicationIn UnProtected]. UnProtected is mutually exclusive from remaining types. (optional)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.views_summary import ViewsSummary
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.smb_file_opens import SmbFileOpens
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.lock_file_params import LockFileParams
from cohesity_sdk.cluster.cohesity.model.file_lock_status import FileLockStatus
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.multiple_views_update_success_failure_ids import MultipleViewsUpdateSuccessFailureIds
from cohesity_sdk.cluster.cohesity.model.migrate_s3_views import MigrateS3Views
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.overwrite_view_params import OverwriteViewParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.get_view_templates_result import GetViewTemplatesResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.update_share_param import UpdateShareParam
from cohesity_sdk.cluster.cohesity.model.share import Share
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_directory_quota import ViewDirectoryQuota
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.user_quota import UserQuota
from cohesity_sdk.cluster.cohesity.model.error import Error
from cohesity_sdk.cluster.cohesity.model.quota_policy import QuotaPolicy
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
configuration = cohesity_sdk.cluster.Configuration(
...
from cohesity_sdk.cluster.api import view
from cohesity_sdk.cluster.cohesity.model.view_user_quotas import ViewUserQuotas
from cohesity_sdk.cluster.cohesity.model.view_user_quota_settings import ViewUserQuotaSettings
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
