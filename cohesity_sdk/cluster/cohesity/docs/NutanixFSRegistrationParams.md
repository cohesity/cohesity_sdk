...
**endpoint** | **str, none_type** | Specifies the Hostname or IP Address Endpoint for the NutanixFS Source. | 
**source_type** | **str, none_type** | Specifies the NutanixFS source type. Can be either kPrismCentral or kPrismElement or kFileServer or kMountTarget. | 
