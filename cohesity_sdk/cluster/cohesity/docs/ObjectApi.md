...
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.associate_entity_metadata_request import AssociateEntityMetadataRequest
from cohesity_sdk.cluster.cohesity.model.associate_entity_metadata_result import AssociateEntityMetadataResult
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = object.ObjectApi(api_client)
    body = AssociateEntityMetadataRequest(
        entity_list=[
            EntityMetadataParams(
                aws_params=AwsEntityMetadata(
                    aurora_params=AwsAuroraEntityMetadata(
                        db_engine_id="db_engine_id_example",
                        metadata_list=[
                            AwsPostgresMetadata(
                                metadata_type="Credentials",
                                standard_credentials=AwsCredentials(
                                    auth_type="kUseIAMUser",
                                    directory_dns_address="directory_dns_address_example",
                    ...
                    child_metadata=AwsEntityChildMetadata(
                        aurora_metadata=AwsAuroraEntityMetadata(
                            db_engine_id="db_engine_id_example",
                            metadata_list=[
                                AwsPostgresMetadata(
                                    metadata_type="Credentials",
                        ...
                        document_db_metadata=AwsDocumentDBEntityMetadata(
                            db_engine_id="db_engine_id_example",
                            metadata_list=[
                        ...
                        rds_metadata=AwsRdsEntityMetadata(
                            db_engine_id="db_engine_id_example",
                            metadata_list=[
                                AwsPostgresMetadata(
                                    metadata_type="Credentials",
                    ...
                    document_db_params=AwsDocumentDBEntityMetadata(
                        db_engine_id="db_engine_id_example",
                        metadata_list=[
                            AwsDocumentDBMetadata(
                                metadata_type="Credentials",
                    ...
                    rds_params=AwsRdsEntityMetadata(
                        db_engine_id="db_engine_id_example",
                        metadata_list=[
                            AwsPostgresMetadata(
                                metadata_type="Credentials",
                ...
                azure_params=AzureEntityMetadata(
                    azure_cosmos_db_cassandra_params=AzureCosmosDBCassandraEntityMetadata(
                        metadata_list=[
                            AzureCosmosDBCassandraMetadata(
                                credentials=AzureCredentials(
                                    auth_type="UserPassword",
                                    managed_identity_client_id="managed_identity_client_id_example",
                                    password="password_example",
                                    username="username_example",
                                ),
                            ),
                    ...
                    azure_cosmos_db_mongo_db_params=AzureCosmosDBMongoDBEntityMetadata(
                        metadata_list=[
                    ...
                    azure_cosmos_dbno_sql_params=AzureCosmosDBNoSQLEntityMetadata(
                        metadata_list=[
                    ...
                    azure_kubernetes_params=AzureKubernetesEntityMetadata(
                        client_private_key="client_private_key_example",
                        data_mover_image_location="data_mover_image_location_example",
                        datamover_service_type="kNodePort",
                        init_container_image_location="init_container_image_location_example",
                        san_fields=[
                            "san_fields_example",
                        ],
                        service_annotations=[
                        ...
                        velero_aws_plugin_image_location="velero_aws_plugin_image_location_example",
                        velero_image_location="velero_image_location_example",
                        velero_kubevirt_plugin_image_location="velero_kubevirt_plugin_image_location_example",
                    ),
                    azure_my_sql_params=AzureMySqlEntityMetadata(
                        metadata_list=[
                            AzureMySqlMetadata(
                                credentials=AzureCredentials(
                                    auth_type="UserPassword",
                    ...
                    azure_postgre_sql_params=AzurePostgreSQLEntityMetadata(
                        metadata_list=[
                    ...
                    azure_sql_db_params=AzureSqlDBEntityMetadata(
                        metadata_list=[
                            AzureSqlDBMetadata(
                                credentials=AzureCredentials(
                                    auth_type="UserPassword",
                    ...
                    azure_sql_mi_params=AzureSqlMIEntityMetadata(
                        metadata_list=[
                            AzureSqlMIMetadata(
                                credentials=AzureCredentials(
                                    auth_type="UserPassword",
                ...
                entity_id=1,
                experimental_adapter_params=ExperimentalAdapterEntityMetadata(
                    custom_metadata_params="custom_metadata_params_example",
                    id="id_example",
                    password="password_example",
                    username="username_example",
                ),
                gcp_params=GCPEntityMetadata(
                    alloy_db_postgre_sql_params=GcpAlloyDBPostgreSQLEntityMetadata(
                        metadata_list=[
                    ...
                    gcp_sql_params=GcpSqlServerMetadata(
                        standard_credentials=Credentials(
                            password="password_example",
                            username="username_example",
                        ),
                    ),
                    my_sql_params=GcpMySQLEntityMetadata(
                        metadata_list=[
                            GcpMySQLMetadata(
                                credentials=Credentials(
                                    password="password_example",
                    ...
                    postgre_sql_params=GcpPostgreSQLEntityMetadata(
                        metadata_list=[
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_browse_request import ObjectBrowseRequest
from cohesity_sdk.cluster.cohesity.model.file_folder_info import FileFolderInfo
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.cancel_object_runs_results import CancelObjectRunsResults
from cohesity_sdk.cluster.cohesity.model.cancel_object_runs_request import CancelObjectRunsRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.construct_meta_info_result import ConstructMetaInfoResult
from cohesity_sdk.cluster.cohesity.model.construct_meta_info_request import ConstructMetaInfoRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    body = ConstructMetaInfoRequest(
        environment="kVMware",
        kubernetes_params=ConstructMetaInfoKubernetesParams(
            object_id=1,
        ),
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = object.ObjectApi(api_client)
    id = 1 # int | Specifies a unique id of the Entity.
    metadata_type = "Credentials" # str | Specifies the metadata type to be deleted. This is a required field currently and the API will error out if this field is not provided. (optional)
    environment_type = "kAwsAuroraPostgres" # str | Specifies the environment type for the Credentials metadata to be deleted. This will be only set when the metadata type is Credentials. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Delete Metadata with Entity
        api_instance.delete_entity_metadata(id)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.filtered_objects_response_body import FilteredObjectsResponseBody
from cohesity_sdk.cluster.cohesity.model.filter_objects_request import FilterObjectsRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_indexed_object_snapshots_response_body import GetIndexedObjectSnapshotsResponseBody
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get snapshots of indexed object.
        api_response = api_instance.get_all_indexed_object_snapshots(object_id, indexed_object_name)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_entity_metadata_result import GetEntityMetadataResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Metadata of Entities
        api_response = api_instance.get_entity_metadata(source_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    use_cached_data = True # bool | Specifies whether we can serve the GET request to the read replica cache. There is a lag of 15 seconds between the read replica and primary data source. (optional)
    object_action_key = "kVMware" # str | Filter by ObjectActionKey, which uniquely represents backup type for a given version. An object can be protected in multiple ways but atmost once for a given combination of ObjectActionKey and ObjectId. When specified, only versions of given ObjectActionKey are returned for corresponding object id. (optional)
    from_file_mtime_usecs = 1 # int | Specifies the timestamp in Unix time epoch in microseconds to filter indexed object's snapshots based on file mtime after and equal to this value. If not specified and toFileMtimeUsecs is specified, then the fromFileMtimeUsecs will be set to 7 days before toFileMtimeUsecs. (optional)
    to_file_mtime_usecs = 1 # int | Specifies the timestamp in Unix time epoch in microseconds to filter indexed object's snapshots based on file mtime before and equal to this value. If not specified and fromFileMtimeUsecs is specified, then the toFileMtimeUsecs will be set to current time. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Get snapshots of indexed object.
        api_response = api_instance.get_indexed_object_snapshots(protection_group_id, object_id, indexed_object_name)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_protection_run_summary import ObjectProtectionRunSummary
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
> file_type get_object_run_messages_report(id, run_id)
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = object.ObjectApi(api_client)
    id = 1 # int | Specifies the id of the object.
    run_id = "runId_example" # str | Specifies the id of the run in the format OBJECT-<objectId>:<runStartTime>.
    object_action_key = "kVMware" # str | Specifies the backup type for the run. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Get the CSV of various Messages for a given run.
        api_response = api_instance.get_object_run_messages_report(id, run_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
> get_object_run_success_files(id, run_id)
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the CSV of errors/warnings for a given run and an object.
        api_instance.get_object_run_success_files(id, run_id)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_object_runs_response_body import GetObjectRunsResponseBody
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the list of runs for an object.
        api_response = api_instance.get_object_runs(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_snapshot import ObjectSnapshot
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.common_object_snapshot_volume_params import CommonObjectSnapshotVolumeParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get volume info of object snapshot.
        api_response = api_instance.get_object_snapshot_volume_info(snapshot_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_object_snapshots_response_body import GetObjectSnapshotsResponseBody
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # List the snapshots for a given object.
        api_response = api_instance.get_object_snapshots(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_stats import ObjectStats
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get stats for a given object.
        api_response = api_instance.get_object_stats(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_with_children import ObjectWithChildren
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.objects_last_run import ObjectsLastRun
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_pit_ranges_protected_object_response_body import GetPITRangesProtectedObjectResponseBody
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get PIT ranges for an object
        api_response = api_instance.get_pit_ranges_for_protected_object(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.protected_object_info import ProtectedObjectInfo
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an Object.
        api_response = api_instance.get_protected_object_of_any_type_by_id(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.get_protected_objects_response import GetProtectedObjectsResponse
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    ids = [
        1,
    ] # [int] | Filter by a list of Object ids. Only one of ids or globalHashes should be used. (optional)
    object_action_keys = [
        "kVMware",
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.snapshot_diff_result import SnapshotDiffResult
from cohesity_sdk.cluster.cohesity.model.snapshot_diff_params import SnapshotDiffParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.source_hierarchy_object_summaries import SourceHierarchyObjectSummaries
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    nutanix_fs_object_types = [
        "kPrismCentral",
    ] # [str] | Specifies the Nutanix FS object types to filter objects. (optional)
    ...
    try:
        # List objects on a source which can be used for data protection.
        api_response = api_instance.get_source_hierarchy_objects(source_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
> ModifySourceHierarchyObjectsResult modify_source_hierarchy_objects(source_id, body)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.modify_source_hierarchy_objects_result import ModifySourceHierarchyObjectsResult
from cohesity_sdk.cluster.cohesity.model.modify_source_hierarchy_objects_request import ModifySourceHierarchyObjectsRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = object.ObjectApi(api_client)
    source_id = 1 # int | Specifies the source ID where objects are to be modified.
    body = ModifySourceHierarchyObjectsRequest(
        modification_requests=[
            SourceHierarchyModificationRequest(
                action_type="Add",
                vcd_modify_params=VCDModifyHierarchyParams(
                    urn="urn_example",
                ),
            ),
        ],
    ) # ModifySourceHierarchyObjectsRequest | Specifies the parameters to add/update objects in entity hierarchy.
    request_initiator_type = "UIUser" # str | Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Modify objects in source hierarchy.
        api_response = api_instance.modify_source_hierarchy_objects(source_id, body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.objects_action_request import ObjectsActionRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.object_action_request import ObjectActionRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import object
from cohesity_sdk.cluster.cohesity.model.update_object_snapshot_request import UpdateObjectSnapshotRequest
from cohesity_sdk.cluster.cohesity.model.object_snapshot import ObjectSnapshot
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
