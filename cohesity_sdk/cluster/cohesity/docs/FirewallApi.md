...
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_profile_params import FirewallProfileParams
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = firewall.FirewallApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_ip_sets import FirewallIPSets
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_profiles import FirewallProfiles
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_entry import FirewallEntry
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_profile_names_params import FirewallProfileNamesParams
...
from cohesity_sdk.cluster.api import firewall
from cohesity_sdk.cluster.cohesity.model.firewall_entry import FirewallEntry
from cohesity_sdk.cluster.cohesity.model.update_firewall_request import UpdateFirewallRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
