...
from cohesity_sdk.cluster.api import policy
from cohesity_sdk.cluster.cohesity.model.protection_policy_response import ProtectionPolicyResponse
from cohesity_sdk.cluster.cohesity.model.protection_policy_request import ProtectionPolicyRequest
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = policy.PolicyApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import policy
from cohesity_sdk.cluster.cohesity.model.policy_summary_response import PolicySummaryResponse
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the protection policy summary
        api_response = api_instance.get_policy_summary(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import policy
from cohesity_sdk.cluster.cohesity.model.policy_template_response import PolicyTemplateResponse
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import policy
from cohesity_sdk.cluster.cohesity.model.policy_templates_response_with_pagination import PolicyTemplatesResponseWithPagination
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import policy
from cohesity_sdk.cluster.cohesity.model.protection_policy_response_with_pagination import ProtectionPolicyResponseWithPagination
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
