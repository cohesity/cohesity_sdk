...
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.add_active_directory_principals_parameters import AddActiveDirectoryPrincipalsParameters
from cohesity_sdk.cluster.cohesity.model.error import Error
from cohesity_sdk.cluster.cohesity.model.added_active_directory_principal import AddedActiveDirectoryPrincipal
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.create_active_directory_request import CreateActiveDirectoryRequest
from cohesity_sdk.cluster.cohesity.model.active_directory import ActiveDirectory
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete an Active Directory.
        api_instance.delete_active_directory(id, active_directory_admin_username, active_directory_admin_password)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.active_directories import ActiveDirectories
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an Active Directory by id.
        api_response = api_instance.get_active_directory_by_id(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.active_directory_principals import ActiveDirectoryPrincipals
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.active_directory_topology import ActiveDirectoryTopology
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.centrify_zones import CentrifyZones
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.domain_controllers_response import DomainControllersResponse
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Domain Controllers of specified domains.
        api_response = api_instance.get_domain_controllers(domain_names)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.trusted_domain_params import TrustedDomainParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import active_directory
from cohesity_sdk.cluster.cohesity.model.active_directory import ActiveDirectory
from cohesity_sdk.cluster.cohesity.model.update_active_directory_request import UpdateActiveDirectoryRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
