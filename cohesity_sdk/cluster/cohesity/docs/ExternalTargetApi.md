...
from cohesity_sdk.cluster.api import external_target
from cohesity_sdk.cluster.cohesity.model.external_target import ExternalTarget
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = external_target.ExternalTargetApi(api_client)
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a External Target.
        api_instance.delete_external_target(id)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import external_target
from cohesity_sdk.cluster.cohesity.model.archival_media_info import ArchivalMediaInfo
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # List archive media information
        api_response = api_instance.get_external_target_media_info(cluster_id, cluster_incarnation_id, archival_job_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import external_target
from cohesity_sdk.cluster.cohesity.model.external_targets import ExternalTargets
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import external_target
from cohesity_sdk.cluster.cohesity.model.global_bandwidth_settings import GlobalBandwidthSettings
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
