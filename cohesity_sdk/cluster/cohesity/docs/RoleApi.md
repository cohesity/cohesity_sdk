...
from cohesity_sdk.cluster.api import role
from cohesity_sdk.cluster.cohesity.model.role import Role
from cohesity_sdk.cluster.cohesity.model.create_role_parameters import CreateRoleParameters
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = role.RoleApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import role
from cohesity_sdk.cluster.cohesity.model.roles import Roles
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import role
from cohesity_sdk.cluster.cohesity.model.role import Role
from cohesity_sdk.cluster.cohesity.model.update_role_parameters import UpdateRoleParameters
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
