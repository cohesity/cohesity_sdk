...
from cohesity_sdk.cluster.api import recovery
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = recovery.RecoveryApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.download_files_and_folders_request_params import DownloadFilesAndFoldersRequestParams
from cohesity_sdk.cluster.cohesity.model.recovery import Recovery
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
    ...
    body = DownloadFilesAndFoldersRequestParams(
        ...
        files_and_folders=[
            FilesAndFoldersObject(
                ...
                document_params=AdditionalDocumentInfo(
                    o365_params=O365DocumentMetadata(
                        subsite_item=SubsiteItem(
                            absolute_item_path="absolute_item_path_example",
                            relative_subsite_path="relative_subsite_path_example",
                            site_type="GroupSubsite",
                            site_uuid="site_uuid_example",
                        ),
                    ),
                ),
                is_directory=True,
...
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.recovery import Recovery
from cohesity_sdk.cluster.cohesity.model.create_recovery_request import CreateRecoveryRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Performs a Recovery.
        api_response = api_instance.create_recovery(body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Download files from the given download file recovery.
        api_instance.download_files_from_recovery(id)
    except cohesity_sdk.cluster.ApiException as e:
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Download an indexed file.
        api_instance.download_indexed_file(snapshots_id)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.fetch_uptier_data_response import FetchUptierDataResponse
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.fetch_directories_params import FetchDirectoriesParams
from cohesity_sdk.cluster.cohesity.model.directory_list_result import DirectoryListResult
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.recoveries import Recoveries
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Recovery for a given id.
        api_response = api_instance.get_recovery_by_id(id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.get_restore_points_in_time_range_response import GetRestorePointsInTimeRangeResponse
from cohesity_sdk.cluster.cohesity.model.get_restore_points_in_time_range_params import GetRestorePointsInTimeRangeParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import recovery
from cohesity_sdk.cluster.cohesity.model.virtual_disk_information_response_params import VirtualDiskInformationResponseParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Fetches information of virtual disks
        api_response = api_instance.virtual_disk_information(cluster_id, cluster_incarnation_id, job_id, object_id)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
