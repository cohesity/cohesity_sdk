# cohesity_sdk.cluster.DataSourceConnectorLocalApi
...
from cohesity_sdk.cluster.api import data_source_connector_local
from cohesity_sdk.cluster.cohesity.model.error import Error
from cohesity_sdk.cluster.cohesity.model.data_source_connector_logs import DataSourceConnectorLogs
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = data_source_connector_local.DataSourceConnectorLocalApi(api_client)

    # example, this endpoint has no required or optional parameters
    try:
        # Lists the data-source connector logs.
        api_response = api_instance.get_data_source_connector_logs()
        pprint(api_response)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import data_source_connector_local
from cohesity_sdk.cluster.cohesity.model.data_source_connector_local_status import DataSourceConnectorLocalStatus
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists the data-source connector status.
        api_response = api_instance.get_data_source_connector_status()
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import data_source_connector_local
from cohesity_sdk.cluster.cohesity.model.data_source_connector_registration_request import DataSourceConnectorRegistrationRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Register a data-source connector.
        api_instance.register_data_source_connector(body)
    except cohesity_sdk.cluster.ApiException as e:
