...
from cohesity_sdk.cluster.api import privilege
from cohesity_sdk.cluster.cohesity.model.privileges import Privileges
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = privilege.PrivilegeApi(api_client)
    names = [
        "names_example",
