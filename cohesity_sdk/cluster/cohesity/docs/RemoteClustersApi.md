...
from cohesity_sdk.cluster.api import remote_clusters
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = remote_clusters.RemoteClustersApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import remote_clusters
from cohesity_sdk.cluster.cohesity.model.update_remote_cluster_params import UpdateRemoteClusterParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import remote_clusters
from cohesity_sdk.cluster.cohesity.model.remote_clusters import RemoteClusters
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import remote_clusters
from cohesity_sdk.cluster.cohesity.model.register_remote_cluster_parameters import RegisterRemoteClusterParameters
from cohesity_sdk.cluster.cohesity.model.update_remote_cluster_params import UpdateRemoteClusterParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import remote_clusters
from cohesity_sdk.cluster.cohesity.model.remote_cluster_params import RemoteClusterParams
from cohesity_sdk.cluster.cohesity.model.validate_remote_cluster_connection_params import ValidateRemoteClusterConnectionParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Validate Remote Cluster config.
        api_response = api_instance.validate_remote_cluster(body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
