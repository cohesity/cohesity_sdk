...
------------- | ------------- | -------------
[**add_principals**](UserApi.md#add_principals) | **POST** /principals | Add the specified principals for the users or groups created on the Cohesity Cluster.
...
[**get_user_task_notifications**](UserApi.md#get_user_task_notifications) | **GET** /users/{sid}/notifications | Get task notifications for the given user.
...
[**update_linux_credentials_v2**](UserApi.md#update_linux_credentials_v2) | **PUT** /users/linux-password | Update or validate linux user password.
...
[**update_user_s3_keys**](UserApi.md#update_user_s3_keys) | **POST** /users/{sid}/update-s3-keys | Update S3 keys for a User
[**verify_user_otp**](UserApi.md#verify_user_otp) | **POST** /users/verify-otp | Verify the OTP for a user.


# **add_principals**
> AddedPrincipalResponseObject add_principals(body)
...
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.create_principal_request_params import CreatePrincipalRequestParams
from cohesity_sdk.cluster.cohesity.model.added_principal_response_object import AddedPrincipalResponseObject
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = user.UserApi(api_client)
    body = CreatePrincipalRequestParams(
        principal_type="SSOUser",
        sso_user_principal_params=[
    ...
    ) # CreatePrincipalRequestParams | Specifies parameters to add multiple principals.

    # example passing only required values which don't have defaults set
    try:
        # Add the specified principals for the users or groups created on the Cohesity Cluster.
        api_response = api_instance.add_principals(body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->add_principals: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**CreatePrincipalRequestParams**](CreatePrincipalRequestParams.md)| Specifies parameters to add multiple principals. |

### Return type

[**AddedPrincipalResponseObject**](AddedPrincipalResponseObject.md)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.create_groups_params import CreateGroupsParams
from cohesity_sdk.cluster.cohesity.model.groups import Groups
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.user_session import UserSession
from cohesity_sdk.cluster.cohesity.model.create_user_session_request_params import CreateUserSessionRequestParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
# Enter a context with an instance of the API client
with cohesity_sdk.cluster.ApiClient() as api_client:
    # Create an instance of the API class
    api_instance = user.UserApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.create_or_update_api_key_request import CreateOrUpdateAPIKeyRequest
from cohesity_sdk.cluster.cohesity.model.created_user_api_key import CreatedUserAPIKey
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.users_list import UsersList
from cohesity_sdk.cluster.cohesity.model.create_users_parameters import CreateUsersParameters
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.delete_groups_request import DeleteGroupsRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.delete_users_request import DeleteUsersRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.active_sessions_count_params import ActiveSessionsCountParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.user_api_keys import UserAPIKeys
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.group_params import GroupParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.assigned_sources import AssignedSources
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.error import Error
from cohesity_sdk.cluster.cohesity.model.security_principals import SecurityPrincipals
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
configuration = cohesity_sdk.cluster.Configuration(
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.user_api_key import UserAPIKey
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the list of API keys owned by the user.
        api_response = api_instance.get_user_api_keys(user_sid)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.user_params import UserParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
> GetUserTaskNotificationsResponseObject get_user_task_notifications(sid)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.get_user_task_notifications_response_object import GetUserTaskNotificationsResponseObject
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = user.UserApi(api_client)
    sid = "sid_example" # str | Specify the SID of the user.
    include_count = True # bool | Specifies whether the notification count is needed or not. (optional)
    exclude_event_logs = True # bool | Specifies whether to exclude event logs within the response. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Get task notifications for the given user.
        api_response = api_instance.get_user_task_notifications(sid)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->get_user_task_notifications: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Get task notifications for the given user.
        api_response = api_instance.get_user_task_notifications(sid, include_count=include_count, exclude_event_logs=exclude_event_logs)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->get_user_task_notifications: %s\n" % e)
```
...
[**GetUserTaskNotificationsResponseObject**](GetUserTaskNotificationsResponseObject.md)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.secret_key_entity import SecretKeyEntity
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.group_params import GroupParams
from cohesity_sdk.cluster.cohesity.model.update_group_parameters import UpdateGroupParameters
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
# **update_linux_credentials_v2**
> SuccessResp update_linux_credentials_v2(body)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.update_linux_password_request import UpdateLinuxPasswordRequest
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    ) # UpdateLinuxPasswordRequest | Specifies the linux user parameters.

    # example passing only required values which don't have defaults set
    try:
        # Update or validate linux user password.
        api_response = api_instance.update_linux_credentials_v2(body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->update_linux_credentials_v2: %s\n" % e)
```
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.update_user_parameters import UpdateUserParameters
from cohesity_sdk.cluster.cohesity.model.user_params import UserParams
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.s3_keys import S3Keys
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    sid = "sid_example" # str | Specify the SID of the user.
    body = S3Keys(
        s3_access_key_id="s3_access_key_id_example",
        s3_secret_key="s3_secret_key_example",
    ) # S3Keys | Specifies the body to update the User S3 Keys

    # example passing only required values which don't have defaults set
    try:
        # Update S3 keys for a User
        api_instance.update_user_s3_keys(sid, body)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->update_user_s3_keys: %s\n" % e)
```
...
# **verify_user_otp**
> UserOtpResponseObject verify_user_otp(body)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import user
from cohesity_sdk.cluster.cohesity.model.user_otp_params import UserOtpParams
from cohesity_sdk.cluster.cohesity.model.user_otp_response_object import UserOtpResponseObject
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    body = UserOtpParams(
        otp="otp_example",
        otp_type="Totp",
    ) # UserOtpParams | Request to verify OTP.

    # example passing only required values which don't have defaults set
    try:
        # Verify the OTP for a user.
        api_response = api_instance.verify_user_otp(body)
        pprint(api_response)
    except cohesity_sdk.cluster.ApiException as e:
        print("Exception when calling UserApi->verify_user_otp: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**UserOtpParams**](UserOtpParams.md)| Request to verify OTP. |

### Return type

[**UserOtpResponseObject**](UserOtpResponseObject.md)
