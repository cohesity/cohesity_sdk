...
**sender_email_address** | **str, none_type** | This is used for setting \&quot;Sender\&quot; field in SMTP header. This has to be in valid email format, and could be different from username, and it&#39;s a required field if the username is not of valid email address.  | [optional] 
