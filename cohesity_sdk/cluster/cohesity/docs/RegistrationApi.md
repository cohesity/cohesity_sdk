# cohesity_sdk.cluster.RegistrationApi
...
from cohesity_sdk.cluster.api import registration
from cohesity_sdk.cluster.cohesity.model.helios_reg_config import HeliosRegConfig
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = registration.RegistrationApi(api_client)
...
import cohesity_sdk.cluster
from cohesity_sdk.cluster.api import registration
from cohesity_sdk.cluster.cohesity.model.helios_claim_request import HeliosClaimRequest
from cohesity_sdk.cluster.cohesity.model.error import Error
from pprint import pprint
# Defining the host is optional and defaults to http://localhost/v2
# See configuration.py for a list of all supported configuration parameters.
