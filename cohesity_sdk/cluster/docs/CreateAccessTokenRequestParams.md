...
------------ | ------------- | ------------- | -------------
**certificate** | **str** | Specifies the certificate for logging in the cert base auth cluster. | [optional] 
...
**password** | **str** | Specifies the password of the Cohesity user account. | [optional] 
**private_key** | **str** | Specifies the matching private key of the above certificate. | [optional] 
