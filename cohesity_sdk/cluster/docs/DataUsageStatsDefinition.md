...
**data_in_bytes_prev** | **int** | Specifies the storage used before any data reduction using deduplication and compression. | [optional] 
**data_in_bytes_prev_timestamp_usec** | **int** | Specifies Timestamp of DataInBytesPrev | [optional] 
...
**data_written_bytes_prev** | **int** | Specifies the data written after it has been reduced by deduplication and compression at a previous time. | [optional] 
**data_written_bytes_prev_timestamp_usec** | **int** | Specifies Timestamp of DataWrittenBytesPrev | [optional] 
...
**local_tier_resiliency_impact_bytes_prev** | **int** | Specifies the size of the data has been replicated to other nodes as per RF or Erasure Coding policy at a specific time. | [optional] 
**local_tier_resiliency_impact_bytes_prev_timestamp_usec** | **int** | Specifies Timestamp of LocalTierResiliencyImpactBytesPrev. | [optional] 
...
**outdated_logical_usage_bytes** | **int** | Specifies the logical usage as computed by the Cohesity Cluster. | [optional] 
...
**storage_consumed_bytes_prev** | **int** | Specifies the total capacity, as computed by the Cohesity Cluster, after the size of the data has been reduced by change-block tracking, compression and deduplication at a previous time to compare. | [optional] 
**storage_consumed_bytes_prev_timestamp_usec** | **int** | Specifies Timestamp of StorageConsumedBytesPrev. | [optional] 
...
**unique_physical_data_bytes_timestamp_usec** | **int** | Specifies Timestamp of UniquePhysicalDataBytes. | [optional] 
...
json = "{}"
# create an instance of DataUsageStatsDefinition from a JSON string
data_usage_stats_definition_instance = DataUsageStatsDefinition.from_json(json)
# print the JSON string representation of the object
print(DataUsageStatsDefinition.to_json())

# convert the object into a dict
data_usage_stats_definition_dict = data_usage_stats_definition_instance.to_dict()
# create an instance of DataUsageStatsDefinition from a dict
data_usage_stats_definition_from_dict = DataUsageStatsDefinition.from_dict(data_usage_stats_definition_dict)
```
