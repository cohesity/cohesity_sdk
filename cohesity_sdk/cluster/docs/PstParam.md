...
**separate_download_files** | **bool, none_type** | If true, a separate download file will be made for each snapshot. If false, a single common download file will be used for all snapshots. Default is false. | [optional] 
