...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    aws_object_types = ['aws_object_types_example'] # List[str] | Specifies the object types to filter objects on. Only applicable if the environment is AWS. (optional)
    azure_uuids = ['azure_uuids_example'] # List[str] | Specifies the Azure UUID for the Microsoft365 objects. If specified, the objects with the matching Azure UUIDs will be returned. (optional)
    ...
    object_uuids = ['object_uuids_example'] # List[str] | Specifies a list of object uuids to filter the object, based on the object uuid. These uuid are vendor specific and should be of the form, <sourceUuid_uuid>. (optional)
    ...
    tag_search_name = 'tag_search_name_example' # str | Specifies the tag name to filter the tagged objects and snapshots. User can specify a wildcard character '*' as a suffix to a string where all object's tag names are matched with the prefix string. (optional)
    tag_names = ['tag_names_example'] # List[str] | Specifies the tag names to filter the tagged objects and snapshots only for non system tags (optional)
    anomaly_tags = ['anomaly_tags_example'] # List[str] | Specifies the Anomaly's tag names to filter the tagged snapshots (optional)
    data_classification_tags = ['data_classification_tags_example'] # List[str] | Specifies the Data classification's tag names to filter the tagged snapshots (optional)
    threat_tags = ['threat_tags_example'] # List[str] | Specifies the threat tag's names to filter the tagged snapshots (optional)
    tag_names_excluded = ['tag_names_excluded_example'] # List[str] | Specifies the tag names to not include in the tagged snapshots response (optional)
    tag_types = ['tag_types_example'] # List[str] | Specifies the tag type to filter the objects and snapshots. (optional)
    tag_categories = ['tag_categories_example'] # List[str] | Specifies the tag category to filter the objects and snapshots. (optional)
    tag_sub_categories = ['tag_sub_categories_example'] # List[str] | Specifies the tag subcategory to filter the objects and snapshots (optional)
    include_helios_tag_info_for_objects = True # bool | Specifies whether to include helios tags information for objects in response. Default value is false (optional)
    external_filters = ['external_filters_example'] # List[str] | Specifies the key-value pairs to filtering the results for the search. Each filter is of the form 'key:value'. The filter 'externalFilters:k1:v1&externalFilters:k2:v2&externalFilters:k2:v3' returns the documents where each document will match the query (k1=v1) AND (k2=v2 OR k2 = v3). Allowed keys: - vmBiosUuid - graphUuid - arn - instanceId - bucketName - azureId (optional)
 ...
 **aws_object_types** | [**List[str]**](str.md)| Specifies the object types to filter objects on. Only applicable if the environment is AWS. | [optional] 
 **azure_uuids** | [**List[str]**](str.md)| Specifies the Azure UUID for the Microsoft365 objects. If specified, the objects with the matching Azure UUIDs will be returned. | [optional] 
 ...
 **object_uuids** | [**List[str]**](str.md)| Specifies a list of object uuids to filter the object, based on the object uuid. These uuid are vendor specific and should be of the form, &lt;sourceUuid_uuid&gt;. | [optional] 
 ...
 **tag_names** | [**List[str]**](str.md)| Specifies the tag names to filter the tagged objects and snapshots only for non system tags | [optional] 
 **anomaly_tags** | [**List[str]**](str.md)| Specifies the Anomaly&#39;s tag names to filter the tagged snapshots | [optional] 
 **data_classification_tags** | [**List[str]**](str.md)| Specifies the Data classification&#39;s tag names to filter the tagged snapshots | [optional] 
 **threat_tags** | [**List[str]**](str.md)| Specifies the threat tag&#39;s names to filter the tagged snapshots | [optional] 
 **tag_names_excluded** | [**List[str]**](str.md)| Specifies the tag names to not include in the tagged snapshots response | [optional] 
 **tag_types** | [**List[str]**](str.md)| Specifies the tag type to filter the objects and snapshots. | [optional] 
 **tag_categories** | [**List[str]**](str.md)| Specifies the tag category to filter the objects and snapshots. | [optional] 
 **tag_sub_categories** | [**List[str]**](str.md)| Specifies the tag subcategory to filter the objects and snapshots | [optional] 
 **include_helios_tag_info_for_objects** | **bool**| Specifies whether to include helios tags information for objects in response. Default value is false | [optional] 
 **external_filters** | [**List[str]**](str.md)| Specifies the key-value pairs to filtering the results for the search. Each filter is of the form &#39;key:value&#39;. The filter &#39;externalFilters:k1:v1&amp;externalFilters:k2:v2&amp;externalFilters:k2:v3&#39; returns the documents where each document will match the query (k1&#x3D;v1) AND (k2&#x3D;v2 OR k2 &#x3D; v3). Allowed keys: - vmBiosUuid - graphUuid - arn - instanceId - bucketName - azureId | [optional] 
