# RecoverAzureSQLDBSnapshotParams
...
**recover_azure_sqldb_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureSQLDBSnapshotParams from a JSON string
recover_azure_sqldb_snapshot_params_instance = RecoverAzureSQLDBSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureSQLDBSnapshotParams.to_json())

# convert the object into a dict
recover_azure_sqldb_snapshot_params_dict = recover_azure_sqldb_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureSQLDBSnapshotParams from a dict
recover_azure_sqldb_snapshot_params_from_dict = RecoverAzureSQLDBSnapshotParams.from_dict(recover_azure_sqldb_snapshot_params_dict)
```
