...
**nfs_open_file_count** | **int** | Specifies the number of files open over the NFS4 protocol. | [optional] 
...
**smb_open_file_count** | **int** | Specifies the number of files open over the SMB protocol. | [optional] 
