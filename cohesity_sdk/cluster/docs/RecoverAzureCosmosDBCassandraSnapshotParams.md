# RecoverAzureCosmosDBCassandraSnapshotParams
...
**recover_azure_cosmos_db_cassandra_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureCosmosDBCassandraSnapshotParams from a JSON string
recover_azure_cosmos_db_cassandra_snapshot_params_instance = RecoverAzureCosmosDBCassandraSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureCosmosDBCassandraSnapshotParams.to_json())

# convert the object into a dict
recover_azure_cosmos_db_cassandra_snapshot_params_dict = recover_azure_cosmos_db_cassandra_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureCosmosDBCassandraSnapshotParams from a dict
recover_azure_cosmos_db_cassandra_snapshot_params_from_dict = RecoverAzureCosmosDBCassandraSnapshotParams.from_dict(recover_azure_cosmos_db_cassandra_snapshot_params_dict)
```
