...
**child_tasks** | [**List[ChildTaskParams]**](ChildTaskParams.md) | The child tasks used as part of the restore. | [optional] 
...
**error_messages** | **List[str]** | Specifies error messages about the recovery. | [optional] 
...
**num_granular_objects_restored_successfully** | **int** | Specifies the total number of objects that were successfully restored. The remaining objects were either skipped or had some error in restore operation. | [optional] [readonly] 
**num_granular_objects_to_restore** | **int** | Specifies the total number of objects which were requested to be restored. | [optional] [readonly] 
**num_objects** | **int** | Specifies the object count in a recovery task. | [optional] 
...
**retry_tear_down** | **bool** | Specifies whether it&#39;s possible to retry tear down of objects created by recovery operation. | [optional] 
...
**warning_messages** | **List[str]** | Specifies warning messages about the recovery. | [optional] 
...
**nutanix_fs_params** | [**RecoverNutanixFSParams**](RecoverNutanixFSParams.md) |  | [optional] 
...
**postgres_params** | [**PostgresParams**](PostgresParams.md) |  | [optional] 
