...
**event_source** | **str** | Specifies source where the event occurred. | [optional] 
**first_timestamp_usecs** | **int** | Specifies Unix epoch Timestamp (in microseconds) of the first occurrence of the Alert. | [optional] 
**id** | **str** | Specifies unique id of the alert. | [optional] 
**label_ids** | **List[str]** | Specifies the labels for which this alert has been raised. | [optional] 
**latest_timestamp_usecs** | **int** | Specifies Unix epoch Timestamp (in microseconds) of the most recent occurrence of the Alert. | [optional] 
**property_list** | [**List[Label]**](Label.md) | List of property key and values associated with alert | [optional] 
...
**resolution_id_string** | **str** | Resolution Id String. | [optional] 
**resolved_timestamp_usecs** | **int** | Specifies Unix epoch Timestamps in microseconds when alert is resolved. | [optional] 
**severity** | **str** | Specifies the alert severity. | [optional] 
**suppression_id** | **int** | Specifies unique id generated when the Alert is suppressed by the admin. | [optional] 
**tenant_ids** | **List[str]** | Specifies the tenants for which this alert has been raised. | [optional] 
