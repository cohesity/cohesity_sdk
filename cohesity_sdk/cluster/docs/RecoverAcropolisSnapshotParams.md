...
**datastore_migration_info** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type** | Specifies the info about datastore migration. This is only applicable for AcropolisVm. | [optional] 
**instant_recovery_info** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type** | Specifies the info about instant recovery. This is only applicable for AcropolisVm. | [optional] 
