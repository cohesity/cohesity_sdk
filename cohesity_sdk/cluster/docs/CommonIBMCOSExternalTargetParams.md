...
common_ibmcos_external_target_params_instance = CommonIBMCOSExternalTargetParams.from_json(json)
# print the JSON string representation of the object
print(CommonIBMCOSExternalTargetParams.to_json())

# convert the object into a dict
common_ibmcos_external_target_params_dict = common_ibmcos_external_target_params_instance.to_dict()
# create an instance of CommonIBMCOSExternalTargetParams from a dict
common_ibmcos_external_target_params_from_dict = CommonIBMCOSExternalTargetParams.from_dict(common_ibmcos_external_target_params_dict)
```
