# RecoverAzurePostgreSQLSnapshotParams
...
**recover_azure_postgre_sql_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzurePostgreSQLSnapshotParams from a JSON string
recover_azure_postgre_sql_snapshot_params_instance = RecoverAzurePostgreSQLSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzurePostgreSQLSnapshotParams.to_json())

# convert the object into a dict
recover_azure_postgre_sql_snapshot_params_dict = recover_azure_postgre_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverAzurePostgreSQLSnapshotParams from a dict
recover_azure_postgre_sql_snapshot_params_from_dict = RecoverAzurePostgreSQLSnapshotParams.from_dict(recover_azure_postgre_sql_snapshot_params_dict)
```
