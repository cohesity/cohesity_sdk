...
**cluster_id** | **int** | Specifies the cluster id of the vault cluster. | 
**cluster_name** | **str** | Specifies the cluster name of the vault cluster. | [optional] [readonly] 
...
json = "{}"
# create an instance of OnpremVaultConfig from a JSON string
onprem_vault_config_instance = OnpremVaultConfig.from_json(json)
# print the JSON string representation of the object
print(OnpremVaultConfig.to_json())

# convert the object into a dict
onprem_vault_config_dict = onprem_vault_config_instance.to_dict()
# create an instance of OnpremVaultConfig from a dict
onprem_vault_config_from_dict = OnpremVaultConfig.from_dict(onprem_vault_config_dict)
```
