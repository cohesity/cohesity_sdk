...
**disable_s3_object_lock_config** | **bool, none_type** | Specifies whether to disable S3 Object Lock configuration on the cloned S3 View. This field is only applicable if the source View is an S3 View with S3 Object Lock configuration enabled. | [optional] 
