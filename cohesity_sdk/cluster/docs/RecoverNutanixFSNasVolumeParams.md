...
json = "{}"
# create an instance of RecoverNutanixFSNasVolumeParams from a JSON string
recover_nutanix_fs_nas_volume_params_instance = RecoverNutanixFSNasVolumeParams.from_json(json)
# print the JSON string representation of the object
print(RecoverNutanixFSNasVolumeParams.to_json())

# convert the object into a dict
recover_nutanix_fs_nas_volume_params_dict = recover_nutanix_fs_nas_volume_params_instance.to_dict()
# create an instance of RecoverNutanixFSNasVolumeParams from a dict
recover_nutanix_fs_nas_volume_params_from_dict = RecoverNutanixFSNasVolumeParams.from_dict(recover_nutanix_fs_nas_volume_params_dict)
```
