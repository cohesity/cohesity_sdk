...
**label_filter_entity_type** | **str** | The type of the entity for which the label filters are specified. Example: kPersistentVolumeClaim or kVirtualMachine. | [optional] 
...
**selected_resources** | [**List[ResourceInfo]**](ResourceInfo.md) | Array of Object which has group, version, kind, etc. as its fields to identify a resource type and a resource list which is essentially the list of instances of that resource type. | [optional] 
