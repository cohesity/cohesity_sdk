...
**recover_excluded_disks** | **bool, none_type** | If this field is set to true, then the user excluded disks will be recovered as blank disks. | [optional] 
**recover_independent_disks** | **bool, none_type** | If this field is set to true, then the independent disks which were excluded while backup will be recovered as blank disks. | [optional] 
