# RecoverAzureCosmosDBNoSQLSnapshotParams
...
**recover_azure_cosmos_dbno_sql_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureCosmosDBNoSQLSnapshotParams from a JSON string
recover_azure_cosmos_dbno_sql_snapshot_params_instance = RecoverAzureCosmosDBNoSQLSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureCosmosDBNoSQLSnapshotParams.to_json())

# convert the object into a dict
recover_azure_cosmos_dbno_sql_snapshot_params_dict = recover_azure_cosmos_dbno_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureCosmosDBNoSQLSnapshotParams from a dict
recover_azure_cosmos_dbno_sql_snapshot_params_from_dict = RecoverAzureCosmosDBNoSQLSnapshotParams.from_dict(recover_azure_cosmos_dbno_sql_snapshot_params_dict)
```
