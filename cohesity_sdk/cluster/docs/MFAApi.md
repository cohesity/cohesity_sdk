...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    body = cohesity_sdk.cluster.ConfigureSupportUserMfaParams() # ConfigureSupportUserMfaParams | The update request for MFA Settings

    try:
        # Stores the updated MFA configuration.
        api_response = api_instance.configure_support_mfa_config(body)
        print("The response of MFAApi->configure_support_mfa_config:\n")
        pprint(api_response)
