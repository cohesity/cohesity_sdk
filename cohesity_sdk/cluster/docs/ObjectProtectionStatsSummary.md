...
**environment** | **str, none_type** | Specifies the source environment of the object. | [optional] 
...
**protection_env_type** | **str, none_type** | Specifies the protection environment type. | [optional] 
