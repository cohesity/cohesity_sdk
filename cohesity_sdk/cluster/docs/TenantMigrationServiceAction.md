...
**error_message** | **str, none_type** | Specifies the error message if an error occurred. | [optional] 
**error_type** | **str, none_type** | Specifies the type of error which occurred. | [optional] 
