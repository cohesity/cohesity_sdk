...
**cpu** | **int** | Number of CPUs | [optional] 
...
**is_node_reachable** | **bool** | Specifies whether the node is reachable or not | [optional] 
...
**system_memory_bytes** | **int** | System Memory in bytes | [optional] 
