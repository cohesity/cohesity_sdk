# RecoverAwsDocumentDBSnapshotParams
...
**recover_aws_document_db_object_params** | [**RecoverAwsDocumentDBObjectParams**](RecoverAwsDocumentDBObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAwsDocumentDBSnapshotParams from a JSON string
recover_aws_document_db_snapshot_params_instance = RecoverAwsDocumentDBSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAwsDocumentDBSnapshotParams.to_json())

# convert the object into a dict
recover_aws_document_db_snapshot_params_dict = recover_aws_document_db_snapshot_params_instance.to_dict()
# create an instance of RecoverAwsDocumentDBSnapshotParams from a dict
recover_aws_document_db_snapshot_params_from_dict = RecoverAwsDocumentDBSnapshotParams.from_dict(recover_aws_document_db_snapshot_params_dict)
```
