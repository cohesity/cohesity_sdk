# RecoverGCPSqlServerSnapshotParams
...
**recover_gcp_sql_server_object_params** | [**RecoverGcpObjectParams**](RecoverGcpObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverGCPSqlServerSnapshotParams from a JSON string
recover_gcp_sql_server_snapshot_params_instance = RecoverGCPSqlServerSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverGCPSqlServerSnapshotParams.to_json())

# convert the object into a dict
recover_gcp_sql_server_snapshot_params_dict = recover_gcp_sql_server_snapshot_params_instance.to_dict()
# create an instance of RecoverGCPSqlServerSnapshotParams from a dict
recover_gcp_sql_server_snapshot_params_from_dict = RecoverGCPSqlServerSnapshotParams.from_dict(recover_gcp_sql_server_snapshot_params_dict)
```
