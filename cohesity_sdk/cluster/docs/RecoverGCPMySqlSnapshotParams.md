...
**recover_gcp_my_sql_object_params** | [**RecoverGcpObjectParams**](RecoverGcpObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverGCPMySqlSnapshotParams from a JSON string
recover_gcpmy_sql_snapshot_params_instance = RecoverGCPMySqlSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverGCPMySqlSnapshotParams.to_json())

# convert the object into a dict
recover_gcpmy_sql_snapshot_params_dict = recover_gcpmy_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverGCPMySqlSnapshotParams from a dict
recover_gcpmy_sql_snapshot_params_from_dict = RecoverGCPMySqlSnapshotParams.from_dict(recover_gcpmy_sql_snapshot_params_dict)
```
