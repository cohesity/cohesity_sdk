...
**source_name** | **str, none_type** | Specifies the source name of the VM to which the disks will be restored. | [optional] 
**target** | **str, none_type** | Specifies the name of the vm to which the disks will be restored. | [optional] 
