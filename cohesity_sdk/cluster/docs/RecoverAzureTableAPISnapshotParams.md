# RecoverAzureTableAPISnapshotParams
...
**recover_azure_table_api_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureTableAPISnapshotParams from a JSON string
recover_azure_table_api_snapshot_params_instance = RecoverAzureTableAPISnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureTableAPISnapshotParams.to_json())

# convert the object into a dict
recover_azure_table_api_snapshot_params_dict = recover_azure_table_api_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureTableAPISnapshotParams from a dict
recover_azure_table_api_snapshot_params_from_dict = RecoverAzureTableAPISnapshotParams.from_dict(recover_azure_table_api_snapshot_params_dict)
```
