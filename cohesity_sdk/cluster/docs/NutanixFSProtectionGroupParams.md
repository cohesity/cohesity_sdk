# NutanixFSProtectionGroupParams
...
------------ | ------------- | ------------- | -------------
**backup_existing_snapshot** | **bool** | Specifies that snapshot label is not set for Data-Protect Nutanix FS Volumes backup. If field is set to true, existing oldest snapshot is used for backup and subsequent incremental will be selected in ascending order of snapshot create time on the source. If snapshot label is set, this field is set to false. | [optional] 
...
**modify_source_permissions** | **bool** | Specifies if the Nutanix FS source permissions should be modified internally to allow backups. | [optional] 
...
**objects** | [**List[NutanixFSProtectionGroupObjectParams]**](NutanixFSProtectionGroupObjectParams.md) | Specifies the objects to be included in the Protection Group. | 
...
json = "{}"
# create an instance of NutanixFSProtectionGroupParams from a JSON string
nutanix_fs_protection_group_params_instance = NutanixFSProtectionGroupParams.from_json(json)
# print the JSON string representation of the object
print(NutanixFSProtectionGroupParams.to_json())

# convert the object into a dict
nutanix_fs_protection_group_params_dict = nutanix_fs_protection_group_params_instance.to_dict()
# create an instance of NutanixFSProtectionGroupParams from a dict
nutanix_fs_protection_group_params_from_dict = NutanixFSProtectionGroupParams.from_dict(nutanix_fs_protection_group_params_dict)
```
