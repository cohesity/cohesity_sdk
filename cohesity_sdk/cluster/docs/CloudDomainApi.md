...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.cluster.CloudDomainApi(api_client)
    body = cohesity_sdk.cluster.CloudDomainParams() # CloudDomainParams | Specified the vault id

    try:
        api_response = api_instance.attach_cloud_domain(body)
        print("The response of CloudDomainApi->attach_cloud_domain:\n")
        pprint(api_response)
