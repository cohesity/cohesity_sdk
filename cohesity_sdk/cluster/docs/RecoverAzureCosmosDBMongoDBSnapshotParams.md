# RecoverAzureCosmosDBMongoDBSnapshotParams
...
**recover_azure_cosmos_db_mongo_db_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureCosmosDBMongoDBSnapshotParams from a JSON string
recover_azure_cosmos_db_mongo_db_snapshot_params_instance = RecoverAzureCosmosDBMongoDBSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureCosmosDBMongoDBSnapshotParams.to_json())

# convert the object into a dict
recover_azure_cosmos_db_mongo_db_snapshot_params_dict = recover_azure_cosmos_db_mongo_db_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureCosmosDBMongoDBSnapshotParams from a dict
recover_azure_cosmos_db_mongo_db_snapshot_params_from_dict = RecoverAzureCosmosDBMongoDBSnapshotParams.from_dict(recover_azure_cosmos_db_mongo_db_snapshot_params_dict)
```
