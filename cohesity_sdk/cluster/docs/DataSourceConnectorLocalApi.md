...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    api_instance = cohesity_sdk.cluster.DataSourceConnectorLocalApi(api_client)

    try:
        # Lists the data-source connector logs.
        api_response = api_instance.get_data_source_connector_logs()
        print("The response of DataSourceConnectorLocalApi->get_data_source_connector_logs:\n")
        pprint(api_response)
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceConnectorLocalApi->get_data_source_connector_status:\n")
        pprint(api_response)
    except Exception as e:
...
with cohesity_sdk.cluster.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cohesity_sdk.cluster.DataSourceConnectorLocalApi(api_client)
    body = cohesity_sdk.cluster.DataSourceConnectorRegistrationRequest() # DataSourceConnectorRegistrationRequest | Specifies the parameters to register the connector.
