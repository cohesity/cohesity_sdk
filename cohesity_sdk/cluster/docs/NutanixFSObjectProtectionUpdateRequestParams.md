# NutanixFSObjectProtectionUpdateRequestParams

Specifies the update parameters which are specific to NutanixFS object protection.
...
json = "{}"
# create an instance of NutanixFSObjectProtectionUpdateRequestParams from a JSON string
nutanix_fs_object_protection_update_request_params_instance = NutanixFSObjectProtectionUpdateRequestParams.from_json(json)
# print the JSON string representation of the object
print(NutanixFSObjectProtectionUpdateRequestParams.to_json())

# convert the object into a dict
nutanix_fs_object_protection_update_request_params_dict = nutanix_fs_object_protection_update_request_params_instance.to_dict()
# create an instance of NutanixFSObjectProtectionUpdateRequestParams from a dict
nutanix_fs_object_protection_update_request_params_from_dict = NutanixFSObjectProtectionUpdateRequestParams.from_dict(nutanix_fs_object_protection_update_request_params_dict)
```
