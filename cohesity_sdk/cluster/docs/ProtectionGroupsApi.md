...
[**get_runs_report**](ProtectionGroupsApi.md#get_runs_report) | **GET** /data-protect/protection-groups/{id}/runs/{runId}/objects/{objectId}/downloadFiles | Get the CSV of errors/warnings for a given run and an object.
...
> CommonProtectionGroupResponseParams2b38269eFdbd48e8Bbea460ff18221a3 create_protection_group(body)
...
from cohesity_sdk.cluster.model.common_protection_group_request_paramsfd6c9ec1_ca9f4d6d_ac23_f050e0cce95f import CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f
from cohesity_sdk.cluster.exceptions import ApiException
from pprint import pprint
...
body = CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f(
        name="name_example",
        ...
        environment="kVMware",
        is_paused=True,
    ) # CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f | Specifies the parameters to create a Protection Group.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f**](CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f.md)| Specifies the parameters to create a Protection Group. |

### Return type

[**CommonProtectionGroupResponseParams2b38269eFdbd48e8Bbea460ff18221a3**](CommonProtectionGroupResponseParams2b38269eFdbd48e8Bbea460ff18221a3.md)
...
> CommonProtectionGroupResponseParams2b38269eFdbd48e8Bbea460ff18221a3 get_protection_group_by_id(id)
...
try:
    ...
    description: null
    externalDocs: null
}].get_protection_group_by_id(id, request_initiator_type=request_initiator_type, include_last_run_info=include_last_run_info, prune_excluded_source_ids=prune_excluded_source_ids, prune_source_ids=prune_source_ids)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ProtectionGroupsApi->get_protection_group_by_id: %s\n" % e)
```
...
try:
    ...
    description: null
    externalDocs: null
}].get_protection_group_run(id, run_id, request_initiator_type=request_initiator_type, tenant_ids=tenant_ids, include_tenants=include_tenants, include_object_details=include_object_details)
	pprint(api_response)
except ApiException as e:
	print("Exception when calling ProtectionGroupsApi->get_protection_group_run: %s\n" % e)
```
...
try:
    ...
    description: null
    externalDocs: null
}].get_protection_runs(start_time_usecs=start_time_usecs, end_time_usecs=end_time_usecs, run_status=run_status)
	pprint(api_response)
except ApiException as e:
...
try:
	# Get the CSV of errors/warnings for a given run and an object.
	client.protection_groups.get_runs_report(id, run_id, object_id)
except ApiException as e:
	print("Exception when calling ProtectionGroupsApi->get_runs_report: %s\n" % e)
...
try:
    ...
    description: null
    externalDocs: null
}].get_runs_report(id, run_id, object_id, file_type=file_type)
except ApiException as e:
	print("Exception when calling ProtectionGroupsApi->get_runs_report: %s\n" % e)
```
...
> CommonProtectionGroupResponseParams2b38269eFdbd48e8Bbea460ff18221a3 update_protection_group(id, body)
...
body = CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f(
        ...
        environment="kVMware",
        is_paused=True,
    ) # CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f | Specifies the parameters to update a Protection Group.
 ...
 **body** | [**CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f**](CommonProtectionGroupRequestParamsfd6c9ec1Ca9f4d6dAc23F050e0cce95f.md)| Specifies the parameters to update a Protection Group. |
