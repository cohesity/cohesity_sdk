...
**in_maintenance_mode** | **bool, none_type** | InMaintnenanceMode is used to mark a node in maintenance mode. | [optional] 
...
**is_upgrade_in_progress** | **bool, none_type** | isUpgradeInProgress is used to mark a node being upgraded. | [optional] 
...
**patch_software_version** | **str, none_type** | PatchSoftwareVersion is the current version of patch applied on a node. | [optional] 
...
**total_disk_bytes** | **int, none_type** | TotalDiskBytes specifies the total disk capacity of the node in bytes. | [optional] 
**used_disk_bytes** | **int, none_type** | UsedDiskBytes specifies the used disk capacity of the node in bytes. | [optional] 
