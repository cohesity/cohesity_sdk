...
**objects** | [**List[RecoverExperimentalAdapterObjectParams]**](RecoverExperimentalAdapterObjectParams.md) | Specifies the local snapshot ids and other details of the objects to be recovered. | [optional] 
...
json = "{}"
# create an instance of RecoverExperimentalAdapterSnapshotParams from a JSON string
recover_experimental_adapter_snapshot_params_instance = RecoverExperimentalAdapterSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverExperimentalAdapterSnapshotParams.to_json())

# convert the object into a dict
recover_experimental_adapter_snapshot_params_dict = recover_experimental_adapter_snapshot_params_instance.to_dict()
# create an instance of RecoverExperimentalAdapterSnapshotParams from a dict
recover_experimental_adapter_snapshot_params_from_dict = RecoverExperimentalAdapterSnapshotParams.from_dict(recover_experimental_adapter_snapshot_params_dict)
```
