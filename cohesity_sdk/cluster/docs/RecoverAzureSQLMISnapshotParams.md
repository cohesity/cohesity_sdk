# RecoverAzureSQLMISnapshotParams
...
**recover_azure_sqlmi_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureSQLMISnapshotParams from a JSON string
recover_azure_sqlmi_snapshot_params_instance = RecoverAzureSQLMISnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureSQLMISnapshotParams.to_json())

# convert the object into a dict
recover_azure_sqlmi_snapshot_params_dict = recover_azure_sqlmi_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureSQLMISnapshotParams from a dict
recover_azure_sqlmi_snapshot_params_from_dict = RecoverAzureSQLMISnapshotParams.from_dict(recover_azure_sqlmi_snapshot_params_dict)
```
