# RecoverAzureTableStorageSnapshotParams
...
**recover_azure_table_storage_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureTableStorageSnapshotParams from a JSON string
recover_azure_table_storage_snapshot_params_instance = RecoverAzureTableStorageSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureTableStorageSnapshotParams.to_json())

# convert the object into a dict
recover_azure_table_storage_snapshot_params_dict = recover_azure_table_storage_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureTableStorageSnapshotParams from a dict
recover_azure_table_storage_snapshot_params_from_dict = RecoverAzureTableStorageSnapshotParams.from_dict(recover_azure_table_storage_snapshot_params_dict)
```
