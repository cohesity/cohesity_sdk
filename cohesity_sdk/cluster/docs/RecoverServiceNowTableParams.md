...
**records** | **List[str]** | Specifies a list of records IDs to be recovered for the  specified table. | [optional] 
...
recover_service_now_table_params_instance = RecoverServiceNowTableParams.from_json(json)
# print the JSON string representation of the object
print(RecoverServiceNowTableParams.to_json())

# convert the object into a dict
recover_service_now_table_params_dict = recover_service_now_table_params_instance.to_dict()
# create an instance of RecoverServiceNowTableParams from a dict
recover_service_now_table_params_from_dict = RecoverServiceNowTableParams.from_dict(recover_service_now_table_params_dict)
```
