...
**node_ips** | **List[Optional[str]]** | List of IPs of nodes in the cluster. | [optional] 
...
fortknox_onprem_primary_cluster_instance = FortknoxOnpremPrimaryCluster.from_json(json)
# print the JSON string representation of the object
print(FortknoxOnpremPrimaryCluster.to_json())

# convert the object into a dict
fortknox_onprem_primary_cluster_dict = fortknox_onprem_primary_cluster_instance.to_dict()
# create an instance of FortknoxOnpremPrimaryCluster from a dict
fortknox_onprem_primary_cluster_from_dict = FortknoxOnpremPrimaryCluster.from_dict(fortknox_onprem_primary_cluster_dict)
```
