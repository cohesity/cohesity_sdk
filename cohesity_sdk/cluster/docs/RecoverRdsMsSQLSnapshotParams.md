...
**recover_rds_ms_sql_object_params** | [**RecoverRdsMsSQLObjectParams**](RecoverRdsMsSQLObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverRdsMsSQLSnapshotParams from a JSON string
recover_rds_ms_sql_snapshot_params_instance = RecoverRdsMsSQLSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverRdsMsSQLSnapshotParams.to_json())

# convert the object into a dict
recover_rds_ms_sql_snapshot_params_dict = recover_rds_ms_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverRdsMsSQLSnapshotParams from a dict
recover_rds_ms_sql_snapshot_params_from_dict = RecoverRdsMsSQLSnapshotParams.from_dict(recover_rds_ms_sql_snapshot_params_dict)
```
