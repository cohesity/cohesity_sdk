...
**creation_time_usecs** | **int** | Specifies the time in micro seconds when this protection group was created. | [optional] 
...
**pause_metadata** | [**PauseMetadata**](PauseMetadata.md) |  | [optional] 
**permissions** | [**List[TenantInfo]**](TenantInfo.md) | Specifies the list of tenants that have permissions for this protection group. | [optional] 
...
**nutanix_fs_params** | [**NutanixFSProtectionGroupParams**](NutanixFSProtectionGroupParams.md) |  | [optional] 
...
**postgres_params** | [**PostgresProtectionGroupParams**](PostgresProtectionGroupParams.md) |  | [optional] 
