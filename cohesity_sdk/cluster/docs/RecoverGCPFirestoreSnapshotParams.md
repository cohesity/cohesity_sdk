# RecoverGCPFirestoreSnapshotParams
...
**recover_gcp_firestore_object_params** | [**RecoverGcpObjectParams**](RecoverGcpObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverGCPFirestoreSnapshotParams from a JSON string
recover_gcp_firestore_snapshot_params_instance = RecoverGCPFirestoreSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverGCPFirestoreSnapshotParams.to_json())

# convert the object into a dict
recover_gcp_firestore_snapshot_params_dict = recover_gcp_firestore_snapshot_params_instance.to_dict()
# create an instance of RecoverGCPFirestoreSnapshotParams from a dict
recover_gcp_firestore_snapshot_params_from_dict = RecoverGCPFirestoreSnapshotParams.from_dict(recover_gcp_firestore_snapshot_params_dict)
```
