...
------------ | ------------- | ------------- | -------------
**is_response_truncated** | **bool, none_type** | Indicates whether the result is truncated due to hitting maximum size limit governed by magneto_http_rpc_response_size_limit_bytes | [optional] 
