# RecoverGCPPostgreSQLSnapshotParams
...
**recover_gcp_postgre_sql_object_params** | [**RecoverGcpObjectParams**](RecoverGcpObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverGCPPostgreSQLSnapshotParams from a JSON string
recover_gcp_postgre_sql_snapshot_params_instance = RecoverGCPPostgreSQLSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverGCPPostgreSQLSnapshotParams.to_json())

# convert the object into a dict
recover_gcp_postgre_sql_snapshot_params_dict = recover_gcp_postgre_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverGCPPostgreSQLSnapshotParams from a dict
recover_gcp_postgre_sql_snapshot_params_from_dict = RecoverGCPPostgreSQLSnapshotParams.from_dict(recover_gcp_postgre_sql_snapshot_params_dict)
```
