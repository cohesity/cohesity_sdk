...
------------ | ------------- | ------------- | -------------
**sql_target_params** | [**SqlTargetParamsForRecoverSqlAppFiles**](SqlTargetParamsForRecoverSqlAppFiles.md) |  | 
...
json = "{}"
# create an instance of RecoverSqlAppFilesParams from a JSON string
recover_sql_app_files_params_instance = RecoverSqlAppFilesParams.from_json(json)
# print the JSON string representation of the object
print(RecoverSqlAppFilesParams.to_json())

# convert the object into a dict
recover_sql_app_files_params_dict = recover_sql_app_files_params_instance.to_dict()
# create an instance of RecoverSqlAppFilesParams from a dict
recover_sql_app_files_params_from_dict = RecoverSqlAppFilesParams.from_dict(recover_sql_app_files_params_dict)
```
