...
**sql_target_params** | [**SqlTargetParamsForRecoverSqlAppFiles**](SqlTargetParamsForRecoverSqlAppFiles.md) |  | [optional] 
**target_environment** | **str** | Specifies the environment of the recovery target. The corresponding params below must be filled out. | [optional]  if omitted the server will use the default value of "kSQL"
