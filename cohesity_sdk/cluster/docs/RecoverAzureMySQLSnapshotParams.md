# RecoverAzureMySQLSnapshotParams
...
**recover_azure_mysql_object_params** | [**AzureDbObjectRecoveryParams**](AzureDbObjectRecoveryParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAzureMySQLSnapshotParams from a JSON string
recover_azure_my_sql_snapshot_params_instance = RecoverAzureMySQLSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAzureMySQLSnapshotParams.to_json())

# convert the object into a dict
recover_azure_my_sql_snapshot_params_dict = recover_azure_my_sql_snapshot_params_instance.to_dict()
# create an instance of RecoverAzureMySQLSnapshotParams from a dict
recover_azure_my_sql_snapshot_params_from_dict = RecoverAzureMySQLSnapshotParams.from_dict(recover_azure_my_sql_snapshot_params_dict)
```
