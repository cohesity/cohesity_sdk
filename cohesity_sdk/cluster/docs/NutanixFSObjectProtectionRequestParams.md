# NutanixFSObjectProtectionRequestParams
...
json = "{}"
# create an instance of NutanixFSObjectProtectionRequestParams from a JSON string
nutanix_fs_object_protection_request_params_instance = NutanixFSObjectProtectionRequestParams.from_json(json)
# print the JSON string representation of the object
print(NutanixFSObjectProtectionRequestParams.to_json())

# convert the object into a dict
nutanix_fs_object_protection_request_params_dict = nutanix_fs_object_protection_request_params_instance.to_dict()
# create an instance of NutanixFSObjectProtectionRequestParams from a dict
nutanix_fs_object_protection_request_params_from_dict = NutanixFSObjectProtectionRequestParams.from_dict(nutanix_fs_object_protection_request_params_dict)
```
