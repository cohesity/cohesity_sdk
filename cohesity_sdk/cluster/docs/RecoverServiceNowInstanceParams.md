# RecoverServiceNowInstanceParams
...
**excluded_table_prefixes** | **List[str]** | Specifies the prefixes of tables to be excluded from recovery. | [optional] 
**excluded_tables** | **List[str]** | Specifies the names of tables to be excluded from recovery. | [optional] 
**selected_table_prefixes** | **List[str]** | Specifies the prefixes of tables to be recovered. | [optional] 
**selected_tables** | **List[str]** | Specifies the names of tables to be recovered. | [optional] 
...
recover_service_now_instance_params_instance = RecoverServiceNowInstanceParams.from_json(json)
# print the JSON string representation of the object
print(RecoverServiceNowInstanceParams.to_json())

# convert the object into a dict
recover_service_now_instance_params_dict = recover_service_now_instance_params_instance.to_dict()
# create an instance of RecoverServiceNowInstanceParams from a dict
recover_service_now_instance_params_from_dict = RecoverServiceNowInstanceParams.from_dict(recover_service_now_instance_params_dict)
```
