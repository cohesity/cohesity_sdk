# RecoverAwsRedshiftSnapshotParams
...
**recover_aws_redshift_object_params** | [**RecoverAwsRedshiftObjectParams**](RecoverAwsRedshiftObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverAwsRedshiftSnapshotParams from a JSON string
recover_aws_redshift_snapshot_params_instance = RecoverAwsRedshiftSnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverAwsRedshiftSnapshotParams.to_json())

# convert the object into a dict
recover_aws_redshift_snapshot_params_dict = recover_aws_redshift_snapshot_params_instance.to_dict()
# create an instance of RecoverAwsRedshiftSnapshotParams from a dict
recover_aws_redshift_snapshot_params_from_dict = RecoverAwsRedshiftSnapshotParams.from_dict(recover_aws_redshift_snapshot_params_dict)
```
