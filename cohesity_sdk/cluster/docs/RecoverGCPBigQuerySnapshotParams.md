# RecoverGCPBigQuerySnapshotParams
...
**recover_gcp_big_query_object_params** | [**RecoverGCPBigQueryObjectParams**](RecoverGCPBigQueryObjectParams.md) |  | [optional] 
...
json = "{}"
# create an instance of RecoverGCPBigQuerySnapshotParams from a JSON string
recover_gcp_big_query_snapshot_params_instance = RecoverGCPBigQuerySnapshotParams.from_json(json)
# print the JSON string representation of the object
print(RecoverGCPBigQuerySnapshotParams.to_json())

# convert the object into a dict
recover_gcp_big_query_snapshot_params_dict = recover_gcp_big_query_snapshot_params_instance.to_dict()
# create an instance of RecoverGCPBigQuerySnapshotParams from a dict
recover_gcp_big_query_snapshot_params_from_dict = RecoverGCPBigQuerySnapshotParams.from_dict(recover_gcp_big_query_snapshot_params_dict)
```
