...
------------ | ------------- | ------------- | -------------
**hashes** | **[str], none_type** | Specifies a list of the source hashes. Only files matches with these hashes will be returned. Only supported for adapters supported by ThreatHunting. | [optional] 
