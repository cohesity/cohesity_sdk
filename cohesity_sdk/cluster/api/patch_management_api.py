...
class PatchManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.apply_patches = _Endpoint(
            settings={
                'response_type': (list[ServicePatchLevel],),
                'auth': [
                    'TokenHeader',
        ...
        self.get_applied_patches = _Endpoint(
            settings={
                'response_type': (list[AppliedPatch],),
                'auth': [
                    'TokenHeader',
        ...
        self.get_available_patches = _Endpoint(
            settings={
                'response_type': (list[AvailablePatch],),
                'auth': [
                    'TokenHeader',
        ...
        self.get_patches_history = _Endpoint(
            settings={
                'response_type': (list[PatchOperation],),
                'auth': [
                    'TokenHeader',
        ...
        self.import_patches = _Endpoint(
            settings={
                'response_type': (list[PatchDetail],),
                'auth': [
                    'TokenHeader',
