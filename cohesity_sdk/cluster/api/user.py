...
from cohesity_sdk.cluster.models.create_users_parameters import CreateUsersParameters
    ...
    def __init__(self, api_client=None):
        ...
        def __update_user_s3_keys(
            ...
            **kwargs
            ...
            >>> thread = api.update_user_s3_keys(sid, body, async_req=True)
            >>> result = thread.get()

            Args:
                sid (str): Specify the SID of the user.
                body (S3Keys): Specifies the body to update the User S3 Keys
        ...
        self.update_user_s3_keys = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'TokenHeader',
