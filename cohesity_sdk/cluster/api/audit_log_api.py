        ...
        def __get_audit_logs(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                usernames (list[str]): Specifies a list of usernames, only audit logs made by these users will be returned.. [optional]
                domains (list[str]): Specifies a list of domains, only audit logs made by user in these domains will be returned.. [optional]
                entity_types (list[str]): Specifies a list of entity types, only audit logs containing these entity types will be returned.. [optional]
                actions (list[str]): Specifies a list of actions, only audit logs containing these actions will be returned.. [optional]
                ...
                tenant_ids (list[str]): Specifies a list of tenant ids, only audit logs made by these tenants will be returned.. [optional]
