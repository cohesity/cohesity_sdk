    ...
    def __init__(self, api_client=None):
        ...
        def __fetch_uptier_data(
            ...
            **kwargs
            ...
            >>> thread = api.fetch_uptier_data(archive_u_id, async_req=True)
            >>> result = thread.get()

            Args:
                archive_u_id (str): Archive UID of the current restore.
        ...
        def __get_recoveries(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Filter Recoveries for given ids.. [optional]
                ...
                tenant_ids (list[str]): TenantIds contains ids of the organizations for which recoveries are to be returned.. [optional]
                include_tenants (bool): Specifies if objects of all the organizations under the hierarchy of the logged in user's organization should be returned.. [optional]
                ...
                snapshot_target_type (list[str]): Specifies the snapshot's target type from which recovery has been performed.. [optional]
                archival_target_type (list[str]): Specifies the snapshot's archival target type from which recovery has been performed. This parameter applies only if 'snapshotTargetType' is 'Archival'.. [optional]
                snapshot_environments (list[str]): Specifies the list of snapshot environment types to filter Recoveries. If empty, Recoveries related to all environments will be returned.. [optional]
                status (list[str]): Specifies the list of run status to filter Recoveries. If empty, Recoveries with all run status will be returned.. [optional]
                recovery_actions (list[str]): Specifies the list of recovery actions to filter Recoveries. If empty, Recoveries related to all actions will be returned.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
