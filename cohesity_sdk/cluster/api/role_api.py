    ...
    def __init__(self, api_client=None):
        ...
        def __get_roles(
            ...
            **kwargs
            ...
            Keyword Args:
                names (list[str]): Specifies a list of Role names.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which Roles are to be returned.. [optional]
