    ...
    def __init__(self, api_client=None):
        ...
        def __get_protection_sources(
            ...
            **kwargs
            ...
            Keyword Args:
                request_initiator_type (str): Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which Sources are to be returned.. [optional]
        ...
        def __get_source_registrations(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Ids specifies the list of source registration ids to return. If left empty, every source registration will be returned by default.. [optional]
