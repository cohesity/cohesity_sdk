    ...
    def __init__(self, api_client=None):
        ...
        def __delete_infected_objects(
            ...
            **Privileges:** ```CLUSTER_MODIFY``` <br><br>Delete infected objects permanently.  # noqa: E501
            ...
            >>> thread = api.delete_infected_objects(body, async_req=True)
            >>> result = thread.get()

            Args:
                body (DeleteInfectedObjectsParameters): Specifies the parameters of infected objects to be deleted.
        ...
        self.delete_infected_objects = _Endpoint(
            settings={
                'response_type': (DeleteInfectedObjects,),
                'auth': [
                    'TokenHeader',
            ...
            api_client=api_client,
            callable=__delete_infected_objects
        )
        ...
        def __update_infected_files(
            ...
            **Privileges:** ```CLUSTER_MODIFY``` <br><br>Update infected entities state.  # noqa: E501
            ...
            Args:
                body (UpdateInfectedFilesParameters): Specifies the parameters of infected entities to be updated.
