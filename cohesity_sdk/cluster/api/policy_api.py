    ...
    def __init__(self, api_client=None):
        ...
        def __get_policy_templates(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                ids (list[str]): Filter policies by a list of policy template ids.. [optional]
                policy_names (list[str]): Filter policies by a list of policy names.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the organizations for which objects are to be returned.. [optional]
        ...
        def __get_protection_policies(
            ...
            **kwargs
            ...
            Keyword Args:
                request_initiator_type (str): Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests.. [optional]
                ids (list[str]): Filter policies by a list of policy ids.. [optional]
                policy_names (list[str]): Filter policies by a list of policy names.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the organizations for which objects are to be returned.. [optional]
                include_tenants (bool): IncludeTenantPolicies specifies if objects of all the organizations under the hierarchy of the logged in user's organization should be returned.. [optional]
                types (list[str]): Types specifies the policy type of policies to be returned. [optional] if omitted the server will use the default value of ["Regular"]
