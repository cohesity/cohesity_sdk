    ...
    def __init__(self, api_client=None):
        ...
        def __get_external_target_media_info(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                entity_ids (list[int]): Specifies an array of entityIds to optionally filter by. An entityId is a unique id for a VM assigned by the Cohesity Cluster.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_external_targets(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Filter by a list of External Target ids.. [optional]
                global_ids (list[str]): Filter by a list of External Target global ids.. [optional]
                names (list[str]): Filter by a list of External Target names.. [optional]
                purpose_types (list[str]): Filter by a list of External Target purpose types.. [optional]
                storage_types (list[str]): Filter by a list of External Target storage types. Nas option in archival_target_storage_type will soon be deprecated. Please use NAS instead.. [optional]
                storage_classes (list[str]): Filter by a list of External Target storage classes.. [optional]
                ownership_contexts (list[str]): Specifies whether how this external target is being consumed either Local or FortKnox.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
