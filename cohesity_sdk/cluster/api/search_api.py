        ...
        def __search_objects(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                environments (list[str]): Specifies the environment type to filter objects.. [optional]
                protection_types (list[str]): Specifies the protection type to filter objects.. [optional]
                ...
                protection_group_ids (list[str]): Specifies a list of Protection Group ids to filter the objects. If specified, the objects protected by specified Protection Group ids will be returned.. [optional]
                object_ids (list[int]): Specifies a list of Object ids to filter.. [optional]
                os_types (list[str]): Specifies the operating system types to filter objects on.. [optional]
                o365_object_types (list[str]): Specifies the object types to filter objects on. Only applicable if the environment is o365.. [optional]
                azure_object_types (list[str]): Specifies the object types to filter objects on. Only applicable if the environment is Azure.. [optional]
                source_ids (list[int]): Specifies a list of Protection Source object ids to filter the objects. If specified, the object which are present in those Sources will be returned.. [optional]
                source_uuids (list[str]): Specifies a list of Protection Source object uuids to filter the objects. If specified, the object which are present in those Sources will be returned.. [optional]
                ...
                last_run_status_list (list[str]): Specifies a list of status of the object's last protection run. Only objects with last run status of these will be returned.. [optional]
                region_ids (list[str]): Specifies a list of region ids. Only records from clusters having these region ids will be returned.. [optional]
                cluster_identifiers (list[str]): Specifies the list of cluster identifiers. Format is clusterId:clusterIncarnationId. Only records from clusters having these identifiers will be returned.. [optional]
                storage_domain_ids (list[str]): Specifies the list of storage domain ids. Format is clusterId:clusterIncarnationId:storageDomainId. Only objects having protection in these storage domains will be returned.. [optional]
        ...
        def __search_protected_objects(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                protection_group_ids (list[str]): Specifies a list of Protection Group ids to filter the objects. If specified, the objects protected by specified Protection Group ids will be returned.. [optional]
                object_ids (list[int]): Specifies a list of Object ids to filter.. [optional]
                storage_domain_ids (list[int]): Specifies the Storage Domain ids to filter objects for which Protection Groups are writing data to Cohesity Views on the specified Storage Domains.. [optional]
                ...
                os_types (list[str]): Specifies the operating system types to filter objects on.. [optional]
                source_ids (list[int]): Specifies a list of Protection Source object ids to filter the objects. If specified, the object which are present in those Sources will be returned.. [optional]
                run_instance_ids (list[int]): Specifies a list of run instance ids. If specified only objects belonging to the provided run id will be retunrned.. [optional]
