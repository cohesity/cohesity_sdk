    ...
    def __init__(self, api_client=None):
        ...
        def __get_tags(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Filter by a list of Tag Ids. If Ids are mentioned all other fields will be ignored.. [optional]
                names (list[str]): Filter by a list of Tag names.. [optional]
                namespaces (list[str]): Filter by a list of Namespaces.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which tags are to be returned.. [optional]
