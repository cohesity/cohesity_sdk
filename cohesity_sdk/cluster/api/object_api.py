    ...
    def __init__(self, api_client=None):
        ...
        def __get_all_indexed_object_snapshots(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                run_types (list[str]): Filter by run type. Only protection run matching the specified types will be returned. By default, CDP hydration snapshots are not included, unless explicitly queried using this field.. [optional]
        ...
        def __get_entity_metadata(
            ...
            **kwargs
            ...
            Keyword Args:
                entity_ids (list[int]): EntityIds contains ids of the entities for which objects are to be returned.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_object_runs(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which objects are to be returned.. [optional]
                ...
                run_types (list[str]): Filter by run type. Only protection run matching the specified types will be returned.. [optional]
                local_backup_object_status (list[str]): Specifies a list of status for the object in the backup run.. [optional]
                replication_object_status (list[str]): Specifies a list of status for the object in the replication run.. [optional]
                archival_object_status (list[str]): Specifies a list of status for the object in the archival run.. [optional]
                cloud_spin_run_status (list[str]): Specifies a list of status for the object in the cloud spin run.. [optional]
        ...
        def __get_object_snapshots(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                snapshot_actions (list[str]): Specifies a list of recovery actions. Only snapshots that applies to these actions will be returned.. [optional]
                run_types (list[str]): Filter by run type. Only protection run matching the specified types will be returned. By default, CDP hydration snapshots are not included, unless explicitly queried using this field.. [optional]
                protection_group_ids (list[str]): If specified, this returns only the snapshots of the specified object ID, which belong to the provided protection group IDs.. [optional]
                run_instance_ids (list[int]): Filter by a list run instance ids. If specified, only snapshots created by these protection runs will be returned.. [optional]
                region_ids (list[str]): Filter by a list of region ids.. [optional]
                object_action_keys (list[str]): Filter by ObjectActionKey, which uniquely represents protection of an object. An object can be protected in multiple ways but atmost once for a given combination of ObjectActionKey. When specified, only snapshots matching given action keys are returned for corresponding object.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_objects_last_run(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Specifies a list of object ids, only last runs for these objects will be returned.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which objects are to be returned.. [optional]
        ...
        def __get_pit_ranges_for_protected_object(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                protection_group_ids (list[str]): If specified, return only the points in time corresponding to these protection group IDs.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_protected_object_of_any_type_by_id(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                environments (list[str]): Filter by environment types such as 'kVMware', 'kView', etc. Only Protected objects protecting the specified environment types are returned.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which objects are to be returned.. [optional]
        ...
        def __get_protected_objects_of_any_type(
            ...
            **kwargs
            ...
            Keyword Args:
                request_initiator_type (str): Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests.. [optional]
                ids (list[int]): Filter by a list of Object ids.. [optional]
                ...
                policy_ids (list[str]): Filter by Policy ids that are associated with Protected Objects.. [optional]
        ...
        def __get_source_hierarchy_objects(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which objects are to be returned.. [optional]
                include_tenants (bool): If true, the response will include Objects which belongs to all tenants which the current user has permission to see.. [optional]
                vmware_object_types (list[str]): Specifies the VMware object types to filter objects.. [optional]
                netapp_object_types (list[str]): Specifies the Netapp object types to filter objects.. [optional]
                o365_object_types (list[str]): Specifies the Office 365 object types to filter objects.. [optional]
                cassandra_object_types (list[str]): Specifies the Cassandra object types to filter objects.. [optional]
                mongodb_object_types (list[str]): Specifies the Mongo DB object types to filter objects.. [optional]
                couchbase_object_types (list[str]): Specifies the Couchbase object types to filter objects.. [optional]
                hdfs_object_types (list[str]): Specifies the HDFS object types to filter objects.. [optional]
                hbase_object_types (list[str]): Specifies the Hbase object types to filter objects.. [optional]
                hive_object_types (list[str]): Specifies the Hive object types to filter objects.. [optional]
                hyperv_object_types (list[str]): Specifies the HyperV object types to filter objects.. [optional]
                azure_object_types (list[str]): Specifies the Azure object types to filter objects.. [optional]
                kvm_object_types (list[str]): Specifies the KVM object types to filter objects.. [optional]
                aws_object_types (list[str]): Specifies the AWS object types to filter objects.. [optional]
                gcp_object_types (list[str]): Specifies the GCP object types to filter objects.. [optional]
                acropolis_object_types (list[str]): Specifies the Acropolis object types to filter objects.. [optional]
                generic_nas_object_types (list[str]): Specifies the generic NAS object types to filter objects.. [optional]
                isilon_object_types (list[str]): Specifies the Isilon object types to filter objects.. [optional]
                flashblade_object_types (list[str]): Specifies the Flashblade object types to filter objects.. [optional]
                elastifile_object_types (list[str]): Specifies the Elastifile object types to filter objects.. [optional]
                gpfs_object_types (list[str]): Specifies the GPFS object types to filter objects.. [optional]
                pure_object_types (list[str]): Specifies the Pure object types to filter objects.. [optional]
                nimble_object_types (list[str]): Specifies the Nimble object types to filter objects.. [optional]
                physical_object_types (list[str]): Specifies the Physical object types to filter objects.. [optional]
                kubernetes_object_types (list[str]): Specifies the Kubernetes object types to filter objects.. [optional]
                exchange_object_types (list[str]): Specifies the Exchange object types to filter objects.. [optional]
                ad_object_types (list[str]): Specifies the AD object types to filter objects.. [optional]
                mssql_object_types (list[str]): Specifies the MSSQL object types to filter objects.. [optional]
                oracle_object_types (list[str]): Specifies the Oracle object types to filter objects.. [optional]
                use_cached_data (bool): Specifies whether we can serve the GET request to the read replica cache. There is a lag of 15 seconds between the read replica and primary data source.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
