    ...
    def __init__(self, api_client=None):
        ...
        def __create_group(
            ...
            **kwargs
            ...
            Args:
                body (list[CreateGroupParams]): Specifies the new group parameters.
        ...
        def __get_active_sessions_count(
            ...
            **kwargs
            ...
            Keyword Args:
                sids (list[str]): Filter sessions based on user sids.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_all_api_keys(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Filter by API Key Ids. [optional]
                owner_sids (list[str]): Filter by list of owner (user) SIDs. [optional]
        ...
        def __get_groups(
            ...
            **kwargs
            ...
            Keyword Args:
                names (list[str]): Specifies a list of group names to filter.. [optional]
                roles (list[str]): Specifies a list of roles to filter.. [optional]
                domain (str): Specifies the group domain to filter.. [optional]
                sids (list[str]): Specifies a list of sids to filter.. [optional]
                ...
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which groups are to be returned.. [optional]
        ...
        def __get_security_principals(
            ...
            **kwargs
            ...
            Args:
                sids (list[str]): Specifies a list of SIDs.
        ...
        def __get_users(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                sids (list[str]): Specifies a list of sids to filter.. [optional]
                usernames (list[str]): Specifies a list of usernames to filter.. [optional]
                match_partial_names (bool): If true, the names in usernames are matched by any partial rather than exactly matched.. [optional]
                email_addresses (list[str]): Specifies a list of email addresses to filter.. [optional]
                roles (list[str]): Specifies a list of roles to filter.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which users are to be returned.. [optional]
