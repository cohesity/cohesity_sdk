    ...
    def __init__(self, api_client=None):
        ...
        def __get_data_tiering_analysis_group_runs(
            ...
            **kwargs
            ...
            Keyword Args:
                run_ids (list[str]): Filter by a list of analysis group run ids.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.get_data_tiering_analysis_group_runs = _Endpoint(
            settings={
                'response_type': (list[DataTieringAnalysisGroupRun],),
                'auth': [
                    'TokenHeader',
        ...
        def __get_data_tiering_analysis_groups(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Filter by a list of Analysis Group IDs.. [optional]
        ...
        self.get_data_tiering_analysis_groups = _Endpoint(
            settings={
                'response_type': (list[DataTieringAnalysisGroup],),
                'auth': [
                    'TokenHeader',
        ...
        def __get_data_tiering_tasks(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Filter by a list of data tiering task ids.. [optional]
        ...
        self.get_data_tiering_tasks = _Endpoint(
            settings={
                'response_type': (list[DataTieringTask],),
                'auth': [
                    'TokenHeader',
