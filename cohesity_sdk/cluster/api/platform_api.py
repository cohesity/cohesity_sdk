    ...
    def __init__(self, api_client=None):
        ...
        def __add_hosts(
            ...
            **kwargs
            ...
            Args:
                body (list[HostEntry]): Specifies the request to add entries to /etc/hosts
        ...
        def __get_cluster_vlans(
            ...
            **kwargs
            ...
            Keyword Args:
                interface_names (list[str]): Vlan interface names, it should be in interface_group_name.vlan_id format.. [optional]
                tenant_ids (list[str]): Ids of the tenants, used to get vlans assigned to tenants.. [optional]
        ...
        def __get_interface_groups(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Ids of the interface groups.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_nodes(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): \"List of IDs to be returned. If empty, all nodes are returned.\". [optional]
                ...
                cluster_partition_ids (list[int]): ClusterPartitionIdList specifies the list of Ids used to filter the nodes by specified cluster partition.. [optional]
        ...
        def __get_remote_disks(
            ...
            **kwargs
            ...
            Keyword Args:
                disk_ids (list[int]): Specifies a list of disk ids, only disks having these ids will be returned.. [optional]
                node_ids (list[int]): Specifies a list of node ids, only disks in these nodes will be returned.. [optional]
                tiers (list[str]): Specifies a list of disk tiers, only disks with given tiers will be returned.. [optional]
        ...
        self.list_feature_flag = _Endpoint(
            settings={
                'response_type': (list[FeatureFlag],),
                'auth': [
                    'TokenHeader',
