    ...
    def __init__(self, api_client=None):
        ...
        self.add_active_directory_principals = _Endpoint(
            ...
            root_map={
                ...
                'openapi_types': {
                    'body':
                        (list[AddActiveDirectoryPrincipalsParameters],),
                },
                'attribute_map': {
                },
                'location_map': {
        ...
        def __get_active_directory(
            ...
            **kwargs
            ...
            Keyword Args:
                domain_names (list[str]): Filter by a list of Active Directory domain names.. [optional]
                ids (list[int]): Filter by a list of Active Directory Ids.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which Active Directories are to be returned.. [optional]
        ...
        def __get_active_directory_by_id(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                object_class (list[str]): Specifies a list of object classes, only security principals with object class in this list will be returned. This field is appliciable if 'includeSecurityPrincipals' is set to true.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_active_directory_principals(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                sids (list[str]): Optionally filter by a list of security identifiers (SIDs) found in the specified domain. Only principals matching the specified SIDs are returned. If specified, a 'searchTerm' parameter should not be specified. Note: Duplicate SIDs will be ignored.. [optional]
        ...
        def __get_domain_controllers(
            ...
            **kwargs
            ...
            Args:
                domain_names (list[str]): Specifies a list of domain names.
