    ...
    def __init__(self, api_client=None):
        ...
        def __get_storage_domains(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Filter by a list of Storage Domain ids.. [optional]
                names (list[str]): Filter by a list of Storage Domain names.. [optional]
                cluster_partition_ids (list[int]): Filter by a list of cluster partition ids.. [optional]
                tenant_ids (list[str]): TenantIds contains ids of the tenants for which Storage Domains are to be returned.. [optional]
