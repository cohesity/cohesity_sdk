    ...
    def __init__(self, api_client=None):
        ...
        def __get_identities(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Specifies IDs of configured identity providers. [optional]
                tenant_ids (list[str]): Specifies the tenant id's to get IDPs configured on tenants. [optional]
                domains (list[str]): Specifies domains of the IDP configurations. [optional]
        ...
        def __get_identity_providers(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[int]): Specifies ids of configured identity providers. [optional]
                tenant_ids (list[str]): Specifies the tenant id's to get idps configured on tenants. [optional]
                names (list[str]): Specifies the names of the identity providers. [optional]
                domains (list[str]): Specifies domains of the idp configurations. [optional]
                include_all_tenants (bool): Specifies if idp configurations on all the tenants under the hierarchy of the logged in user should be returned. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
