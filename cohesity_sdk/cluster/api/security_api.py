...
class SecurityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_csr_list(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                ids (list[str]): Specifies the ids of the csrs. If this is not specified, all the csrs on the cluster will be returned.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.get_csr_list = _Endpoint(
            settings={
                'response_type': (list[CommonCsrResponseParams],),
                'auth': [
                    'TokenHeader',
        ...
        def __list_trusted_cas(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): Specifies the ids of the certificates to be returned.. [optional]
                names (list[str]): Specifies the names of the certificates to be returned.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
