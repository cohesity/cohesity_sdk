...
class ProtectionGroupApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_protection_group(
            ...
            **Privileges:** ```PROTECTION_MODIFY``` <br><br>Create a Protection Group.  # noqa: E501
        ...
        def __create_protection_group_run(
            ...
            **Privileges:** ```PROTECTION_JOB_OPERATE``` <br><br>Create a new protection run. This can be used to start a run for a Protection Group on demand, ignoring the schedule and retention specified in the protection policy.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __delete_protection_group(
            ...
            **Privileges:** ```PROTECTION_MODIFY``` <br><br>Returns Success if the Protection Group is deleted.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_group_by_id(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Returns the Protection Group corresponding to the specified Group id.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_group_run(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get a run for a particular Protection Group.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_group_runs(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the runs for a particular Protection Group.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_protection_group_runs = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'only_return_shell_info': 'onlyReturnShellInfo',
                    'exclude_error_runs': 'excludeErrorRuns',
                    'job_run_start_time_usecs': 'jobRunStartTimeUsecs',
                    'only_return_data_migration_jobs': 'onlyReturnDataMigrationJobs',
                    'include_extension_info': 'includeExtensionInfo',
                    'include_rpo_snapshots': 'includeRpoSnapshots',
                    'source_id': 'sourceId',
                    'max_result_count': 'maxResultCount',
                    'pagination_cookie': 'paginationCookie',
                    'include_external_target_runs': 'includeExternalTargetRuns',
                },
                'location_map': {
                    'id': 'path',
                    'request_initiator_type': 'header',
                    ...
                    'only_return_shell_info': 'query',
                    'exclude_error_runs': 'query',
                    'job_run_start_time_usecs': 'query',
                    'only_return_data_migration_jobs': 'query',
                    'include_extension_info': 'query',
                    'include_rpo_snapshots': 'query',
                    'source_id': 'query',
                    'max_result_count': 'query',
                    'pagination_cookie': 'query',
                    'include_external_target_runs': 'query',
                },
                'collection_format_map': {
                    'tenant_ids': 'csv',
                    'run_types': 'csv',
        ...
        def __get_protection_groups(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the list of Protection Groups.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_run_progress(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the progress of a run.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_run_stats(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the stats for a run.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_protection_runs(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get a list of protection runs.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_run_debug_logs(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the debug logs for all objects of a run for a particular Protection Group.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_run_debug_logs_for_object(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get the debug logs for a particular object of a run for a particular Protection Group.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_run_messages_report(
            ...
            **Privileges:** ```PROTECTION_VIEW``` <br><br>Get an CSV report for given objectId and run id. Each row in CSV report contains the fields from correspoinding proto message.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __perform_action_on_protection_group_run(
            ...
            **Privileges:** ```PROTECTION_MODIFY``` <br><br>Perform various actions on a Protection Group run.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __update_protection_group(
            ...
            **Privileges:** ```PROTECTION_MODIFY``` <br><br>Update the specified Protection Group.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
