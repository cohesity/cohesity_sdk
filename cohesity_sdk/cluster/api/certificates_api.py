...
class CertificatesApi:
    ...
    @validate_call
    def get_web_server_certificate(
        self,
        ...
        **Privileges:** ```CLUSTER_VIEW``` <br><br>Returns the Server Certificate configured on the cluster.
        ...
        _param = self._get_web_server_certificate_serialize(
    ...
    @validate_call
    def get_web_server_certificate_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_web_server_certificate_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_web_server_certificate_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webserver-certificate',
