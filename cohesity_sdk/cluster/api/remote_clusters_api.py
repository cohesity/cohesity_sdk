    ...
    def __init__(self, api_client=None):
        ...
        def __get_remote_clusters(
            ...
            **kwargs
            ...
            Keyword Args:
                cluster_ids (list[int]): Specifies a list of Remote Cluster ids to filter.. [optional]
                cluster_names (list[str]): Specifies a list of Remote Cluster names to filter.. [optional]
                node_addresses (list[str]): Specifies a list of Remote Cluster IPs to filter.. [optional]
