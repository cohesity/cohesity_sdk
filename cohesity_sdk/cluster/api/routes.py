...
class RoutesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __add_static_route(
            ...
            **Privileges:** ```CLUSTER_MODIFY, CLUSTER_CREATE``` <br><br>Configure a static route on an interface.  # noqa: E501
        ...
        def __delete_static_route(
            ...
            **kwargs
            ...
            ```Unknown Privileges``` <br><br>Delete a static route on a network interface.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __list_static_routes(
            ...
            **Privileges:** ```CLUSTER_VIEW, CLUSTER_CREATE``` <br><br>List the static routes for the Cohesity Cluster.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __update_static_route(
            ...
            **kwargs
            ...
            ```Unknown Privileges``` <br><br>Update static route details.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
