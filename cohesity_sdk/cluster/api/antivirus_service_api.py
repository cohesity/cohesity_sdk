    ...
    def __init__(self, api_client=None):
        ...
        def __get_icap_uri_connection_status(
            ...
            **kwargs
            ...
            Keyword Args:
                uris (list[str]): Specifies a list of URIs to check connection status.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_infected_files(
            ...
            **kwargs
            ...
            Keyword Args:
                view_ids (list[int]): Specifies a list of view ids. Only infected files from these views will be returned.. [optional]
                path (str): Specifies the file path.. [optional]
                states (list[str]): Specifies the file states.. [optional]
