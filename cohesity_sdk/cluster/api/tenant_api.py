...
from cohesity_sdk.models.unknownbasetype import UNKNOWN_BASE_TYPE
    ...
    def __init__(self, api_client=None):
        ...
        def __list_tenants(
            ...
            **kwargs
            ...
            Keyword Args:
                ids (list[str]): List of tenantIds to filter.. [optional]
                statuses (list[str]): Filter by current status of tenant. If left blank, only active and inactive tenants are returned.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
