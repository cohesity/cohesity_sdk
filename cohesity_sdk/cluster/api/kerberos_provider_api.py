    ...
    def __init__(self, api_client=None):
        ...
        def __get_kerberos_providers(
            ...
            **kwargs
            ...
            Keyword Args:
                realm_names (list[str]): Filter by a list of realm names.. [optional]
                has_ldap (bool): Filter by whether LDAP is associated with the provider.. [optional]
                ids (list[int]): Filter by a list of Kerberos Provider Ids.. [optional]
                kdc_servers (list[str]): Filter by a list of KDC servers.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
