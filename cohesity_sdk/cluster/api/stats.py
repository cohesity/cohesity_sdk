...
class StatsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_replication_backlog_stats(
            self,
            **kwargs
        ):
            """Get Time Series Stats for Replication Backlog.  # noqa: E501

            **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get Replication Backlog Stats.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_replication_backlog_stats(async_req=True)
            >>> result = thread.get()
        ...
        self.get_replication_backlog_stats = _Endpoint(
            settings={
                'response_type': (ReplicationBacklogStats,),
                'auth': [
                    'TokenHeader',
                ...
                'endpoint_path': '/stats/replication-backlog',
                'operation_id': 'get_replication_backlog_stats',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'target_cluster_list': 'targetClusterList',
                },
                'location_map': {
                    'include_tenants': 'query',
                    'is_in_bound': 'query',
                    'target_cluster_list': 'query',
                },
                'collection_format_map': {
                    'target_cluster_list': 'csv',
                }
            },
            headers_map={
                'accept': [
            ...
            api_client=api_client,
            callable=__get_replication_backlog_stats
        )

        def __get_replication_clusters(
            self,
            start_time_msecs,
            ...
            **kwargs
            ...
            """get_replication_clusters  # noqa: E501

            **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get list of clusters with total data replicated for each.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_replication_clusters(start_time_msecs, rollup_interval_secs, target_cluster_list, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['start_time_msecs'] = \
                start_time_msecs
            kwargs['rollup_interval_secs'] = \
                rollup_interval_secs
            kwargs['target_cluster_list'] = \
                target_cluster_list
            return self.call_with_http_info(**kwargs)

        self.get_replication_clusters = _Endpoint(
            settings={
                'response_type': (ReplicationClustersResponse,),
                'auth': [
                    'TokenHeader',
                ...
                'endpoint_path': '/stats/replication-clusters',
                'operation_id': 'get_replication_clusters',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_replication_clusters
        )

        def __get_replication_data_trend(
            self,
            start_time_msecs,
            rollup_interval_secs,
            **kwargs
        ):
            """get_replication_data_trend  # noqa: E501

            **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get replication data trends over time for all entities in the given schema.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_replication_data_trend(start_time_msecs, rollup_interval_secs, async_req=True)
            >>> result = thread.get()
        ...
        self.get_replication_data_trend = _Endpoint(
            settings={
                ...
                'endpoint_path': '/stats/replication-data-trend',
                'operation_id': 'get_replication_data_trend',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_replication_data_trend
        )

        def __get_replication_objects(
            self,
            **kwargs
        ):
            """get_replication_objects  # noqa: E501

            **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get list of all replicated objects in the given time range  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_replication_objects(async_req=True)
            >>> result = thread.get()
        ...
        self.get_replication_objects = _Endpoint(
            settings={
                'response_type': (ReplicationObjectsList,),
                'auth': [
                    'TokenHeader',
                ...
                'endpoint_path': '/stats/replication-objects',
                'operation_id': 'get_replication_objects',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_replication_objects
        )

        def __get_replication_objects_trend(
            self,
            start_time_msecs,
            rollup_interval_secs,
            **kwargs
        ):
            """get_replication_objects_trend  # noqa: E501

            **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get replication object trends over time for all entities in the given schema.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_replication_objects_trend(start_time_msecs, rollup_interval_secs, async_req=True)
            >>> result = thread.get()
        ...
        self.get_replication_objects_trend = _Endpoint(
            settings={
                'response_type': (TimeSeriesStats,),
                'auth': [
                    'TokenHeader',
                ...
                'endpoint_path': '/stats/replication-objects-trend',
                'operation_id': 'get_replication_objects_trend',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_replication_objects_trend
        )
