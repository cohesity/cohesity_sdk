    ...
    def __init__(self, api_client=None):
        ...
        def __get_view_clients(
            ...
            **kwargs
            ...
            Keyword Args:
                protocols (list[str]): Specifies a list of protocols to filter the clients.. [optional]
                view_ids (list[int]): Specifies a list of View ids. Only clients connected to these Views will be returned.. [optional]
        ...
        def __get_view_clients_summary(
            ...
            **kwargs
            ...
            Keyword Args:
                view_ids (list[int]): Specifies a list of View ids. Only clients connected to these Views will be included in the summary.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __get_views(
            ...
            **kwargs
            ...
            Keyword Args:
                view_names (list[str]): Filter by a list of View names.. [optional]
                view_ids (list[int]): Filter by a list of View ids.. [optional]
                storage_domain_ids (list[int]): Filter by a list of Storage Domains (View Boxes) specified by id.. [optional]
                storage_domain_names (list[str]): Filter by a list of View Box names.. [optional]
                protocol_accesses (list[str]): Filter by a list of protocol accesses. Only views with protocol accesses in these specified accesses list will be returned.. [optional]
                ...
                protection_group_ids (list[int]): This field will be deprecated. Filter by Protection Group ids. Return Views that are being protected by listed Groups, which are specified by ids. If both protectionGroupIds and viewProtectionGroupIds are specified, only viewProtectionGroupIds will be used.. [optional]
                view_protection_group_ids (list[str]): Filter by Protection Group ids. Return Views that are being protected by listed Groups, which are specified by ids.. [optional]
                ...
                internal_access_sids (list[str]): Sids of restricted principals who can access the view. This is an internal field and therefore does not have json tag.. [optional]
                ...
                categories (list[str]): Filter by a list of View categories.. [optional]
                view_protection_types (list[str]): Filter by a list of View protection types. Supported types: [Local Archival ReplicationOut ReplicationIn UnProtected]. UnProtected is mutually exclusive from remaining types.. [optional]
                last_run_any_statuses (list[str]): Filter by last any run status of the view.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Skipped' indicates that the run was skipped.. [optional]
                last_run_local_backup_statuses (list[str]): Filter by last local backup run status of the view.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Skipped' indicates that the run was skipped.. [optional]
                last_run_replication_statuses (list[str]): Filter by last remote replication run status of the view.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Skipped' indicates that the run was skipped.. [optional]
                last_run_archival_statuses (list[str]): Filter by last cloud archival run status of the view.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Skipped' indicates that the run was skipped.. [optional]
                ...
                qos_principal_ids (list[int]): qosPrincipalIds contains ids of the QoS principal for which views are to be returned.. [optional]
