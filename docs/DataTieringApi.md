...
> CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d create_data_tiering_task(body)
...
```python
from cohesity_sdk.cluster.cohesity_client_v2 import CohesityClientV2
from cohesity_sdk.cluster.model.common_data_tiering_task_params5c1d98b2_cff640b8_b8794515965329a7 import CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7
from cohesity_sdk.cluster.model.error import Error
from cohesity_sdk.cluster.model.common_data_tiering_task_responsefbe77d13_fcf6433c_bdb813da7859148d import CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d
from cohesity_sdk.cluster.exceptions import ApiException
from pprint import pprint
...
body = CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7(
        name="name_example",
        ...
        type="Downtier",
    ) # CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7 | Specifies the parameters to create a data tiering task.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7**](CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7.md)| Specifies the parameters to create a data tiering task. |

### Return type

[**CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d**](CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d.md)
...
try:
    ...
    description: null
    externalDocs: null
}].get_data_tiering_analysis_groups(ids=ids)
	pprint(api_response)
except ApiException as e:
...
> CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d get_data_tiering_task_by_id(id)
...
try:
    ...
    description: null
    externalDocs: null
}].get_data_tiering_tasks(ids=ids)
	pprint(api_response)
except ApiException as e:
...
> CommonDataTieringTaskResponsefbe77d13Fcf6433cBdb813da7859148d update_data_tiering_task(id, body)
...
body = CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7(
        ...
        type="Downtier",
    ) # CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7 | Specifies the parameters to update a data tiering task.
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Specifies the id of the data tiering task. |
 **body** | [**CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7**](CommonDataTieringTaskParams5c1d98b2Cff640b8B8794515965329a7.md)| Specifies the parameters to update a data tiering task. |
