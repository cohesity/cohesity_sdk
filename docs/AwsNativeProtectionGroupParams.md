...
**objects** | [**List[AwsNativeProtectionGroupObjectParams]**](AwsNativeProtectionGroupObjectParams.md) | Specifies the objects to be included in the Protection Group. | [optional] 
...
json = "{}"
# create an instance of AwsNativeProtectionGroupParams from a JSON string
aws_native_protection_group_params_instance = AwsNativeProtectionGroupParams.from_json(json)
# print the JSON string representation of the object
print(AwsNativeProtectionGroupParams.to_json())

# convert the object into a dict
aws_native_protection_group_params_dict = aws_native_protection_group_params_instance.to_dict()
# create an instance of AwsNativeProtectionGroupParams from a dict
aws_native_protection_group_params_from_dict = AwsNativeProtectionGroupParams.from_dict(aws_native_protection_group_params_dict)
```
