...
try:
    ...
    description: null
    externalDocs: null
}].get_applied_patches(service=service, include_details=include_details)
	pprint(api_response)
except ApiException as e:
...
try:
    ...
    description: null
    externalDocs: null
}].get_available_patches(service=service, include_details=include_details)
	pprint(api_response)
except ApiException as e:
...
try:
    ...
    description: null
    externalDocs: null
}].get_patch_operation_status(include_details=include_details)
	pprint(api_response)
except ApiException as e:
...
try:
    ...
    description: null
    externalDocs: null
}].get_patches_history(service=service)
	pprint(api_response)
except ApiException as e:
