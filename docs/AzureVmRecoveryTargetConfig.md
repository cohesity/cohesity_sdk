...
**original_source_config** | **{str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type** | Specifies the Source configuration if VM&#39;s are being recovered to Original Source. | [optional] 
